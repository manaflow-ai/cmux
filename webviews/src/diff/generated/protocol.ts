...
export type DiffSource = { "kind": "patch", path: string, } | { "kind": "unstaged", repoRoot: string, } | { "kind": "staged", repoRoot: string, } | { "kind": "branch", repoRoot: string, baseRef?: string, } | { "kind": "agentTurn", provider: AgentProvider, sessionId: string, };
