...
GUARDED = (
    ...
    " && github.run_attempt == 2 && contains(needs.changes.outputs.macos_pr_owned_jobs,"
    ...
    "github.event_name == 'workflow_dispatch' && github.ref == 'refs/heads/main' && contains("
