...
check_no_bare_github_hosted_runners() {
  ...
  local hits
  # cla-policy-guard.yml, web-complexity-trusted.yml, and the merge-group
  # required-check bridge are control-plane
  ...
  # or contributor-controlled machine. Exempt these control-plane files here.
