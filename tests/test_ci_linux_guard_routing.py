...
class LinuxGuardRoutingTests(unittest.TestCase):
    ...
    def test_owned_mac_control_plane_runs_only_its_own_guard_lane(self):
        ...
        expected_groups = {
            "scripts/ci/mini_dispatch.py": ("preflight",),
            "scripts/ci/nightly_mini_route.py": ("preflight",),
            ...
            "tests/test_ci_mini_dispatch.py": ("preflight", "quality-determinism"),
            "tests/test_nightly_mini_route.py": ("preflight", "quality-determinism"),
