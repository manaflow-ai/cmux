...
def test_live_socket_injects_supported_hooks(failures: list[str]) -> None:
    code, real_argv, cmux_log, stderr = run_wrapper(socket_state="live", argv=["hello"])
...
def test_missing_socket_skips_hook_injection(failures: list[str]) -> None:
    code, real_argv, cmux_log, stderr = run_wrapper(socket_state="missing", argv=["hello"])
...
def test_stale_socket_skips_hook_injection(failures: list[str]) -> None:
    code, real_argv, cmux_log, stderr = run_wrapper(socket_state="stale", argv=["hello"])
