    ...
    for topic, aliases in topics.items():
        ...
        for invocation in aliases:
            ...
            try:
                ...
                if topic == "cloud":
                    expected += ["cua-driver --version", "cua-driver doctor", "cua-driver mcp", "DISPLAY=:1", "cmux cloud route --json", "would_provision", "route --provision", "terminal wait", "terminal read", "google-chrome-stable --no-first-run --remote-debugging-address=127.0.0.1 --remote-debugging-port=9222", "cmux cloud dev <machine> --no-open"]
