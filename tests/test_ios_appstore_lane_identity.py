...
if "archive" in args:
    ...
    write_plist(
        ...
        {{
            ...
            # Production App Store exports must carry the same runtime-origin
            # contract that the release artifact gate verifies. Keep the fake
            # archive realistic so the test reaches export/upload assertions.
