...
class Workflow(unittest.TestCase):
    ...
    def test_runs_whenever_owned_pools_are_on(self):
        ...
        self.assertEqual(self.doc[True]["workflow_run"]["workflows"][:2], ["CI", "E2E test with video recording"])
        paths = self.doc["env"]["SOURCE_WORKFLOW_PATHS"].split()
        self.assertEqual(set(paths) - {rescue.CI_WORKFLOW_PATH, rescue.E2E_WORKFLOW_PATH},
