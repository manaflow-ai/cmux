...
Please read this Agreement carefully before signing and keep a copy for your records. For a contribution submitted through GitHub, you may sign electronically by posting the exact phrase `I have read the CLA Document and I hereby sign the CLA` as a comment on your pull request. That comment, made from your GitHub account, is your signature and has the same effect as a signed copy returned to Manaflow, Inc. If you cannot sign through GitHub, you may return a completed and signed copy to Manaflow, Inc.
