...
/**
 * Inject SSH keys into a Morph instance
 * Injects the user's registered SSH public keys into the authorized_keys file of a running Morph VM. Useful when new SSH keys have been added or need to be refreshed.
 */
export const postApiMorphTaskRunsByTaskRunIdInjectSshKeysMutation = (options?: Partial<Options<PostApiMorphTaskRunsByTaskRunIdInjectSshKeysData>>): UseMutationOptions<PostApiMorphTaskRunsByTaskRunIdInjectSshKeysResponse, DefaultError, Options<PostApiMorphTaskRunsByTaskRunIdInjectSshKeysData>> => {
    const mutationOptions: UseMutationOptions<PostApiMorphTaskRunsByTaskRunIdInjectSshKeysResponse, DefaultError, Options<PostApiMorphTaskRunsByTaskRunIdInjectSshKeysData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await postApiMorphTaskRunsByTaskRunIdInjectSshKeys({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
 ...
 */
export const getApiUserSshKeysOptions = (options?: Options<GetApiUserSshKeysData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
 ...
 * Delete an SSH key
 */
export const deleteApiUserSshKeysByIdMutation = (options?: Partial<Options<DeleteApiUserSshKeysByIdData>>): UseMutationOptions<DeleteApiUserSshKeysByIdResponse, DefaultError, Options<DeleteApiUserSshKeysByIdData>> => {
    const mutationOptions: UseMutationOptions<DeleteApiUserSshKeysByIdResponse, DefaultError, Options<DeleteApiUserSshKeysByIdData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await deleteApiUserSshKeysById({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
...
/**
 * Import SSH keys from the connected GitHub account
 */
export const postApiUserSshKeysImportGithubMutation = (options?: Partial<Options<PostApiUserSshKeysImportGithubData>>): UseMutationOptions<PostApiUserSshKeysImportGithubResponse, DefaultError, Options<PostApiUserSshKeysImportGithubData>> => {
    const mutationOptions: UseMutationOptions<PostApiUserSshKeysImportGithubResponse, DefaultError, Options<PostApiUserSshKeysImportGithubData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await postApiUserSshKeysImportGithub({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
