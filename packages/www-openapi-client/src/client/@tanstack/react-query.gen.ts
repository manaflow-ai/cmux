 ...
 */
export const putApiIntegrationsGithubPrsMergeMutation = (options?: Partial<Options<PutApiIntegrationsGithubPrsMergeData>>): UseMutationOptions<PutApiIntegrationsGithubPrsMergeResponse, PutApiIntegrationsGithubPrsMergeError, Options<PutApiIntegrationsGithubPrsMergeData>> => {
    const mutationOptions: UseMutationOptions<PutApiIntegrationsGithubPrsMergeResponse, PutApiIntegrationsGithubPrsMergeError, Options<PutApiIntegrationsGithubPrsMergeData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await putApiIntegrationsGithubPrsMerge({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
 ...
 */
export const patchApiIntegrationsGithubPrsCloseMutation = (options?: Partial<Options<PatchApiIntegrationsGithubPrsCloseData>>): UseMutationOptions<PatchApiIntegrationsGithubPrsCloseResponse, PatchApiIntegrationsGithubPrsCloseError, Options<PatchApiIntegrationsGithubPrsCloseData>> => {
    const mutationOptions: UseMutationOptions<PatchApiIntegrationsGithubPrsCloseResponse, PatchApiIntegrationsGithubPrsCloseError, Options<PatchApiIntegrationsGithubPrsCloseData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await patchApiIntegrationsGithubPrsClose({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
