 ...
 */
export const putApiIntegrationsGithubPrsMerge = <ThrowOnError extends boolean = false>(options: Options<PutApiIntegrationsGithubPrsMergeData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).put<PutApiIntegrationsGithubPrsMergeResponses, PutApiIntegrationsGithubPrsMergeErrors, ThrowOnError>({
        url: '/api/integrations/github/prs/merge',
        ...options,
        headers: {
            'Content-Type': 'application/json',
 ...
 */
export const patchApiIntegrationsGithubPrsClose = <ThrowOnError extends boolean = false>(options: Options<PatchApiIntegrationsGithubPrsCloseData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).patch<PatchApiIntegrationsGithubPrsCloseResponses, PatchApiIntegrationsGithubPrsCloseErrors, ThrowOnError>({
