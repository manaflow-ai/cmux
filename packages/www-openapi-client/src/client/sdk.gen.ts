 ...
 */
export const postApiMorphTaskRunsByTaskRunIdInjectSshKeys = <ThrowOnError extends boolean = false>(options: Options<PostApiMorphTaskRunsByTaskRunIdInjectSshKeysData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostApiMorphTaskRunsByTaskRunIdInjectSshKeysResponses, PostApiMorphTaskRunsByTaskRunIdInjectSshKeysErrors, ThrowOnError>({
 ...
 */
export const getApiUserSshKeys = <ThrowOnError extends boolean = false>(options?: Options<GetApiUserSshKeysData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetApiUserSshKeysResponses, GetApiUserSshKeysErrors, ThrowOnError>({
 ...
 */
export const postApiUserSshKeys = <ThrowOnError extends boolean = false>(options: Options<PostApiUserSshKeysData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostApiUserSshKeysResponses, PostApiUserSshKeysErrors, ThrowOnError>({
        url: '/api/user/ssh-keys',
        ...options,
        headers: {
            'Content-Type': 'application/json',
 ...
 * Delete an SSH key
 */
export const deleteApiUserSshKeysById = <ThrowOnError extends boolean = false>(options: Options<DeleteApiUserSshKeysByIdData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).delete<DeleteApiUserSshKeysByIdResponses, DeleteApiUserSshKeysByIdErrors, ThrowOnError>({
 ...
 */
export const postApiUserSshKeysImportGithub = <ThrowOnError extends boolean = false>(options?: Options<PostApiUserSshKeysImportGithubData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).post<PostApiUserSshKeysImportGithubResponses, PostApiUserSshKeysImportGithubErrors, ThrowOnError>({
