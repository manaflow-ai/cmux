...
- **Prompt snippets and custom commands** — Define reusable prompts and project-specific actions in [`cmux.json`](https://cmux.com/docs/custom-commands) that launch from the command palette
