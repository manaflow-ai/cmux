...
| `app.showWorkspaceTitleBar` | boolean | `true` | Show the workspace title row while keeping pane tabs independent. Minimal Mode always hides the row and preserves this preference. |
