...
| `terminal.macosPressAndHold` | boolean | `false` | When true, held letters open the macOS accent menu without repeating into the terminal. Key repeat stays disabled for those letters while the menu is open. |
