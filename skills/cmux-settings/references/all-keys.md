...
| `app.defaultWorkspacePath` | string | `""` | Folder the Open Folder panel starts in, for example ~/code. Supports ~ and $VAR. Leave empty to start in the active workspace's directory. |
