...
| `app.equalizeSplitsOnCreate` | boolean | `false` | When true, creating a split resizes the panes along that split's direction to equal sizes. When false, a new split halves the pane it was created from. |
