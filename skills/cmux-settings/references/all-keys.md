...
| `browser.engine` | `"webkit"` or `"chromium"` | `"webkit"` | Engine for new browser surfaces. Experimental; `chromium` requires an installed OWL Chromium runtime, see docs/chromium-runtime.md. |
