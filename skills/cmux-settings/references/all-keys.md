...
| `terminal.prefixProgramTitlesWithDirectory` | boolean | `false` | When true, prefix program-set terminal titles with the current directory name. Titles beginning with `~` or already identifying the directory are left unchanged. |
