...
| `app.singleWindowMode` | boolean | `false` | When true, automatic workspace requests reuse an existing main window instead of creating a fallback window. Explicit New Window commands still create windows. |
