...
| `sidebar.lastInteractionTimestampStyle` | `"relative"` or `"absolute"` | `"relative"` | How the last-interaction label renders the timestamp: a ticking "now/12m/3h/2d" bucket, or a static absolute time-of-day with seconds. |
