...
- Sidebar details: `sidebar.hideAllDetails`, `sidebar.wrapWorkspaceTitles`, `sidebar.hideWorkspaceCloseButton`, `sidebar.showBranchDirectory`, `sidebar.showPullRequests`, `sidebar.showPorts`, `sidebar.showLog`.
