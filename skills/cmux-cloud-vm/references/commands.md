...
- **Socket methods:** the advertised `vm.scp_info` method returns the machine's SCP transfer connection details for clients that need to move files without exposing provider credentials.
