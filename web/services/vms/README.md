...
- `CMUX_VM_PLAN_FREE_CREATE_CREDIT_ITEM_ID`, optional Stack Auth team item used as the free-plan create-credit bucket. Leave unset, or set to `none`, `disabled`, `off`, or `false`, to avoid a total-create cap.
