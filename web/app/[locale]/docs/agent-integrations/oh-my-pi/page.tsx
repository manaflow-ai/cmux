...
export default function OhMyPiPage() {
  ...
  return (
    <>
      ...
      <CodeBlock lang="bash">{`cmux omp
cmux omp --madmax --high
cmux omp team`}</CodeBlock>
      <p>{t("usageDesc")}</p>
      ...
      <CodeBlock lang="bash">{`npm install -g @oh-my-pi/pi-coding-agent oh-my-pi
omp setup
omp doctor`}</CodeBlock>
      ...
      <table>
        ...
        <tbody>
          <tr><td><code>~/.cmuxterm/omp-bin/</code></td><td>{t("dirShim")}</td></tr>
