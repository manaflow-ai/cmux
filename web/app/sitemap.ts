...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const paths = [
    ...
    { path: "/gemini-cli", lastModified: "2026-06-23", changeFrequency: "monthly" as const, priority: 0.6 },
    { path: "/aider", lastModified: "2026-06-23", changeFrequency: "monthly" as const, priority: 0.6 },
    { path: "/amp", lastModified: "2026-06-23", changeFrequency: "monthly" as const, priority: 0.6 },
    { path: "/cursor-cli", lastModified: "2026-06-23", changeFrequency: "monthly" as const, priority: 0.6 },
