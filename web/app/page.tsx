      ...
      <main className="w-full max-w-2xl mx-auto px-6 py-16 sm:py-24">
        ...
        <div className="flex items-center gap-3" data-dev="download" style={{ marginTop: 21, marginBottom: 33 }}>
          ...
          <a
            ...
            className="inline-flex items-center gap-2 rounded-full border border-border px-5 py-2.5 text-[15px] font-medium text-foreground hover:bg-code-bg transition-colors"
          >
