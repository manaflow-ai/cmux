  ...
  },
  {
    ...
    shortcuts: [
      ...
      { id: "focusDown", combos: [["⌥", "⌘", "↓"]], description: { en: "Focus pane down", ja: "下のペインにフォーカス" } },
      {
        id: "resizeSplitLeft",
        combos: [],
        description: { en: "Resize split left", ja: "分割を左にリサイズ" },
        note: { en: "unbound by default", ja: "デフォルトでは未割り当て" },
      },
      {
        id: "resizeSplitRight",
        combos: [],
        description: { en: "Resize split right", ja: "分割を右にリサイズ" },
        note: { en: "unbound by default", ja: "デフォルトでは未割り当て" },
      },
      {
        id: "resizeSplitUp",
        combos: [],
        description: { en: "Resize split up", ja: "分割を上にリサイズ" },
        note: { en: "unbound by default", ja: "デフォルトでは未割り当て" },
      },
      {
        id: "resizeSplitDown",
        combos: [],
        description: { en: "Resize split down", ja: "分割を下にリサイズ" },
        note: { en: "unbound by default", ja: "デフォルトでは未割り当て" },
      },
