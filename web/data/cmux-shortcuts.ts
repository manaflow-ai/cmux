  ...
  },
  {
    ...
    shortcuts: [
      ...
      { id: "moveWorkspaceDown", combos: [["⌃", "⌥", "⌘", "]"]], description: { en: "Move workspace down", ja: "ワークスペースを下へ移動" } },
      {
        ...
        combos: [],
        description: {
          en: "Move workspace to top",
          ja: "ワークスペースを先頭へ移動",
          "zh-CN": "将工作区移到顶部",
          "zh-TW": "將工作區移到頂部",
          ko: "워크스페이스를 맨 위로 이동",
          de: "Arbeitsbereich nach oben verschieben",
          es: "Mover el espacio de trabajo arriba",
          fr: "Déplacer l’espace de travail en haut",
          it: "Sposta lo spazio di lavoro in cima",
          da: "Flyt arbejdsområdet øverst",
          pl: "Przenieś obszar roboczy na górę",
          ru: "Переместить рабочее пространство наверх",
          bs: "Premjesti radni prostor na vrh",
          ar: "نقل مساحة العمل إلى الأعلى",
          no: "Flytt arbeidsområdet øverst",
          "pt-BR": "Mover o espaço de trabalho para o topo",
          th: "ย้ายพื้นที่ทำงานไปด้านบน",
          tr: "Çalışma alanını en üste taşı",
          km: "ផ្លាស់ទីកន្លែងធ្វើការទៅកំពូល",
          uk: "Перемістити робочий простір угору",
        },
      },
      {
        id: "focusHistoryBack",
