...
export const shortcutCategories: ShortcutCategory[] = [
  ...
  },
  {
    ...
    shortcuts: [
      ...
      { id: "markdownFindNextAlternate", combos: [["⌃", "N"]], description: { en: "Find next match in Markdown preview", ja: "Markdown プレビューで次を検索" } },
      { id: "markdownFindPreviousAlternate", combos: [["⌃", "P"]], description: { en: "Find previous match in Markdown preview", ja: "Markdown プレビューで前を検索" } },
    ],
  },
  {
    id: "split-panes",
