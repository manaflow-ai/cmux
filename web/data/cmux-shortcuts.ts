...
export const shortcutCategories: ShortcutCategory[] = [
  ...
  },
  {
    ...
    shortcuts: [
      ...
      {
        id: "movePaneToNewOuterSplitLeft",
        combos: [],
        description: {
          ar: "نقل اللوحة إلى تقسيم خارجي جديد على اليسار",
          bs: "Premjesti panel u novi vanjski razdjeljak lijevo",
          da: "Flyt panelet til en ny ydre opdeling til venstre",
          de: "Pane in eine neue äußere Teilung nach links verschieben",
          en: "Move pane to a new outer split on the left",
          es: "Mover el panel a una nueva división exterior a la izquierda",
          fr: "Déplacer le panneau vers une nouvelle division extérieure à gauche",
          it: "Sposta il pannello in una nuova divisione esterna a sinistra",
          ja: "ペインを左側の新しい外側分割へ移動",
          km: "ផ្លាស់ទីផ្ទាំងទៅការបែងចែកខាងក្រៅថ្មីនៅខាងឆ្វេង",
          ko: "패널을 왼쪽의 새 외부 분할로 이동",
          no: "Flytt panelet til en ny ytre deling til venstre",
          pl: "Przenieś panel do nowego zewnętrznego podziału po lewej stronie",
          "pt-BR": "Mover o painel para uma nova divisão externa à esquerda",
          ru: "Переместить панель в новое внешнее разделение слева",
          th: "ย้ายบานหน้าต่างไปยังการแบ่งภายนอกใหม่ทางซ้าย",
          tr: "Bölmeyi soldaki yeni bir dış bölmeye taşı",
          uk: "Перемістити панель у новий зовнішній розділ ліворуч",
          "zh-CN": "将面板移动到左侧的新外部分屏",
          "zh-TW": "將面板移動到左側的新外部分割",
        },
        note: {
      ...
      {
        id: "movePaneToNewOuterSplitRight",
        combos: [],
        description: {
          ar: "نقل اللوحة إلى تقسيم خارجي جديد على اليمين",
          bs: "Premjesti panel u novi vanjski razdjeljak desno",
          da: "Flyt panelet til en ny ydre opdeling til højre",
          de: "Pane in eine neue äußere Teilung nach rechts verschieben",
          en: "Move pane to a new outer split on the right",
          es: "Mover el panel a una nueva división exterior a la derecha",
          fr: "Déplacer le panneau vers une nouvelle division extérieure à droite",
          it: "Sposta il pannello in una nuova divisione esterna a destra",
          ja: "ペインを右側の新しい外側分割へ移動",
          km: "ផ្លាស់ទីផ្ទាំងទៅការបែងចែកខាងក្រៅថ្មីនៅខាងស្តាំ",
          ko: "패널을 오른쪽의 새 외부 분할로 이동",
          no: "Flytt panelet til en ny ytre deling til høyre",
          pl: "Przenieś panel do nowego zewnętrznego podziału po prawej stronie",
          "pt-BR": "Mover o painel para uma nova divisão externa à direita",
          ru: "Переместить панель в новое внешнее разделение справа",
          th: "ย้ายบานหน้าต่างไปยังการแบ่งภายนอกใหม่ทางขวา",
          tr: "Bölmeyi sağdaki yeni bir dış bölmeye taşı",
          uk: "Перемістити панель у новий зовнішній розділ праворуч",
          "zh-CN": "将面板移动到右侧的新外部分屏",
          "zh-TW": "將面板移動到右側的新外部分割",
        },
        note: {
          ar: "غير مُعيّن افتراضيًا",
          bs: "nije dodijeljeno prema zadanim postavkama",
      ...
      {
        id: "movePaneToNewOuterSplitAbove",
        combos: [],
        description: {
          ar: "نقل اللوحة إلى تقسيم خارجي جديد في الأعلى",
          bs: "Premjesti panel u novi vanjski razdjeljak iznad",
          da: "Flyt panelet til en ny ydre opdeling ovenfor",
          de: "Pane in eine neue äußere Teilung nach oben verschieben",
          en: "Move pane to a new outer split above",
          es: "Mover el panel a una nueva división exterior arriba",
          fr: "Déplacer le panneau vers une nouvelle division extérieure au-dessus",
          it: "Sposta il pannello in una nuova divisione esterna sopra",
          ja: "ペインを上側の新しい外側分割へ移動",
          km: "ផ្លាស់ទីផ្ទាំងទៅការបែងចែកខាងក្រៅថ្មីនៅខាងលើ",
          ko: "패널을 위쪽의 새 외부 분할로 이동",
          no: "Flytt panelet til en ny ytre deling over",
          pl: "Przenieś panel do nowego zewnętrznego podziału powyżej",
          "pt-BR": "Mover o painel para uma nova divisão externa acima",
          ru: "Переместить панель в новое внешнее разделение сверху",
          th: "ย้ายบานหน้าต่างไปยังการแบ่งภายนอกใหม่ด้านบน",
          tr: "Bölmeyi yukarıdaki yeni bir dış bölmeye taşı",
          uk: "Перемістити панель у новий зовнішній розділ вище",
          "zh-CN": "将面板移动到上方的新外部分屏",
          "zh-TW": "將面板移動到上方的新外部分割",
        },
        note: {
          ar: "غير مُعيّن افتراضيًا",
          bs: "nije dodijeljeno prema zadanim postavkama",
      ...
      {
        id: "movePaneToNewOuterSplitBelow",
        combos: [],
        description: {
          ar: "نقل اللوحة إلى تقسيم خارجي جديد في الأسفل",
          bs: "Premjesti panel u novi vanjski razdjeljak ispod",
          da: "Flyt panelet til en ny ydre opdeling nedenfor",
          de: "Pane in eine neue äußere Teilung nach unten verschieben",
          en: "Move pane to a new outer split below",
          es: "Mover el panel a una nueva división exterior abajo",
          fr: "Déplacer le panneau vers une nouvelle division extérieure au-dessous",
          it: "Sposta il pannello in una nuova divisione esterna sotto",
          ja: "ペインを下側の新しい外側分割へ移動",
          km: "ផ្លាស់ទីផ្ទាំងទៅការបែងចែកខាងក្រៅថ្មីនៅខាងក្រោម",
          ko: "패널을 아래쪽의 새 외부 분할로 이동",
          no: "Flytt panelet til en ny ytre deling under",
          pl: "Przenieś panel do nowego zewnętrznego podziału poniżej",
          "pt-BR": "Mover o painel para uma nova divisão externa abaixo",
          ru: "Переместить панель в новое внешнее разделение снизу",
          th: "ย้ายบานหน้าต่างไปยังการแบ่งภายนอกใหม่ด้านล่าง",
          tr: "Bölmeyi aşağıdaki yeni bir dış bölmeye taşı",
          uk: "Перемістити панель у новий зовнішній розділ нижче",
          "zh-CN": "将面板移动到下方的新外部分屏",
          "zh-TW": "將面板移動到下方的新外部分割",
        },
        note: {
          ar: "غير مُعيّن افتراضيًا",
          bs: "nije dodijeljeno prema zadanim postavkama",
