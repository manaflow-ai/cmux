...
export const shortcutCategories: ShortcutCategory[] = [
  ...
  },
  {
    ...
    shortcuts: [
      ...
      { id: "markdownFindForward", combos: [["/"], ["⌘", "F"]], description: { en: "Search Markdown preview forward", ja: "Markdown プレビューを前方検索" } },
      { id: "markdownFindBackward", combos: [["⇧", "/"]], description: { en: "Search Markdown preview backward", ja: "Markdown プレビューを後方検索" } },
      { id: "markdownFindNext", combos: [["N"], ["⌃", "N"], ["⌘", "G"]], description: { en: "Find next match in Markdown preview", ja: "Markdown プレビューで次を検索" } },
      { id: "markdownFindPrevious", combos: [["⇧", "N"], ["⌃", "P"], ["⌥", "⌘", "G"]], description: { en: "Find previous match in Markdown preview", ja: "Markdown プレビューで前を検索" } },
    ],
  },
  {
    id: "split-panes",
