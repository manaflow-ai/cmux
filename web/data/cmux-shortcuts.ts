  ...
  },
  {
    ...
    shortcuts: [
      ...
      { id: "focusRightSidebar", combos: [["⌘", "⇧", "E"]], description: { en: "Toggle right-sidebar focus", ja: "右サイドバーのフォーカスを切り替え" } },
      {
        ...
        combos: [["⌃", "6"]],
        description: {
          en: "Show Source Control in the right sidebar",
          ja: "右サイドバーにソース管理を表示",
          "zh-CN": "在右侧边栏显示源代码管理",
          "zh-TW": "在右側邊欄顯示原始碼管理",
          ko: "오른쪽 사이드바에 소스 제어 표시",
          de: "Quellcodeverwaltung in der rechten Seitenleiste anzeigen",
          es: "Mostrar el control de código fuente en la barra lateral derecha",
          fr: "Afficher le contrôle de code source dans la barre latérale droite",
          it: "Mostra il controllo del codice sorgente nella barra laterale destra",
          da: "Vis kildekodekontrol i højre sidepanel",
          pl: "Pokaż kontrolę kodu źródłowego na prawym pasku bocznym",
          ru: "Показать управление исходным кодом в правой боковой панели",
          bs: "Prikaži kontrolu izvornog koda u desnoj bočnoj traci",
          ar: "إظهار التحكم بالمصدر في الشريط الجانبي الأيمن",
          no: "Vis kildekodekontroll i høyre sidepanel",
          "pt-BR": "Mostrar controle de código-fonte na barra lateral direita",
          th: "แสดงการควบคุมซอร์สโค้ดในแถบด้านขวา",
          tr: "Kaynak Denetimini sağ kenar çubuğunda göster",
          km: "បង្ហាញការគ្រប់គ្រងកូដប្រភពក្នុងរបារចំហៀងខាងស្តាំ",
          uk: "Показати керування вихідним кодом у правій бічній панелі",
        },
        note: {
          en: "Beta: enable Source Control in Settings > Beta Features first.",
          ja: "ベータ機能です。先に「設定」>「ベータ機能」でソース管理を有効にしてください。",
          "zh-CN": "测试功能：请先在“设置”>“测试功能”中启用源代码管理。",
          "zh-TW": "測試功能：請先在「設定」>「測試功能」中啟用原始碼管理。",
          ko: "베타 기능입니다. 먼저 설정 > 베타 기능에서 소스 제어를 활성화하세요.",
          de: "Beta: Aktivieren Sie zuerst die Quellcodeverwaltung unter Einstellungen > Betafunktionen.",
          es: "Beta: activa primero el control de código fuente en Configuración > Funciones beta.",
          fr: "Bêta : activez d'abord le contrôle de code source dans Réglages > Fonctionnalités bêta.",
          it: "Beta: abilita prima il controllo del codice sorgente in Impostazioni > Funzionalità beta.",
          da: "Beta: Aktivér først kildekodekontrol under Indstillinger > Betafunktioner.",
          pl: "Beta: najpierw włącz kontrolę kodu źródłowego w Ustawienia > Funkcje beta.",
          ru: "Бета-функция: сначала включите управление исходным кодом в Настройки > Бета-функции.",
          bs: "Beta: prvo omogućite kontrolu izvornog koda u Postavke > Beta funkcije.",
          ar: "إصدار تجريبي: فعّل التحكم بالمصدر أولاً من الإعدادات > الميزات التجريبية.",
          no: "Beta: aktiver kildekodekontroll først under Innstillinger > Betafunksjoner.",
          "pt-BR": "Beta: ative primeiro o controle de código-fonte em Ajustes > Recursos beta.",
          th: "เบต้า: เปิดใช้การควบคุมซอร์สโค้ดก่อนที่ การตั้งค่า > ฟีเจอร์เบต้า",
          tr: "Beta: önce Ayarlar > Beta Özellikleri bölümünden Kaynak Denetimini etkinleştirin.",
          km: "បេតា៖ សូមបើកការគ្រប់គ្រងកូដប្រភពជាមុននៅ ការកំណត់ > មុខងារបេតា។",
          uk: "Бета: спочатку ввімкніть керування вихідним кодом у Налаштуваннях > Бета-функції.",
        },
      },
      {
