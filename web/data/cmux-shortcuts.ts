...
export const shortcutCategories: ShortcutCategory[] = [
  ...
  },
  {
    ...
    shortcuts: [
      ...
      { id: "scrollbackPageUp", combos: [["⇧", "Page Up"]], description: { en: "Scroll terminal page up", ja: "ターミナルを1ページ上へスクロール" } },
      { id: "scrollbackPageDown", combos: [["⇧", "Page Down"]], description: { en: "Scroll terminal page down", ja: "ターミナルを1ページ下へスクロール" } },
      { id: "scrollbackLineUp", combos: [["⇧", "↑"]], description: { en: "Scroll terminal line up", ja: "ターミナルを1行上へスクロール" } },
      { id: "scrollbackLineDown", combos: [["⇧", "↓"]], description: { en: "Scroll terminal line down", ja: "ターミナルを1行下へスクロール" } },
