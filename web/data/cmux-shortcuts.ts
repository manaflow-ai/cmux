...
const nearestWidthSplitNote: LocalizedText = {
  ar: "أقرب تقسيم حاوٍ على محور العرض",
  bs: "najbliža obuhvatna podjela po širini",
  da: "nærmeste omsluttende breddeopdeling",
  de: "nächstgelegene umschließende Breitenaufteilung",
  en: "nearest enclosing width split",
  es: "división de ancho contenedora más cercana",
  fr: "division de largeur parente la plus proche",
  it: "divisione di larghezza contenitrice più vicina",
  ja: "最も近い幅方向の親分割",
  km: "ការបែងចែកទទឹងមេដែលនៅជិតបំផុត",
  ko: "가장 가까운 상위 너비 분할",
  no: "nærmeste omsluttende breddeinndeling",
  pl: "najbliższy nadrzędny podział szerokości",
  "pt-BR": "divisão de largura contêiner mais próxima",
  ru: "ближайшее охватывающее разделение по ширине",
  th: "การแบ่งความกว้างครอบที่ใกล้ที่สุด",
  tr: "en yakın kapsayıcı genişlik bölmesi",
  uk: "найближчий охоплювальний поділ за шириною",
  "zh-CN": "最近的上层宽度分割",
  "zh-TW": "最近的上層寬度分割",
};

const nearestHeightSplitNote: LocalizedText = {
  ar: "أقرب تقسيم حاوٍ على محور الارتفاع",
  bs: "najbliža obuhvatna podjela po visini",
  da: "nærmeste omsluttende højdeopdeling",
  de: "nächstgelegene umschließende Höhenaufteilung",
  en: "nearest enclosing height split",
  es: "división de altura contenedora más cercana",
  fr: "division de hauteur parente la plus proche",
  it: "divisione di altezza contenitrice più vicina",
  ja: "最も近い高さ方向の親分割",
  km: "ការបែងចែកកម្ពស់មេដែលនៅជិតបំផុត",
  ko: "가장 가까운 상위 높이 분할",
  no: "nærmeste omsluttende høydeinndeling",
  pl: "najbliższy nadrzędny podział wysokości",
  "pt-BR": "divisão de altura contêiner mais próxima",
  ru: "ближайшее охватывающее разделение по высоте",
  th: "การแบ่งความสูงครอบที่ใกล้ที่สุด",
  tr: "en yakın kapsayıcı yükseklik bölmesi",
  uk: "найближчий охоплювальний поділ за висотою",
  "zh-CN": "最近的上层高度分割",
  "zh-TW": "最近的上層高度分割",
};
...
export const shortcutCategories: ShortcutCategory[] = [
  ...
  },
  {
    ...
    shortcuts: [
      ...
      {
        id: "setPaneWidth25Percent",
        combos: [["⌥", "⌘", "1"]],
        description: {
          ar: "تعيين عرض اللوحة إلى 25٪",
          bs: "Postavi širinu panela na 25%",
          da: "Indstil panelbredde til 25 %",
          de: "Bereichsbreite auf 25 % setzen",
          en: "Set Pane Width to 25%",
          es: "Establecer ancho del panel al 25 %",
          fr: "Définir la largeur du panneau à 25 %",
          it: "Imposta larghezza pannello al 25%",
          ja: "ペインの幅を25%に設定",
          km: "កំណត់ទទឹងផ្ទាំងទៅ 25%",
          ko: "패널 너비를 25%로 설정",
          no: "Sett panelbredden til 25 %",
          pl: "Ustaw szerokość panelu na 25%",
          "pt-BR": "Definir largura do painel como 25%",
          ru: "Установить ширину панели на 25 %",
          th: "ตั้งค่าความกว้างบานหน้าต่างเป็น 25%",
          tr: "Bölme genişliğini %25 olarak ayarla",
          uk: "Установити ширину панелі на 25%",
          "zh-CN": "将面板宽度设为 25%",
          "zh-TW": "將面板寬度設為 25%",
        },
        note: nearestWidthSplitNote,
      },
      {
        id: "setPaneWidth50Percent",
        combos: [["⌥", "⌘", "2"]],
        description: {
          ar: "تعيين عرض اللوحة إلى 50٪",
          bs: "Postavi širinu panela na 50%",
          da: "Indstil panelbredde til 50 %",
          de: "Bereichsbreite auf 50 % setzen",
          en: "Set Pane Width to 50%",
          es: "Establecer ancho del panel al 50 %",
          fr: "Définir la largeur du panneau à 50 %",
          it: "Imposta larghezza pannello al 50%",
          ja: "ペインの幅を50%に設定",
          km: "កំណត់ទទឹងផ្ទាំងទៅ 50%",
          ko: "패널 너비를 50%로 설정",
          no: "Sett panelbredden til 50 %",
          pl: "Ustaw szerokość panelu na 50%",
          "pt-BR": "Definir largura do painel como 50%",
          ru: "Установить ширину панели на 50 %",
          th: "ตั้งค่าความกว้างบานหน้าต่างเป็น 50%",
          tr: "Bölme genişliğini %50 olarak ayarla",
          uk: "Установити ширину панелі на 50%",
          "zh-CN": "将面板宽度设为 50%",
          "zh-TW": "將面板寬度設為 50%",
        },
        note: nearestWidthSplitNote,
      ...
      {
        id: "setPaneWidth75Percent",
        combos: [["⌥", "⌘", "3"]],
        description: {
          ar: "تعيين عرض اللوحة إلى 75٪",
          bs: "Postavi širinu panela na 75%",
          da: "Indstil panelbredde til 75 %",
          de: "Bereichsbreite auf 75 % setzen",
          en: "Set Pane Width to 75%",
          es: "Establecer ancho del panel al 75 %",
          fr: "Définir la largeur du panneau à 75 %",
          it: "Imposta larghezza pannello al 75%",
          ja: "ペインの幅を75%に設定",
          km: "កំណត់ទទឹងផ្ទាំងទៅ 75%",
          ko: "패널 너비를 75%로 설정",
          no: "Sett panelbredden til 75 %",
          pl: "Ustaw szerokość panelu na 75%",
          "pt-BR": "Definir largura do painel como 75%",
          ru: "Установить ширину панели на 75 %",
          th: "ตั้งค่าความกว้างบานหน้าต่างเป็น 75%",
          tr: "Bölme genişliğini %75 olarak ayarla",
          uk: "Установити ширину панелі на 75%",
          "zh-CN": "将面板宽度设为 75%",
          "zh-TW": "將面板寬度設為 75%",
        },
        note: nearestWidthSplitNote,
      ...
      {
        id: "setPaneHeight25Percent",
        combos: [["⌥", "⌘", "⇧", "1"]],
        description: {
          ar: "تعيين ارتفاع اللوحة إلى 25٪",
          bs: "Postavi visinu panela na 25%",
          da: "Indstil panelhøjde til 25 %",
          de: "Bereichshöhe auf 25 % setzen",
          en: "Set Pane Height to 25%",
          es: "Establecer altura del panel al 25 %",
          fr: "Définir la hauteur du panneau à 25 %",
          it: "Imposta altezza pannello al 25%",
          ja: "ペインの高さを25%に設定",
          km: "កំណត់កម្ពស់ផ្ទាំងទៅ 25%",
          ko: "패널 높이를 25%로 설정",
          no: "Sett panelhøyden til 25 %",
          pl: "Ustaw wysokość panelu na 25%",
          "pt-BR": "Definir altura do painel como 25%",
          ru: "Установить высоту панели на 25 %",
          th: "ตั้งค่าความสูงบานหน้าต่างเป็น 25%",
          tr: "Bölme yüksekliğini %25 olarak ayarla",
          uk: "Установити висоту панелі на 25%",
          "zh-CN": "将面板高度设为 25%",
          "zh-TW": "將面板高度設為 25%",
        },
        note: nearestHeightSplitNote,
      },
      {
        id: "setPaneHeight50Percent",
        combos: [["⌥", "⌘", "⇧", "2"]],
        description: {
          ar: "تعيين ارتفاع اللوحة إلى 50٪",
          bs: "Postavi visinu panela na 50%",
          da: "Indstil panelhøjde til 50 %",
          de: "Bereichshöhe auf 50 % setzen",
          en: "Set Pane Height to 50%",
          es: "Establecer altura del panel al 50 %",
          fr: "Définir la hauteur du panneau à 50 %",
          it: "Imposta altezza pannello al 50%",
          ja: "ペインの高さを50%に設定",
          km: "កំណត់កម្ពស់ផ្ទាំងទៅ 50%",
          ko: "패널 높이를 50%로 설정",
          no: "Sett panelhøyden til 50 %",
          pl: "Ustaw wysokość panelu na 50%",
          "pt-BR": "Definir altura do painel como 50%",
          ru: "Установить высоту панели на 50 %",
          th: "ตั้งค่าความสูงบานหน้าต่างเป็น 50%",
          tr: "Bölme yüksekliğini %50 olarak ayarla",
          uk: "Установити висоту панелі на 50%",
          "zh-CN": "将面板高度设为 50%",
          "zh-TW": "將面板高度設為 50%",
        },
        note: nearestHeightSplitNote,
      ...
      {
        id: "setPaneHeight75Percent",
        combos: [["⌥", "⌘", "⇧", "3"]],
        description: {
          ar: "تعيين ارتفاع اللوحة إلى 75٪",
          bs: "Postavi visinu panela na 75%",
          da: "Indstil panelhøjde til 75 %",
          de: "Bereichshöhe auf 75 % setzen",
          en: "Set Pane Height to 75%",
          es: "Establecer altura del panel al 75 %",
          fr: "Définir la hauteur du panneau à 75 %",
          it: "Imposta altezza pannello al 75%",
          ja: "ペインの高さを75%に設定",
          km: "កំណត់កម្ពស់ផ្ទាំងទៅ 75%",
          ko: "패널 높이를 75%로 설정",
          no: "Sett panelhøyden til 75 %",
          pl: "Ustaw wysokość panelu na 75%",
          "pt-BR": "Definir altura do painel como 75%",
          ru: "Установить высоту панели на 75 %",
          th: "ตั้งค่าความสูงบานหน้าต่างเป็น 75%",
          tr: "Bölme yüksekliğini %75 olarak ayarla",
          uk: "Установити висоту панелі на 75%",
          "zh-CN": "将面板高度设为 75%",
          "zh-TW": "將面板高度設為 75%",
        },
        note: nearestHeightSplitNote,
