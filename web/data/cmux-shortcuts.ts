...
export const shortcutCategories: ShortcutCategory[] = [
  ...
  },
  {
    ...
    shortcuts: [
      ...
      {
        id: "toggleZoomableSplitLayout",
        combos: [],
        description: { en: "Toggle zoomable split layout", ja: "ズーム可能な分割レイアウトを切り替え" },
        note: { en: "unbound by default", ja: "デフォルトでは未割り当て" },
      },
      { id: "canvasRevealFocusedPane", combos: [["⌃", "⌘", "R"]], description: { en: "Reveal focused pane in canvas or zoomable splits", ja: "キャンバスまたはズーム可能な分割でフォーカス中のペインを表示" } },
      { id: "canvasOverview", combos: [["⌃", "⌘", "O"]], description: { en: "Toggle canvas or zoomable split overview", ja: "キャンバスまたはズーム可能な分割の全体表示を切り替え" } },
      { id: "canvasZoomIn", combos: [["⌥", "⌘", "="]], description: { en: "Zoom in canvas or zoomable splits", ja: "キャンバスまたはズーム可能な分割を拡大" } },
      { id: "canvasZoomOut", combos: [["⌥", "⌘", "-"]], description: { en: "Zoom out canvas or zoomable splits", ja: "キャンバスまたはズーム可能な分割を縮小" } },
      { id: "canvasZoomReset", combos: [["⌥", "⌘", "0"]], description: { en: "Actual size in canvas or zoomable splits", ja: "キャンバスまたはズーム可能な分割を実寸表示" } },
