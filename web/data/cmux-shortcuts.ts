    ...
    shortcuts: [
      ...
      { id: "splitDown", combos: [["⌘", "⇧", "D"]], description: { en: "Split down", ja: "下に分割" } },
      {
        ...
        description: {
          ...
          "zh-CN": "向右拆分工作区根布局",
          "zh-TW": "向右分割工作區根版面",
          "ko": "워크스페이스 루트를 오른쪽으로 분할",
          "de": "Arbeitsbereich-Wurzel nach rechts teilen",
          "es": "Dividir la raíz a la derecha",
          "fr": "Diviser la racine à droite",
          "it": "Dividi la radice a destra",
          "da": "Opdel roden til højre",
          "pl": "Podziel główny układ w prawo",
          "ru": "Разделить корень вправо",
          "bs": "Podijeli korijen desno",
          "ar": "تقسيم جذر مساحة العمل إلى اليمين",
          "no": "Del arbeidsområderot til høyre",
          "pt-BR": "Dividir a raiz para a direita",
          "th": "แยกรากไปทางขวา",
          "tr": "Kökü sağa böl",
          "km": "បំបែកប្លង់មេនៃកន្លែងធ្វើការទៅស្តាំ",
          "uk": "Розділити корінь праворуч",
      ...
      },
      {
        ...
        description: {
          ...
          "zh-CN": "向下拆分工作区根布局",
          "zh-TW": "向下分割工作區根版面",
          "ko": "워크스페이스 루트를 아래로 분할",
          "de": "Arbeitsbereich-Wurzel nach unten teilen",
          "es": "Dividir la raíz hacia abajo",
          "fr": "Diviser la racine vers le bas",
          "it": "Dividi la radice in basso",
          "da": "Opdel roden nedad",
          "pl": "Podziel główny układ w dół",
          "ru": "Разделить корень вниз",
          "bs": "Podijeli korijen dolje",
          "ar": "تقسيم جذر مساحة العمل إلى الأسفل",
          "no": "Del arbeidsområderot ned",
          "pt-BR": "Dividir a raiz para baixo",
          "th": "แยกรากลงล่าง",
          "tr": "Kökü aşağı böl",
          "km": "បំបែកប្លង់មេនៃកន្លែងធ្វើការចុះក្រោម",
          "uk": "Розділити корінь вниз",
        } satisfies Record<Locale, string>,
        note: {
          "en": "unbound by default",
          "ja": "デフォルトでは未割り当て",
