  ...
  },
  {
    ...
    shortcuts: [
      ...
      { id: "equalizeSplits", combos: [["⌃", "⌘", "⇧", "="]], description: { en: "Equalize split sizes", ja: "分割サイズを均等にする" } },
      {
        id: "growPaneLeft",
        combos: [],
        description: { en: "Grow the focused pane toward the left", ja: "フォーカス中のペインを左方向に拡大" },
        note: { en: "unbound by default", ja: "デフォルトでは未割り当て" },
      },
      {
        id: "growPaneRight",
        combos: [],
        description: { en: "Grow the focused pane toward the right", ja: "フォーカス中のペインを右方向に拡大" },
        note: { en: "unbound by default", ja: "デフォルトでは未割り当て" },
      },
      {
        id: "growPaneUp",
        combos: [],
        description: { en: "Grow the focused pane upward", ja: "フォーカス中のペインを上方向に拡大" },
        note: { en: "unbound by default", ja: "デフォルトでは未割り当て" },
      },
      {
        id: "growPaneDown",
        combos: [],
        description: { en: "Grow the focused pane downward", ja: "フォーカス中のペインを下方向に拡大" },
        note: { en: "unbound by default", ja: "デフォルトでは未割り当て" },
      },
      { id: "setPaneWidth25Percent", combos: [["⌥", "⌘", "1"]], description: { en: "Set focused pane width to 25%", ja: "フォーカス中のペイン幅を25%に設定" }, note: { en: "nearest enclosing width split", ja: "最も近い幅方向の親分割" } },
      { id: "setPaneWidth50Percent", combos: [["⌥", "⌘", "2"]], description: { en: "Set focused pane width to 50%", ja: "フォーカス中のペイン幅を50%に設定" }, note: { en: "nearest enclosing width split", ja: "最も近い幅方向の親分割" } },
      { id: "setPaneWidth75Percent", combos: [["⌥", "⌘", "3"]], description: { en: "Set focused pane width to 75%", ja: "フォーカス中のペイン幅を75%に設定" }, note: { en: "nearest enclosing width split", ja: "最も近い幅方向の親分割" } },
      { id: "setPaneHeight25Percent", combos: [["⌥", "⌘", "⇧", "1"]], description: { en: "Set focused pane height to 25%", ja: "フォーカス中のペインの高さを25%に設定" }, note: { en: "nearest enclosing height split", ja: "最も近い高さ方向の親分割" } },
      { id: "setPaneHeight50Percent", combos: [["⌥", "⌘", "⇧", "2"]], description: { en: "Set focused pane height to 50%", ja: "フォーカス中のペインの高さを50%に設定" }, note: { en: "nearest enclosing height split", ja: "最も近い高さ方向の親分割" } },
      { id: "setPaneHeight75Percent", combos: [["⌥", "⌘", "⇧", "3"]], description: { en: "Set focused pane height to 75%", ja: "フォーカス中のペインの高さを75%に設定" }, note: { en: "nearest enclosing height split", ja: "最も近い高さ方向の親分割" } },
    ],
  },
  {
    id: "canvas",
