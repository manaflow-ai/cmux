...
export const shortcutCategories: ShortcutCategory[] = [
  {
    ...
    shortcuts: [
      ...
      { id: "toggleFullScreen", combos: [["⌃", "⌘", "F"]], description: { en: "Toggle full screen", ja: "フルスクリーンを切り替え" } },
      {
        ...
        combos: [["⌃", "⌘", "V"]],
        description: {
          ar: "تبديل الإملاء الصوتي",
          bs: "Uključi/isključi glasovni diktat",
          da: "Slå stemmediktering til/fra",
          de: "Sprachdiktat umschalten",
          en: "Toggle voice dictation",
          ...
          pl: "Przełącz dyktowanie głosowe",
          "pt-BR": "Alternar ditado por voz",
          ru: "Переключить голосовую диктовку",
          th: "สลับการป้อนตามคำบอกด้วยเสียง",
          tr: "Sesli dikteyi aç/kapat",
          uk: "Перемкнути голосовий диктант",
          "zh-CN": "切换语音听写",
          "zh-TW": "切換語音聽寫",
        },
        note: {
          ar: "تتم معالجة الكلام على الجهاز",
          bs: "Prepoznavanje govora ostaje na uređaju",
          da: "Talegenkendelse forbliver på enheden",
          de: "Die Spracherkennung bleibt auf dem Gerät",
          en: "speech stays on-device",
          es: "El reconocimiento de voz se procesa en el dispositivo",
          fr: "La reconnaissance vocale reste sur l’appareil",
          it: "Il riconoscimento vocale resta sul dispositivo",
          ja: "音声認識はデバイス上で処理",
          km: "ការស្គាល់សំឡេងដំណើរការនៅលើឧបករណ៍",
          ko: "음성 인식은 기기에서 처리됩니다",
          no: "Talegjenkjenning skjer på enheten",
          pl: "Rozpoznawanie mowy odbywa się na urządzeniu",
          "pt-BR": "O reconhecimento de fala permanece no dispositivo",
          ru: "Распознавание речи выполняется на устройстве",
          th: "ประมวลผลเสียงพูดบนอุปกรณ์",
          tr: "Konuşma tanıma cihazda işlenir",
          uk: "Розпізнавання мовлення обробляється на пристрої",
          "zh-CN": "语音识别在设备上处理",
          "zh-TW": "語音辨識在裝置上處理",
        },
      },
