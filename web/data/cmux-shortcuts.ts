...
export const shortcutCategories: ShortcutCategory[] = [
  {
    ...
    shortcuts: [
      ...
      { id: "uiScaleZoomIn", combos: [["⌘", "⇧", "="]], description: { en: "UI zoom in", ja: "UIを拡大" } },
      { id: "uiScaleZoomOut", combos: [["⌘", "⇧", "-"]], description: { en: "UI zoom out", ja: "UIを縮小" } },
      { id: "uiScaleReset", combos: [["⌘", "⇧", "0"]], description: { en: "Reset UI zoom", ja: "UIズームをリセット" } },
