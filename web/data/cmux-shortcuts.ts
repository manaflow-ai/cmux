...
export const shortcutCategories: ShortcutCategory[] = [
  ...
  },
  {
    ...
    shortcuts: [
      ...
      { id: "growPaneLeft", combos: [["⌥", "⌘", "⇧", "←"]], description: { en: "Grow pane left", ja: "ペインを左に拡大" } },
      { id: "growPaneRight", combos: [["⌥", "⌘", "⇧", "→"]], description: { en: "Grow pane right", ja: "ペインを右に拡大" } },
      { id: "growPaneUp", combos: [["⌥", "⌘", "⇧", "↑"]], description: { en: "Grow pane up", ja: "ペインを上に拡大" } },
      { id: "growPaneDown", combos: [["⌥", "⌘", "⇧", "↓"]], description: { en: "Grow pane down", ja: "ペインを下に拡大" } },
