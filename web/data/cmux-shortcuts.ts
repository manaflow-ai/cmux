    ...
    shortcuts: [
      ...
      },
      {
        ...
        description: {
          ...
          "bs": "Otvori GUI način",
          "da": "Åbn GUI-tilstand",
          "it": "Apri modalità GUI",
          "km": "បើករបៀប GUI",
          "no": "Åpne GUI-modus",
          "pl": "Otwórz tryb GUI",
          "pt-BR": "Abrir modo GUI",
          "ru": "Открыть режим GUI",
          "th": "เปิดโหมด GUI",
          "tr": "GUI modunu aç",
          "uk": "Відкрити режим GUI"
        },
        note: {
          "en": "Customize in Settings or shortcuts.bindings.newGuiMode.",
          "ja": "設定または shortcuts.bindings.newGuiMode で変更できます。",
          "de": "Anpassbar in den Einstellungen oder über shortcuts.bindings.newGuiMode.",
          "fr": "Personnalisez dans les réglages ou via shortcuts.bindings.newGuiMode.",
          "ar": "يمكن التخصيص في الإعدادات أو عبر shortcuts.bindings.newGuiMode.",
          "es": "Personaliza en Ajustes o mediante shortcuts.bindings.newGuiMode.",
          "zh-TW": "可在設定或 shortcuts.bindings.newGuiMode 中自訂。",
          "zh-CN": "可在设置或 shortcuts.bindings.newGuiMode 中自定义。",
          "ko": "설정 또는 shortcuts.bindings.newGuiMode에서 변경할 수 있습니다.",
          "bs": "Prilagodite u postavkama ili putem shortcuts.bindings.newGuiMode.",
          "da": "Tilpas i Indstillinger eller via shortcuts.bindings.newGuiMode.",
          "it": "Personalizza nelle impostazioni o tramite shortcuts.bindings.newGuiMode.",
          "km": "ប្ដូរតាមចិត្តនៅក្នុងការកំណត់ ឬតាម shortcuts.bindings.newGuiMode។",
          "no": "Tilpass i Innstillinger eller via shortcuts.bindings.newGuiMode.",
          "pl": "Dostosuj w ustawieniach lub przez shortcuts.bindings.newGuiMode.",
          "pt-BR": "Personalize nos ajustes ou em shortcuts.bindings.newGuiMode.",
          "ru": "Настройте в параметрах или через shortcuts.bindings.newGuiMode.",
          "th": "ปรับแต่งได้ในการตั้งค่าหรือผ่าน shortcuts.bindings.newGuiMode",
          "tr": "Ayarlar veya shortcuts.bindings.newGuiMode üzerinden özelleştirin.",
          "uk": "Налаштуйте в параметрах або через shortcuts.bindings.newGuiMode."
        },
