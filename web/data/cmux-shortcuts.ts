...
export const shortcutCategories: ShortcutCategory[] = [
  ...
  },
  {
    ...
    shortcuts: [
      ...
      { id: "terminalFontSizeIncrease", combos: [["⌘", "="]], description: { en: "Increase font size — current surface", ja: "フォントサイズを拡大 — 現在のサーフェス" } },
      { id: "terminalFontSizeDecrease", combos: [["⌘", "-"]], description: { en: "Decrease font size — current surface", ja: "フォントサイズを縮小 — 現在のサーフェス" } },
      { id: "terminalFontSizeReset", combos: [["⌘", "0"]], description: { en: "Reset font size — current surface", ja: "フォントサイズをリセット — 現在のサーフェス" } },
      {
        id: "terminalFontSizeIncreaseWorkspace",
        combos: [],
        description: { en: "Increase font size — current workspace", ja: "フォントサイズを拡大 — 現在のワークスペース" },
        note: { en: "unbound by default; preserves per-surface size differences", ja: "既定では未割当。各サーフェスのサイズ差を維持" },
      },
      {
        id: "terminalFontSizeDecreaseWorkspace",
        combos: [],
        description: { en: "Decrease font size — current workspace", ja: "フォントサイズを縮小 — 現在のワークスペース" },
        note: { en: "unbound by default; preserves per-surface size differences", ja: "既定では未割当。各サーフェスのサイズ差を維持" },
      },
      {
        id: "terminalFontSizeResetWorkspace",
        combos: [],
        description: { en: "Reset font size — current workspace", ja: "フォントサイズをリセット — 現在のワークスペース" },
        note: { en: "unbound by default", ja: "既定では未割当" },
      },
      {
        id: "terminalFontSizeIncreaseGlobal",
        combos: [],
        description: { en: "Increase font size — all workspaces", ja: "フォントサイズを拡大 — 全ワークスペース" },
        note: { en: "unbound by default; preserves per-surface size differences", ja: "既定では未割当。各サーフェスのサイズ差を維持" },
      },
      {
        id: "terminalFontSizeDecreaseGlobal",
        combos: [],
        description: { en: "Decrease font size — all workspaces", ja: "フォントサイズを縮小 — 全ワークスペース" },
        note: { en: "unbound by default; preserves per-surface size differences", ja: "既定では未割当。各サーフェスのサイズ差を維持" },
      },
      {
        id: "terminalFontSizeResetGlobal",
        combos: [],
        description: { en: "Reset font size — all workspaces", ja: "フォントサイズをリセット — 全ワークスペース" },
        note: { en: "unbound by default", ja: "既定では未割当" },
      },
    ],
  },
