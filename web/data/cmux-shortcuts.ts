  ...
  },
  {
    ...
    shortcuts: [
      ...
      { id: "splitDown", combos: [["⌘", "⇧", "D"]], description: { en: "Split down", ja: "下に分割" } },
      {
        ...
        combos: [],
        description: { en: "Move pane to a new outer split on the left", ja: "ペインを左側の新しい外側分割へ移動" },
        note: { en: "unbound by default", ja: "デフォルトでは未割り当て" },
      },
      {
        id: "movePaneToNewOuterSplitRight",
        combos: [],
        description: { en: "Move pane to a new outer split on the right", ja: "ペインを右側の新しい外側分割へ移動" },
        note: { en: "unbound by default", ja: "デフォルトでは未割り当て" },
      },
      {
        id: "movePaneToNewOuterSplitAbove",
        combos: [],
        description: { en: "Move pane to a new outer split above", ja: "ペインを上側の新しい外側分割へ移動" },
        note: { en: "unbound by default", ja: "デフォルトでは未割り当て" },
      },
      {
        id: "movePaneToNewOuterSplitBelow",
        combos: [],
        description: { en: "Move pane to a new outer split below", ja: "ペインを下側の新しい外側分割へ移動" },
        note: { en: "unbound by default", ja: "デフォルトでは未割り当て" },
      },
