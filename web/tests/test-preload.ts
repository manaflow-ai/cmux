...
// and flaky in CI — e.g. route tests assert rate-limit IDs are present, but env
// values froze to `undefined` whenever another suite imported env first. Pinning
// the deterministic test env here, before any import, removes the ordering
// dependency. Individual suites may still override these at their own top level.
