...
- AppKit/UIKit layout, cell rendering, typing, socket telemetry, notification, file-watcher, search, or process-sampling paths that rebuild, sort, or filter unbounded collections on every event without a cached snapshot or explicit size bound.
