    ...
    var body: some View {
        NavigationSplitView {
            ...
            WindowDetailView(
                ...
                isPaneSynced: store.isPaneSynced,
                permissions: store.permissions,
                status: store.status,
                onRefreshWindows: store.reloadWindows,
                onRestartLiveCapture: store.restartLiveCapture,
                onNativeSlotFrameChange: store.updateNativeSlotFrame,
                onSyncPane: store.syncSelectedWindowIntoPane,
                onDetachPane: store.detachSyncedWindow,
