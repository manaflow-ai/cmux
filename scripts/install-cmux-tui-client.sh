...
# a prebuilt universal binary to install instead of downloading (offline/dev builds), and
# CMUX_TUI_CLIENT_RETRY_DELAY_SECONDS shortens the bounded retry delay in tests.
set -euo pipefail
