...
SCOPES=()
for d in Packages/Shared/CMUXMobileCore Packages/iOS/CmuxMobile* Packages/Shared/CmuxSyncStore Packages/Shared/CmuxAgentReplica ios/cmuxPackage/Sources ios/cmux; do
  [ -d "$d" ] && SCOPES+=("$d")
done
