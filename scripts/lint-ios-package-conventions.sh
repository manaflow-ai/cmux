...
SCOPES=()
for d in Packages/Shared/CMUXMobileCore Packages/iOS/CmuxMobile* Packages/Shared/CmuxSyncStore Packages/Shared/CmuxAgentReplica Packages/Shared/CmuxAgentWire Packages/Shared/CmuxAgentSync Packages/macOS/CmuxAgentTruthKit ios/cmuxPackage/Sources ios/cmux; do
  [ -d "$d" ] && SCOPES+=("$d")
done
