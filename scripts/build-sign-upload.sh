...
if [ ! -d "GhosttyKit.xcframework" ]; then
  ...
  cd ghostty && zig build -Dcrash-report-subdir=cmux/crash -Demit-xcframework=true -Demit-macos-app=false -Dxcframework-target=universal -Doptimize=ReleaseFast && cd ..
