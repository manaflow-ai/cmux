...
if [[ "$TARGET" == "simulator" ]]; then
  ...
  SIMCTL_CHILD_CMUX_PRESENCE_BASE_URL="${CMUX_PRESENCE_BASE_URL:-}" \
  SIMCTL_CHILD_CMUX_DOT_FORCE_ONLY="${CMUX_DOT_FORCE_ONLY:-}" \
  ...
  DEVICECTL_CHILD_CMUX_PRESENCE_BASE_URL="${CMUX_PRESENCE_BASE_URL:-}" \
  DEVICECTL_CHILD_CMUX_DOT_FORCE_ONLY="${CMUX_DOT_FORCE_ONLY:-}" \
