...
FOCUSED_GATE_SELECTORS = {
    ...
    "cmuxTests/AgentChatTranscriptServiceLifetimeTests",
    ...
    "cmuxTests/BrowserDesignModeScreenshotEvaluatorTests",
    "cmuxTests/BrowserViewportRuntimeTests",
    "cmuxTests/CLISSHSessionAttachAnchorTests",
    "cmuxTests/CLINotifyProcessIntegrationRegressionTests",
    ...
    "cmuxTests/CloudPortAccessLateCoordinatorTests",
    "cmuxTests/CloudWorkspaceRenameSurfaceParityTests",
    "cmuxTests/CompositorBlurWindowLifetimeTests",
    "cmuxTests/CmuxBundledBinPathIntegrationTests",
    "cmuxTests/ComputerUseWatchTargetRuntimeTests",
