...
def build_cli_cases(ctx: StressContext) -> list[CliCase]:
    ...
    cases = [
        ...
        CliCase("agent-submit", ctx_argv(lambda c: ["agent-submit", "--workspace", require(c.workspace_id, "workspace"), "--surface", require(c.surface_id, "surface"), "stress atomic prompt"]), expect_codes=any_code, covered_command="agent-submit"),
