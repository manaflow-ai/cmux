...
final class ProfileStoreTests: XCTestCase {
    ...
    override func setUp() {
        ...
        tempDir = FileManager.default.temporaryDirectory
            .appendingPathComponent("cmux-profile-tests-\(UUID().uuidString)", isDirectory: true)
        try? FileManager.default.createDirectory(at: tempDir, withIntermediateDirectories: true)
        ProfileStore.overrideProfilesDirectory = tempDir
    }

    override func tearDown() {
        ProfileStore.overrideProfilesDirectory = nil
        if let tempDir {
    ...
    func testSaveProfileSetsActiveProfileName() {
        ...
        let saved = ProfileStore.saveCurrentSession(name: "MyProfile", tabManager: manager)
        XCTAssertNotNil(saved, "saveCurrentSession should succeed")
