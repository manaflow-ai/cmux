...
extension CLINotifyProcessIntegrationRegressionTests {
    ...
    func testCodexHookDropsAmbiguousTTYWithAmbientSurfaceEnvironment() throws {
        ...
        let state = MockSocketServerState()
        let root = FileManager.default.temporaryDirectory
            .appendingPathComponent("cmux-codex-ambiguous-tty-\(UUID().uuidString)", isDirectory: true)
        let repo = root.appendingPathComponent("cmuxterm-hq", isDirectory: true)
        let workspaceId = "11111111-1111-1111-1111-111111111111"
        let surfaceId = "22222222-2222-2222-2222-222222222222"
        let siblingSurfaceId = "33333333-3333-3333-3333-333333333333"
        let sessionId = "codex-ambiguous-tty-session"
        let ttyName = "ttys011"
        ...
        let serverHandled = startMockServer(listenerFD: listenerFD, state: state) { line in
            ...
            case "surface.list":
                return self.v2Response(
                    ...
                    result: [
                        "surfaces": [
                            ["id": siblingSurfaceId, "ref": "surface:1", "index": 0, "focused": false],
                            ["id": surfaceId, "ref": "surface:2", "index": 1, "focused": true],
                        ],
                    ]
                )
            case "debug.terminals":
                return self.v2Response(
                    ...
                    result: [
                        "terminals": [
                            ["tty": ttyName, "workspace_id": workspaceId, "surface_id": siblingSurfaceId],
                            ["tty": ttyName, "workspace_id": workspaceId, "surface_id": surfaceId],
                        ],
                    ]
                )
            case "surface.resume.set", "surface.resume.clear":
    ...
    func testCodexHookDoesNotPublishResumeBindingFromMappedSurfaceUnderAmbiguousTTY() throws {
        ...
        let state = MockSocketServerState()
        let root = FileManager.default.temporaryDirectory
            .appendingPathComponent("cmux-codex-ambiguous-tty-workspace-only-\(UUID().uuidString)", isDirectory: true)
        let repo = root.appendingPathComponent("cmuxterm-hq", isDirectory: true)
        let workspaceId = "11111111-1111-1111-1111-111111111111"
        let focusedSurfaceId = "22222222-2222-2222-2222-222222222222"
        let siblingSurfaceId = "33333333-3333-3333-3333-333333333333"
        let sessionId = "codex-ambiguous-tty-workspace-only-session"
        let ttyName = "ttys011"
            ...
            case "surface.list":
                return self.v2Response(
                    ...
                    result: [
                        "surfaces": [
                            ["id": siblingSurfaceId, "ref": "surface:1", "index": 0, "focused": false],
                            ["id": focusedSurfaceId, "ref": "surface:2", "index": 1, "focused": true],
                        ],
                    ]
                )
            case "debug.terminals":
                return self.v2Response(
                    ...
                    result: [
                        "terminals": [
                            ["tty": ttyName, "workspace_id": workspaceId, "surface_id": siblingSurfaceId],
                            ["tty": ttyName, "workspace_id": workspaceId, "surface_id": focusedSurfaceId],
                        ],
                    ]
                )
            case "system.top":
