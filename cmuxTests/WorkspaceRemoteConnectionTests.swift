...
final class WorkspaceRemoteConnectionTests: XCTestCase {
    ...
    func testRemotePlatformProbeScriptWorksWhenTrLacksCharacterClasses() throws {
        let fileManager = FileManager.default
        ...
        XCTAssertTrue(result.stdout.contains("__CMUX_REMOTE_OS__=Linux"), result.stdout)
        XCTAssertTrue(result.stdout.contains("__CMUX_REMOTE_ARCH__=x86_64"), result.stdout)
        XCTAssertTrue(result.stdout.contains("__CMUX_REMOTE_EXISTS__=yes"), result.stdout)
    }
