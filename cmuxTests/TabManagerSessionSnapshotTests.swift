...
final class TabManagerSessionSnapshotTests {
    ...
    @Test func testFocusHistoryNavigationNotificationSeesUpdatedDirectionState() throws {
        ...
        let observer = NotificationCenter.default.addObserver(
            ...
            observedCanNavigateForward = MainActor.assumeIsolated {
                manager.canNavigateForward
            }
        }
        defer {
            NotificationCenter.default.removeObserver(observer)
    ...
    @Test func testClosedItemHistoryAsyncLoadMergesEarlyMutation() async throws {
        let tempDir = FileManager.default.temporaryDirectory
        ...
        await waitForClosedHistoryCount(2, in: loadingStore)
    ...
    @Test func testClosedItemHistoryAsyncLoadReplaysQueuedPanelWorkspaceRemap() async throws {
        let tempDir = FileManager.default.temporaryDirectory
        ...
        await waitForClosedHistoryCount(1, in: loadingStore)
    ...
    @Test func testSessionSnapshotSkipsCloudVMLoadingWorkspaces() {
        let manager = TabManager()
        let localWorkspace = manager.tabs[0]
        localWorkspace.setCustomTitle("Local")
    ...
    @Test func testSessionSnapshotRestoresManagedWebSocketCloudVMWorkspace() throws {
        let manager = TabManager()
        let remoteWorkspace = manager.addWorkspace(select: true)
        remoteWorkspace.setCustomTitle("Cloud VM")
        let configuration = WorkspaceRemoteConfiguration(
    ...
    @Test func testRestoreSessionSnapshotDropsStaleLocalCloudVMWorkspaces() {
    ...
    @Test func testRestoreSessionSnapshotKeepsSingleManagedCloudVMAtTop() throws {
    ...
    @Test func testSessionSnapshotRestoresDefaultFreestyleSSHDAsSelfHealingAttach() throws {
    ...
    @Test func testSessionRestoreDropsStalePTYSessionForDefaultFreestyleSSHD() throws {
        let manager = TabManager()
        let remoteWorkspace = manager.addWorkspace(select: true)
    ...
    @Test func testLegacyDefaultFreestyleSSHDRestoreRepairsRawSSHSnapshotBeforeSpawning() throws {
