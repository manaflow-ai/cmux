...
final class WorkspacePanelGitBranchTests: XCTestCase {
    ...
    func testForkAgentConversationUsesWorkspaceDirectoryFallback() throws {
        ...
        XCTAssertEqual(
            ...
            "cd -- '/tmp/workspace fork repo' 2>/dev/null && '/Users/example/.bun/bin/codex' 'fork' '019dad34-d218-7943-b81a-eddac5c87951'\n"
        )
    }
    ...
    func testForkAgentConversationInRemoteWorkspaceUsesFallbackDirectoryInForkCommand() throws {
        ...
        XCTAssertEqual(
            forkPanel.surface.initialInput,
            "cd -- '/Users/cmux/fallback repo' 2>/dev/null && '/Users/example/.bun/bin/codex' 'fork' '019dad34-d218-7943-b81a-eddac5c87951'\n"
        )
    }
    ...
    func testForkAgentWorkspaceLaunchInLocalWorkspaceUsesLocalTerminalWorkingDirectory() throws {
        ...
        XCTAssertEqual(
            launch.initialTerminalInput,
            "cd -- '/tmp/local fork repo' 2>/dev/null && '/Users/example/.bun/bin/codex' 'fork' '019dad34-d218-7943-b81a-eddac5c87951'\n"
        )
    }
