...
extension TerminalControllerSocketSecurityTests {
    ...
    @Test func remoteCommandsCanTargetRegisteredWindowOrWorkspaceWithoutFocus() throws {
        ...
        _ = managerA.addLocalWorkspace(select: false, eagerLoadTerminal: false)
        let workspaceB = managerB.addLocalWorkspace(select: false, eagerLoadTerminal: false)
        let workspaceC = managerC.addLocalWorkspace(select: false, eagerLoadTerminal: false)
