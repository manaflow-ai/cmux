...
final class GhosttySurfaceOverlayTests: XCTestCase {
    ...
    private func makeScrollbarSyncFixture(
        file: StaticString = #filePath,
        line: UInt = #line
    ) -> (
        window: NSWindow,
        surfaceView: ScrollbarPostingSurfaceView,
        hostedView: GhosttySurfaceScrollView,
        ...
        return (window, surfaceView, hostedView, scrollView)
    }
    ...
    func testNativeScrollerDragToBottomRestoresPassiveScrollbarFollowing() {
        guard let fixture = makeScrollbarSyncFixture() else { return }
        ...
        XCTAssertEqual(fixture.scrollView.contentView.bounds.origin.y, 0, accuracy: 0.01)

        simulateNativeScrollerDrag(on: fixture.scrollView, to: 500)
        XCTAssertEqual(fixture.scrollView.contentView.bounds.origin.y, 500, accuracy: 0.01)
    ...
    func testNativeScrollerDragToTopKeepsScrollbackPinnedAgainstPassiveBottomPacket() {
        guard let fixture = makeScrollbarSyncFixture() else { return }
        defer { fixture.window.orderOut(nil) }
        ...
        let topOriginY = fixture.scrollView.documentView!.frame.height - fixture.scrollView.contentView.bounds.height
        simulateNativeScrollerDrag(on: fixture.scrollView, to: topOriginY)
        XCTAssertEqual(fixture.scrollView.contentView.bounds.origin.y, topOriginY, accuracy: 0.01)
