...
struct TerminalStartupRestoreFailureTests {
    @Test("Binding-only persistent SSH resume attaches after topology commit without local census admission", .disabled("Legacy SSH path unreachable since 5f0d2227241 routed daemon-bootstrapping SSH configs to cmux-tui; rewrite against cmux-tui."))
