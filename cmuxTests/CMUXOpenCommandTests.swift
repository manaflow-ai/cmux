...
final class CMUXOpenCommandTests: XCTestCase {
    ...
    func testDiffCommandGeneratesCodeViewAndOpensBrowserSplit() throws {
        ...
        let scrollDownFirst = try XCTUnwrap((shortcuts["diffViewerScrollDown"] as? [String: Any])?["first"] as? [String: Any])
        XCTAssertEqual((scrollDownFirst["key"] as? String, scrollDownFirst["control"] as? Bool), ("j", true))
        let scrollUpFirst = try XCTUnwrap((shortcuts["diffViewerScrollUp"] as? [String: Any])?["first"] as? [String: Any])
        XCTAssertEqual((scrollUpFirst["key"] as? String, scrollUpFirst["control"] as? Bool), ("k", false))
        ...
        XCTAssertEqual(((nextFile["first"] as? [String: Any])?["key"] as? String, (nextFile["second"] as? [String: Any])?["key"] as? String), ("]", "f"))
        let previousFile = try XCTUnwrap(shortcuts["diffViewerPreviousFile"] as? [String: Any])
        XCTAssertEqual(((previousFile["first"] as? [String: Any])?["key"] as? String, (previousFile["second"] as? [String: Any])?["key"] as? String), ("[", "f"))
