...
final class CMUXOpenCommandTests: XCTestCase {
    ...
    func testDiffCommandGeneratesCodeViewAndOpensBrowserSplit() throws {
        ...
        XCTAssertTrue(html.contains("getOrCreateWorkerPoolSingleton"), html)
        XCTAssertTrue(html.contains("terminateWorkerPoolSingleton"), html)
        XCTAssertTrue(html.contains("poolSize: 3"), html)
