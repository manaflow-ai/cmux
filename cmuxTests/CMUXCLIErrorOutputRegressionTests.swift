...
final class CMUXCLIErrorOutputRegressionTests: XCTestCase {
    ...
    func testRightSidebarHelpOmitsBetaModesUntilEnabled() throws {
        let cliPath = try bundledCLIPath()
    ...
    func testNoteReadIgnoresInvalidAmbientSurfaceWhenWorkspaceIsAvailable() throws {
        let cliPath = try bundledCLIPath()
    ...
    func testNoteWriteRejectsUnknownFlagInPositionalContent() throws {
        let cliPath = try bundledCLIPath()
