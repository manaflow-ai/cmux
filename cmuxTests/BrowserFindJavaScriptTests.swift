...
// Find-in-page script generation and escaping moved to the CmuxBrowserFind package
// (BrowserFindScript). Its behavior is covered by CmuxBrowserFindTests/BrowserFindServiceTests.
