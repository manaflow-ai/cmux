...
final class SessionPersistenceTests: XCTestCase {
    ...
    func testWorkspaceSessionSnapshotRestoresPaneNotificationsIntoStore() throws {
        ...
        let notification = TerminalNotification(
            ...
            isRead: false,
            paneFlash: true,
            scrollPosition: TerminalNotificationScrollPosition(row: 42)
        )
        ...
        XCTAssertEqual(panelSnapshot.notifications?.first?.scrollPosition?.row, 42)
        ...
        XCTAssertEqual(restoredNotification.scrollPosition?.row, 42)
