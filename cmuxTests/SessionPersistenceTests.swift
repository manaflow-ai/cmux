...
final class SocketListenerAcceptPolicyTests: XCTestCase {
    ...
    func testClaudeResumeCommandPreservesLaunchFlagsAndDropsInjectedHookSettings() {
        ...
        XCTAssertEqual(
            ...
            "cd '/tmp/cmux project' && 'env' 'CLAUDE_CONFIG_DIR=/tmp/claude config' 'CMUX_PRESERVE_CLAUDE_AUTH_SELECTION_ENV=1' '/opt/Claude Code/bin/claude' '--resume' 'claude-session-123' '--model' 'sonnet' '--permission-mode' 'auto'"
        )
    }
    ...
    func testClaudeResumeCommandPreservesDangerouslySkipPermissionsAndObservedEnvironment() {
        ...
        XCTAssertEqual(
            snapshot.resumeCommand,
            "cd '/Users/lawrence/fun' && 'env' 'CLAUDE_CONFIG_DIR=/Users/lawrence/.codex-accounts/claude/_p1775010019397' 'CMUX_PRESERVE_CLAUDE_AUTH_SELECTION_ENV=1' '/Users/lawrence/.local/bin/claude' '--resume' '24ec0052-450c-4914-b1dd-2ee80d4bc84b' '--dangerously-skip-permissions'"
        )
    }
    ...
    func testResumeCommandPreservesSafeProviderEnvironmentValuesOnly() {
        ...
        XCTAssertEqual(
            snapshot.resumeCommand,
            "'env' 'ANTHROPIC_MODEL=' 'CMUX_PRESERVE_CLAUDE_AUTH_SELECTION_ENV=1' 'claude' '--resume' 'claude-session-env'"
        )
    }
