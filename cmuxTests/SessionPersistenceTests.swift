...
final class SessionPersistenceTests: XCTestCase {
    ...
    func testReconciledFrameAfterScreenChangePullsBackStrandedWindow() {
        // Built-in display only; the window's titlebar (top ~64pt near y≈1520) is
        // far above the built-in's visible top (944), with only its bottom edge
        // dipping into the display.
