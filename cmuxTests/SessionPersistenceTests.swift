...
final class SessionPersistenceTests: XCTestCase {
    ...
    func testClaudeConfigDirectoryPathPrefersCodexAccountsAliasForSubrouterPath() throws {
        ...
        try FileManager.default.createSymbolicLink(
            ...
            withDestinationURL: home.appendingPathComponent(".subrouter", isDirectory: true).appendingPathComponent("codex", isDirectory: true)
        )
