...
final class SettingsSearchIndexTests: XCTestCase {
    func testAlternativeSearchTermsFindSettingsRows() {
        ...
        assertSearch("sound file", contains: SettingsSearchIndex.settingID(for: .notifications, idSuffix: "notification-sound"))
        ...
        assertSearch("claude executable", contains: SettingsSearchIndex.settingID(for: .agentIntegrations, idSuffix: "claude-path"))
        assertSearch("resume on reopen", contains: SettingsSearchIndex.settingID(for: .agentSessions, idSuffix: "agent-auto-resume"))
        assertSearch("workspace cwd", contains: SettingsSearchIndex.settingID(for: .workspacesAndTabs, idSuffix: "workspace-inherit-working-directory"))
        assertSearch("claude sessions", contains: SettingsSearchIndex.settingID(for: .agentSessions, idSuffix: "agent-auto-resume"))
        assertSearch("opencode resume", contains: SettingsSearchIndex.settingID(for: .agentSessions, idSuffix: "agent-auto-resume"))
        assertSearch("textbox height", contains: SettingsSearchIndex.settingID(for: .terminal, idSuffix: "textbox-max-lines"))
        assertSearch("tmux resume command approval", contains: SettingsSearchIndex.settingID(for: .agentSessions, idSuffix: "resume-commands"))
        ...
        assertSearch("imessage", contains: SettingsSearchIndex.settingID(for: .notifications, idSuffix: "imessage-mode"))
        assertSearch("chat prompt", contains: SettingsSearchIndex.settingID(for: .notifications, idSuffix: "imessage-mode"))
    ...
    func testSettingsPathAnchorIncludesAgentAutoResume() {
        XCTAssertEqual(
            ...
            SettingsSearchIndex.settingID(for: .agentSessions, idSuffix: "agent-auto-resume")
        )
    }
    ...
    func testSettingsPathAnchorIncludesWorkspaceWorkingDirectoryInheritance() {
        XCTAssertEqual(
            ...
            SettingsSearchIndex.settingID(for: .workspacesAndTabs, idSuffix: "workspace-inherit-working-directory")
        )
    }
    ...
    func testSettingsPathAnchorIncludesIMessageMode() {
        XCTAssertEqual(
            ...
            SettingsSearchIndex.settingID(for: .notifications, idSuffix: "imessage-mode")
        )
    }
