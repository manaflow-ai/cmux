...
final class SettingsSearchIndexTests: XCTestCase {
    func testAlternativeSearchTermsFindSettingsRows() {
        ...
        assertSearch("smooth trackpad scroll", contains: SettingsSearchIndex.settingID(for: .terminal, idSuffix: "smooth-scrolling"))
    ...
    func testSettingsPathAnchorIncludesTerminalSmoothScrolling() {
        XCTAssertEqual(
            SettingsSearchIndex.anchorID(forSettingsPath: "terminal.smoothScrolling"),
            SettingsSearchIndex.settingID(for: .terminal, idSuffix: "smooth-scrolling")
        )
    }
