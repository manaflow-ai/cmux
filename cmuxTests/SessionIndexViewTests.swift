...
final class SessionIndexViewTests: XCTestCase {
    ...
    func testClaudeResumeCommandPinsConfigDirectoryFromFileURL() {
        ...
        XCTAssertEqual(
            entry.resumeCommand,
            "env CLAUDE_CONFIG_DIR='/tmp/claude config' CMUX_PRESERVE_CLAUDE_AUTH_SELECTION_ENV=1 claude --resume claude-session-123"
        )
    }
    ...
    func testClaudeResumeCommandUsesNearestProjectsDirectory() {
        ...
        XCTAssertEqual(
            entry.resumeCommand,
            "env CLAUDE_CONFIG_DIR='/tmp/projects/claude config' CMUX_PRESERVE_CLAUDE_AUTH_SELECTION_ENV=1 claude --resume claude-session-123"
        )
    }
