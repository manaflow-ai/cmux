...
final class SessionIndexViewTests: XCTestCase {
    ...
    func testClaudeResumeCommandPinsSnapshotConfigDirectory() throws {
        ...
        XCTAssertEqual(
            entry.resumeCommand,
            posixShWrappedForTest("env CLAUDE_CONFIG_DIR='\(configDir.path)' CMUX_PRESERVE_CLAUDE_AUTH_SELECTION_ENV=1 CMUX_PRESERVE_CLAUDE_AUTH_SELECTION_ENV_KEYS=CLAUDE_CONFIG_DIR \(AgentResumeArgv.claudeWrapperShellExecutableToken) --resume claude-session-123")
        )
    }
