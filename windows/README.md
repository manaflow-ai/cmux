...
- Settings panel for themes, accent colors, workspace names/colors, built-in/custom backgrounds, import/export/reset, density, tabs/status bar visibility, toolbar shortcut visibility, performance mode, terminal text size, and terminal scrollback.
