...
final class Workspace: Identifiable, ObservableObject {
    ...
    func replaceCloudVMLoadingSurfaceWithTerminal(
        ...
        bonsplitController.updateTab(
            ...
            iconImageData: .some(terminalTabAgentIconPayload(forPanelId: pair.key).imageData),
            iconAsset: .some(terminalTabAgentIconPayload(forPanelId: pair.key).assetName),
    ...
    func respawnTerminalSurface(
        ...
        bonsplitController.updateTab(
            ...
            title: resolvedTitle,
            icon: .some(replacementPanel.displayIcon),
            iconImageData: .some(terminalTabAgentIconPayload(forPanelId: panelId).imageData),
            iconAsset: .some(terminalTabAgentIconPayload(forPanelId: panelId).assetName),
            kind: .some(SurfaceKind.terminal.rawValue),
    ...
    func attachDetachedSurface(
        ...
        guard let newTabId = bonsplitController.createTab(
            ...
            icon: detached.icon,
            iconImageData: terminalTabAgentIconPayload(forDetached: detached).imageData,
            iconAsset: terminalTabAgentIconPayload(forDetached: detached).assetName,
            kind: detached.kind,
