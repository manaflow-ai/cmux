    ...
    private func sessionPanelSnapshot(
        ...
        case .markdown:
            ...
            markdownSnapshot = SessionMarkdownPanelSnapshot(
                ...
                fontSizePoints: markdownPanel.fontSizeOverridePoints
            )
            filePreviewSnapshot = nil
            rightSidebarToolSnapshot = nil
            projectSnapshot = nil
        ...
        case .markdown:
            guard let filePath = snapshot.markdown?.filePath,
                  let markdownPanel = newMarkdownSurface(
                    inPane: paneId,
                    filePath: filePath,
                    fontSizePoints: snapshot.markdown?.fontSizePoints,
                    focus: false
                  ) else {
                return nil
            }
...
final class Workspace: Identifiable, ObservableObject {
    ...
    func openOrFocusMarkdownSplit(
        ...
        if let targetPane = preferredRightSideTargetPane(fromPanelId: panelId) {
            return newMarkdownSurface(inPane: targetPane, filePath: filePath, fontSizePoints: fontSizePoints, focus: true)
        }
    ...
    func newMarkdownSplit(
        ...
        let markdownPanel = MarkdownPanel(workspaceId: id, filePath: filePath, fontSizePoints: fontSizePoints)
    ...
    func openOrFocusMarkdownSurface(
        ...
        for (existingId, panel) in panels {
            ...
            if (markdownPanel.filePath as NSString).resolvingSymlinksInPath == canonical {
                if let fontSizePoints {
                    markdownPanel.setFontSize(fontSizePoints)
                }
                if focus {
                    focusPanel(existingId)
                }
        ...
        return newMarkdownSurface(inPane: paneId, filePath: filePath, fontSizePoints: fontSizePoints, focus: focus)
    }
