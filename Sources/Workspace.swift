...
final class Workspace: Identifiable, ObservableObject {
    ...
    func clearRestoredAgentSnapshotForAgentRouting(panelId: UUID) { restoredAgentSnapshotsByPanelId.removeValue(forKey: panelId); restoredAgentAutoResumePendingPanelIds.remove(panelId); invalidatedRestoredAgentFingerprintsByPanelId.removeValue(forKey: panelId) }
