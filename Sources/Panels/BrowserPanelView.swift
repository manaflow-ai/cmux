...
struct BrowserPanelView: View {
    ...
    @State private var sharedOmnibarSuggestions: BrowserPortalOmnibarSuggestionsConfiguration?
    @State private var sharedAddressBarFocused = false
    @State private var sharedAddressBarHeight: CGFloat = 0
    ...
    private var shouldRenderOmnibarSuggestionsInPortal: Bool {
        sharedOmnibarSuggestions != nil && panel.shouldRenderWebView
    }

    private var shouldRenderOmnibarSuggestionsInSwiftUI: Bool {
        sharedOmnibarSuggestions != nil && !shouldRenderOmnibarSuggestionsInPortal
    }
    ...
    private var portalOmnibarSuggestions: BrowserPortalOmnibarSuggestionsConfiguration? {
        ...
        return sharedOmnibarSuggestions
    }
    ...
    private func handleBrowserWebViewClickIntent(_ notification: Notification) {
        ...
        cmuxDebugLog(
            ...
            "addressFocused=\(sharedAddressBarFocused ? 1 : 0)"
        )
#endif
    ...
    private var omnibarSuggestionsOverlayView: some View {
        if shouldRenderOmnibarSuggestionsInSwiftUI,
           let configuration = sharedOmnibarSuggestions {
    ...
    private var omnibarHeaderView: some View {
        OmnibarPaneChrome(
            ...
            accessorySpacing: browserToolbarAccessorySpacing,
            onRequestPanelFocus: onRequestPanelFocus,
            onReloadOrStop: handleReloadOrStopButtonAction,
            onReload: handleReloadButtonContextMenuAction,
            onHardReload: handleHardRefreshButtonAction,
            onAddressBarFocusStateChange: { focused in
                sharedAddressBarFocused = focused
                syncWebViewResponderPolicyWithViewState(reason: "sharedOmnibar.focusChanged")
            },
            onChromeHeightChange: { height in
                sharedAddressBarHeight = height
            },
            onSuggestionsPresentationChange: { configuration in
                sharedOmnibarSuggestions = configuration
            },
            leadingAccessories: {
            ...
            trailingAccessories: { isCompact in
        ...
        return Group {
            if panel.shouldRenderWebView {
                WebViewRepresentable(
                    ...
                    shouldFocusWebView: isFocused && !sharedAddressBarFocused,
                    ...
                    paneTopChromeHeight: panel.isOmnibarVisible ? sharedAddressBarHeight : 0
                )
                ...
                .simultaneousGesture(TapGesture().onEnded {
                    ...
                    if sharedAddressBarFocused {
                        NotificationCenter.default.post(
                            name: .browserDidBlurAddressBar,
                            object: panel.id
                        )
                    }
                })
