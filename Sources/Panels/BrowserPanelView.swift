...
struct WebViewRepresentable: NSViewRepresentable {
    ...
    func updateNSView(_ nsView: NSView, context: Context) {
        ...
        if let previousWebView = coordinator.webView, previousWebView !== webView {
            panel.surfaceSelectionEventCoordinator.webBridgeRegistry.detach(webView: previousWebView)
        ...
        panel.surfaceSelectionEventCoordinator.webBridgeRegistry.attach(
            webView: webView,
            surfaceId: panel.id,
