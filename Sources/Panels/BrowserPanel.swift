...
func browserHandleExternalNavigation(
    ...
    guard let action = BrowserExternalNavigationResolver().externalNavigationAction(for: url) else { return false }
...
private class BrowserNavigationDelegate: NSObject, WKNavigationDelegate {
    ...
    func webView(
        ...
        if let url = navigationAction.request.url,
           BrowserExternalNavigationResolver().shouldRouteExternalNavigation(url) {
