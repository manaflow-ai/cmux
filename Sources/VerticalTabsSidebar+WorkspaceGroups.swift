...
extension VerticalTabsSidebar {
    func sidebarWorkspaceGroupTableConfiguration(
        ...
        let model = SidebarGroupHeaderRowModel(
            ...
            shortcutHintStyle: settings.shortcutHintStyle,
            shortcutHintColorHex: settings.shortcutHintColorHex,
    ...
    func sidebarWorkspaceGroupRow(
        ...
        let header = SidebarWorkspaceGroupHeaderView(
            ...
            shortcutHintStyle: snapshot.shortcutHintStyle,
            shortcutHintColorHex: snapshot.shortcutHintColorHex,
