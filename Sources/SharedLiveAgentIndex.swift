...
final class SharedLiveAgentIndex {
    ...
    private var pendingForkValidationGenerationByPanel: [PanelKey: UUID] = [:]
    ...
    func snapshotForForkConversationCandidate(workspaceId: UUID, panelId: UUID) -> SessionRestorableAgentSnapshot? {
        ...
        guard pendingForkValidationGenerationByPanel[panelKey] == nil else {
            return nil
        }
        guard let index,
    ...
    func snapshotForForkAvailability(workspaceId: UUID, panelId: UUID) -> SessionRestorableAgentSnapshot? {
        let panelKey = PanelKey(workspaceId: workspaceId, panelId: panelId)
        guard pendingForkValidationGenerationByPanel[panelKey] == nil,
    ...
    private func requestRefresh(
        ...
        if let refreshTailID,
           ...
           freshness == .joinCurrentGeneration || generation.phase == .queued {
            ...
            if let panelKey {
                ...
                pendingForkValidationGenerationByPanel[panelKey] = generation.id
            }
        ...
        if let panelKey {
            ...
            pendingForkValidationGenerationByPanel[panelKey] = generationID
        }
    ...
    private func applyForkValidations(
        ...
        where pendingForkValidationGenerationByPanel[panelKey] == generationID {
            ...
            pendingForkValidationGenerationByPanel.removeValue(forKey: panelKey)
        }
    }
