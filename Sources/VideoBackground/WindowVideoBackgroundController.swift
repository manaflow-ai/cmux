...
final class VideoBackgroundPlaybackCoordinator {
    ...
    static let shared = VideoBackgroundPlaybackCoordinator()
...
final class WindowVideoBackgroundController {
    ...
    static func ensure(
        ...
        audioArbiter: VideoBackgroundAudioArbiter? = nil,
        playbackCoordinator: VideoBackgroundPlaybackCoordinator? = nil
        ...
        if let existing = objc_getAssociatedObject(window, Self.associatedObjectKey)
            ...
            controller = WindowVideoBackgroundController(
                window: window,
                defaults: defaults,
                audioArbiter: audioArbiter ?? .shared,
