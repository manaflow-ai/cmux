...
final class FocusableTerminalView: NSView {
...
struct SwiftTermView: NSViewRepresentable {
    ...
    func updateNSView(_ nsView: FocusableTerminalView, context _: Context) {
    ...
    private func applyPalette(to terminalView: LocalProcessTerminalView, config _: GhosttyConfig) {
