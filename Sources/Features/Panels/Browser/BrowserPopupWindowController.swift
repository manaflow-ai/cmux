...
final class BrowserPopupWindowController: NSObject, NSWindowDelegate {
    ...
    init(
        ...
        popupUIDelegate = uiDel
        popupNavigationDelegate = navDel
        downloadDelegate = dlDel
...
private final class PopupNavigationDelegate: NSObject, WKNavigationDelegate {
    // MARK: Properties
