...
private struct MarkdownPointerObserver: NSViewRepresentable {
    ...
    func makeNSView(context _: Context) -> MarkdownPanelPointerObserverView {
        let view = MarkdownPanelPointerObserverView()
        view.onPointerDown = onPointerDown
        return view
    }

    func updateNSView(_ nsView: MarkdownPanelPointerObserverView, context _: Context) {
        nsView.onPointerDown = onPointerDown
    }
}

// MARK: - MarkdownPanelPointerObserverView
