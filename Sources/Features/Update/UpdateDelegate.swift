...
// MARK: - UpdateDriver + SPUUpdaterDelegate
...
extension UpdateDriver: SPUUpdaterDelegate {
    ...
    func updater(_: SPUUpdater, willInstallUpdateOnQuit _: SUAppcastItem, immediateInstallationBlock immediateInstallHandler: @escaping () -> Void) -> Bool {
