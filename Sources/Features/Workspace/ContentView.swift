...
// MARK: - InternalTabDragConfigurationModifier
...
// MARK: - ShortcutHintPillBackground
...
final class FileDropOverlayView: NSView {
    ...
    override func draggingEntered(_ sender: any NSDraggingInfo) -> NSDragOperation {
        updateDragTarget(sender, phase: "entered")
    }

    override func draggingUpdated(_ sender: any NSDraggingInfo) -> NSDragOperation {
        updateDragTarget(sender, phase: "updated")
    }
...
// MARK: - CommandPaletteOverlayPromotionPolicy
...
// MARK: - CommandPaletteOverlayContainerView
...
// MARK: - WindowCommandPaletteOverlayController
...
struct ContentView: View {
    ...
    struct CommandPaletteSwitcherFingerprintWorkspace {
        let id: UUID
    ...
    struct CommandPaletteSwitcherFingerprintSurface {
        let id: UUID
        let displayName: String
    ...
    struct CommandPaletteSwitcherFingerprintContext {
        let windowId: UUID
    ...
    private struct CommandPaletteRenameTarget: Equatable {
        ...
        var title: String {
            switch kind {
                case .workspace:
                    String(localized: "commandPalette.rename.workspaceTitle", defaultValue: "Rename Workspace")
                case .tab:
                    String(localized: "commandPalette.rename.tabTitle", defaultValue: "Rename Tab")
            }
        }
        ...
        var description: String {
            switch kind {
                case .workspace:
                    String(localized: "commandPalette.rename.workspaceDescription", defaultValue: "Choose a custom workspace name.")
                case .tab:
                    String(localized: "commandPalette.rename.tabDescription", defaultValue: "Choose a custom tab name.")
            }
        }
        ...
        var placeholder: String {
            switch kind {
                case .workspace:
                    String(localized: "commandPalette.rename.workspacePlaceholder", defaultValue: "Workspace name")
                case .tab:
                    String(localized: "commandPalette.rename.tabPlaceholder", defaultValue: "Tab name")
            }
        }
    }
    ...
    private struct CommandPaletteResolvedSearchMatch {
        let commandID: String
        let score: Int
        let titleMatchIndices: Set<Int>
    }
    ...
    private nonisolated static let commandPaletteCommandsPrefix = ">"
    ...
    private static let minimumSidebarWidth: CGFloat = .init(SessionPersistencePolicy.minimumSidebarWidth)
    ...
    private var contentAndSidebarLayout: AnyView {
        let layout = if sidebarBlendMode == SidebarBlendModeOption.withinWindow.rawValue {
    ...
    private var terminalContent: some View {
        ...
        let retiringWorkspaceId = retiringWorkspaceId
    ...
    private func commandPaletteRenameInputView(target: CommandPaletteRenameTarget) -> some View {
        VStack(spacing: 0) {
            TextField(target.placeholder, text: $commandPaletteRenameDraft)
                ...
                .backport
                .onKeyPress(.delete) { modifiers in
    ...
    static func commandPalettePendingActivationRequestID(
        ...
        switch pendingActivation {
            case let .selected(requestID, _, _):
                requestID
            case let .command(requestID, _):
                requestID
            case nil:
                nil
        }
    ...
    static func commandPaletteResolvedPendingActivation(
        ...
        switch pendingActivation {
            case let .selected(activationRequestID, fallbackSelectedIndex, preferredCommandID):
            ...
            case let .command(activationRequestID, commandID):
    ...
    private nonisolated static func commandPaletteListScope(for query: String) -> CommandPaletteListScope {
        if query.hasPrefix(commandPaletteCommandsPrefix) {
            return .commands
        }
        return .switcher
    }

    private nonisolated static func commandPaletteRefreshQuery(
        stateQuery: String,
        observedQuery: String?
    ) -> String {
    ...
    private nonisolated static func commandPaletteQueryForMatching(
        query: String,
        scope: CommandPaletteListScope
    ) -> String {
        switch scope {
    ...
    private nonisolated static func commandPaletteSwitcherIncludesSurfaceEntries(
        searchAllSurfaces: Bool,
        query: String
    ) -> Bool {
    ...
    private nonisolated static func commandPaletteResolvedSearchMatches(
        searchCorpus: [CommandPaletteSearchCorpusEntry<String>],
        query: String,
    ...
    private nonisolated static func commandPalettePreviewSearchMatches(
        scope: CommandPaletteListScope,
        searchCorpus: [CommandPaletteSearchCorpusEntry<String>],
        candidateCommandIDs: [String],
        searchCorpusByID: [String: CommandPaletteSearchCorpusEntry<String>],
    ...
    private nonisolated static func commandPaletteHistoryBoost(
        ...
        let ageDays = max(0, now - entry.lastUsedAt) / 86400
    ...
    private func installSidebarResizerPointerMonitorIfNeeded() {
        ...
        sidebarResizerPointerMonitor = NSEvent.addLocalMonitorForEvents(
            ...
            let shouldOverrideCursorEvent = switch event.type {
    ...
    private func renameInputHintText(target: CommandPaletteRenameTarget) -> String {
        switch target.kind {
            case .workspace:
                String(localized: "commandPalette.rename.workspaceInputHint", defaultValue: "Enter a workspace name. Press Enter to rename, Escape to cancel.")
            case .tab:
                String(localized: "commandPalette.rename.tabInputHint", defaultValue: "Enter a tab name. Press Enter to rename, Escape to cancel.")
        }
    }
    ...
    private func renameConfirmHintText(target: CommandPaletteRenameTarget) -> String {
        switch target.kind {
            case .workspace:
                String(localized: "commandPalette.rename.workspaceConfirmHint", defaultValue: "Press Enter to apply this workspace name, or Escape to cancel.")
            case .tab:
                String(localized: "commandPalette.rename.tabConfirmHint", defaultValue: "Press Enter to apply this tab name, or Escape to cancel.")
        }
    }
    ...
    private func commandPaletteEntries(
        ...
        switch scope {
            ...
            case .switcher:
                commandPaletteSwitcherEntries(includeSurfaces: includeSurfaces)
        }
    }
    ...
    private func refreshPendingCommandPaletteVisibleResults(
        ...
        let candidateCommandIDs: [String] = if commandPaletteVisibleResultsScope == scope,
                                               commandPaletteVisibleResultsFingerprint == fingerprint
        {
            Self.commandPalettePreviewCandidateCommandIDs(
    ...
    private func commandPaletteEntriesFingerprint(
        ...
        switch scope {
            case .commands:
                commandPaletteCommandsFingerprint()
            case .switcher:
                commandPaletteSwitcherEntriesFingerprint(includeSurfaces: includeSurfaces)
        }
    }
    ...
    private func commandPaletteSurfaceKindLabel(for panelType: PanelType) -> String {
        switch panelType {
            ...
            case .browser:
                String(localized: "commandPalette.kind.browser", defaultValue: "Browser")
            case .markdown:
                String(localized: "commandPalette.kind.markdown", defaultValue: "Markdown")
        }
    }
    ...
    private func registerCommandPaletteHandlers(_ registry: inout CommandPaletteHandlerRegistry) {
        ...
        registry.register(commandId: "palette.equalizeSplits") {
            guard let workspace = tabManager.selectedWorkspace,
                  tabManager.equalizeSplits(tabId: workspace.id)
            else {
                NSSound.beep()
                return
            }
    ...
    private func runCommandPaletteResolvedActivation(_ activation: CommandPaletteResolvedActivation) {
        switch activation {
            ...
            case let .selected(fallbackIndex):
    ...
    private func commandPaletteDebugSnapshot() -> CommandPaletteDebugSnapshot {
        ...
        let mode: String = switch commandPaletteMode {
            case .commands:
    ...
    private func continueRenameFlow(target: CommandPaletteRenameTarget) {
        guard case let .renameInput(activeTarget) = commandPaletteMode,
    ...
    private func applyRenameFlow(target: CommandPaletteRenameTarget, proposedName: String) {
        ...
        switch target.kind {
            ...
            case let .tab(workspaceId, panelId):
                guard let workspace = tabManager.tabs.first(where: { $0.id == workspaceId }) else {
                    NSSound.beep()
                    return
                }
...
// MARK: - CommandPaletteSwitcherSearchMetadata

struct CommandPaletteSwitcherSearchMetadata: Equatable {
    // MARK: Properties
...
// MARK: - CommandPaletteSwitcherSearchIndexer
...
// MARK: - CommandPaletteFuzzyMatcher
...
// MARK: - CommandPaletteSearchCorpusEntry

struct CommandPaletteSearchCorpusEntry<Payload: Sendable> {
    // MARK: Properties
    ...
    init(payload: Payload, rank: Int, title: String, searchableTexts: [String]) {
        ...
        self.rank = rank
        self.title = title
        normalizedSearchableTexts = searchableTexts
            .map(CommandPaletteFuzzyMatcher.normalizeForSearch)
            .filter { !$0.isEmpty }
    }
}

// MARK: - CommandPaletteSearchCorpusResult

struct CommandPaletteSearchCorpusResult<Payload: Sendable> {
    let payload: Payload
    let rank: Int
    let title: String
    let score: Int
...
// MARK: - CommandPaletteSearchEngine
...
// MARK: - SidebarResizerAccessibilityModifier
                                ...
                                TabItemView(
                                    ...
                                    latestNotificationText: {
                                        guard showsSidebarNotificationMessage,
                                              let notification = notificationStore.latestNotification(forTabId: tab.id)
                                        else {
                                            return nil
                                        }
...
// MARK: - ShortcutHintModifierPolicy
...
// MARK: - ShortcutHintDebugSettings
...
// MARK: - DevBuildBannerDebugSettings
...
private enum FeedbackComposerSettings {
    ...
    static let maxTotalAttachmentBytes = 4 * 1024 * 1024
...
// MARK: - FeedbackComposerAttachment
...
// MARK: - PreparedFeedbackComposerAttachment
...
// MARK: - FeedbackComposerAppMetadata
...
// MARK: - FeedbackComposerSubmissionError
...
// MARK: - SidebarDragLifecycleNotification
...
// MARK: - SidebarOutsideDropResetPolicy
...
// MARK: - SidebarDragFailsafePolicy
...
// MARK: - SidebarDragFailsafeMonitor
...
// MARK: - SidebarExternalDropOverlay
...
// MARK: - SidebarExternalDropDelegate
...
// MARK: - SidebarShortcutHintModifierMonitor
...
// MARK: - FeedbackComposerMessageEditor
...
private struct FeedbackComposerMessageEditor: NSViewRepresentable {
    ...
    func updateNSView(_ nsView: FeedbackComposerMessageEditorView, context _: Context) {
...
// MARK: - FeedbackComposerPassthroughLabel
...
// MARK: - FeedbackComposerMessageScrollView
...
// MARK: - FeedbackComposerMessageEditorView
...
// MARK: - SidebarFeedbackComposerSheet
...
// MARK: - FeedbackComposerBridgeError
...
// MARK: - SidebarFooterIconButtonStyle
...
// MARK: - SidebarFooterIconButtonStyleBody
...
// MARK: - SidebarScrollViewResolver
...
private struct SidebarScrollViewResolver: NSViewRepresentable {
    ...
    func makeNSView(context _: Context) -> SidebarScrollViewResolverView {
        let view = SidebarScrollViewResolverView()
        view.onResolve = onResolve
        return view
    }

    func updateNSView(_ nsView: SidebarScrollViewResolverView, context _: Context) {
        nsView.onResolve = onResolve
        nsView.resolveScrollView()
    }
}

// MARK: - SidebarScrollViewResolverView
...
// MARK: - SidebarWorkspaceShortcutHintMetrics
...
private struct TabItemView: View, Equatable {
    ...
    private var explicitRailColor: Color? {
        guard activeTabIndicatorStyle == .leftRail,
              let custom = resolvedCustomTabColor
        else {
            return nil
        }
    ...
    private func pullRequestStatusLabel(_ status: SidebarPullRequestStatus) -> String {
        switch status {
            case .open: String(localized: "sidebar.pullRequest.statusOpen", defaultValue: "open")
            case .merged: String(localized: "sidebar.pullRequest.statusMerged", defaultValue: "merged")
            case .closed: String(localized: "sidebar.pullRequest.statusClosed", defaultValue: "closed")
        }
    }
...
private struct SidebarMetadataEntryRow: View {
    ...
    private var iconView: AnyView? {
        ...
        let symbolName: String = if iconRaw.hasPrefix("sf:") {
...
// MARK: - SidebarMetadataMarkdownBlocks
...
// MARK: - SidebarMetadataMarkdownBlockRow
...
enum SidebarDropPlanner {
    static func indicator(
        ...
        if let targetTabId {
            ...
            let edge: SidebarDropEdge = if let pointerY, let targetHeight {
                edgeForPointer(locationY: pointerY, targetHeight: targetHeight)
            } else {
...
// MARK: - SidebarAutoScrollDirection
...
// MARK: - SidebarDragAutoScrollPlanner
...
// MARK: - SidebarDragAutoScrollController
...
// MARK: - SidebarBonsplitTabDropDelegate
...
private struct MiddleClickCapture: NSViewRepresentable {
    ...
    func makeNSView(context _: Context) -> MiddleClickCaptureView {
        let view = MiddleClickCaptureView()
        view.onMiddleClick = onMiddleClick
        return view
    }

    func updateNSView(_ nsView: MiddleClickCaptureView, context _: Context) {
        nsView.onMiddleClick = onMiddleClick
    }
}

// MARK: - MiddleClickCaptureView
...
// MARK: - DraggableFolderIconRepresentable
...
private struct DraggableFolderIconRepresentable: NSViewRepresentable {
    ...
    func makeNSView(context _: Context) -> DraggableFolderNSView {
        DraggableFolderNSView(directory: directory)
    }

    func updateNSView(_ nsView: DraggableFolderNSView, context _: Context) {
        nsView.directory = directory
        nsView.updateIcon()
    }
}

// MARK: - DraggableFolderNSView
...
final class DraggableFolderNSView: NSView, NSDraggingSource {
    ...
    private func buildPathMenu() -> NSMenu {
        ...
        for pathURL in pathComponents {
            ...
            let displayName: String = if pathURL.path == "/" {
                ...
                FileManager.default.displayName(atPath: pathURL.path)
            }
    ...
    @objc private func openComputer(_: NSMenuItem) {
...
// MARK: - SidebarVisualEffectBackground
...
// MARK: - TitlebarLeadingInsetPassthroughView
...
// MARK: - TitlebarLeadingInsetReader
...
enum SidebarMaterialOption: String, CaseIterable, Identifiable {
    ...
    var title: String {
        switch self {
            ...
            case .sidebar: String(localized: "settings.material.sidebar", defaultValue: "Sidebar")
            case .hudWindow: String(localized: "settings.material.hudWindow", defaultValue: "HUD Window")
            case .menu: String(localized: "settings.material.menu", defaultValue: "Menu")
            case .popover: String(localized: "settings.material.popover", defaultValue: "Popover")
            case .underWindowBackground: String(localized: "settings.material.underWindow", defaultValue: "Under Window")
            case .windowBackground: String(localized: "settings.material.windowBackground", defaultValue: "Window Background")
            case .contentBackground: String(localized: "settings.material.contentBackground", defaultValue: "Content Background")
            case .fullScreenUI: String(localized: "settings.material.fullScreenUI", defaultValue: "Full Screen UI")
            case .sheet: String(localized: "settings.material.sheet", defaultValue: "Sheet")
            case .headerView: String(localized: "settings.material.headerView", defaultValue: "Header View")
            case .toolTip: String(localized: "settings.material.toolTip", defaultValue: "Tool Tip")
        }
    }
    ...
    var material: NSVisualEffectView.Material? {
        switch self {
            case .none: nil
            case .liquidGlass: .underWindowBackground // Fallback material
...
enum SidebarBlendModeOption: String, CaseIterable, Identifiable {
    ...
    var title: String {
        switch self {
            case .behindWindow: String(localized: "settings.blendMode.behindWindow", defaultValue: "Behind Window")
            case .withinWindow: String(localized: "settings.blendMode.withinWindow", defaultValue: "Within Window")
        }
    }
...
enum SidebarStateOption: String, CaseIterable, Identifiable {
    ...
    var title: String {
        switch self {
            case .active: String(localized: "settings.state.active", defaultValue: "Active")
            case .inactive: String(localized: "settings.state.inactive", defaultValue: "Inactive")
            case .followWindow: String(localized: "settings.state.followWindow", defaultValue: "Follow Window")
        }
    }
...
enum SidebarPresetOption: String, CaseIterable, Identifiable {
    ...
    var title: String {
        switch self {
            case .nativeSidebar: String(localized: "settings.preset.nativeSidebar", defaultValue: "Native Sidebar")
            case .glassBehind: String(localized: "settings.preset.raycastGray", defaultValue: "Raycast Gray")
            case .softBlur: String(localized: "settings.preset.softBlur", defaultValue: "Soft Blur")
            case .popoverGlass: String(localized: "settings.preset.popoverGlass", defaultValue: "Popover Glass")
            case .hudGlass: String(localized: "settings.preset.hudGlass", defaultValue: "HUD Glass")
            case .underWindow: String(localized: "settings.preset.underWindow", defaultValue: "Under Window")
        }
    }

    var material: SidebarMaterialOption {
        switch self {
            case .nativeSidebar: .sidebar
            case .glassBehind: .sidebar
            case .softBlur: .sidebar
            case .popoverGlass: .popover
            case .hudGlass: .hudWindow
    ...
    var blendMode: SidebarBlendModeOption {
        switch self {
            case .nativeSidebar: .withinWindow
            case .glassBehind: .behindWindow
            case .softBlur: .behindWindow
            case .popoverGlass: .behindWindow
            case .hudGlass: .withinWindow
            case .underWindow: .withinWindow
        }
    }

    var state: SidebarStateOption {
        switch self {
            case .nativeSidebar: .followWindow
            case .glassBehind: .active
            case .softBlur: .active
            case .popoverGlass: .active
            case .hudGlass: .active
            case .underWindow: .followWindow
        }
    }

    var tintHex: String {
        switch self {
            case .nativeSidebar: "#000000"
            case .glassBehind: "#000000"
            case .softBlur: "#000000"
            case .popoverGlass: "#000000"
            case .hudGlass: "#000000"
            case .underWindow: "#000000"
        }
    }

    var tintOpacity: Double {
        switch self {
            case .nativeSidebar: 0.18
            case .glassBehind: 0.36
            case .softBlur: 0.28
            case .popoverGlass: 0.10
            case .hudGlass: 0.62
            case .underWindow: 0.14
        }
    }

    var cornerRadius: Double {
        switch self {
            case .nativeSidebar: 0.0
            case .glassBehind: 0.0
            case .softBlur: 0.0
            case .popoverGlass: 10.0
            case .hudGlass: 10.0
            case .underWindow: 6.0
        }
    }

    var blurOpacity: Double {
        switch self {
            case .nativeSidebar: 1.0
            case .glassBehind: 0.6
            case .softBlur: 0.45
            case .popoverGlass: 0.9
            case .hudGlass: 0.98
            case .underWindow: 0.9
        }
    }
}
