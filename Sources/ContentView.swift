...
private struct SidebarActiveProfileBadge: View {
    ...
    var body: some View {
        ...
        .accessibilityLabel(String(localized: "sidebar.activeProfileBadge.accessibilityLabel", defaultValue: "Active profile: \(name)"))
    }
}
        ...
        HStack(spacing: 4) {
            ...
            if let name = activeProfileName,
               !name.trimmingCharacters(in: .whitespacesAndNewlines).isEmpty {
                SidebarActiveProfileBadge(name: name.trimmingCharacters(in: .whitespacesAndNewlines))
            }
        }
        .frame(maxWidth: .infinity, alignment: .leading)
    }
