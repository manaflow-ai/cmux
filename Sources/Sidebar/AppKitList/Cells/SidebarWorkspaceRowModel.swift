...
struct SidebarWorkspaceRowModel: Equatable {
    ...
    /// The effective Todo Controls setting, projected at model-build time so
    /// an inherited default or user-value change reconfigures and re-measures
    /// rows instead of reading an unobserved global inside the cell.
