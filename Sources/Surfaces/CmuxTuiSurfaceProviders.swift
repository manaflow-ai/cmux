...
final class CmuxTuiSurfaceProvider: SurfaceProvider {
    ...
    fileprivate var tabByTerminal: [String: String] = [:]
    ...
    fileprivate struct PendingRemoteCreation {
        var resource: SurfaceResource
        var receipt: CloudVMCursor?
        let tabID: String?
    }
    fileprivate var pendingRemoteCreations: [SurfaceResourceID: PendingRemoteCreation] = [:]
