...
enum SettingsSearchAliasIndex {
    ...
    private static let settingAliases: [String: String] = [
        ...
        "terminal:copy-reflow": localized("settings.search.alias.setting.terminal.copy-reflow", defaultValue: "terminal.reflowCopy copy reflow rewrap unwrap wrapped hard wrap line breaks newlines paste paragraphs clean copy raw verbatim cmd c"),
