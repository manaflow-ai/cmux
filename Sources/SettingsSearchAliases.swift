...
enum SettingsSearchAliasIndex {
    ...
    private static let settingAliases: [String: String] = [
        ...
        "browser:terminal-link-placement": localized("settings.search.alias.setting.browser.terminal-link-placement", defaultValue: "browser.terminalLinkBrowserPlacement terminal links browser pane split same pane reuse or split"),
