...
enum SettingsSearchAliasIndex {
    ...
    private static let settingAliases: [String: String] = [
        ...
        "terminal:inline-image-thumbnails": localized("settings.search.alias.setting.terminal.inline-image-thumbnails", defaultValue: "terminal.inlineImageThumbnails image thumbnail preview quick look quicklook png jpg jpeg gif webp heic screenshot plot"),
