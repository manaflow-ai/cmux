...
enum SettingsSearchAliasIndex {
    ...
    private static let settingAliases: [String: String] = [
        ...
        "browser:capture-keyboard-shortcuts": localized("settings.search.alias.setting.browser.capture-keyboard-shortcuts", defaultValue: "browser.captureKeyboardShortcuts browser web page keyboard shortcuts capture cmux vscode command p focus"),
