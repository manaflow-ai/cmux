enum SettingsSearchAliasIndex {
    static func sectionAliases(for target: SettingsNavigationTarget) -> String {
        ...
        case .globalHotkey:
            return localized("settings.search.alias.section.globalHotkey", defaultValue: "system shortcut global keyboard show hide overlay full screen hotkey window")
    ...
    private static let settingAliases: [String: String] = [
        ...
        "globalHotkey:enable-hotkey": localized("settings.search.alias.setting.globalHotkey.enable-hotkey", defaultValue: "global hotkey enable system wide show hide overlay hotkey window full screen"),
        "globalHotkey:shortcut": localized("settings.search.alias.setting.globalHotkey.shortcut", defaultValue: "global hotkey overlay shortcut recorder key command option control"),
