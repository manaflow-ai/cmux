...
enum SettingsSearchAliasIndex {
    ...
    private static let settingAliases: [String: String] = [
        ...
        "mobile:iOSTransportMode": localized("settings.search.alias.setting.mobile.iOSTransportMode", defaultValue: "ios iphone ipad mobile transport mode connection pairing iroh relay tailscale cmux hosted own relay direct connect encrypted endpoint local network cellular attach"),
