enum SettingsSearchAliasIndex {
    ...
    private static let settingAliases: [String: String] = [
        ...
        "betaFeatures:sidebar-extensions": localized("settings.search.alias.setting.betaFeatures.sidebar-extensions", defaultValue: "sidebar extension extensions provider custom left workspace list beta unstable"),
