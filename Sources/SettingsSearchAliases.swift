...
enum SettingsSearchAliasIndex {
    ...
    private static let settingAliases: [String: String] = [
        ...
        "browser:forward-web-notifications": localized("settings.search.alias.setting.browser.forward-web-notifications", defaultValue: "browser.forwardWebNotifications website web page notifications alerts banners sidebar permission"),
