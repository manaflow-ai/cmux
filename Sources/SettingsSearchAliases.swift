...
enum SettingsSearchAliasIndex {
    ...
    private static let settingAliases: [String: String] = [
        ...
        "terminal:restore-terminal-sessions": localized("settings.search.alias.setting.terminal.restore-terminal-sessions", defaultValue: "terminal.restoreTerminalSessions restore terminal sessions workspaces tabs reopen relaunch fresh state browser-only"),
