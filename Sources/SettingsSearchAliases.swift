...
enum SettingsSearchAliasIndex {
    ...
    private static let settingAliases: [String: String] = [
        ...
        "sidebarAppearance:always-show-workspace-numbers": localized("settings.search.alias.setting.app.always-show-workspace-numbers", defaultValue: "sidebar.alwaysShowWorkspaceNumbers workspace number command digit shortcut hint always visible sidebar cmd"),
