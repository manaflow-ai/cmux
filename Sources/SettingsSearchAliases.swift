enum SettingsSearchAliasIndex {
    ...
    private static let settingAliases: [String: String] = [
        ...
        "betaFeatures:extensions": localized("settings.search.alias.setting.betaFeatures.extensions", defaultValue: "sidebar extension extensions provider custom left workspace list beta unstable"),
