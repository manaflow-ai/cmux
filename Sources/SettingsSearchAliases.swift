...
enum SettingsSearchAliasIndex {
    ...
    private static let settingAliases: [String: String] = [
        ...
        "app:file-editor-font-size": localized("settings.search.alias.setting.app.file-editor-font-size", defaultValue: "fileEditor.fontSize file editor font size points zoom scale text bigger smaller larger default"),
        "app:file-editor-font-family": localized("settings.search.alias.setting.app.file-editor-font-family", defaultValue: "fileEditor.fontFamily file editor font family typeface system mono custom"),
        "app:file-editor-line-height": localized("settings.search.alias.setting.app.file-editor-line-height", defaultValue: "fileEditor.lineHeight file editor line height leading spacing paragraph line multiplier"),
