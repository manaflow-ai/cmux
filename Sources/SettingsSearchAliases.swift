...
enum SettingsSearchAliasIndex {
    ...
    private static let settingAliases: [String: String] = [
        ...
        "sidebarAppearance:workspace-todos": localized("settings.search.alias.setting.sidebarAppearance.workspace-todos", defaultValue: "sidebar.workspaceTodos workspace todo task status checklist glyph lane done review working needs attention"),
