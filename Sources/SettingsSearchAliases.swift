enum SettingsSearchAliasIndex {
    ...
    private static let settingAliases: [String: String] = [
        ...
        "app:single-window-mode": localized("settings.search.alias.setting.app.single-window-mode", defaultValue: "app.singleWindowMode single window mode prevent automatic new windows fallback tabs workspaces"),
