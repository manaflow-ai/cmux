...
enum SettingsSearchAliasIndex {
    ...
    private static let settingAliases: [String: String] = [
        ...
        "sidebarAppearance:show-pull-request-checks": localized("settings.search.alias.setting.app.show-pull-request-checks", defaultValue: "sidebar.showPullRequestChecks pr ci checks tests passing failing pending merge conflict"),
