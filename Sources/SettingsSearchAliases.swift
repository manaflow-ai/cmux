...
enum SettingsSearchAliasIndex {
    ...
    private static let settingAliases: [String: String] = [
        ...
        "browser:terminal-link-placement": "browser.terminalLinkBrowserPlacement samePane split " + localized("settings.browser.terminalLinkPlacement.search", defaultValue: "terminal link browser placement same pane tab split open URL"),
