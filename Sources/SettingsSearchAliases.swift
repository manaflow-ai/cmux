...
enum SettingsSearchAliasIndex {
    ...
    private static let settingAliases: [String: String] = [
        ...
        "sidebarAppearance:workspace-spacing": localized("settings.search.alias.setting.sidebarAppearance.workspace-spacing", defaultValue: "sidebar.workspaceSpacing workspace row group gap density compact points"),
