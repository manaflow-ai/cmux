enum SettingsSearchAliasIndex {
    ...
    private static let settingAliases: [String: String] = [
        ...
        "terminal:session-backend": localized("settings.search.alias.setting.terminal.session-backend", defaultValue: "terminal.sessionBackend zellij native live processes relaunch restore persistence resurrection attach"),
