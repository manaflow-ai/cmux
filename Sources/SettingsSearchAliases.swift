enum SettingsSearchAliasIndex {
    ...
    private static let settingAliases: [String: String] = [
        ...
        "terminal:command-history-panel": localized("settings.search.alias.setting.terminal.command-history-panel", defaultValue: "terminal.commandHistoryPanel history command up down arrow shell readline prefix search panel warp"),
