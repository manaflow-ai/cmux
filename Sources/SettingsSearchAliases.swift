enum SettingsSearchAliasIndex {
    ...
    private static let settingAliases: [String: String] = [
        ...
        "betaFeatures:iOSPairingHost": localized("settings.search.alias.setting.betaFeatures.iOSPairingHost", defaultValue: "ios iphone ipad mobile pairing local network permission sync beta"),
