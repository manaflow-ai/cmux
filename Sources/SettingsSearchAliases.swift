enum SettingsSearchAliasIndex {
    ...
    private static let settingAliases: [String: String] = [
        ...
        "browser:omnibar-font-size": localized("settings.search.alias.setting.browser.omnibar-font-size", defaultValue: "browser.omnibarFontSize omnibar address bar url field font size points text bigger smaller larger navigation buttons toolbar"),
