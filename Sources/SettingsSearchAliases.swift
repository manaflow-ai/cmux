enum SettingsSearchAliasIndex {
    ...
    private static let settingAliases: [String: String] = [
        ...
        "browser:extensions": localized("settings.search.alias.setting.browser.extensions", defaultValue: "browser extensions safari webextensions ublock origin 1password bitwarden icloud passwords password manager passkeys video speed controller ad blocker"),
