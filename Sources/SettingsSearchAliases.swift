...
enum SettingsSearchAliasIndex {
    ...
    private static let settingAliases: [String: String] = [
        ...
        "terminal:agent-context-management": localized("settings.search.alias.setting.terminal.agent-context-management", defaultValue: "terminal.agentContextManagement.enabled context pressure context window claude codex long thread compaction recovery"),
        "terminal:agent-context-management-action": localized("settings.search.alias.setting.terminal.agent-context-management-action", defaultValue: "terminal.agentContextManagement.action recovery command compact clear fresh context claude codex"),
        "terminal:agent-context-management-preserve-state": localized("settings.search.alias.setting.terminal.agent-context-management-preserve-state", defaultValue: "terminal.agentContextManagement.preserveState preserve state handoff note file clear fresh context"),
