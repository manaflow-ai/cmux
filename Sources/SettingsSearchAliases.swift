...
enum SettingsSearchAliasIndex {
    ...
    private static let settingAliases: [String: String] = [
        ...
        "sidebarAppearance:workspace-description-color": localized("settings.search.alias.setting.app.workspace-description-color", defaultValue: "sidebar.workspaceDescriptionColor workspace description text color notes notification preview distinguish"),
