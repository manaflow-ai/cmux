...
enum SettingsSearchAliasIndex {
    ...
    private static let settingAliases: [String: String] = [
        ...
        "sidebarAppearance:metadata-collapse-limit": localized("settings.search.alias.setting.sidebarAppearance.metadata-collapse-limit", defaultValue: "sidebarAppearance.metadataCollapseLimit metadata collapse limit show more unlimited all statuses entries"),
