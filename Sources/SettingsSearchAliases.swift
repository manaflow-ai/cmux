enum SettingsSearchAliasIndex {
    ...
    private static let settingAliases: [String: String] = [
        ...
        "app:markdown-viewer-font-size": localized("settings.search.alias.setting.app.markdown-viewer-font-size", defaultValue: "app.markdownViewerFontSize md markdown mdx viewer preview font size zoom scale text readme"),
