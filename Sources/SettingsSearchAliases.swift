...
enum SettingsSearchAliasIndex {
    ...
    private static let settingAliases: [String: String] = [
        ...
        "sidebarAppearance:notification-scheduler": localized("settings.search.alias.setting.sidebarAppearance.notification-scheduler", defaultValue: "sidebar.notificationSchedulerMode scheduler priority urgency blocked first small wins aging round robin arrival fifo unread notifications"),
