...
enum SettingsSearchAliasIndex {
    ...
    private static let settingAliases: [String: String] = [
        ...
        "sidebarAppearance:left-min-width": localized("settings.search.alias.setting.sidebarAppearance.left-min-width", defaultValue: "sidebar.leftMinWidth left sidebar minimum min width narrow narrower thin resize drag workspace sidebar terminal space"),
