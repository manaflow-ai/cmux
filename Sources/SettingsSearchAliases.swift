...
enum SettingsSearchAliasIndex {
    ...
    private static let settingAliases: [String: String] = [
        ...
        "app:app-icon": localized("settings.search.alias.setting.app.app-icon", defaultValue: "app.appIcon app.appIconImagePath dock icon application icon app switcher alternate icon custom image file"),
