...
enum SettingsSearchAliasIndex {
    ...
    private static let settingAliases: [String: String] = [
        ...
        "app:keep-expanded-on-new-tab": localized("settings.search.alias.setting.app.keep-expanded-on-new-tab", defaultValue: "app.keepExpandedOnNewTab pane zoom expanded new tab surface terminal preserve layout"),
