...
enum SettingsSearchAliasIndex {
    ...
    private static let settingAliases: [String: String] = [
        ...
        "terminal:prefix-program-titles-with-directory": localized("settings.search.alias.setting.terminal.prefix-program-titles-with-directory", defaultValue: "terminal.prefixProgramTitlesWithDirectory program title directory folder basename working directory cwd terminal tab workspace agent"),
