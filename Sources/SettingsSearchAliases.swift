...
enum SettingsSearchAliasIndex {
    ...
    private static let settingAliases: [String: String] = [
        ...
        "app:workspace-title-bar": localized("settings.search.alias.setting.app.workspace-title-bar", defaultValue: "app.showWorkspaceTitleBar hide show workspace window folder group title bar pane tabs chrome"),
