...
enum SettingsSearchAliasIndex {
    ...
    private static let settingAliases: [String: String] = [
        ...
        "sidebarAppearance:show-cloud-button": localized("settings.search.alias.setting.app.show-cloud-button", defaultValue: "sidebar.showCloudButton cloud button footer machines hide show"),
