enum SettingsSearchAliasIndex {
    ...
    private static let settingAliases: [String: String] = [
        ...
        "app:restore-session-launch": localized("settings.search.alias.setting.app.restore-session-launch", defaultValue: "app.restorePreviousSessionOnLaunch auto restore session startup launch reopen restore tabs panes splits layout windows"),
