...
enum SettingsSearchAliasIndex {
    static func sectionAliases(for target: SettingsNavigationTarget) -> String {
        ...
        case .betaFeatures:
            return localized("settings.search.alias.section.betaFeatures", defaultValue: "beta experimental unstable preview feed dock source control git scm commit diff right sidebar")
        case .automation:
    ...
    private static let settingAliases: [String: String] = [
        ...
        "betaFeatures:source-control": localized("settings.search.alias.setting.betaFeatures.source-control", defaultValue: "sourceControl.beta.enabled source control git scm commit stage unstage diff changes right sidebar beta"),
