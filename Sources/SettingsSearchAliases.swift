enum SettingsSearchAliasIndex {
    static func sectionAliases(for target: SettingsNavigationTarget) -> String {
        ...
        case .browser:
            return localized("settings.search.alias.section.browser", defaultValue: "web webview address bar omnibar links urls embedded default browser extensions password manager ad blocker")
        case .browserImport:
    ...
    private static let settingAliases: [String: String] = [
        ...
        "browser:extensions": localized("settings.search.alias.setting.browser.extensions", defaultValue: "browser.extensionsDeveloperMode browser.extensionsAllowFileURLAccess browser extensions safari webextensions ublock origin 1password bitwarden icloud passwords password manager passkeys video speed controller ad blocker developer mode appex local file access"),
