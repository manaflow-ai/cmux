enum SettingsSearchAliasIndex {
    ...
    private static let settingAliases: [String: String] = [
        ...
        "app:markdown-cmd-click-links": localized("settings.search.alias.setting.app.markdown-cmd-click-links", defaultValue: "markdown.cmdClickOpenTarget md markdown viewer cmd command click link path file open new tab split right pane"),
