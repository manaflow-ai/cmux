...
enum SettingsSearchAliasIndex {
    ...
    private static let settingAliases: [String: String] = [
        ...
        "automation:agent-panes": localized("settings.search.alias.setting.automation.agent-panes", defaultValue: "automation.agentPanesEnabled agent panes subagent teammate claude task split terminal"),
