...
enum SettingsSearchAliasIndex {
    ...
    private static let settingAliases: [String: String] = [
        ...
        "sidebarAppearance:show-last-interaction": localized("settings.search.alias.setting.app.show-last-interaction", defaultValue: "sidebar.showLastInteractionInsteadOfPath last interaction relative time ago prompt submitted timestamp sidebar"),
        ...
        "sidebarAppearance:last-interaction-timestamp-style": localized("settings.search.alias.setting.app.last-interaction-timestamp-style", defaultValue: "sidebar.lastInteractionTimestampStyle relative absolute timestamp seconds ordering workspace"),
