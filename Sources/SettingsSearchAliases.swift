...
enum SettingsSearchAliasIndex {
    ...
    private static let settingAliases: [String: String] = [
        ...
        "app:teams-spawn-placement": localized("settings.search.alias.setting.app.teams-spawn-placement", defaultValue: "app.teamsSpawnPlacement Claude Teams agent team teammate tmux new-window workspace surface tab pane"),
