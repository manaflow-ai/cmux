...
enum SettingsSearchAliasIndex {
    ...
    private static let settingAliases: [String: String] = [
        ...
        "terminal:macos-press-and-hold": localized("settings.search.alias.setting.terminal.macos-press-and-hold", defaultValue: "terminal.macosPressAndHold macOS press and hold accents accent menu key repeat repeated letters international keyboard"),
