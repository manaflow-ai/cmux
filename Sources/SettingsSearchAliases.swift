enum SettingsSearchAliasIndex {
    ...
    private static let settingAliases: [String: String] = [
        ...
        "terminal:quick-terminal-position": localized("settings.search.alias.setting.terminal.quick-terminal-position", defaultValue: "terminal.quickTerminalPosition quick terminal dropdown quake position top bottom left right center"),
        "terminal:quick-terminal-primary-size": localized("settings.search.alias.setting.terminal.quick-terminal-primary-size", defaultValue: "terminal.quickTerminalPrimarySizeRatio quick terminal dropdown quake primary size height width"),
        "terminal:quick-terminal-secondary-size": localized("settings.search.alias.setting.terminal.quick-terminal-secondary-size", defaultValue: "terminal.quickTerminalSecondarySizeRatio quick terminal dropdown quake secondary size height width"),
        "terminal:quick-terminal-auto-hide": localized("settings.search.alias.setting.terminal.quick-terminal-auto-hide", defaultValue: "terminal.quickTerminalAutoHide quick terminal dropdown quake auto hide blur focus"),
