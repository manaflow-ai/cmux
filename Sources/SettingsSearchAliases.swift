...
enum SettingsSearchAliasIndex {
    ...
    private static let settingAliases: [String: String] = [
        ...
        "sidebarAppearance:workspace-status-style": localized("settings.search.alias.setting.sidebarAppearance.workspace-status-style", defaultValue: "sidebar.workspaceStatusStyle agent status dots compact subtitle sentence one line tab row"),
        "sidebarAppearance:scroll-edge-fade": localized("settings.search.alias.setting.sidebarAppearance.scroll-edge-fade", defaultValue: "sidebar.scrollEdgeFade sidebar tab list fade shadow scrim edge top bottom off subtle"),
