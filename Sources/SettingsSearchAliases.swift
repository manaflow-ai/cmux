...
enum SettingsSearchAliasIndex {
    ...
    private static let settingAliases: [String: String] = [
        ...
        "app:open-new-window-on-cursor-screen": localized("settings.search.alias.setting.app.open-new-window-on-cursor-screen", defaultValue: "app.openNewWindowOnCursorScreen new window multiple displays monitor screen mouse cursor cascade iterm active"),
