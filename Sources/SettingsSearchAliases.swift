...
enum SettingsSearchAliasIndex {
    ...
    private static let settingAliases: [String: String] = [
        ...
        "sidebarAppearance:sidebar-density": localized("settings.search.alias.setting.sidebarAppearance.sidebar-density", defaultValue: "sidebar.density density quiet compact full preset details minimal busy workspace sidebar rows"),
