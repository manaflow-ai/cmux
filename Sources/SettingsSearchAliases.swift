...
enum SettingsSearchAliasIndex {
    ...
    private static let settingAliases: [String: String] = [
        ...
        "browser:terminal-hyperlink-activation": localized("settings.search.alias.setting.browser.terminal-hyperlink-activation", defaultValue: "browser.terminalHyperlinkActivationEnabled terminal hyperlink OSC 8 detected links disable click URL"),
