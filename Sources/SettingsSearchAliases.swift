...
enum SettingsSearchAliasIndex {
    ...
    private static let settingAliases: [String: String] = [
        ...
        "sidebarAppearance:state-indicator-running-color": localized("settings.search.alias.setting.sidebarAppearance.state-indicator-running-color", defaultValue: "sidebar.stateIndicatorColors.running agent status pill running color state indicator lifecycle claude codex bolt"),
        "sidebarAppearance:state-indicator-needs-input-color": localized("settings.search.alias.setting.sidebarAppearance.state-indicator-needs-input-color", defaultValue: "sidebar.stateIndicatorColors.needsInput agent status pill needs input waiting blocked color state indicator lifecycle bell"),
        "sidebarAppearance:state-indicator-idle-color": localized("settings.search.alias.setting.sidebarAppearance.state-indicator-idle-color", defaultValue: "sidebar.stateIndicatorColors.idle agent status pill idle finished done color state indicator lifecycle"),
