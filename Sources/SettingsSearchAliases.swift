enum SettingsSearchAliasIndex {
    ...
    private static let settingAliases: [String: String] = [
        ...
        "terminal:warm-pty-pool": localized("settings.search.alias.setting.terminal.warm-pty-pool", defaultValue: "terminal.warmPtyPool pty warm prewarm shell instant new tab cmd-t split"),
