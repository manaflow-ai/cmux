enum SettingsSearchAliasIndex {
    ...
    private static let settingAliases: [String: String] = [
        ...
        "browser:terminal-link-default-browser-modifier": localized("settings.search.alias.setting.browser.terminal-link-default-browser-modifier", defaultValue: "browser.terminalLinkDefaultBrowserModifier link.click.defaultBrowser command cmd option opt shift control modifier click external system default browser"),
        "browser:terminal-link-cmux-browser-modifier": localized("settings.search.alias.setting.browser.terminal-link-cmux-browser-modifier", defaultValue: "browser.terminalLinkCmuxBrowserModifier link.click.builtInBrowser command cmd option opt shift control modifier click embedded built in browser"),
