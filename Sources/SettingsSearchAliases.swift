...
enum SettingsSearchAliasIndex {
    ...
    private static let settingAliases: [String: String] = [
        ...
        "workspaceColors:state-colors-enabled": localized("settings.search.alias.setting.workspaceColors.state-colors-enabled", defaultValue: "workspaceColors.stateColorsEnabled agent state colors running waiting idle needs input tint workspace tabs"),
        "workspaceColors:state-color-mode": localized("settings.search.alias.setting.workspaceColors.state-color-mode", defaultValue: "workspaceColors.stateColorMode replace blend manual workspace color agent state"),
        "workspaceColors:state-colors": localized("settings.search.alias.setting.workspaceColors.state-colors", defaultValue: "workspaceColors.stateColors running waiting needs input idle unknown agent state hex colors"),
