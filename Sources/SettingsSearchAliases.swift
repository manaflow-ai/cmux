...
enum SettingsSearchAliasIndex {
    ...
    private static let settingAliases: [String: String] = [
        ...
        "sidebarAppearance:workspace-status-style": localized("settings.search.alias.setting.sidebarAppearance.workspace-status-style", defaultValue: "sidebar.workspaceStatusStyle agent status subtitle sentence dot compact one line tab row"),
