...
enum SettingsSearchAliasIndex {
    ...
    private static let settingAliases: [String: String] = [
        ...
        "sidebarAppearance:hide-workspace-close-button": localized("settings.search.alias.setting.sidebarAppearance.hide-workspace-close-button", defaultValue: "sidebar.hideWorkspaceCloseButton workspace close x button title width reclaim"),
