...
enum SettingsSearchAliasIndex {
    ...
    private static let settingAliases: [String: String] = [
        ...
        "browser:terminal-link-split-direction": localized("settings.search.alias.setting.browser.terminal-link-split-direction", defaultValue: "browser.terminalLinkSplitDirection terminal links browser split right down below direction pane"),
