...
enum SettingsSearchAliasIndex {
    ...
    private static let settingAliases: [String: String] = [
        ...
        "textBox:compose-mode": localized("settings.search.alias.setting.textBox.compose-mode", defaultValue: "terminal.composeMode compose mode native editor selection undo multiline input prompt"),
