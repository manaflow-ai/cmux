...
enum SettingsSearchAliasIndex {
    ...
    private static let settingAliases: [String: String] = [
        ...
        "app:artifact-pane-orientation": localized("settings.search.alias.setting.app.artifact-pane-orientation", defaultValue: "app.artifactPaneOrientation artifact pane markdown viewer split right down horizontal vertical orientation layout"),
