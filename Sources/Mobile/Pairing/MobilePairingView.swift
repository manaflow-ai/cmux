...
///
/// Iroh is the normal account-backed path and is presented first in the
/// transport chooser. Tailscale is an explicit compatibility path for QR or
    ...
    private var header: some View {
        VStack(alignment: .leading, spacing: 2) {
            ...
            Text(String(
                ...
                defaultValue: "Sign in to the same cmux account on your iPhone to find this Mac automatically over Iroh."
            ))
                .cmuxFont(.callout)
