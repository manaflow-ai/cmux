...
final class MobilePairingWindowController: ReleasingWindowController {
    ...
    override func makeWindow() -> NSWindow {
        ...
        window.title = String(localized: "mobile.connection.window.title", defaultValue: "Mobile Connection")
...
/// Workspace-owned pane for the mobile connection flow.
@MainActor
final class MobilePairingPanel: Panel {
    ...
    var displayTitle: String {
        String(localized: "mobile.connection.window.title", defaultValue: "Mobile Connection")
    }
