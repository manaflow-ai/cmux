...
/// Authorization policy types for the mobile host: the shared error surface,
/// Stack user-id matching, the DEBUG dev-token policy, and the cached remote
/// Stack verifier. Split from MobileHostService.swift (file-length budget).
