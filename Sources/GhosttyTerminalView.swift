    ...
    private func handleAction(target: ghostty_target_s, action: ghostty_action_s) -> Bool {
        ...
        case GHOSTTY_ACTION_OPEN_URL:
            ...
            return performOnMain {
                ...
                return surfaceView.handleCommandClickOpenURLCallback(urlString: urlString, request: request)
            }
        default:
            return false
        }
...
class GhosttyNSView: NSView, NSUserInterfaceValidations {
    ...
    func completePendingLeftMouseRelease(with event: NSEvent) -> Bool {
        ...
        if linkActivationAuthorized {
            pendingCommandClickContext = prepareCommandClickContext(
                at: point,
    ...
    private func dispatchCommandClickRelease(
        ...
        let resolution = linkActivationAuthorized ? handleCommandClickRelease(
            ...
            commandClickState: pendingCommandClickContext
        ) : nil
