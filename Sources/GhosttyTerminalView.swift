...
final class TerminalSurface: Identifiable, ObservableObject {
    ...
    init(
        ...
        // Attaching records the concrete GhosttyNSView immediately. Visual mounts
        // still wait for a backing window, while explicit runtime requests from the
        // socket/control plane may start from this attached view off-window.
