...
enum SessionPersistencePolicy {
    ...
    static let minimumWindowHeightKey = "minimumWindowHeight"
    static let defaultMinimumWindowHeight: Double = 400
    static let minimumWindowHeightRange: ClosedRange<Double> = 120...400
    ...
    static let minimumWindowHeight: Double = defaultMinimumWindowHeight

    static func resolvedMinimumWindowHeight(defaults: UserDefaults = .standard) -> Double {
        guard let value = defaults.object(forKey: minimumWindowHeightKey) as? NSNumber else {
            return defaultMinimumWindowHeight
        }
        guard value.doubleValue.isFinite else { return defaultMinimumWindowHeight }
        return min(max(value.doubleValue, minimumWindowHeightRange.lowerBound), minimumWindowHeightRange.upperBound)
    }
