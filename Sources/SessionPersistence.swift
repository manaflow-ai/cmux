...
enum SessionPersistencePolicy {
    // The left sidebar minimum-width policy (`sidebar.leftMinWidth`) lives in
    // CmuxSettings' `LeftSidebarWidthSettings`, shared with the catalog, the
    // cmux.json loader, and the Settings pane.
