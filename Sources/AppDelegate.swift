...
final class AppDelegate: NSObject, NSApplicationDelegate, UNUserNotificationCenterDelegate, NSMenuItemValidation, NSMenuDelegate, CmuxConfigStoreReloadEnvironment {
    ...
    /// Opens the mobile connection flow as a dedicated workspace, reusing the
    /// existing connection workspace in the target window when one is open.
    ///
    /// - Parameters:
    ...
    ///   - enforceFeatureFlag: Whether the mobile connection button flag gates the action.
    ...
    func performMobileConnectWorkspaceAction(
        ...
        let title = String(localized: "mobile.connection.window.title", defaultValue: "Mobile Connection")
