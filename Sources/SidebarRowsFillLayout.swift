...
/// `@State` to size a fixed-height empty area. That measurement forced every row
/// (visible and offscreen) to be placed — defeating `LazyVStack` virtualization —
/// and the preference write during layout fed a non-converging relayout loop
/// (https://github.com/manaflow-ai/cmux/issues/2586,
/// https://github.com/manaflow-ai/cmux/issues/5764). This `Layout` instead reads
