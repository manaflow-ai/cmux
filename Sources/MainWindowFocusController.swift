...
final class MainWindowFocusController {
    ...
    private func rightSidebarFocusTarget(
        ...
        case .find:
            return .searchField
        case .gitGraph, .herd, .sessions, .machines, .customSidebar:
            return .host
        case .feed:
    ...
    private func focusRightSidebarEndpoint(
        ...
        case .gitGraph, .herd, .sessions, .customSidebar:
            return mode == .gitGraph || mode == .herd || mode == .customSidebar
                ? focusFallbackRightSidebarHost()
                : false
        case .machines:
