...
enum SettingsSearchIndex {
    ...
    private static let settingEntries: [SettingsSearchEntry] = [
        ...
        setting(.sidebarAppearance, "sidebar-density", String(localized: "settings.sidebar.density", defaultValue: "Sidebar Density"), "density quiet compact full preset details workspace sidebar"),
    ...
    private static let settingsPathAnchorIDs: [String: String] = [
        ...
        "sidebar.density": settingID(for: .sidebarAppearance, idSuffix: "sidebar-density"),
