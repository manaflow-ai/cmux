...
enum SettingsSearchIndex {
    ...
    private static let settingEntries: [SettingsSearchEntry] = [
        ...
        setting(.app, "file-preview-vim-keys", String(localized: "settings.search.filePreviewVimKeys", defaultValue: "Vim Navigation in File Previews"), "cmd click file preview pdf image audio video quick look editor"),
    ...
    private static let settingsPathAnchorIDs: [String: String] = [
        ...
        "app.filePreviewVimKeys": settingID(for: .app, idSuffix: "file-preview-vim-keys"),
