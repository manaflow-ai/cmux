...
enum SettingsSearchIndex {
    ...
    private static let settingEntries: [SettingsSearchEntry] = [
        ...
        setting(.terminal, "macos-press-and-hold", String(localized: "settings.terminal.macosPressAndHold", defaultValue: "macOS Press-and-Hold Accents"), "terminal.macosPressAndHold macOS press and hold accents accent menu key repeat repeated letters international keyboard"),
    ...
    private static let settingsPathAnchorIDs: [String: String] = [
        ...
        "terminal.macosPressAndHold": settingID(for: .terminal, idSuffix: "macos-press-and-hold"),
