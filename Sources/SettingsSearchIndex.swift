...
enum SettingsSearchIndex {
    ...
    private static let settingEntries: [SettingsSearchEntry] = [
        ...
        setting(.browser, "external-application", String(localized: "settings.browser.externalApplication", defaultValue: "External Browser Application"), "browser app application bundle identifier path links urls"),
    ...
    private static let settingsPathAnchorIDs: [String: String] = [
        ...
        "browser.externalApplication": settingID(for: .browser, idSuffix: "external-application"),
