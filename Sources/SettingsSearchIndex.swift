...
enum SettingsSearchIndex {
    ...
    private static let settingEntries: [SettingsSearchEntry] = [
        ...
        setting(.textBox, "compose-mode", String(localized: "settings.textBox.composeMode", defaultValue: "Compose Mode"), "terminal.composeMode compose mode native editor selection undo multiline input prompt"),
    ...
    private static let settingsPathAnchorIDs: [String: String] = [
        ...
        "terminal.composeMode": settingID(for: .textBox, idSuffix: "compose-mode"),
