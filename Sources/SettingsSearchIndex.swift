...
enum SettingsSearchIndex {
    ...
    private static let settingEntries: [SettingsSearchEntry] = [
        ...
        setting(.sidebarAppearance, "left-min-width", String(localized: "settings.sidebar.leftMinWidth", defaultValue: "Sidebar Minimum Width"), "left sidebar minimum min width narrow narrower resize drag workspace sidebar terminal space"),
    ...
    private static let settingsPathAnchorIDs: [String: String] = [
        ...
        "sidebar.leftMinWidth": settingID(for: .sidebarAppearance, idSuffix: "left-min-width"),
