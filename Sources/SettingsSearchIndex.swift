...
enum SettingsSearchIndex {
    ...
    private static let settingEntries: [SettingsSearchEntry] = [
        ...
        setting(.terminal, "prefix-program-titles-with-directory", String(localized: "settings.terminal.prefixProgramTitlesWithDirectory", defaultValue: "Keep Directory in Program Titles"), "terminal.prefixProgramTitlesWithDirectory program title directory folder basename working directory cwd terminal tab workspace agent"),
    ...
    private static let settingsPathAnchorIDs: [String: String] = [
        ...
        "terminal.prefixProgramTitlesWithDirectory": settingID(for: .terminal, idSuffix: "prefix-program-titles-with-directory"),
