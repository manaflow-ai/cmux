...
enum SettingsSearchIndex {
    ...
    private static let settingEntries: [SettingsSearchEntry] = [
        ...
        setting(.sidebarAppearance, "show-pull-request-checks", String(localized: "settings.app.showPullRequestChecks", defaultValue: "Show Pull Request Checks"), "pull request pr ci checks tests passing failing pending merge conflict"),
    ...
    private static let settingsPathAnchorIDs: [String: String] = [
        ...
        "sidebar.showPullRequestChecks": settingID(for: .sidebarAppearance, idSuffix: "show-pull-request-checks"),
