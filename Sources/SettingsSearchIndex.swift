...
enum SettingsSearchIndex {
    ...
    private static let settingEntries: [SettingsSearchEntry] = [
        ...
        setting(.sidebarAppearance, "show-agent-usage", String(localized: "settings.app.showAgentUsage", defaultValue: "Show Agent Usage in Sidebar"), "sidebar.showAgentUsage agent usage model context window tokens percent cost price estimate spend claude codex"),
    ...
    private static let settingsPathAnchorIDs: [String: String] = [
        ...
        "sidebar.showAgentUsage": settingID(for: .sidebarAppearance, idSuffix: "show-agent-usage"),
