...
enum SettingsSearchIndex {
    ...
    private static let settingEntries: [SettingsSearchEntry] = [
        ...
        setting(.browser, "terminal-link-split-direction", String(localized: "settings.browser.terminalLinkSplitDirection", defaultValue: "Terminal Link Split Direction"), "terminal links browser split right down below direction pane"),
    ...
    private static let settingsPathAnchorIDs: [String: String] = [
        ...
        "browser.terminalLinkSplitDirection": settingID(for: .browser, idSuffix: "terminal-link-split-direction"),
