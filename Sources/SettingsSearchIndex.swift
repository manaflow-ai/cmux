...
enum SettingsSearchIndex {
    ...
    private static let settingEntries: [SettingsSearchEntry] = [
        ...
        setting(.sidebarAppearance, "workspace-description-color", String(localized: "settings.app.workspaceDescriptionColor", defaultValue: "Workspace Description Text Color"), "sidebar.workspaceDescriptionColor workspace description notes text color notification distinguish"),
