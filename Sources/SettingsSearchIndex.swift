...
enum SettingsSearchIndex {
    ...
    private static let settingEntries: [SettingsSearchEntry] = [
        ...
        setting(.sidebarAppearance, "show-cloud-button", String(localized: "settings.app.showCloudButton", defaultValue: "Show Cloud Button in Sidebar"), "sidebar.showCloudButton cloud button footer machines"),
    ...
    private static let settingsPathAnchorIDs: [String: String] = [
        ...
        "sidebar.showCloudButton": settingID(for: .sidebarAppearance, idSuffix: "show-cloud-button"),
