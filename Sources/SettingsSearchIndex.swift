...
enum SettingsSearchIndex {
    ...
    private static let settingEntries: [SettingsSearchEntry] = [
        ...
        setting(.browser, "terminal-link-placement", String(localized: "settings.browser.terminalLinkPlacement", defaultValue: "Terminal Link Placement"), String(localized: "settings.browser.terminalLinkPlacement.search", defaultValue: "terminal link browser placement same pane tab split open URL")),
