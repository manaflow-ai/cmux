...
enum SettingsSearchIndex {
    ...
    private static let settingEntries: [SettingsSearchEntry] = [
        ...
        setting(.app, "workspace-title-bar", String(localized: "settings.app.showWorkspaceTitleBar", defaultValue: "Show Workspace Title Bar"), ""),
    ...
    private static let settingsPathAnchorIDs: [String: String] = [
        ...
        "app.showWorkspaceTitleBar": settingID(for: .app, idSuffix: "workspace-title-bar"),
