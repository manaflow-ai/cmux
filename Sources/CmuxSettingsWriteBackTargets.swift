extension CmuxSettingsFileStore {
    static let userDefaultWriteBackTargets: [String: ManagedSettingsWriteBackTarget] = [
        ...
        CmdClickSupportedFileRouteSettings.key: .bool("app.openSupportedFilesInCmux"),
        ...
        CloseTabWarningSettings.warnBeforeClosingTabKey: .bool("app.warnBeforeClosingTab"),
        ...
        SidebarWorkspaceDetailSettings.showWorkspaceDescriptionKey: .bool("sidebar.showWorkspaceDescription"),
