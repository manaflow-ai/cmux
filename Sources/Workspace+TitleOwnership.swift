...
extension Workspace {
    ...
    func updatePanelTitle(panelId: UUID, title: String, stableTitle: String? = nil) -> Bool {
        ...
        // The tab label already took the animating frame through
        // `refreshTabLabel` above; the model keeps the stable title so an
        // advancing spinner never re-renders the sidebar.
