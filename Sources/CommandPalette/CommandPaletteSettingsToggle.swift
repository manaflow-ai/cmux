...
enum CommandPaletteSettingsToggleCommands {
    ...
    static let descriptors: [CommandPaletteSettingToggleDescriptor] = {
        ...
        return [
            ...
            CommandPaletteSettingToggleDescriptor(
                commandId: commandIdPrefix + "extensions",
                settingsKey: "betaFeatures.extensions",
                title: {
                    String(localized: "settings.betaFeatures.extensions", defaultValue: "Extensions")
                },
                sectionTitle: beta,
                keywords: ["betaFeatures.extensions", "sidebar", "extension", "extensions", "beta", "provider", "custom"],
                defaultValue: ExtensionsBetaFeatureSettings.defaultEnabled,
                defaultsKey: ExtensionsBetaFeatureSettings.enabledKey
            ),
            CommandPaletteSettingToggleDescriptor(
