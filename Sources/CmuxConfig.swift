...
final class CmuxConfigStore {
    ...
    private(set) var newWorkspaceContextMenuIsConfigured = false
    private(set) var newWorkspaceMenuSectionOrder: CmuxNewWorkspaceMenuSectionOrder = .default
    private(set) var agentChat: CmuxAgentChatConfiguration = .default
    ...
    @ObservationIgnored private(set) var commandSourcePaths: [String: String] = [:]
    @ObservationIgnored private(set) var actionLookup: [String: CmuxResolvedConfigAction] = [:]
    @ObservationIgnored private(set) var surfaceTabBarButtonSourcePath: String?
    @ObservationIgnored private(set) var surfaceTabBarCommandSourcePaths: [String: String] = [:]
    @ObservationIgnored private(set) var newWorkspaceActionSourcePath: String?

    @ObservationIgnored private(set) var localConfigPath: String?
    @ObservationIgnored private weak var tabManager: TabManager?
    @ObservationIgnored let globalConfigPath: String
    @ObservationIgnored private let fileWatchingEnabled: Bool
