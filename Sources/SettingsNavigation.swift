...
enum SettingsSearchIndex {
    ...
    private static let settingEntries: [SettingsSearchEntry] = [
        ...
        setting(.terminal, "video-background", String(localized: "settings.terminal.videoBackground", defaultValue: "Video Background"), "terminal.videoBackground dynamic video background youtube playlist queue quality resolution volume muted audio sound unmute wallpaper animated dim opacity mp4 loop Ghostty background-opacity"),
    ...
    private static let settingsPathAnchorIDs: [String: String] = [
        ...
        "terminal.videoBackground.enabled": settingID(for: .terminal, idSuffix: "video-background"),
        "terminal.videoBackground.source": settingID(for: .terminal, idSuffix: "video-background"),
        "terminal.videoBackground.queue": settingID(for: .terminal, idSuffix: "video-background"),
        "terminal.videoBackground.quality": settingID(for: .terminal, idSuffix: "video-background"),
        "terminal.videoBackground.muted": settingID(for: .terminal, idSuffix: "video-background"),
        "terminal.videoBackground.volume": settingID(for: .terminal, idSuffix: "video-background"),
        "terminal.videoBackground.dimOpacity": settingID(for: .terminal, idSuffix: "video-background"),
