...
enum SettingsSearchIndex {
    ...
    private static let settingEntries: [SettingsSearchEntry] = [
        ...
        setting(.terminal, "agent-context-management", String(localized: "settings.terminal.agentContextManagement", defaultValue: "Manage Agent Context Pressure"), ""),
        setting(.terminal, "agent-context-management-action", String(localized: "settings.terminal.agentContextManagement.action", defaultValue: "Recovery Command"), ""),
        setting(.terminal, "agent-context-management-preserve-state", String(localized: "settings.terminal.agentContextManagement.preserveState", defaultValue: "Preserve State Before Fresh Context"), ""),
