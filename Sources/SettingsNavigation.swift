...
enum SettingsSearchIndex {
    ...
    private static let settingEntries: [SettingsSearchEntry] = [
        ...
        setting(.workspaceColors, "state-colors-enabled", String(localized: "settings.workspaceColors.stateColorsEnabled", defaultValue: "Agent State Colors"), "agent state running waiting idle needs input tint workspace tabs"),
        setting(.workspaceColors, "state-color-mode", String(localized: "settings.workspaceColors.stateColorMode", defaultValue: "State Color Behavior"), "replace blend manual workspace color agent state"),
        setting(.workspaceColors, "state-colors", String(localized: "settings.workspaceColors.stateColors", defaultValue: "State Colors"), "running waiting needs input idle unknown agent state hex colors"),
    ...
    private static let settingsPathAnchorIDs: [String: String] = [
        ...
        "workspaceColors.stateColorsEnabled": settingID(for: .workspaceColors, idSuffix: "state-colors-enabled"),
        "workspaceColors.stateColorMode": settingID(for: .workspaceColors, idSuffix: "state-color-mode"),
        "workspaceColors.stateColors": settingID(for: .workspaceColors, idSuffix: "state-colors"),
