...
enum SettingsSearchIndex {
    ...
    private static let settingEntries: [SettingsSearchEntry] = [
        ...
        setting(.terminal, "warm-pty-pool", String(localized: "settings.terminal.warmPtyPool", defaultValue: "Prewarm New Terminal Shell"), "terminal.warmPtyPool pty warm prewarm shell instant cmd t command t new tab split"),
    ...
    private static let settingsPathAnchorIDs: [String: String] = [
        ...
        "terminal.warmPtyPool": settingID(for: .terminal, idSuffix: "warm-pty-pool"),
