...
enum SettingsSearchIndex {
    ...
    private static let settingEntries: [SettingsSearchEntry] = [
        ...
        setting(.app, "markdown-viewer-font-size", String(localized: "settings.app.markdownViewerFontSize", defaultValue: "Markdown Viewer Font Size"), "app.markdownViewerFontSize md markdown viewer font size zoom scale text readme"),
    ...
    private static let settingsPathAnchorIDs: [String: String] = [
        ...
        "app.markdownViewerFontSize": settingID(for: .app, idSuffix: "markdown-viewer-font-size"),
