...
enum SettingsSearchIndex {
    ...
    private static let settingEntries: [SettingsSearchEntry] = [
        ...
        setting(.sidebarAppearance, "state-indicator-running-color", String(localized: "settings.sidebar.stateIndicatorColors.running", defaultValue: "Running Status Color"), "sidebar.stateIndicatorColors.running agent status pill running color state indicator lifecycle"),
        setting(.sidebarAppearance, "state-indicator-needs-input-color", String(localized: "settings.sidebar.stateIndicatorColors.needsInput", defaultValue: "Needs Input Status Color"), "sidebar.stateIndicatorColors.needsInput agent status pill needs input waiting blocked color state indicator lifecycle"),
        setting(.sidebarAppearance, "state-indicator-idle-color", String(localized: "settings.sidebar.stateIndicatorColors.idle", defaultValue: "Idle Status Color"), "sidebar.stateIndicatorColors.idle agent status pill idle finished done color state indicator lifecycle"),
    ...
    private static let settingsPathAnchorIDs: [String: String] = [
        ...
        "sidebar.stateIndicatorColors.running": settingID(for: .sidebarAppearance, idSuffix: "state-indicator-running-color"),
        "sidebar.stateIndicatorColors.needsInput": settingID(for: .sidebarAppearance, idSuffix: "state-indicator-needs-input-color"),
        "sidebar.stateIndicatorColors.idle": settingID(for: .sidebarAppearance, idSuffix: "state-indicator-idle-color"),
