...
enum SettingsSearchIndex {
    ...
    private static let settingEntries: [SettingsSearchEntry] = [
        ...
        setting(.sidebarAppearance, "sidebar-style", String(localized: "settings.app.sidebarStyle", defaultValue: "Sidebar Style"), "recents recent codex claude compact classic glyph status workspace"),
    ...
    private static let settingsPathAnchorIDs: [String: String] = [
        ...
        "sidebar.style": settingID(for: .sidebarAppearance, idSuffix: "sidebar-style"),
