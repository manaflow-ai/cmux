...
enum SettingsSearchIndex {
    ...
    private static let settingEntries: [SettingsSearchEntry] = [
        ...
        setting(.terminal, "quick-terminal-position", String(localized: "settings.quickTerminal.position", defaultValue: "Quick Terminal Position"), "terminal.quickTerminalPosition quick terminal dropdown quake position top bottom left right center"),
        setting(.terminal, "quick-terminal-primary-size", String(localized: "settings.quickTerminal.primarySize", defaultValue: "Quick Terminal Primary Size"), "terminal.quickTerminalPrimarySizeRatio quick terminal dropdown quake height width size"),
        setting(.terminal, "quick-terminal-secondary-size", String(localized: "settings.quickTerminal.secondarySize", defaultValue: "Quick Terminal Secondary Size"), "terminal.quickTerminalSecondarySizeRatio quick terminal dropdown quake height width size"),
        setting(.terminal, "quick-terminal-auto-hide", String(localized: "settings.quickTerminal.autoHide", defaultValue: "Quick Terminal Auto-Hide"), "terminal.quickTerminalAutoHide quick terminal dropdown quake hide focus blur"),
    ...
    private static let settingsPathAnchorIDs: [String: String] = [
        ...
        "terminal.quickTerminalPosition": settingID(for: .terminal, idSuffix: "quick-terminal-position"),
        "terminal.quickTerminalPrimarySizeRatio": settingID(for: .terminal, idSuffix: "quick-terminal-primary-size"),
        "terminal.quickTerminalSecondarySizeRatio": settingID(for: .terminal, idSuffix: "quick-terminal-secondary-size"),
        "terminal.quickTerminalAutoHide": settingID(for: .terminal, idSuffix: "quick-terminal-auto-hide"),
