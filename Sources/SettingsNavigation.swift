...
enum SettingsSearchIndex {
    ...
    private static let settingEntries: [SettingsSearchEntry] = [
        ...
        setting(.automation, "agent-hooks", String(localized: "settings.automation.agentHooks.title", defaultValue: "Agent hooks"), "codex opencode cursor gemini copilot codebuddy factory qoder notifications session restore"),
