...
enum SettingsSearchIndex {
    ...
    private static let settingEntries: [SettingsSearchEntry] = [
        ...
        setting(.app, "artifact-pane-orientation", String(localized: "settings.app.artifactPaneOrientation", defaultValue: "Artifact Pane Split"), "artifact pane markdown viewer split right down horizontal vertical orientation layout"),
    ...
    private static let settingsPathAnchorIDs: [String: String] = [
        ...
        "app.artifactPaneOrientation": settingID(for: .app, idSuffix: "artifact-pane-orientation"),
