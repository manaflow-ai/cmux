...
enum SettingsSearchIndex {
    ...
    private static let settingEntries: [SettingsSearchEntry] = [
        ...
        setting(.app, "single-window-mode", String(localized: "settings.app.singleWindowMode", defaultValue: "Single Window Mode"), "single window prevent automatic new windows workspaces"),
    ...
    private static let settingsPathAnchorIDs: [String: String] = [
        ...
        "app.singleWindowMode": settingID(for: .app, idSuffix: "single-window-mode"),
