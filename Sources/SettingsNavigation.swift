...
enum SettingsSearchIndex {
    ...
    private static let settingEntries: [SettingsSearchEntry] = [
        ...
        setting(.app, "markdown-font-size", String(localized: "settings.app.markdownViewerFontSize", defaultValue: "Markdown Viewer Font Size"), "markdown viewer font size text scale zoom points"),
    ...
    private static let settingsPathAnchorIDs: [String: String] = [
        ...
        "app.markdownViewerFontSize": settingID(for: .app, idSuffix: "markdown-font-size"),
