...
enum SettingsSearchIndex {
    ...
    private static let settingEntries: [SettingsSearchEntry] = [
        ...
        setting(.browser, "terminal-link-placement", String(localized: "settings.browser.terminalLinkPlacement", defaultValue: "Terminal Link Browser Placement"), "click links browser pane split same pane"),
    ...
    private static let settingsPathAnchorIDs: [String: String] = [
        ...
        "browser.terminalLinkBrowserPlacement": settingID(for: .browser, idSuffix: "terminal-link-placement"),
