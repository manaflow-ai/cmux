...
enum SettingsSearchIndex {
    ...
    private static let settingEntries: [SettingsSearchEntry] = [
        ...
        setting(.app, "reorder-pinned-notification", String(localized: "settings.app.reorderPinnedOnNotification", defaultValue: "Reorder Pinned on Notification"), "workspace notification order pinned"),
    ...
    private static let settingsPathAnchorIDs: [String: String] = [
        ...
        "app.reorderPinnedOnNotification": settingID(for: .app, idSuffix: "reorder-pinned-notification"),
