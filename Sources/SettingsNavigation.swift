...
enum SettingsSearchIndex {
    ...
    private static let settingEntries: [SettingsSearchEntry] = [
        ...
        setting(.sidebarAppearance, "workspace-status-style", String(localized: "settings.sidebar.workspaceStatusStyle", defaultValue: "Compact Agent Status Dots"), "sidebar.workspaceStatusStyle agent status dots compact subtitle sentence one line tab row"),
        setting(.sidebarAppearance, "scroll-edge-fade", String(localized: "settings.sidebar.scrollEdgeFade", defaultValue: "Tab List Edge Fade"), "sidebar.scrollEdgeFade sidebar tab list fade shadow scrim edge top bottom off subtle"),
    ...
    private static let settingsPathAnchorIDs: [String: String] = [
        ...
        "sidebar.workspaceStatusStyle": settingID(for: .sidebarAppearance, idSuffix: "workspace-status-style"),
        "sidebar.scrollEdgeFade": settingID(for: .sidebarAppearance, idSuffix: "scroll-edge-fade"),
