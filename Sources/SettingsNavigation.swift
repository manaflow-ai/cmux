...
enum SettingsSearchIndex {
    ...
    private static let settingEntries: [SettingsSearchEntry] = [
        ...
        setting(.markdown, "markdown-wiki-links", String(localized: "settings.app.markdownWikiLinks", defaultValue: "Wiki Links"), "markdown.wikiLinks md markdown viewer wiki wikilink double bracket obsidian vault note backlink"),
        setting(.markdown, "markdown-wiki-anchor", String(localized: "settings.app.markdownWikiLinkAnchor", defaultValue: "Wiki Link Anchor Folder"), "markdown.wikiLinkAnchor wiki link anchor root top level folder obsidian vault git repository marker"),
    ...
    private static let settingsPathAnchorIDs: [String: String] = [
        ...
        "markdown.wikiLinkAnchor": settingID(for: .markdown, idSuffix: "markdown-wiki-anchor"),
