...
enum SettingsSearchIndex {
    ...
    private static let settingEntries: [SettingsSearchEntry] = [
        ...
        setting(.sidebarAppearance, "workspace-todos", String(localized: "settings.sidebar.workspaceTodos", defaultValue: "Workspace Todo Status"), "workspace todo task status checklist glyph done review working"),
    ...
    private static let settingsPathAnchorIDs: [String: String] = [
        ...
        "sidebar.workspaceTodos": settingID(for: .sidebarAppearance, idSuffix: "workspace-todos"),
