...
enum SettingsSearchIndex {
    ...
    private static let settingEntries: [SettingsSearchEntry] = [
        ...
        setting(.betaFeatures, "extensions", String(localized: "settings.betaFeatures.extensions", defaultValue: "Extensions"), "sidebar extension extensions provider custom left workspace list"),
    ...
    private static let settingsPathAnchorIDs: [String: String] = [
        ...
        "extensions.beta.enabled": settingID(for: .betaFeatures, idSuffix: "extensions"),
