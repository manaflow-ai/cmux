...
enum SettingsSearchIndex {
    ...
    private static let settingEntries: [SettingsSearchEntry] = [
        ...
        setting(.sidebarAppearance, "show-last-interaction", String(localized: "settings.app.showLastInteractionInsteadOfPath", defaultValue: "Show Last Interaction Instead of Path"), "last interaction relative time ago prompt submitted timestamp"),
        ...
        setting(.sidebarAppearance, "last-interaction-timestamp-style", String(localized: "settings.app.lastInteractionTimestampStyle", defaultValue: "Last Interaction Timestamp Style"), "sidebar.lastInteractionTimestampStyle relative absolute timestamp seconds ordering"),
    ...
    private static let settingsPathAnchorIDs: [String: String] = [
        ...
        "sidebar.showLastInteractionInsteadOfPath": settingID(for: .sidebarAppearance, idSuffix: "show-last-interaction"),
        ...
        "sidebar.lastInteractionTimestampStyle": settingID(for: .sidebarAppearance, idSuffix: "last-interaction-timestamp-style"),
