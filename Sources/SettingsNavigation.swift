...
enum SettingsSearchIndex {
    ...
    private static let settingEntries: [SettingsSearchEntry] = [
        ...
        setting(.sidebarAppearance, "sidebar-position", String(localized: "settings.app.sidebarPosition", defaultValue: "Sidebar Position"), "workspace tabs left right side edge"),
    ...
    private static let settingsPathAnchorIDs: [String: String] = [
        ...
        "sidebar.position": settingID(for: .sidebarAppearance, idSuffix: "sidebar-position"),
