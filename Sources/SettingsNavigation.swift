...
enum SettingsSearchIndex {
    ...
    private static let settingEntries: [SettingsSearchEntry] = [
        ...
        setting(.terminal, "claude-resume-mode", String(localized: "settings.terminal.claudeResumeMode", defaultValue: "Claude Resume Prompt"), "terminal.claudeResumeMode claude code resume full session summary compacted prompt auto answer skip menu usage limits"),
    ...
    private static let settingsPathAnchorIDs: [String: String] = [
        ...
        "terminal.claudeResumeMode": settingID(for: .terminal, idSuffix: "claude-resume-mode"),
