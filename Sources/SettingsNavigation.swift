...
enum SettingsSearchIndex {
    ...
    private static let settingEntries: [SettingsSearchEntry] = [
        ...
        setting(.app, "open-new-window-on-cursor-screen", String(localized: "settings.app.openNewWindowOnCursorScreen", defaultValue: "Open New Window on Cursor's Display"), "new window multiple displays monitor screen mouse cursor cascade iterm active"),
    ...
    private static let settingsPathAnchorIDs: [String: String] = [
        ...
        "app.openNewWindowOnCursorScreen": settingID(for: .app, idSuffix: "open-new-window-on-cursor-screen"),
