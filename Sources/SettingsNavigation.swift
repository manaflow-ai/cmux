...
enum SettingsSearchIndex {
    ...
    private static let settingEntries: [SettingsSearchEntry] = [
        ...
        setting(.app, "surface-tab-active-background", String(localized: "settings.surfaceTabBar.activeBackground", defaultValue: "Active Tab Background"), "ui.surfaceTabBar.activeTabBackground surface pane tab bar selected active background color theme flat"),
        setting(.app, "surface-tab-active-foreground", String(localized: "settings.surfaceTabBar.activeForeground", defaultValue: "Active Tab Text"), "ui.surfaceTabBar.activeTabForeground surface pane tab bar selected active foreground label text color"),
        setting(.app, "surface-tab-inactive-background", String(localized: "settings.surfaceTabBar.inactiveBackground", defaultValue: "Inactive Tab Background"), "ui.surfaceTabBar.inactiveTabBackground surface pane tab bar unselected inactive background color theme flat"),
        setting(.app, "surface-tab-inactive-foreground", String(localized: "settings.surfaceTabBar.inactiveForeground", defaultValue: "Inactive Tab Text"), "ui.surfaceTabBar.inactiveTabForeground surface pane tab bar unselected inactive foreground label text color"),
        setting(.app, "surface-tab-divider", String(localized: "settings.surfaceTabBar.divider", defaultValue: "Tab Divider"), "ui.surfaceTabBar.tabDividerColor surface pane tab bar divider separator border color none quiet"),
        setting(.app, "surface-tab-indicator", String(localized: "settings.surfaceTabBar.indicator", defaultValue: "Active Tab Indicator"), "ui.surfaceTabBar.activeTabIndicatorColor surface pane tab bar active indicator accent line color"),
        setting(.app, "surface-tab-indicator-edge", String(localized: "settings.surfaceTabBar.indicatorEdge", defaultValue: "Indicator Edge"), "ui.surfaceTabBar.activeTabIndicatorEdge surface pane tab bar active indicator accent line edge top bottom"),
    ...
    private static let settingsPathAnchorIDs: [String: String] = [
        ...
        "ui.surfaceTabBar.activeTabBackground": settingID(for: .app, idSuffix: "surface-tab-active-background"),
        "ui.surfaceTabBar.activeTabForeground": settingID(for: .app, idSuffix: "surface-tab-active-foreground"),
        "ui.surfaceTabBar.inactiveTabBackground": settingID(for: .app, idSuffix: "surface-tab-inactive-background"),
        "ui.surfaceTabBar.inactiveTabForeground": settingID(for: .app, idSuffix: "surface-tab-inactive-foreground"),
        "ui.surfaceTabBar.tabDividerColor": settingID(for: .app, idSuffix: "surface-tab-divider"),
        "ui.surfaceTabBar.activeTabIndicatorColor": settingID(for: .app, idSuffix: "surface-tab-indicator"),
        "ui.surfaceTabBar.activeTabIndicatorEdge": settingID(for: .app, idSuffix: "surface-tab-indicator-edge"),
