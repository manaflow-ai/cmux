...
enum SettingsSearchIndex {
    ...
    private static let settingEntries: [SettingsSearchEntry] = [
        ...
        setting(.app, "workspace-inherit-cwd", String(localized: "settings.app.workspaceInheritWorkingDirectory", defaultValue: "Inherit Working Directory in New Workspaces"), "workspace inherit working directory cwd ghostty"),
    ...
    private static let settingsPathAnchorIDs: [String: String] = [
        ...
        "app.workspaceInheritWorkingDirectory": settingID(for: .app, idSuffix: "workspace-inherit-cwd"),
