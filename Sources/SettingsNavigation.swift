...
enum SettingsSearchIndex {
    ...
    private static let settingEntries: [SettingsSearchEntry] = [
        ...
        setting(.terminal, "status-bar", String(localized: "settings.terminal.statusBar", defaultValue: "Terminal Status Bar"), "terminal.statusBar persistent pinned bottom status command refresh rows surface pane claude codex tokens cost branch"),
    ...
    private static let settingsPathAnchorIDs: [String: String] = [
        ...
        "terminal.statusBar.enabled": settingID(for: .terminal, idSuffix: "status-bar"),
        "terminal.statusBar.height": settingID(for: .terminal, idSuffix: "status-bar"),
        "terminal.statusBar.command": settingID(for: .terminal, idSuffix: "status-bar"),
        "terminal.statusBar.refreshInterval": settingID(for: .terminal, idSuffix: "status-bar"),
