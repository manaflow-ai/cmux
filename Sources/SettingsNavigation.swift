...
enum SettingsSearchIndex {
    ...
    private static let settingEntries: [SettingsSearchEntry] = [
        ...
        setting(.workspaceColors, "random-panel-backgrounds", String(localized: "settings.workspaceColors.randomizeTerminalPanelBackgrounds", defaultValue: "Randomize Terminal Panel Backgrounds"), "terminal panel background random split pane host layer palette"),
    ...
    private static let settingsPathAnchorIDs: [String: String] = [
        ...
        "workspaceColors.randomizeTerminalPanelBackgrounds": settingID(for: .workspaceColors, idSuffix: "random-panel-backgrounds"),
