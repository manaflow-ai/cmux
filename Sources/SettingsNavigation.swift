...
enum SettingsSearchIndex {
    ...
    private static let settingEntries: [SettingsSearchEntry] = [
        ...
        setting(.app, "new-surface-placement", String(localized: "settings.app.newSurfacePlacement", defaultValue: "New Surface Placement"), "surface tab order position pane"),
    ...
    private static let settingsPathAnchorIDs: [String: String] = [
        ...
        "app.newSurfacePlacement": settingID(for: .app, idSuffix: "new-surface-placement"),
