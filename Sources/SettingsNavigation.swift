...
enum SettingsSearchIndex {
    ...
    private static let settingEntries: [SettingsSearchEntry] = [
        ...
        setting(.sidebarAppearance, "auto-detect-workspace-icon", String(localized: "settings.app.autoDetectWorkspaceIcon", defaultValue: "Auto-Detect Workspace Icons"), "favicon icon logo app icon workspace avatar"),
    ...
    private static let settingsPathAnchorIDs: [String: String] = [
        ...
        "sidebar.autoDetectWorkspaceIcon": settingID(for: .sidebarAppearance, idSuffix: "auto-detect-workspace-icon"),
