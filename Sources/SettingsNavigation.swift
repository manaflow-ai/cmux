...
enum SettingsSearchIndex {
    ...
    private static let settingEntries: [SettingsSearchEntry] = [
        ...
        setting(.app, "markdown-cmd-click-links", String(localized: "settings.app.markdownCmdClickOpenTarget", defaultValue: "Markdown Viewer Cmd-Click Links"), "markdown.cmdClickOpenTarget md markdown viewer cmd command click link path file open new tab split right pane"),
    ...
    private static let settingsPathAnchorIDs: [String: String] = [
        ...
        "markdown.cmdClickOpenTarget": settingID(for: .app, idSuffix: "markdown-cmd-click-links"),
