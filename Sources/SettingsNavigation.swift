...
enum SettingsSearchIndex {
    ...
    private static let settingEntries: [SettingsSearchEntry] = [
        ...
        setting(.sidebarAppearance, "show-running-agents", String(localized: "settings.app.showRunningAgentsPanel", defaultValue: "Show Running Agents Panel"), "agents running status workspace pane"),
    ...
    private static let settingsPathAnchorIDs: [String: String] = [
        ...
        "sidebar.showRunningAgentsPanel": settingID(for: .sidebarAppearance, idSuffix: "show-running-agents"),
