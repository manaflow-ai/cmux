...
enum SettingsSearchIndex {
    ...
    private static let settingEntries: [SettingsSearchEntry] = [
        ...
        setting(.browser, "engine", String(localized: "settings.browser.engine", defaultValue: "Browser Engine (Experimental)"), "webkit chromium engine experimental owl runtime browser surfaces"),
    ...
    private static let settingsPathAnchorIDs: [String: String] = [
        ...
        "browser.engine": settingID(for: .browser, idSuffix: "engine"),
