...
enum SettingsSearchIndex {
    ...
    private static let settingEntries: [SettingsSearchEntry] = [
        ...
        setting(.terminal, "agent-context-management", String(localized: "settings.terminal.agentContextManagement", defaultValue: "Manage Agent Context Pressure"), "context pressure context window claude codex long thread compaction recovery"),
        setting(.terminal, "agent-context-management-action", String(localized: "settings.terminal.agentContextManagement.action", defaultValue: "Recovery Command"), "recovery command compact clear fresh context claude codex"),
        setting(.terminal, "agent-context-management-preserve-state", String(localized: "settings.terminal.agentContextManagement.preserveState", defaultValue: "Preserve State Before Fresh Context"), "preserve state handoff note file clear fresh context"),
    ...
    private static let settingsPathAnchorIDs: [String: String] = [
        ...
        "terminal.agentContextManagement.enabled": settingID(for: .terminal, idSuffix: "agent-context-management"),
        "terminal.agentContextManagement.action": settingID(for: .terminal, idSuffix: "agent-context-management-action"),
        "terminal.agentContextManagement.preserveState": settingID(for: .terminal, idSuffix: "agent-context-management-preserve-state"),
