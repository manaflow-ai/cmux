...
enum SettingsSearchIndex {
    ...
    private static let settingEntries: [SettingsSearchEntry] = [
        ...
        setting(.browser, "omnibar-font-size", String(localized: "settings.browser.omnibarFontSize", defaultValue: "Omnibar Font Size"), "omnibar address bar url field font size points text bigger smaller larger navigation buttons toolbar"),
    ...
    private static let settingsPathAnchorIDs: [String: String] = [
        ...
        "browser.omnibarFontSize": settingID(for: .browser, idSuffix: "omnibar-font-size"),
