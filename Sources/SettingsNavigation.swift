...
enum SettingsNavigationTarget: String, CaseIterable, Identifiable {
    ...
    var searchText: String {
        ...
        case .terminal:
            return "\(title) scrollbar file drops drag drop shift preview image path auto resume restore reopen relaunch quit sessions agents claude codex opencode rovodev toggle"
        case .workspaceColors:
...
enum SettingsSearchIndex {
    ...
    private static let settingEntries: [SettingsSearchEntry] = [
        ...
        setting(.terminal, "file-drops", String(localized: "settings.terminal.fileDropDefaultAction", defaultValue: "Terminal File Drops"), "drag drop finder image file path preview shift relative terminal shell"),
    ...
    private static let settingsPathAnchorIDs: [String: String] = [
        ...
        "terminal.fileDropDefaultAction": settingID(for: .terminal, idSuffix: "file-drops"),
