...
enum SettingsSearchIndex {
    ...
    private static let settingEntries: [SettingsSearchEntry] = [
        ...
        setting(.sidebarAppearance, "show-cloud-button", String(localized: "settings.app.showCloudButton", defaultValue: "Show Cloud Button in Sidebar"), "sidebar.showCloudButton cloud button footer machines"), setting(.sidebarAppearance, "wrap-workspace-titles", String(localized: "settings.app.wrapWorkspaceTitles", defaultValue: "Wrap Workspace Titles in Sidebar"), "workspace title wrap multiline pr pull request"),
    ...
    private static let settingsPathAnchorIDs: [String: String] = [
        ...
        "sidebar.showCloudButton": settingID(for: .sidebarAppearance, idSuffix: "show-cloud-button"), "sidebar.wrapWorkspaceTitles": settingID(for: .sidebarAppearance, idSuffix: "wrap-workspace-titles"),
