...
enum SettingsSearchIndex {
    ...
    private static let settingEntries: [SettingsSearchEntry] = [
        ...
        setting(.sidebarAppearance, "workspace-spacing", String(localized: "settings.sidebarAppearance.workspaceSpacing", defaultValue: "Workspace Spacing"), "sidebar.workspaceSpacing workspace row group gap density compact points"),
    ...
    private static let settingsPathAnchorIDs: [String: String] = [
        ...
        "sidebar.workspaceSpacing": settingID(for: .sidebarAppearance, idSuffix: "workspace-spacing"),
