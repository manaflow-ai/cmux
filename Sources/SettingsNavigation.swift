...
enum SettingsSearchIndex {
    ...
    private static let settingEntries: [SettingsSearchEntry] = [
        ...
        setting(.terminal, "surface-hibernation", String(localized: "settings.terminal.surfaceHibernation", defaultValue: "Surface Hibernation"), "terminal.surfaceHibernation idle hibernate suspend background shell surfaces memory unmounted workspaces live cap"),
    ...
    private static let settingsPathAnchorIDs: [String: String] = [
        ...
        "terminal.surfaceHibernation.enabled": settingID(for: .terminal, idSuffix: "surface-hibernation"),
        "terminal.surfaceHibernation.idleSeconds": settingID(for: .terminal, idSuffix: "surface-hibernation"),
        "terminal.surfaceHibernation.unmountedIdleSeconds": settingID(for: .terminal, idSuffix: "surface-hibernation"),
        "terminal.surfaceHibernation.maxLiveSurfaces": settingID(for: .terminal, idSuffix: "surface-hibernation"),
