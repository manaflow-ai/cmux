...
enum SettingsSearchIndex {
    ...
    private static let settingEntries: [SettingsSearchEntry] = [
        ...
        setting(.app, "file-editor-font-size", String(localized: "settings.app.fileEditorFontSize", defaultValue: "File Editor Font Size"), "fileEditor.fontSize file editor font size points zoom scale text bigger smaller larger default"),
        setting(.app, "file-editor-font-family", String(localized: "settings.app.fileEditorFontFamily", defaultValue: "File Editor Font"), "fileEditor.fontFamily file editor font family typeface system mono custom"),
        setting(.app, "file-editor-line-height", String(localized: "settings.app.fileEditorLineHeight", defaultValue: "File Editor Line Height"), "fileEditor.lineHeight file editor line height leading spacing paragraph line multiplier"),
    ...
    private static let settingsPathAnchorIDs: [String: String] = [
        ...
        "fileEditor.fontSize": settingID(for: .app, idSuffix: "file-editor-font-size"),
        "fileEditor.fontFamily": settingID(for: .app, idSuffix: "file-editor-font-family"),
        "fileEditor.lineHeight": settingID(for: .app, idSuffix: "file-editor-line-height"),
