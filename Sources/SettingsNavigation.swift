...
enum SettingsSearchIndex {
    ...
    private static let settingEntries: [SettingsSearchEntry] = [
        ...
        setting(.app, "teams-spawn-placement", String(localized: "settings.app.teamsSpawnPlacement", defaultValue: "Claude Teams Spawn Placement"), "claude teams teammates tmux new-window workspace surface tab pane"),
    ...
    private static let settingsPathAnchorIDs: [String: String] = [
        ...
        "app.teamsSpawnPlacement": settingID(for: .app, idSuffix: "teams-spawn-placement"),
