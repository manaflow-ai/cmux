...
enum SettingsSearchIndex {
    ...
    private static let settingEntries: [SettingsSearchEntry] = [
        ...
        setting(.app, "app-icon", String(localized: "settings.app.appIcon", defaultValue: "App Icon"), "dock icon alternate custom image file path"),
    ...
    private static let settingsPathAnchorIDs: [String: String] = [
        ...
        "app.appIconImagePath": settingID(for: .app, idSuffix: "app-icon"),
