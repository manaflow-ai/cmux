...
enum SettingsSearchIndex {
    ...
    private static let settingEntries: [SettingsSearchEntry] = [
        ...
        setting(.sidebarAppearance, "always-show-workspace-numbers", String(localized: "settings.app.alwaysShowWorkspaceNumbers", defaultValue: "Always Show Workspace Numbers"), "workspace number command digit shortcut hint always visible cmd"),
    ...
    private static let settingsPathAnchorIDs: [String: String] = [
        ...
        "sidebar.alwaysShowWorkspaceNumbers": settingID(for: .sidebarAppearance, idSuffix: "always-show-workspace-numbers"),
