...
enum SettingsSearchIndex {
    ...
    private static let settingEntries: [SettingsSearchEntry] = [
        ...
        setting(.sidebarAppearance, "show-ssh-hosts", String(localized: "settings.app.showSSHHosts", defaultValue: "Show SSH Hosts in Sidebar"), "ssh config hosts connect"),
    ...
    private static let settingsPathAnchorIDs: [String: String] = [
        ...
        "sidebar.showSSHHosts": settingID(for: .sidebarAppearance, idSuffix: "show-ssh-hosts"),
