...
enum SettingsSearchIndex {
    ...
    private static let settingEntries: [SettingsSearchEntry] = [
        ...
        setting(.browser, "terminal-hyperlink-activation", String(localized: "settings.browser.terminalHyperlinkActivation", defaultValue: "Enable Terminal Hyperlink Activation"), "terminal hyperlink OSC 8 detected links disable click URL"),
    ...
    private static let settingsPathAnchorIDs: [String: String] = [
        ...
        "browser.terminalHyperlinkActivationEnabled": settingID(for: .browser, idSuffix: "terminal-hyperlink-activation"),
