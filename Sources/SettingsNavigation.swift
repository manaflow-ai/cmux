...
enum SettingsSearchIndex {
    ...
    private static let settingEntries: [SettingsSearchEntry] = [
        ...
        setting(.sidebarAppearance, "metadata-collapse-limit", String(localized: "settings.app.metadataCollapseLimit", defaultValue: "Metadata Collapse Limit"), "metadata collapse limit show more unlimited all statuses entries"),
    ...
    private static let settingsPathAnchorIDs: [String: String] = [
        ...
        "sidebarAppearance.metadataCollapseLimit": settingID(for: .sidebarAppearance, idSuffix: "metadata-collapse-limit"),
