...
enum SettingsSearchIndex {
    ...
    private static let settingEntries: [SettingsSearchEntry] = [
        ...
        setting(.app, "file-editor-syntax-highlighting", String(localized: "settings.app.fileEditorSyntaxHighlighting", defaultValue: "File Editor Syntax Highlighting"), "fileEditor.syntaxHighlighting syntax highlight colors tokens code"),
        setting(.app, "file-editor-line-numbers", String(localized: "settings.app.fileEditorLineNumbers", defaultValue: "File Editor Line Numbers"), "fileEditor.lineNumbers gutter line numbers"),
        setting(.app, "file-editor-indent-guides", String(localized: "settings.app.fileEditorIndentGuides", defaultValue: "File Editor Indent Guides"), "fileEditor.indentGuides indent guides columns"),
        setting(.app, "file-editor-current-line-highlight", String(localized: "settings.app.fileEditorCurrentLineHighlight", defaultValue: "File Editor Current Line"), "fileEditor.currentLineHighlight current line caret"),
        setting(.app, "file-editor-tab-width", String(localized: "settings.app.fileEditorTabWidth", defaultValue: "File Editor Tab Width"), "fileEditor.tabWidth tab width indent columns"),
