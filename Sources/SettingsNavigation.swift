...
enum SettingsSearchIndex {
    ...
    private static let settingEntries: [SettingsSearchEntry] = [
        ...
        setting(
            ...
            String(localized: "settings.terminal.restoreTerminalSessions", defaultValue: "Restore Terminal Sessions on Reopen"),
            String(
                localized: "settings.search.alias.setting.terminal.restore-terminal-sessions",
                defaultValue: "terminal.restoreTerminalSessions restore terminal sessions workspaces tabs reopen relaunch fresh state browser-only"
            )
        ),
    ...
    private static let settingsPathAnchorIDs: [String: String] = [
        ...
        "terminal.restoreTerminalSessions": settingID(for: .terminal, idSuffix: "restore-terminal-sessions"),
