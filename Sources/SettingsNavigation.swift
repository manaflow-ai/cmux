...
enum SettingsSearchIndex {
    ...
    private static let settingEntries: [SettingsSearchEntry] = [
        ...
        setting(.app, "notification-delivery", String(localized: "settings.notifications.delivery.title", defaultValue: "Notification Delivery"), "notifications delivery dynamic notch focus do not disturb system"),
        ...
        setting(
            .terminal,
            "agent-auto-retry",
            String(localized: "settings.terminal.agentAutoRetry", defaultValue: "Retry Failed Agent Sessions"),
            String(
    ...
    private static let settingsPathAnchorIDs: [String: String] = [
        ...
        "notifications.delivery": settingID(for: .app, idSuffix: "notification-delivery"),
