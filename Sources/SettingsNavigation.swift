...
enum SettingsSearchIndex {
    ...
    private static let settingEntries: [SettingsSearchEntry] = [
        ...
        setting(.sidebarAppearance, "workspace-status-style", String(localized: "settings.sidebar.workspaceStatusStyle", defaultValue: "Workspace Status Style"), "sidebar.workspaceStatusStyle agent status subtitle sentence dot compact one line tab row"),
