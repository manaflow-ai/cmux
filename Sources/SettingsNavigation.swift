...
enum SettingsSearchIndex {
    ...
    private static let settingEntries: [SettingsSearchEntry] = [
        ...
        setting(.sidebarAppearance, "show-agent-activity", String(localized: "settings.app.showAgentActivity", defaultValue: "Show Active Agents in Sidebar"), "sidebar.showAgentActivity active coding agent agents spinner running count activity"),
