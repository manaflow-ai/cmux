...
enum SettingsSearchIndex {
    ...
    private static let settingEntries: [SettingsSearchEntry] = [
        ...
        setting(.browser, "capture-keyboard-shortcuts", String(localized: "settings.browser.captureKeyboardShortcuts", defaultValue: "Allow Browser to Capture Keyboard Shortcuts"), "browser web page keyboard shortcuts capture cmux vscode command p focus"),
    ...
    private static let settingsPathAnchorIDs: [String: String] = [
        ...
        "browser.captureKeyboardShortcuts": settingID(for: .browser, idSuffix: "capture-keyboard-shortcuts"),
