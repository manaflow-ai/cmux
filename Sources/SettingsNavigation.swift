...
enum SettingsSearchIndex {
    ...
    private static let settingEntries: [SettingsSearchEntry] = [
        ...
        setting(.browser, "terminal-link-preview-delay", String(localized: "settings.browser.terminalLinkPreviewDelay", defaultValue: "Terminal Link Preview Delay"), "url hover preview dwell delay milliseconds thumbnail web page"),
    ...
    private static let settingsPathAnchorIDs: [String: String] = [
        ...
        "browser.terminalLinkPreviewHoverDelayMilliseconds": settingID(for: .browser, idSuffix: "terminal-link-preview-delay"),
