...
enum SettingsSearchIndex {
    ...
    private static let settingEntries: [SettingsSearchEntry] = [
        ...
        setting(.app, "warn-before-closing-tab-x-button", String(localized: "settings.app.warnBeforeClosingTabXButton", defaultValue: "Warn Before X-Button Tab Close"), "mouse x button tab close confirmation"),
