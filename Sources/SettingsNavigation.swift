...
enum SettingsSearchIndex {
    ...
    private static let settingEntries: [SettingsSearchEntry] = [
        ...
        setting(.sidebarAppearance, "notification-scheduler", String(localized: "settings.sidebar.notificationSchedulerMode", defaultValue: "Notification Scheduler"), "scheduler priority urgency blocked first small wins aging round robin arrival fifo"),
    ...
    private static let settingsPathAnchorIDs: [String: String] = [
        ...
        "sidebar.notificationSchedulerMode": settingID(for: .sidebarAppearance, idSuffix: "notification-scheduler"),
