...
enum SettingsSearchIndex {
    ...
    private static let settingEntries: [SettingsSearchEntry] = [
        ...
        setting(.browser, "terminal-link-default-browser-modifier", String(localized: "settings.browser.terminalLinkDefaultBrowserModifier", defaultValue: "Default Browser Link Click Modifier"), "link.click.defaultBrowser command option shift control click link system browser external"),
        setting(.browser, "terminal-link-cmux-browser-modifier", String(localized: "settings.browser.terminalLinkCmuxBrowserModifier", defaultValue: "cmux Browser Link Click Modifier"), "link.click.builtInBrowser command option shift control click link embedded built in browser pane"),
    ...
    private static let settingsPathAnchorIDs: [String: String] = [
        ...
        "browser.terminalLinkDefaultBrowserModifier": settingID(for: .browser, idSuffix: "terminal-link-default-browser-modifier"),
        "browser.terminalLinkCmuxBrowserModifier": settingID(for: .browser, idSuffix: "terminal-link-cmux-browser-modifier"),
        "link.click.defaultBrowser": settingID(for: .browser, idSuffix: "terminal-link-default-browser-modifier"),
        "link.click.builtInBrowser": settingID(for: .browser, idSuffix: "terminal-link-cmux-browser-modifier"),
