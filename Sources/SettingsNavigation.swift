...
enum SettingsSearchIndex {
    ...
    private static let settingEntries: [SettingsSearchEntry] = [
        ...
        setting(.terminal, "video-background", String(localized: "settings.terminal.videoBackground", defaultValue: "Video Background"), "terminal.videoBackground dynamic video background youtube playlist muted wallpaper animated dim opacity mp4 loop"),
