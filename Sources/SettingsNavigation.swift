...
enum SettingsSearchIndex {
    ...
    private static let settingEntries: [SettingsSearchEntry] = [
        ...
        setting(.workspaceColors, "pane-flash-color", String(localized: "settings.workspaceColors.paneFlashColor", defaultValue: "Pane Flash"), "attention ring flash color needs input"),
    ...
    private static let settingsPathAnchorIDs: [String: String] = [
        ...
        "notifications.paneFlashColor": settingID(for: .workspaceColors, idSuffix: "pane-flash-color"),
