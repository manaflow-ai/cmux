...
enum SettingsSearchIndex {
    ...
    private static let settingEntries: [SettingsSearchEntry] = [
        ...
        setting(.terminal, "smooth-scrolling", String(localized: "settings.terminal.smoothScrolling", defaultValue: "Smooth Terminal Scrolling"), "terminal.smoothScrolling smooth scroll scrolling scrollback pixel precise trackpad magic mouse"),
    ...
    private static let settingsPathAnchorIDs: [String: String] = [
        ...
        "terminal.smoothScrolling": settingID(for: .terminal, idSuffix: "smooth-scrolling"),
