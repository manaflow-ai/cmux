...
enum SettingsSearchIndex {
    ...
    private static let settingEntries: [SettingsSearchEntry] = [
        ...
        setting(.app, "canvas-split-divider-thickness", String(localized: "settings.app.canvasSplitDividerThickness", defaultValue: "Split Divider Thickness"), "canvas.splitDividerThickness divider thickness split panes zoomable layout"),
    ...
    private static let settingsPathAnchorIDs: [String: String] = [
        ...
        "canvas.splitDividerThickness": settingID(for: .app, idSuffix: "canvas-split-divider-thickness"),
