...
enum SettingsSearchIndex {
    ...
    private static let settingEntries: [SettingsSearchEntry] = [
        ...
        setting(.browser, "forward-web-notifications", String(localized: "settings.browser.forwardWebNotifications", defaultValue: "Forward Website Notifications"), "website web page alerts banners sidebar permission"),
    ...
    private static let settingsPathAnchorIDs: [String: String] = [
        ...
        "browser.forwardWebNotifications": settingID(for: .browser, idSuffix: "forward-web-notifications"),
