...
enum SettingsSearchIndex {
    ...
    private static let settingEntries: [SettingsSearchEntry] = [
        ...
        setting(.terminal, "agent-auto-retry", String(localized: "settings.terminal.agentAutoRetry", defaultValue: "Retry Stalled Agent Sessions"), String(localized: "settings.search.alias.setting.terminal.agent-auto-retry", defaultValue: "terminal.autoRetryAgentSessions auto retry stalled error transport api rate limit overloaded agents claude codex")),
