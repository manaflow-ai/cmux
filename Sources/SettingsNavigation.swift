...
enum SettingsSearchIndex {
    ...
    private static let settingEntries: [SettingsSearchEntry] = [
        ...
        setting(.app, "restore-session-launch", String(localized: "settings.app.restorePreviousSessionOnLaunch", defaultValue: "Restore Previous Session on Launch"), "session restore launch startup tabs panes splits windows workspace layout persistence"),
    ...
    private static let settingsPathAnchorIDs: [String: String] = [
        ...
        "app.restorePreviousSessionOnLaunch": settingID(for: .app, idSuffix: "restore-session-launch"),
