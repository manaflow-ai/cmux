...
enum SettingsSearchIndex {
    ...
    private static let settingEntries: [SettingsSearchEntry] = [
        ...
        setting(.terminal, "copy-reflow", String(localized: "settings.terminal.reflowCopy", defaultValue: "Reflow Wrapped Text on Copy"), "terminal.reflowCopy copy reflow rewrap unwrap wrapped line breaks newlines paste paragraphs clean copy raw cmd c"),
    ...
    private static let settingsPathAnchorIDs: [String: String] = [
        ...
        "terminal.reflowCopy": settingID(for: .terminal, idSuffix: "copy-reflow"),
