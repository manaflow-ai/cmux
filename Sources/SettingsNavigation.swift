...
enum SettingsSearchIndex {
    ...
    private static let settingEntries: [SettingsSearchEntry] = [
        ...
        setting(.sidebarAppearance, "workspace-controls", String(localized: "settings.sidebar.workspaceControls", defaultValue: "Workspace Controls"), "sidebar workspace row hover close tasks controls"),
        ...
        setting(.betaFeatures, "workspaceTasks", String(localized: "settings.betaFeatures.workspaceTasks", defaultValue: "Workspace Tasks"), "workspace tasks todos goals deliverables beta"),
        setting(.betaFeatures, "workspaceControls", String(localized: "settings.betaFeatures.workspaceControls", defaultValue: "Workspace Controls"), "workspace controls sidebar hover beta"),
    ...
    private static let settingsPathAnchorIDs: [String: String] = [
        ...
        "workspaceTasks.beta.enabled": settingID(for: .betaFeatures, idSuffix: "workspaceTasks"),
        "workspaceControls.beta.enabled": settingID(for: .betaFeatures, idSuffix: "workspaceControls"),
        ...
        "sidebar.workspaceControls": settingID(for: .sidebarAppearance, idSuffix: "workspace-controls"),
