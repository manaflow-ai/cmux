...
// MARK: - UITest hooks: terminal cmd-click, socket/display/portal diagnostics (DEBUG)
extension AppDelegate {
#if DEBUG
    func setupTerminalCmdClickUITestIfNeeded() {
    ...
    func scheduleUITestSocketSanityCheckIfNeeded() {
        let env = ProcessInfo.processInfo.environment
    ...
    func setupDisplayResolutionUITestDiagnosticsIfNeeded() {
        let env = ProcessInfo.processInfo.environment
    ...
    func setupPortalStatsUITestDiagnosticsIfNeeded() {
        let env = ProcessInfo.processInfo.environment
