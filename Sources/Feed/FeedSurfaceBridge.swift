    ...
    private func snapshot() -> [String: Any] {
        ...
        return [
            ...
            "copy": [
                ...
                "loadExamples": String(localized: "feed.examples.load", defaultValue: "Load examples"),
                "demoPermissionTitle": String(localized: "feed.examples.permission.title", defaultValue: "Run database migration"),
                "demoPermissionBody": String(localized: "feed.examples.permission.body", defaultValue: "bun run db:migrate"),
                "demoPlanTitle": String(localized: "feed.examples.plan.title", defaultValue: "Plan ready for review"),
                "demoPlanBody": String(localized: "feed.examples.plan.body", defaultValue: "Update the bridge, add focused tests, then build the tagged app."),
                "demoQuestionTitle": String(localized: "feed.examples.question.title", defaultValue: "Verification scope"),
                "demoQuestionPrompt": String(localized: "feed.examples.question.prompt", defaultValue: "Which verification should run?"),
                "demoQuestionOptionFocused": String(localized: "feed.examples.question.focused", defaultValue: "Focused tests"),
                "demoQuestionOptionFull": String(localized: "feed.examples.question.full", defaultValue: "Full test suite"),
