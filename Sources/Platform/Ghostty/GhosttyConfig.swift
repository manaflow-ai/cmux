...
struct GhosttyConfig {
    ...
    var backgroundColor: NSColor = .init(hex: "#272822")!
    var backgroundOpacity: Double = 1.0
    var foregroundColor: NSColor = .init(hex: "#fdfff1")!
    var cursorColor: NSColor = .init(hex: "#c0c1b5")!
    var cursorTextColor: NSColor = .init(hex: "#8d8e82")!
    var selectionBackground: NSColor = .init(hex: "#57584f")!
    var selectionForeground: NSColor = .init(hex: "#fdfff1")!
