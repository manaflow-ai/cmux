...
// MARK: - WindowDragHandleBreadcrumbLimiter
...
// MARK: - WindowDragHandleAssociatedObjectKeys
...
func windowDragSuppressionDepth(window: NSWindow?) -> Int {
    guard let window,
          let value = objc_getAssociatedObject(window, WindowDragHandleAssociatedObjectKeys.suppressionDepth) as? NSNumber
    else {
        return 0
    }
