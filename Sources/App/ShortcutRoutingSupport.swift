...
private let ghosttyTerminalOwnedShortcutsBeforeAppShortcut = [
    StoredShortcut(first: ShortcutStroke(key: "k", command: true)),
    StoredShortcut(first: ShortcutStroke(key: "a", command: true)),
    StoredShortcut(first: ShortcutStroke(key: "t", command: true, shift: true)),
    StoredShortcut(first: ShortcutStroke(key: "z", command: true)),
    StoredShortcut(first: ShortcutStroke(key: "z", command: true, shift: true)),
    StoredShortcut(first: ShortcutStroke(key: "j", command: true)),
    StoredShortcut(first: ShortcutStroke(key: "j", command: true, shift: true)),
    StoredShortcut(first: ShortcutStroke(key: "j", command: true, shift: true, control: true)),
    StoredShortcut(first: ShortcutStroke(key: "j", command: true, shift: true, option: true)),
    StoredShortcut(first: ShortcutStroke(key: "space", command: true, keyCode: 115)),
    StoredShortcut(first: ShortcutStroke(key: "space", command: true, keyCode: 119)),
    StoredShortcut(first: ShortcutStroke(key: "space", command: true, keyCode: 116)),
    StoredShortcut(first: ShortcutStroke(key: "space", command: true, keyCode: 121)),
    StoredShortcut(first: ShortcutStroke(key: "↑", command: true)),
    StoredShortcut(first: ShortcutStroke(key: "↓", command: true)),
    StoredShortcut(first: ShortcutStroke(key: "↑", command: true, shift: true)),
    StoredShortcut(first: ShortcutStroke(key: "↓", command: true, shift: true)),
    StoredShortcut(first: ShortcutStroke(key: "[", command: true)),
    StoredShortcut(first: ShortcutStroke(key: "]", command: true)),
    StoredShortcut(first: ShortcutStroke(key: "↑", command: true, control: true)),
    StoredShortcut(first: ShortcutStroke(key: "↓", command: true, control: true)),
    StoredShortcut(first: ShortcutStroke(key: "←", command: true, control: true)),
    StoredShortcut(first: ShortcutStroke(key: "→", command: true, control: true)),
    StoredShortcut(first: ShortcutStroke(key: "f", command: true)),
    StoredShortcut(first: ShortcutStroke(key: "e", command: true)),
    StoredShortcut(first: ShortcutStroke(key: "f", command: true, shift: true)),
    StoredShortcut(first: ShortcutStroke(key: "g", command: true)),
    StoredShortcut(first: ShortcutStroke(key: "g", command: true, shift: true)),
    StoredShortcut(first: ShortcutStroke(key: "i", command: true, option: true)),
    StoredShortcut(first: ShortcutStroke(key: "v", command: true, shift: true)),
    StoredShortcut(first: ShortcutStroke(key: "→", command: true)),
    StoredShortcut(first: ShortcutStroke(key: "←", command: true)),
    StoredShortcut(first: ShortcutStroke(key: "space", command: true, keyCode: 51)),
]
