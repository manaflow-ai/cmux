...
struct SettingsView: View {
    ...
    @AppStorage(TerminalTextBoxInputSettings.showOnNewTerminalsKey)
    private var showTextBoxOnNewTerminals = TerminalTextBoxInputSettings.defaultShowOnNewTerminals
    @AppStorage(TerminalTextBoxInputSettings.focusOnNewTerminalsKey)
    private var focusTextBoxOnNewTerminals = TerminalTextBoxInputSettings.defaultFocusOnNewTerminals
