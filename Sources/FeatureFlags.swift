...
final class CmuxFeatureFlags {
  ...
  private static let proUpgradeDefinition = CmuxFeatureFlagDefinition(
    ...
    flagDescription: String(
      ...
      defaultValue:
        "Shows Pro upgrade entrypoints in the sidebar, Settings, command palette, and Help menu."
    ),
  ...
  private static let mobileConnectDefinition = CmuxFeatureFlagDefinition(
    ...
    title: String(
      localized: "featureFlags.mobileConnect.title", defaultValue: "Mobile Connect button"),
    flagDescription: String(
  ...
  private static let agentChatDefinition = CmuxFeatureFlagDefinition(
    ...
    flagDescription: String(
      ...
      defaultValue:
        "Shows Agent Chat entrypoints in the new-workspace dropdown, command palette, and surface tab bar."
    ),
