...
/// - Once a payload has arrived, its value remains authoritative until a later
///   payload supplies a replacement. Missing refresh values never erase a
///   cached remote kill switch.
///
