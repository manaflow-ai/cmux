...
class TerminalController {
    ...
    private nonisolated func socketWorkerV2Response(_ request: V2SocketRequest) -> String {
        ...
        case "hooks.invoke", "hooks.invoke.begin", "hooks.invoke.append", "hooks.invoke.execute": return v2Result(id: request.id, v2RemoteHookInvocation(method: request.method, params: request.params))
