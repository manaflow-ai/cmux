...
class TerminalController {
    ...
    private nonisolated static let socketWorkerCoordinatorHopMethods: Set<String> = [
        ...
        // workspace.set_auto_title. The synchronous hop keeps each create's
        // reply ordered after its store mutation, so create-then-list on one
        // connection reads its own write, and keeps set_auto_title's
        // apply-then-reply semantics for naming engines.
        "notification.create",
