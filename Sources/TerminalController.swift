...
class TerminalController {
    ...
    private struct V2SocketRequest {
        ...
        let id: Any?
        let method: String
        let typedParams: [String: JSONValue]
    ...
    private nonisolated func socketWorkerV2Response(_ request: V2SocketRequest) -> String {
        ...
        case "sidebar.custom.validate":
            return Self.v2Encoder.response(id: request.wireID, v2CustomSidebarValidate(params: request.typedParams))
        case "sidebar.custom.reload":
            return Self.v2Encoder.response(id: request.wireID, v2CustomSidebarReload(params: request.typedParams))
        case "sidebar.custom.select":
            return Self.v2Encoder.response(id: request.wireID, v2CustomSidebarSelect(params: request.typedParams))
#if DEBUG
