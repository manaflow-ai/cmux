...
class TerminalController {
    ...
    private func helpText() -> String {
        ...
        Notification commands:
          ...
          set_status <key> <value> [--icon=X] [--color=#hex] [--url=X] [--priority=N] [--format=plain|markdown] [--protocol=X] [--tab=X] [--panel=ID] - Set a status entry
    ...
    private func setStatus(_ args: String) -> String {
        upsertSidebarMetadata(
            args,
            missingError: "ERROR: Missing status key or value — usage: set_status <key> <value> [--icon=X] [--color=#hex] [--url=X] [--priority=N] [--format=plain|markdown] [--protocol=X] [--tab=X] [--panel=ID]"
        )
    }
