...
/// Command-palette metadata for surface kinds: the localized kind label and
/// the search keywords for each `PanelType`. Extracted from `ContentView`'s
/// palette plumbing because `ContentView.swift` sits at its file-length
/// budget.
