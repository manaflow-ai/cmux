...
enum KeyboardShortcutSettings {
    ...
    enum Action: String, CaseIterable, Identifiable {
        ...
        var label: String {
            ...
            case .uiScaleZoomIn: return String(localized: "menu.view.uiZoomIn", defaultValue: "UI Zoom In")
            case .uiScaleZoomOut: return String(localized: "menu.view.uiZoomOut", defaultValue: "UI Zoom Out")
            case .uiScaleReset: return String(localized: "menu.view.uiZoomReset", defaultValue: "Reset UI Zoom")
