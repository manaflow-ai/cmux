...
enum KeyboardShortcutSettings {
    ...
    enum Action: String, CaseIterable, Identifiable {
        ...
        var label: String {
            ...
            case .selectSurface1: return String(localized: "shortcut.selectSurface1.label", defaultValue: "Select Surface 1")
            case .selectSurface2: return String(localized: "shortcut.selectSurface2.label", defaultValue: "Select Surface 2")
            case .selectSurface3: return String(localized: "shortcut.selectSurface3.label", defaultValue: "Select Surface 3")
            case .selectSurface4: return String(localized: "shortcut.selectSurface4.label", defaultValue: "Select Surface 4")
            case .selectSurface5: return String(localized: "shortcut.selectSurface5.label", defaultValue: "Select Surface 5")
            case .selectSurface6: return String(localized: "shortcut.selectSurface6.label", defaultValue: "Select Surface 6")
            case .selectSurface7: return String(localized: "shortcut.selectSurface7.label", defaultValue: "Select Surface 7")
            case .selectSurface8: return String(localized: "shortcut.selectSurface8.label", defaultValue: "Select Surface 8")
            case .selectSurface9: return String(localized: "shortcut.selectSurface9.label", defaultValue: "Select Last Surface")
