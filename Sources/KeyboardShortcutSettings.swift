...
enum KeyboardShortcutSettings {
    ...
    enum Action: String, CaseIterable, Identifiable {
        ...
        var label: String {
            ...
            case .canvasFreeform: return String(localized: "shortcut.canvasFreeform.label", defaultValue: "Canvas")
            case .canvasScrollingColumns: return String(localized: "shortcut.canvasScrollingColumns.label", defaultValue: "Arrange Canvas as Columns")
