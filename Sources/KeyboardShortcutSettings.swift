...
enum KeyboardShortcutSettings {
    ...
    enum Action: String, CaseIterable, Identifiable {
        ...
        var label: String {
            ...
            case .focusHistoryBack: return String(localized: "shortcut.focusHistoryBack.label", defaultValue: "Back")
            case .focusHistoryForward: return String(localized: "shortcut.focusHistoryForward.label", defaultValue: "Forward")
