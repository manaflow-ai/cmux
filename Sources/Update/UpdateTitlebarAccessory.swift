...
final class TitlebarControlsAccessoryViewController: NSTitlebarAccessoryViewController, NSPopoverDelegate {
    ...
    private var lastShowsWorkspaceTitlebar = WorkspaceTitlebarSettings.isVisible() && !WorkspacePresentationModeSettings.isMinimal()
    ...
    private var showsWorkspaceTitlebar: Bool { WorkspaceTitlebarSettings.isVisible() && !WorkspacePresentationModeSettings.isMinimal() }
