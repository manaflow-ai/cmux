...
public final class WindowGlassEffect: WindowGlassEffectManaging {
    private static let backgroundIdentifier = NSUserInterfaceItemIdentifier("cmux.windowGlassBackground")
    private static let rootIdentifier = NSUserInterfaceItemIdentifier("cmux.windowGlassRoot")
    private static let foregroundContainerViewIdentifier = NSUserInterfaceItemIdentifier("cmux.windowGlassForeground")
