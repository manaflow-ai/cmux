    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 16) {
            VStack(alignment: .leading, spacing: 8) {
                ...
                Text(privacyModeBranded("Panecho can automatically check for updates in the background.", stable: String(localized: "update.popover.autoUpdatesDescription", defaultValue: "cmux can automatically check for updates in the background.")))
                    .font(.system(size: 11))
                    .foregroundColor(.secondary)
