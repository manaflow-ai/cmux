...
public enum SettingsSearchIndex {
    ...
    public static func entry(withID id: String) -> SettingsSearchEntry? {
        entriesByID[id]
    }

    public static func sectionEntry(for target: SettingsNavigationTarget) -> SettingsSearchEntry {
        entriesByID[sectionID(for: target)] ?? sectionEntries[0]
    }

    public static func sectionID(for target: SettingsNavigationTarget) -> String { "section:\(target.rawValue)" }
    public static func settingID(for target: SettingsNavigationTarget, idSuffix: String) -> String { "setting:\(target.rawValue):\(idSuffix)" }

    public static func anchorID(forSettingsPath path: String) -> String? {
