...
extension Array where Element == CuratedSettingEntry {
    ...
    public static var cmuxDefault: [CuratedSettingEntry] {
        [
            ...
            .init(section: .app, id: "markdown-viewer-font-size", title: "Markdown Viewer Font Size", synonyms: "app.markdownViewerFontSize md markdown mdx viewer preview font size zoom scale text readme"),
