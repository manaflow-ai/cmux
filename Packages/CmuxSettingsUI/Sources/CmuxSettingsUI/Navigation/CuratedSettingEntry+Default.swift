...
extension Array where Element == CuratedSettingEntry {
    ...
    public static var cmuxDefault: [CuratedSettingEntry] {
        [
            ...
            .init(section: .app, id: "single-window-mode", title: "Single Window Mode", synonyms: "app.singleWindowMode single window mode prevent automatic new windows fallback tabs workspaces"),
