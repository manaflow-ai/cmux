...
extension Array where Element == CuratedSettingEntry {
    ...
    public static var cmuxDefault: [CuratedSettingEntry] {
        [
            ...
            .init(section: .app, id: "terminal-editor-command", title: "Terminal Editor", synonyms: "app.terminalEditorCommand terminal editor nvim vim neovim helix hx tui open file login shell cmd click"),
            .init(section: .app, id: "terminal-editor-file-types", title: "Terminal Editor File Types", synonyms: "app.terminalEditorExtensions terminal editor file types extensions nvim vim open file cmd click rs ts py"),
