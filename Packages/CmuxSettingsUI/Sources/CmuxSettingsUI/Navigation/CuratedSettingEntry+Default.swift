...
extension Array where Element == CuratedSettingEntry {
    ...
    public static var cmuxDefault: [CuratedSettingEntry] {
        [
            ...
            .init(section: .terminal, id: "command-history-panel", title: "Command History Panel", synonyms: "terminal.commandHistoryPanel history command up down arrow shell readline prefix search panel warp"),
