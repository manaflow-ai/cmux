...
extension Array where Element == CuratedSettingEntry {
    ...
    public static var cmuxDefault: [CuratedSettingEntry] {
        [
            ...
            .init(section: .terminal, id: "quick-terminal-position", title: "Quick Terminal Position", synonyms: "terminal.quickTerminalPosition quick terminal dropdown quake position top bottom left right center"),
            .init(section: .terminal, id: "quick-terminal-primary-size", title: "Quick Terminal Primary Size", synonyms: "terminal.quickTerminalPrimarySizeRatio quick terminal dropdown quake primary size height width"),
            .init(section: .terminal, id: "quick-terminal-secondary-size", title: "Quick Terminal Secondary Size", synonyms: "terminal.quickTerminalSecondarySizeRatio quick terminal dropdown quake secondary size height width"),
            .init(section: .terminal, id: "quick-terminal-auto-hide", title: "Quick Terminal Auto-Hide", synonyms: "terminal.quickTerminalAutoHide quick terminal dropdown quake auto hide blur focus"),
