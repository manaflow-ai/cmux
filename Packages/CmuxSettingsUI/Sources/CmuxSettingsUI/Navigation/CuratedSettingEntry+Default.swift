...
extension Array where Element == CuratedSettingEntry {
    ...
    public static var cmuxDefault: [CuratedSettingEntry] {
        [
            ...
            .init(section: .app, id: "window-open-at-fixed-size", title: "Open Windows at a Fixed Size", synonyms: "window.openAtFixedSize fixed size window dimensions geometry width height points open new window restore last size ghostty startup launch"),
            .init(section: .app, id: "window-width", title: "Fixed Window Width", synonyms: "window.width fixed window width points dimensions size geometry open new window"),
            .init(section: .app, id: "window-height", title: "Fixed Window Height", synonyms: "window.height fixed window height points dimensions size geometry open new window"),
