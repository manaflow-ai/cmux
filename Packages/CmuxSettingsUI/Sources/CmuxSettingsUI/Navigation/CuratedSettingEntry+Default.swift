...
extension Array where Element == CuratedSettingEntry {
    ...
    public static var cmuxDefault: [CuratedSettingEntry] {
        [
            ...
            .init(section: .terminal, id: "regex-highlights", title: "Automatic Text Highlights", synonyms: "terminal.regexHighlights regex regular expression highlight alert error warning terminal text"),
