...
public protocol SettingsHostActions: AnyObject {
    ...
    /// Clears host-owned settings that are not represented in
    /// ``SettingCatalog`` but should still return to their default
    /// state when the user chooses **Reset All Settings**.
...
public final class NoopSettingsHostActions: SettingsHostActions {
    ...
    public func resetHostOnlySettings() {}
