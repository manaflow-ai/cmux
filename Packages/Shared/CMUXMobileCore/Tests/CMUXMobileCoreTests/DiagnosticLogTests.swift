...
@Suite struct DiagnosticLogTests {
    ...
    @Test func diagnosticTaxonomyHasStableRawValuesAndRedactedMappings() {
        ...
        #expect(DiagnosticSessionLifecycleKind.retirementStarted.rawValue == 12)
        #expect(DiagnosticSessionLifecycleKind.parentCloseAcknowledged.rawValue == 13)
        #expect(DiagnosticSessionLifecycleKind.postCloseCleanupCompleted.rawValue == 14)
        #expect(DiagnosticSessionLifecycleKind.replacementDialStarted.rawValue == 15)
