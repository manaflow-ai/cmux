...
public struct CmxIrohPathHint: Equatable, Sendable {
    ...
    /// An optional overlay, site, or provider profile identifier.
    ///
    ...
    ///
    /// Every non-public hint requires an expiry. Iroh-native private hints
    /// without an expiry exist only in the internal legacy compatibility path
    /// and remain unusable until refreshed.
    /// - Parameters:
    ...
    ///   - networkProfileID: An optional overlay, site, or profile identifier.
    ...
    public init(
        ...
        try validate(requirePrivateExpiry: true, requireSafeValueShape: true)
    }
    ...
    func validate() throws {
        try validate(requirePrivateExpiry: false, requireSafeValueShape: false)
    }
    ...
    private func validate(
        ...
        if let networkProfileID,
           !Self.isSafeIdentifier(networkProfileID, maximumUTF8Count: 128) {
            throw CmxIrohPathHintError.invalidNetworkProfileID
        }
...
extension CmxIrohPathHint: Codable {
    public init(from decoder: Decoder) throws {
        ...
        try self.init(
            kind: container.decode(CmxIrohPathHintKind.self, forKey: .kind),
            value: container.decode(String.self, forKey: .value),
            source: container.decode(CmxIrohPathHintSource.self, forKey: .source),
            privacyScope: container.decode(CmxIrohPathHintPrivacyScope.self, forKey: .privacyScope),
            expiresAt: container.decodeIfPresent(Date.self, forKey: .expiresAt),
            networkProfileID: container.decodeIfPresent(String.self, forKey: .networkProfileID)
        )
    }
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encodeIfPresent(networkProfileID, forKey: .networkProfileID)
    }
}
