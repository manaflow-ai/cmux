...
public struct MobileTerminalRenderGridReplay: Sendable {
    ...
    private func deltaPatchBytes() -> Data {
        ...
        // Row deltas clear before repainting. Keep the complete scroll, clear,
        // paint, and cursor restore inside one synchronized update so the
        // renderer cannot present a partially cleared grid during live output.
