...
public struct V2DirectoryRequest: Codable, Equatable, Sendable {
    ...
    public init(cursor: String?, haveRevision: Int?, requestID: String, schemaID: V2DirectoryRequestSchemaID) {
        self.cursor = cursor
...
public struct V2SocketSetup: Codable, Equatable, Sendable {
    ...
    public init(device: V2DeviceDescriptor, haveRevision: Int?, proof: V2DeviceProof?, requestID: String, schemaID: V2SocketSetupSchemaID) {
        self.device = device
        self.haveRevision = haveRevision
        self.proof = proof
        self.requestID = requestID
...
public struct V2DeviceProof: Codable, Equatable, Sendable {
    ...
    public init(issuedAt: Int, requestID: String, signature: String) {
...
public struct V2ChallengeResponse: Codable, Equatable, Sendable {
    ...
    public init(challenge: V2Challenge, requestID: String, schemaID: V2ChallengeResponseSchemaID) {
...
public struct V2ChangedResponse: Codable, Equatable, Sendable {
    ...
    public init(revision: Int, schemaID: V2ChangedResponseSchemaID, teamID: String) {
...
public struct V2CompletedResponse: Codable, Equatable, Sendable {
    ...
    public init(requestID: String, revision: Int, schemaID: V2CompletedResponseSchemaID) {
        self.requestID = requestID
        self.revision = revision
        self.schemaID = schemaID
    }
...
public struct V2DirectoryResponse: Codable, Equatable, Sendable {
    ...
    public init(directory: V2Directory, requestID: String, schemaID: V2DirectoryResponseSchemaID) {
...
public struct V2Directory: Codable, Equatable, Sendable {
    ...
    public init(devices: [V2DeviceRecord], issuedAt: Int, nextCursor: String?, permissionExpiresAt: Int, relayURLs: [String], revision: Int, teamID: String) {
...
public struct V2ErrorResponse: Codable, Equatable, Sendable {
    ...
    public init(code: V2ErrorCode, requestID: String, retryable: Bool, retryAfterMS: Int?, schemaID: V2ErrorResponseSchemaID) {
        self.code = code
        self.requestID = requestID
...
public struct V2ReadyResponse: Codable, Equatable, Sendable {
    ...
    public init(challenge: V2Challenge?, device: V2DeviceRecord?, requestID: String, schemaID: V2ReadyResponseSchemaID, sessionID: String, teamRevision: Int, ticket: V2Ticket?) {
        self.challenge = challenge
        self.device = device
        self.requestID = requestID
        self.schemaID = schemaID
...
public struct V2RegisteredResponse: Codable, Equatable, Sendable {
    ...
    public init(device: V2DeviceRecord, requestID: String, schemaID: V2RegisteredResponseSchemaID) {
        self.device = device
        self.requestID = requestID
        self.schemaID = schemaID
    }
...
public struct V2RelayResponse: Codable, Equatable, Sendable {
    ...
    public init(credentials: [V2RelayCredential], requestID: String, schemaID: V2RelayResponseSchemaID) {
...
public struct V2RevokedResponse: Codable, Equatable, Sendable {
    ...
    public init(deviceRecordID: String, revision: Int, schemaID: V2RevokedResponseSchemaID, teamID: String) {
        self.deviceRecordID = deviceRecordID
        self.revision = revision
        self.schemaID = schemaID
        self.teamID = teamID
...
public struct V2TicketResponse: Codable, Equatable, Sendable {
    ...
    public init(requestID: String, schemaID: V2TicketResponseSchemaID, ticket: V2Ticket) {
        self.requestID = requestID
        self.schemaID = schemaID
        self.ticket = ticket
    }
