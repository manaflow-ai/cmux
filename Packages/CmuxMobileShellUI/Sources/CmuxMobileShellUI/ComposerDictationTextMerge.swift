...
extension String {
    /// Combine this captured base text with the current dictation transcript.
    ///
    ...
    func mergingDictationTranscript(_ transcript: String) -> String {
        ...
        if let last = last, last.isWhitespace {
