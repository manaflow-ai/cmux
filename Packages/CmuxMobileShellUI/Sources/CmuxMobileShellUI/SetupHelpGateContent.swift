...
/// file-scope so the gate guidance is data, separate from the view that lays it
/// out.
func setupHelpGateContent(for gate: MobileSetupGuidanceState) -> SetupHelpGateContent {
    switch gate {
    case .notSignedIn:
