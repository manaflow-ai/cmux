...
extension ControlCommandCoordinator {
    ...
    public func handleSidebarV1(command: String, args: String) -> String? {
        ...
        case "report_command_history": return sidebarReportCommandHistory(args)
        case "report_command_history_snapshot": return sidebarReportCommandHistorySnapshot(args)
