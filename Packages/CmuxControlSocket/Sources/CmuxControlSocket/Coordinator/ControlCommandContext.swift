...
/// coordinator.
///
/// This protocol grows one domain at a time across stage 3c. It currently
/// covers the window domain; workspace/surface/pane/browser/sidebar reaches
/// land in later sub-stages.
@MainActor
public protocol ControlCommandContext: AnyObject {
