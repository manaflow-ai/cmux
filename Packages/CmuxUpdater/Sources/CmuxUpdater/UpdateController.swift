...
public final class UpdateController {
    ...
    private func startLaunchUpdateProbeIfNeeded() {
        ...
        if isDevelopmentUpdateBundleIdentifier(hostBundle.bundleIdentifier) {
            log.append("launch update probe skipped (dev build, bundle=\(hostBundle.bundleIdentifier ?? "nil"))")
            backgroundProbeTask?.cancel()
