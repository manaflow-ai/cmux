...
extension ShortcutAction {
    ...
    public var defaultStroke: ShortcutStroke? {
        ...
        case .growPaneLeft: return ShortcutStroke(key: "←", command: true, shift: true, option: true)
        case .growPaneRight: return ShortcutStroke(key: "→", command: true, shift: true, option: true)
        case .growPaneUp: return ShortcutStroke(key: "↑", command: true, shift: true, option: true)
        case .growPaneDown: return ShortcutStroke(key: "↓", command: true, shift: true, option: true)
