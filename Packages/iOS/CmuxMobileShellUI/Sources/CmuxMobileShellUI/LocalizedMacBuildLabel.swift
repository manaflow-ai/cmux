...
func localizedMacBuildLabel(_ label: String) -> String {
...
func macAppInstanceDisplayName(_ displayName: String, instanceTag: String?) -> String {
    ...
    return String(format: format, name, localizedMacBuildLabel(label))
}
