...
struct TerminalComposerView: View {
    ...
    private var queuedNotes: [OfflineAgentNote] {
        store.offlineAgentNotes
    }

    private var queuedNoteCounts: (pending: Int, sending: Int, sent: Int, failed: Int) {
        (
    ...
    private var latestQueuedNoteSnippet: String? {
        queuedNotes
    ...
    private var offlineNoteStatusRow: some View {
    ...
    private func offlineNoteSubtitle(counts: (pending: Int, sending: Int, sent: Int, failed: Int)) -> String {
        if counts.pending > 0 {
