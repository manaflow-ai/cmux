...
struct PairingView: View {
                    ...
                    .overlay(alignment: .topLeading) {
                        ...
                        if UITestConfig.mockDataEnabled {
                            Color.clear
                                ...
                                .accessibilityLabel(L10n.string("mobile.connections.addFormAccessibilityLabel", defaultValue: "Add Connection form"))
    ...
    private var navigationTitle: String {
        if initialPresentation.showsManualPairingControls {
            return L10n.string("mobile.connections.add", defaultValue: "Add Connection")
        }
        return L10n.string(
