...
/// A horizontal task-composer scroll view whose content dissolves beneath the
/// pinned leading and trailing controls instead of ending at hard clip edges.
/// The mask follows finger-driven content offsets from `layoutSubviews`, the
/// same UIKit-owned approach used by the terminal accessory bar.
