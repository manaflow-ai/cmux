...
struct SignInView: View {
    ...
    var body: some View {
        NavigationStack {
            ...
            .task(id: authRestoreDeadlineTaskID) {
                await updateAuthRestoreDeadline(isRestoring: authManager.isRestoringSession)
            }
        }
    }
    ...
    @ViewBuilder
    private var authRestoreStatus: some View {
    ...
    private func updateAuthRestoreDeadline(isRestoring: Bool) async {
