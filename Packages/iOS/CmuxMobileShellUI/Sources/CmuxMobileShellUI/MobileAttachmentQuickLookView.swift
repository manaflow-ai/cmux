...
/// Hosts Quick Look for one local file without copying or re-encoding it.
/// Shared by the task composer and terminal composer attachment previews.
struct MobileAttachmentQuickLookView: UIViewControllerRepresentable {
    let fileURL: URL
    let title: String
    var accessibilityIdentifier: String = "MobileAttachmentQuickLook"
