...
///
/// The id must survive an app reinstall so the device-registry slot keyed on
...
///
/// Uses a dedicated service name, so transport cleanup never removes this id.
/// `createOrAdopt` reports
    ...
    func createOrAdopt(_ desired: String) -> String? {
        ...
        case errSecDuplicateItem:
            ...
            case .absent:
                ...
                // the device could never mint an id and registration would be
