...
public final class MobileShellComposite: MobileTerminalOutputSinking {
    ...
    @ObservationIgnored @CancelOnDeinit var remoteClient: MobileCoreRPCClient? {
        didSet {
            if remoteClient == nil {
    ...
    @ObservationIgnored @CancelOnDeinit private var terminalEventListenerTask: Task<Void, Never>?
    ...
    @ObservationIgnored @CancelOnDeinit private var hostIdentityAdoptionTask: Task<Void, Never>?
    /// Tail of the serialized paired-Mac store write chain; see
    /// ``performSerializedPairedMacWrite(ifStillCurrent:_:)``.
    @ObservationIgnored @CancelOnDeinit private var pairedMacWriteChain: Task<Void, Never>?
    @ObservationIgnored @CancelOnDeinit private var pushedRouteSyncTask: Task<Void, Never>?
    ...
    @ObservationIgnored @CancelOnDeinit private var terminalSubscriptionStartTask: Task<Void, Never>?
    ...
    // it.
    @ObservationIgnored @CancelOnDeinit private var renderGridLivenessTimer: (any DispatchSourceTimer)?
    ...
    /// in-flight slot.
    @ObservationIgnored @CancelOnDeinit private var renderGridLivenessProbeTask: Task<Void, Never>?
    private var renderGridLivenessProbeID: UUID?
    private var lastTerminalEventAt: Date?
    @ObservationIgnored @CancelOnDeinit private var terminalSubscriptionRefreshTask: Task<Void, Never>?
    @ObservationIgnored @CancelOnDeinit private var createWorkspaceTask: Task<Void, Never>?
    @ObservationIgnored @CancelOnDeinit private var createTerminalTask: Task<Void, Never>?
    @ObservationIgnored @CancelOnDeinit private var workspaceListRefreshTask: Task<Void, Never>?
    ...
    @ObservationIgnored @CancelOnDeinit private var pullToRefreshTask: Task<Void, Never>?
    ...
    @ObservationIgnored @CancelOnDeinit private var secondaryAggregationTask: Task<Void, Never>?
    ...
    @ObservationIgnored @CancelOnDeinit var terminalReplayTasksBySurfaceID: [String: Task<Void, Never>]
    ...
    @ObservationIgnored @CancelOnDeinit private var networkPathObservationTask: Task<Void, Never>?
    private var recoveryInFlight = false
    @ObservationIgnored @CancelOnDeinit private var recoveryTask: Task<Void, Never>?
    ...
    @ObservationIgnored @CancelOnDeinit private var presenceTask: Task<Void, Never>?
