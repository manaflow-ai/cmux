...
extension MobileShellComposite {
    ...
    private func recoverFromPushedRouteBatch(
        ...
        // A failed recovery records its transient cooldown in the shared
        // automatic-reconnect owner. `recoverMobileConnection` consults that
        // same authority for unchanged presence heartbeats, while changed
        // route evidence clears the cooldown above.
