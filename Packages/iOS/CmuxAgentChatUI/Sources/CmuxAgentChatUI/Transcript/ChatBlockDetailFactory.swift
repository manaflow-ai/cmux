...
func makeChatBlockDetail(message: ChatMessage) -> ChatBlockDetail? {
    switch message.kind {
...
func makeChatBlockDetail(block: TerminalCommandBlock) -> ChatBlockDetail {
    terminalDetail(id: "term-\(block.id)", command: block.command, output: block.output)
}

func makeCodeBlockDetail(id: String, code: String, language: String?) -> ChatBlockDetail {
