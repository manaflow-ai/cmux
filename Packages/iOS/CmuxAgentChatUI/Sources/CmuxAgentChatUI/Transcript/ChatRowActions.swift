...
public struct ChatRowActions {
    ...
    /// Opens native workspace changes at a file path when the host enables the debug placement.
    public var openFileChanges: ((String) -> Void)?
    ...
    ///   - openFileChanges: Opens native changes at a file path, or `nil` to keep detail-sheet taps.
    ...
    public init(
        ...
        openFileChanges: ((String) -> Void)? = nil,
        ...
        self.openFileChanges = openFileChanges
