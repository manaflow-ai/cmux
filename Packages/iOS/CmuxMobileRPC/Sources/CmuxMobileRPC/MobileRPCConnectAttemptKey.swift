...
///
/// Diagnostic route descriptions intentionally redact peer identities.
/// Admission keys routes by a stable physical endpoint boundary, so cleanup
/// debt survives credential and anonymous ticket identity changes.
