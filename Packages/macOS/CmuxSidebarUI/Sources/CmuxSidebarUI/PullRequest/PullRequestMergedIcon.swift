...
/// Custom vector glyph for a merged pull request: a checkmark-style merge path
/// into a node graph. Drawn at a fixed 13×13 frame; ``PullRequestStatusIcon``
/// scales it.
struct PullRequestMergedIcon: View {
    let color: Color
