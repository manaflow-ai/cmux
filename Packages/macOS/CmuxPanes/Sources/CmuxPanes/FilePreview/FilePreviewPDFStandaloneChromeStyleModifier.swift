...
/// Applies the circular standalone-button chrome background/border for a given
/// `FilePreviewPDFChromeStyleVariant`, used for the lone external-open control
/// that sits beside the grouped PDF preview chrome.
