...
/// The content view inside a ``FilePreviewPDFThumbnailItem``: a rounded
/// selection backing, the page thumbnail image, and a centered page-number
/// label.
///
/// Selection appearance reacts to ``isSelectedForPreview`` and
/// ``isSelectionActiveForPreview`` (emphasized vs unemphasized). Package-internal.
