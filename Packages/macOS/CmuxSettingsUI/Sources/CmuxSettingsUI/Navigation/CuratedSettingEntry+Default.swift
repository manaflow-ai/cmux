...
extension Array where Element == CuratedSettingEntry {
    ...
    public static var cmuxDefault: [CuratedSettingEntry] {
        [
            ...
            .init(section: .app, id: "file-editor-syntax-highlighting", title: "File Editor Syntax Highlighting", synonyms: "fileEditor.syntaxHighlighting file editor syntax highlighting colorize colors code source preview theme dark light keywords strings comments"),
