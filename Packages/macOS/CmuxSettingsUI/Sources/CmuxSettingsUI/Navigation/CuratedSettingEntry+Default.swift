...
extension Array where Element == CuratedSettingEntry {
    ...
    public static var cmuxDefault: [CuratedSettingEntry] {
        [
            ...
            .init(section: .sidebarAppearance, id: "show-ssh-hosts", title: "Show SSH Hosts in Sidebar", synonyms: "sidebar.showSSHHosts ssh config hosts aliases remote servers section connect"),
