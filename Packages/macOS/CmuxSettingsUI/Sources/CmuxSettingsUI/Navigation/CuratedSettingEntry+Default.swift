...
extension Array where Element == CuratedSettingEntry {
    ...
    public static var cmuxDefault: [CuratedSettingEntry] {
        [
            ...
            .init(section: .sidebarAppearance, id: "show-pr-ci-status", title: String(localized: "settings.app.showPullRequestCIStatus", defaultValue: "Show PR CI Status in Sidebar"), synonyms: "sidebar.showPullRequestCIStatus ci checks github actions build status pull request"),
