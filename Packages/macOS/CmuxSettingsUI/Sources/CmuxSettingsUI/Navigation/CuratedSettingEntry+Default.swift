...
extension Array where Element == CuratedSettingEntry {
    ...
    public static var cmuxDefault: [CuratedSettingEntry] {
        [
            ...
            .init(section: .app, id: "reorder-pinned-notification", title: String(localized: "settings.app.reorderPinnedOnNotification", defaultValue: "Reorder Pinned on Notification"), synonyms: "app.reorderPinnedOnNotification notification reorder pinned workspace top unread sort"),
