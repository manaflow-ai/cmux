...
extension Array where Element == CuratedSettingEntry {
    ...
    public static func cmuxDefault(catalog: SettingCatalog) -> [CuratedSettingEntry] {
        [
            ...
            .init(section: .sidebarAppearance, id: "sidebar-density", title: String(localized: "settings.sidebar.density", defaultValue: "Sidebar Density"), synonyms: "Sidebar Density sidebar.density density quiet compact full preset details minimal busy workspace sidebar rows"),
