...
extension Array where Element == CuratedSettingEntry {
    ...
    public static func cmuxDefault(catalog: SettingCatalog) -> [CuratedSettingEntry] {
        [
            ...
            .init(section: .browser, id: "external-application", title: String(localized: "settings.browser.externalApplication", defaultValue: "External Browser Application"), detailText: String(localized: "settings.browser.externalApplication.subtitle", defaultValue: "HTTP(S) URLs opened outside cmux use this app name, bundle identifier, or .app path. Leave empty, or use an unresolved value, to use the system default."), synonyms: String(localized: "settings.search.alias.setting.browser.external-application", defaultValue: "browser.externalApplication external browser app application bundle identifier path links urls")),
