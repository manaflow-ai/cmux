...
extension Array where Element == CuratedSettingEntry {
    ...
    public static var cmuxDefault: [CuratedSettingEntry] {
        [
            ...
            .init(section: .app, id: "keep-expanded-on-new-tab", title: String(localized: "settings.app.keepExpandedOnNewTab", defaultValue: "Keep Pane Expanded on New Tab"), paths: ["app.keepExpandedOnNewTab"], synonyms: "app.keepExpandedOnNewTab pane zoom expanded new tab surface terminal preserve layout"),
