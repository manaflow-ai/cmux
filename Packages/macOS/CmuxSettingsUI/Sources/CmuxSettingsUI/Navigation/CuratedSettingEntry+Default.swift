...
extension Array where Element == CuratedSettingEntry {
    ...
    public static var cmuxDefault: [CuratedSettingEntry] {
        [
            ...
            .init(section: .app, id: "workspace-title-bar", title: String(localized: "settings.app.showWorkspaceTitleBar", defaultValue: "Show Workspace Title Bar"), synonyms: String(localized: "settings.search.alias.setting.app.workspace-title-bar", defaultValue: "app.showWorkspaceTitleBar hide show workspace window folder group title bar pane tabs chrome")),
