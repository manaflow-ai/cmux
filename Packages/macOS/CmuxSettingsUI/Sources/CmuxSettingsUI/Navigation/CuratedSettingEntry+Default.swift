...
extension Array where Element == CuratedSettingEntry {
    ...
    public static var cmuxDefault: [CuratedSettingEntry] {
        [
            ...
            .init(section: .sidebarAppearance, id: "notification-scheduler", title: "Notification Scheduler", synonyms: "sidebar.notificationSchedulerMode scheduler priority urgency blocked first small wins aging round robin arrival fifo unread notifications"),
