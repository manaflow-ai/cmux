...
extension Array where Element == CuratedSettingEntry {
    ...
    public static var cmuxDefault: [CuratedSettingEntry] {
        [
            ...
            .init(section: .sidebarAppearance, id: "always-show-workspace-numbers", title: "Always Show Workspace Numbers", synonyms: "sidebar.alwaysShowWorkspaceNumbers workspace number command digit shortcut hint always visible sidebar cmd ⌘"),
