...
extension Array where Element == CuratedSettingEntry {
    ...
    public static var cmuxDefault: [CuratedSettingEntry] {
        [
            ...
            .init(section: .workspaceColors, id: "state-colors-enabled", title: String(localized: "settings.workspaceColors.stateColorsEnabled", defaultValue: "Agent State Colors"), paths: ["workspaceColors.stateColorsEnabled"], synonyms: String(localized: "settings.search.alias.setting.workspaceColors.state-colors-enabled", defaultValue: "workspaceColors.stateColorsEnabled agent state colors running waiting idle needs input tint workspace tabs")),
            .init(section: .workspaceColors, id: "state-color-mode", title: String(localized: "settings.workspaceColors.stateColorMode", defaultValue: "State Color Behavior"), paths: ["workspaceColors.stateColorMode"], synonyms: String(localized: "settings.search.alias.setting.workspaceColors.state-color-mode", defaultValue: "workspaceColors.stateColorMode replace blend manual workspace color agent state")),
            .init(section: .workspaceColors, id: "state-colors-running", title: String(localized: "settings.workspaceColors.stateColor.running.searchTitle", defaultValue: "Running State Color"), paths: ["workspaceColors.stateColors"], synonyms: String(localized: "settings.search.alias.setting.workspaceColors.state-colors", defaultValue: "workspaceColors.stateColors running waiting needs input idle unknown agent state hex colors")),
            .init(section: .workspaceColors, id: "state-colors-needsInput", title: String(localized: "settings.workspaceColors.stateColor.needsInput.searchTitle", defaultValue: "Needs Input State Color"), paths: ["workspaceColors.stateColors"], synonyms: String(localized: "settings.search.alias.setting.workspaceColors.state-colors", defaultValue: "workspaceColors.stateColors running waiting needs input idle unknown agent state hex colors")),
            .init(section: .workspaceColors, id: "state-colors-idle", title: String(localized: "settings.workspaceColors.stateColor.idle.searchTitle", defaultValue: "Idle State Color"), paths: ["workspaceColors.stateColors"], synonyms: String(localized: "settings.search.alias.setting.workspaceColors.state-colors", defaultValue: "workspaceColors.stateColors running waiting needs input idle unknown agent state hex colors")),
            .init(section: .workspaceColors, id: "state-colors-unknown", title: String(localized: "settings.workspaceColors.stateColor.unknown.searchTitle", defaultValue: "Unknown State Color"), paths: ["workspaceColors.stateColors"], synonyms: String(localized: "settings.search.alias.setting.workspaceColors.state-colors", defaultValue: "workspaceColors.stateColors running waiting needs input idle unknown agent state hex colors")),
