...
extension Array where Element == CuratedSettingEntry {
    ...
    public static var cmuxDefault: [CuratedSettingEntry] {
        [
            ...
            .init(section: .markdown, id: "markdown-viewer", title: "Open Markdown in cmux Viewer", synonyms: "app.openMarkdownInCmuxViewer md markdown mdx viewer preview readme"),
            .init(section: .markdown, id: "markdown-font-size", title: "Markdown Viewer Font Size", synonyms: "markdown.fontSize md markdown viewer font size points zoom scale text bigger smaller larger default"),
            .init(section: .markdown, id: "markdown-font-family", title: "Markdown Viewer Font", synonyms: "markdown.fontFamily md markdown viewer font font-family family typeface system stack custom"),
            .init(section: .markdown, id: "markdown-max-width", title: "Markdown Viewer Max Width", synonyms: "markdown.maxWidth md markdown viewer max width column reading line length pixels px narrow wide"),
            .init(section: .markdown, id: "markdown-wiki-links", title: String(localized: "settings.app.markdownWikiLinks", defaultValue: "Wiki Links"), synonyms: "markdown.wikiLinks md markdown viewer wiki wikilink wiki-link double bracket obsidian vault note backlink"),
            .init(section: .markdown, id: "markdown-wiki-anchor", title: String(localized: "settings.app.markdownWikiLinkAnchor", defaultValue: "Wiki Link Anchor Folder"), synonyms: "markdown.wikiLinkAnchor wiki link anchor root top level folder obsidian vault git repository marker"),
