...
extension Array where Element == CuratedSettingEntry {
    ...
    public static var cmuxDefault: [CuratedSettingEntry] {
        [
            ...
            .init(section: .browser, id: "terminal-link-placement", title: String(localized: "settings.browser.terminalLinkPlacement", defaultValue: "Terminal Link Browser Placement"), synonyms: String(localized: "settings.search.alias.setting.browser.terminal-link-placement", defaultValue: "browser.terminalLinkBrowserPlacement terminal links browser pane split same pane reuse or split")),
