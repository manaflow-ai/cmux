...
extension Array where Element == CuratedSettingEntry {
    ...
    public static var cmuxDefault: [CuratedSettingEntry] {
        [
            ...
            .init(section: .workspaceColors, id: "state-colors-running", title: String(localized: "settings.workspaceColors.stateColor.running.searchTitle", defaultValue: "Running State Color"), paths: ["workspaceColors.stateColors"], synonyms: "workspaceColors.stateColors running active busy agent state hex colors"),
            .init(section: .workspaceColors, id: "state-colors-needsInput", title: String(localized: "settings.workspaceColors.stateColor.needsInput.searchTitle", defaultValue: "Needs Input State Color"), paths: ["workspaceColors.stateColors"], synonyms: "workspaceColors.stateColors waiting needs input blocked prompt question agent state hex colors"),
            .init(section: .workspaceColors, id: "state-colors-idle", title: String(localized: "settings.workspaceColors.stateColor.idle.searchTitle", defaultValue: "Idle State Color"), paths: ["workspaceColors.stateColors"], synonyms: "workspaceColors.stateColors idle stopped finished agent state hex colors"),
            .init(section: .workspaceColors, id: "state-colors-unknown", title: String(localized: "settings.workspaceColors.stateColor.unknown.searchTitle", defaultValue: "Unknown State Color"), paths: ["workspaceColors.stateColors"], synonyms: "workspaceColors.stateColors unknown no status agent state hex colors"),
