...
extension Array where Element == CuratedSettingEntry {
    ...
    public static var cmuxDefault: [CuratedSettingEntry] {
        [
            ...
            .init(section: .app, id: "close-cloud-terminal", title: String(localized: "settings.app.closeCloudTerminal", defaultValue: "Closing a Cloud Terminal"), synonyms: "app.closeCloudTerminal cloud terminal close detach kill process pty command-w cmd-w remote machine"),
