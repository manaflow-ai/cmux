...
extension Array where Element == CuratedSettingEntry {
    ...
    public static func cmuxDefault(catalog: SettingCatalog) -> [CuratedSettingEntry] {
        [
            ...
            .init(section: .textBox, id: "compose-mode", title: String(localized: "settings.textBox.composeMode", defaultValue: "Compose Mode"), synonyms: "Compose Mode terminal.composeMode native editor selection undo multiline input prompt"),
