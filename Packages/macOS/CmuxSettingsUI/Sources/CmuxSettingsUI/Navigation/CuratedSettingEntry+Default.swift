...
extension Array where Element == CuratedSettingEntry {
    ...
    public static var cmuxDefault: [CuratedSettingEntry] {
        [
            ...
            .init(section: .automation, id: "amp", title: String(localized: "settings.automation.amp", defaultValue: "Amp Integration"), synonyms: "Amp Integration automation.ampIntegration integrations.amp.hooksEnabled amp hooks install repair remove status notifications"),
