...
extension Array where Element == CuratedSettingEntry {
    ...
    public static var cmuxDefault: [CuratedSettingEntry] {
        [
            ...
            .init(section: .app, id: "markdown-wiki-links", title: "Markdown Viewer Wiki Links", synonyms: "markdown.wikiLinks md markdown viewer wiki wikilink wiki-link double bracket obsidian vault note backlink"),
