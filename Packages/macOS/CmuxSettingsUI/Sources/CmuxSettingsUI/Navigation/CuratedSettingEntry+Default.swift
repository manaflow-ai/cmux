...
extension Array where Element == CuratedSettingEntry {
    ...
    public static var cmuxDefault: [CuratedSettingEntry] {
        [
            ...
            .init(section: .app, id: "automatic-update-checks", title: String(localized: "settings.app.updates.automaticChecks", defaultValue: "Check for Updates Automatically"), synonyms: "updates automatic checks background sparkle release feed"),
            .init(section: .app, id: "automatic-update-downloads", title: String(localized: "settings.app.updates.automaticDownloads", defaultValue: "Download Updates Automatically"), synonyms: "updates automatic download background prepare restart staging sparkle"),
            .init(section: .app, id: "metered-update-downloads", title: String(localized: "settings.app.updates.meteredDownloads", defaultValue: "Allow Metered Update Downloads"), synonyms: "updates hotspot cellular expensive constrained low data mode bandwidth wifi network"),
