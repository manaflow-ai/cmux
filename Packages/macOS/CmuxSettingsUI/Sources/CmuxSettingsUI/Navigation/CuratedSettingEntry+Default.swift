...
extension Array where Element == CuratedSettingEntry {
    ...
    public static var cmuxDefault: [CuratedSettingEntry] {
        [
            ...
            .init(section: .app, id: "surface-tab-active-background", title: String(localized: "settings.surfaceTabBar.activeBackground", defaultValue: "Active Tab Background"), paths: ["ui.surfaceTabBar.activeTabBackground"], synonyms: "surface pane tab bar selected active background color theme flat"),
            .init(section: .app, id: "surface-tab-active-foreground", title: String(localized: "settings.surfaceTabBar.activeForeground", defaultValue: "Active Tab Text"), paths: ["ui.surfaceTabBar.activeTabForeground"], synonyms: "surface pane tab bar selected active foreground label text color"),
            .init(section: .app, id: "surface-tab-inactive-background", title: String(localized: "settings.surfaceTabBar.inactiveBackground", defaultValue: "Inactive Tab Background"), paths: ["ui.surfaceTabBar.inactiveTabBackground"], synonyms: "surface pane tab bar unselected inactive background color theme flat"),
            .init(section: .app, id: "surface-tab-inactive-foreground", title: String(localized: "settings.surfaceTabBar.inactiveForeground", defaultValue: "Inactive Tab Text"), paths: ["ui.surfaceTabBar.inactiveTabForeground"], synonyms: "surface pane tab bar unselected inactive foreground label text color"),
            .init(section: .app, id: "surface-tab-divider", title: String(localized: "settings.surfaceTabBar.divider", defaultValue: "Tab Divider"), paths: ["ui.surfaceTabBar.tabDividerColor"], synonyms: "surface pane tab bar divider separator border color none quiet"),
            .init(section: .app, id: "surface-tab-indicator", title: String(localized: "settings.surfaceTabBar.indicator", defaultValue: "Active Tab Indicator"), paths: ["ui.surfaceTabBar.activeTabIndicatorColor"], synonyms: "surface pane tab bar active indicator accent line color"),
            .init(section: .app, id: "surface-tab-indicator-edge", title: String(localized: "settings.surfaceTabBar.indicatorEdge", defaultValue: "Indicator Edge"), paths: ["ui.surfaceTabBar.activeTabIndicatorEdge"], synonyms: "surface pane tab bar active indicator accent line edge top bottom"),
