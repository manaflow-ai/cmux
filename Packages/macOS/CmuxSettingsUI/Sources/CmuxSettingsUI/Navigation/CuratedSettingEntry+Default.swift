...
extension Array where Element == CuratedSettingEntry {
    ...
    public static var cmuxDefault: [CuratedSettingEntry] {
        [
            ...
            .init(section: .sidebarAppearance, id: "ghpr-enabled", title: String(localized: "settings.digest.ghpr.enabled", defaultValue: "Enable PRDashboard Integration"), synonyms: "digest.ghpr.enabled ghpr pr pull request prdashboard socket integration sidebar"),
            .init(section: .sidebarAppearance, id: "ghpr-socket-path", title: String(localized: "settings.digest.ghpr.socketPath", defaultValue: "PRDashboard Socket Path"), synonyms: "digest.ghpr.socketPath ghpr socket path unix prdashboard sidebar"),
            .init(section: .sidebarAppearance, id: "ghpr-display-items", title: String(localized: "settings.digest.ghpr.displayItems", defaultValue: "PRDashboard Display Items"), synonyms: "digest.ghpr.displayItems ghpr display items ci review unresolved jira title draft conflicts sidebar"),
            .init(section: .sidebarAppearance, id: "ghpr-jira-base-url", title: String(localized: "settings.digest.ghpr.jiraBaseURL", defaultValue: "Jira Base URL"), synonyms: "digest.ghpr.jiraBaseURL ghpr jira base url ticket link sidebar"),
            ...
            .init(section: .browser, id: "site-search", title: "Browser Site Search", synonyms: "browser.siteSearch browser.siteSearchKeyboardShortcut prefix shortcut omnibar URL template"),
