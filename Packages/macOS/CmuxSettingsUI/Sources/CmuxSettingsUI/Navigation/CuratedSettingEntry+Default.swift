...
extension Array where Element == CuratedSettingEntry {
    ...
    public static var cmuxDefault: [CuratedSettingEntry] {
        [
            ...
            .init(section: .terminal, id: "claude-resume-mode", title: "Claude Resume Prompt", synonyms: "terminal.claudeResumeMode claude code resume full session summary compacted prompt auto answer skip menu usage limits"),
