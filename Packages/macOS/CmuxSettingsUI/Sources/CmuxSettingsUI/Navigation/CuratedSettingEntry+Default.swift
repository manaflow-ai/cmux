...
extension Array where Element == CuratedSettingEntry {
    ...
    public static var cmuxDefault: [CuratedSettingEntry] {
        [
            ...
            .init(section: .mobile, id: "iOSPairingManualHost", title: String(localized: "settings.mobile.manualHost", defaultValue: "Manual Host"), synonyms: "mobile.iOSPairingHost.manualHost manual host lan ip dns subnet router tailscale route iphone ipad"),
