...
extension Array where Element == CuratedSettingEntry {
    ...
    public static var cmuxDefault: [CuratedSettingEntry] {
        [
            ...
            .init(section: .sidebarAppearance, id: "workspace-status-style", title: String(localized: "settings.sidebar.workspaceStatusStyle", defaultValue: "Compact Agent Status Dots"), synonyms: "sidebar.workspaceStatusStyle agent status dots compact subtitle sentence one line tab row"),
            .init(section: .sidebarAppearance, id: "scroll-edge-fade", title: String(localized: "settings.sidebar.scrollEdgeFade", defaultValue: "Tab List Edge Fade"), synonyms: "sidebar.scrollEdgeFade sidebar tab list fade shadow scrim edge top bottom off subtle"),
