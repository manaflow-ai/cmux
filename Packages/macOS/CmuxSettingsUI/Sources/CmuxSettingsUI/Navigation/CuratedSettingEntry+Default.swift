...
extension Array where Element == CuratedSettingEntry {
    ...
    public static var cmuxDefault: [CuratedSettingEntry] {
        [
            ...
            .init(section: .app, id: "keep-expanded-on-new-tab", title: String(localized: "settings.app.keepExpandedOnNewTab", defaultValue: "Keep Pane Expanded on New Tab"), paths: ["app.keepExpandedOnNewTab"], synonyms: String(localized: "settings.search.alias.setting.app.keep-expanded-on-new-tab", defaultValue: "app.keepExpandedOnNewTab pane zoom expanded new tab surface terminal preserve layout")),
