...
extension Array where Element == CuratedSettingEntry {
    ...
    public static var cmuxDefault: [CuratedSettingEntry] {
        [
            ...
            .init(section: .app, id: "update-channel", title: String(localized: "settings.updates.channel", defaultValue: "Update channel"), synonyms: "Update channel updates.channel release candidate rc stable beta early feed sparkle appcast software update"),
