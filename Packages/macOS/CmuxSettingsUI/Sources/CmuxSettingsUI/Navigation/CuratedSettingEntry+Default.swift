...
extension Array where Element == CuratedSettingEntry {
    ...
    public static func cmuxDefault(catalog: SettingCatalog) -> [CuratedSettingEntry] {
        [
            ...
            .init(section: .sidebarAppearance, id: "show-pull-request-checks", title: String(localized: "settings.app.showPullRequestChecks", defaultValue: "Show Pull Request Checks"), synonyms: "Show Pull Request Checks sidebar.showPullRequestChecks pr ci checks tests passing failing pending merge conflict"),
