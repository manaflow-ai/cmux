...
extension Array where Element == CuratedSettingEntry {
    ...
    public static func cmuxDefault(catalog: SettingCatalog) -> [CuratedSettingEntry] {
        [
            ...
            .init(section: .automation, id: "agent-panes", title: String(localized: "settings.automation.agentPanes", defaultValue: "Agent Panes"), synonyms: "Agent Panes automation.agentPanesEnabled agent panes subagent teammate claude task split terminal"),
