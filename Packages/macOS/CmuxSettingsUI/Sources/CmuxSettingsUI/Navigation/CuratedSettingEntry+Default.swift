...
extension Array where Element == CuratedSettingEntry {
    ...
    public static var cmuxDefault: [CuratedSettingEntry] {
        [
            ...
            .init(section: .mobile, id: "irohStatus", title: String(localized: "settings.mobile.iroh.status", defaultValue: "Iroh Endpoint"), detailText: String(localized: "settings.mobile.iroh.status.subtitle", defaultValue: "Connection status for this Mac on iPhone."), synonyms: "iroh endpoint mobile iphone ipad ios connection status"),
