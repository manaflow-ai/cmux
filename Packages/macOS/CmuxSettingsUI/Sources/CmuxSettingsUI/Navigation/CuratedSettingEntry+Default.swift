...
extension Array where Element == CuratedSettingEntry {
    ...
    public static var cmuxDefault: [CuratedSettingEntry] {
        [
            ...
            .init(section: .app, id: "artifact-pane-orientation", title: String(localized: "settings.app.artifactPaneOrientation", defaultValue: "Artifact Pane Split"), synonyms: "app.artifactPaneOrientation artifact pane markdown viewer split right down horizontal vertical orientation layout"),
