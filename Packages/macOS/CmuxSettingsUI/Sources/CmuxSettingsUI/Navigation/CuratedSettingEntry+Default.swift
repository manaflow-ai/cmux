...
extension Array where Element == CuratedSettingEntry {
    ...
    public static var cmuxDefault: [CuratedSettingEntry] {
        [
            ...
            .init(section: .sidebarAppearance, id: "workspace-status-style", title: String(localized: "settings.sidebar.workspaceStatusStyle", defaultValue: "Workspace Status Style"), synonyms: "sidebar.workspaceStatusStyle agent status subtitle sentence dot compact one line tab row"),
