...
extension Array where Element == CuratedSettingEntry {
    ...
    public static var cmuxDefault: [CuratedSettingEntry] {
        [
            ...
            .init(section: .sidebarAppearance, id: "show-cloud-button", title: String(localized: "settings.app.showCloudButton", defaultValue: "Show Cloud Button in Sidebar"), synonyms: "Show Cloud Button in Sidebar sidebar.showCloudButton cloud button footer machines hide show"),
