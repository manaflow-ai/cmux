...
extension Array where Element == CuratedSettingEntry {
    ...
    public static var cmuxDefault: [CuratedSettingEntry] {
        [
            ...
            .init(section: .app, id: "file-editor-syntax-highlighting", title: "File Editor Syntax Highlighting", synonyms: "fileEditor.syntaxHighlighting syntax highlight colors tokens code"),
            .init(section: .app, id: "file-editor-line-numbers", title: "File Editor Line Numbers", synonyms: "fileEditor.lineNumbers gutter line numbers"),
            .init(section: .app, id: "file-editor-indent-guides", title: "File Editor Indent Guides", synonyms: "fileEditor.indentGuides indent guides columns"),
            .init(section: .app, id: "file-editor-current-line-highlight", title: "File Editor Current Line", synonyms: "fileEditor.currentLineHighlight current line caret"),
            .init(section: .app, id: "file-editor-tab-width", title: "File Editor Tab Width", synonyms: "fileEditor.tabWidth tab width indent columns"),
