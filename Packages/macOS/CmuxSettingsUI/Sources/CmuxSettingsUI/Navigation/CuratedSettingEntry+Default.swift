    ...
    public static var cmuxDefault: [CuratedSettingEntry] {
        [
            ...
            .init(
                section: .subrouter,
                id: "enabled",
                title: String(localized: "settings.subrouter.enabled", defaultValue: "Enable Subrouter Integration"),
                synonyms: "subrouter.enabled subrouter agents accounts codex claude daemon switch usage quota"
            ),
            .init(
                section: .subrouter,
                id: "show-account-switcher",
                title: String(localized: "settings.subrouter.showAccountSwitcher", defaultValue: "Show Account Switcher in Sidebar Footer"),
                synonyms: "sidebar.showAccountSwitcher subrouter agents accounts footer switcher status dot popover"
            ),
            .init(
                section: .subrouter,
                id: "endpoint",
                title: String(localized: "settings.subrouter.endpoint", defaultValue: "Daemon Endpoint"),
                synonyms: "subrouter.endpoint subrouter daemon endpoint host port localhost 31415"
            ),
            .init(
                section: .subrouter,
                id: "command-path",
                title: String(localized: "settings.subrouter.commandPath", defaultValue: "sr Binary Path"),
                synonyms: "subrouter.commandPath subrouter sr binary executable path cli command custom"
            ),
