...
extension Array where Element == CuratedSettingEntry {
    ...
    public static var cmuxDefault: [CuratedSettingEntry] {
        [
            ...
            .init(section: .app, id: "workspace-layouts", title: "Workspace Layouts", synonyms: "workspace layouts customize layout default new workspace menu save delete cmux.json actions"),
