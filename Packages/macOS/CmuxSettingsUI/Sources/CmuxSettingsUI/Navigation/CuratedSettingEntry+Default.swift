...
extension Array where Element == CuratedSettingEntry {
    ...
    public static func cmuxDefault(catalog: SettingCatalog) -> [CuratedSettingEntry] {
        [
            ...
            .init(section: .app, id: "file-preview-vim-keys", title: String(localized: "settings.app.filePreviewVimKeys", defaultValue: "Vim Navigation in File Previews"), synonyms: "Vim Navigation in File Previews app.filePreviewVimKeys cmd click file preview pdf image video audio quicklook quick look editor external"),
