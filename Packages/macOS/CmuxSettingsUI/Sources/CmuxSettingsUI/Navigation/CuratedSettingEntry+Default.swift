...
extension Array where Element == CuratedSettingEntry {
    ...
    public static var cmuxDefault: [CuratedSettingEntry] {
        [
            ...
            .init(section: .sidebarAppearance, id: "workspace-description-color", title: String(localized: "settings.app.workspaceDescriptionColor", defaultValue: "Workspace Description Text Color"), synonyms: "Workspace Description Text Color sidebar.workspaceDescriptionColor workspace description notes text color notification preview distinguish"),
