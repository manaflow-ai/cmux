...
extension Array where Element == CuratedSettingEntry {
    ...
    public static var cmuxDefault: [CuratedSettingEntry] {
        [
            ...
            .init(section: .terminal, id: "agent-context-management", title: String(localized: "settings.terminal.agentContextManagement", defaultValue: "Manage Agent Context Pressure"), detailText: String(localized: "settings.terminal.agentContextManagement.subtitleOn", defaultValue: "When Claude Code or Codex reports pressure at a proven idle prompt, cmux can send the selected recovery command."), paths: ["terminal.agentContextManagement.enabled"], synonyms: String(localized: "settings.search.alias.setting.terminal.agent-context-management", defaultValue: "terminal.agentContextManagement.enabled context pressure context window claude codex long thread compaction recovery")),
