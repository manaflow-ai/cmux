...
extension Array where Element == CuratedSettingEntry {
    ...
    public static var cmuxDefault: [CuratedSettingEntry] {
        [
            ...
            .init(section: .markdown, id: "markdown-wiki-links", title: "Wiki Links", synonyms: "markdown.wikiLinks md markdown viewer wiki wikilink wiki-link double bracket obsidian vault note backlink"),
            .init(section: .markdown, id: "markdown-wiki-anchor", title: "Wiki Link Anchor Folder", synonyms: "markdown.wikiLinkAnchor wiki link anchor root top level folder obsidian vault git repository marker"),
