...
extension Array where Element == CuratedSettingEntry {
    ...
    public static var cmuxDefault: [CuratedSettingEntry] {
        [
            ...
            .init(section: .browser, id: "dev-host-no-cache", title: "Always Fetch Fresh Content from Local Dev Servers", synonyms: "browser.disableCacheForDevHosts localhost cache stale fresh hard reload dev server no-cache turbopack vite next"),
