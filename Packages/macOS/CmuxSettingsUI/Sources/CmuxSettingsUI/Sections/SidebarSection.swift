    ...
    private var mainCard: some View {
        SettingsCard {
            ...
            SettingsCardRow(
                ...
                String(localized: "settings.app.workspaceDescriptionColor", defaultValue: "Workspace Description Text Color"),
                subtitle: String(localized: "settings.app.workspaceDescriptionColor.subtitle", defaultValue: "Use a custom text color to distinguish workspace descriptions from notification previews.")
            ) {
                HStack(spacing: 8) {
