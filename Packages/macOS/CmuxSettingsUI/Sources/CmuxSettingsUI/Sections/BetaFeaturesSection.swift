    ...
    private var extensionsRow: some View {
        SettingsCardRow(
            ...
            subtitle: extensions.current
                ? String(localized: "settings.betaFeatures.extensions.subtitleOn", defaultValue: "Shows the puzzle button, the sidebar-toggle extension menu, and lets you install and host ExtensionKit sidebar extensions (unrelated to TUI extensions).")
                : String(localized: "settings.betaFeatures.extensions.subtitleOff", defaultValue: "Hides ExtensionKit sidebar-extension UI until you enable it here (unrelated to TUI extensions).")
        ) {
