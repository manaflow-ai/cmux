...
public struct AppSection: View {
    ...
    @State private var workspaceTitlebarVisibility: DefaultsValueModel<Bool>
    ...
    public init(
        ...
        _workspaceTitlebarVisibility = State(initialValue: DefaultsValueModel(store: defaultsStore, key: catalog.app.workspaceTitlebarVisibility))
    ...
    public var body: some View {
        ...
        .task {
            startSettingsObservation([language, appearance, appIcon, placement, inheritDir, minimalMode, workspaceTitlebarVisibility, keepWorkspaceOpen, firstClick, focusHistoryIncludesPanesAndTabs, equalizeSplitsOnCreate, fileDrop, preferredEditor, openSupported, openMarkdown, globalFontMagnification, markdownFontSize, markdownFontFamily, markdownMaxWidth, canvasPaneGap, canvasSnapping, fileEditorWordWrap, fileEditorSyntaxHighlighting, fileEditorLineNumbers, fileEditorIndentGuides, fileEditorCurrentLineHighlight, fileEditorTabWidth, iMessage, reorder, dockBadge, menuBarOnly, showInMenuBar, paneRing, paneFlash, desktopNotifications, agentPermissionPrompt, agentTurnComplete, agentIdleReminder, soundName, soundCommand, customSoundFile, soundOverrides, telemetry, confirmQuit, warnCloseTab, warnCloseX, hideCloseButton, renameSelects, paletteAllSurfaces])
    ...
    private var mainCard: some View {
        SettingsCard {
            ...
            SettingsCardRow(
                configurationReview: .json("app.workspaceTitlebarVisibility"),
                String(localized: "settings.app.showWorkspaceTitlebar", defaultValue: "Show Workspace Title Bar"),
                subtitle: workspaceTitlebarVisibility.current
                    ? String(localized: "settings.app.showWorkspaceTitlebar.subtitleOn", defaultValue: "Show the folder and active title above pane tabs.")
                    : String(localized: "settings.app.showWorkspaceTitlebar.subtitleOff", defaultValue: "Hide the folder and active title above pane tabs.")
            ) {
