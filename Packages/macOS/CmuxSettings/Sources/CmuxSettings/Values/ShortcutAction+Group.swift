extension ShortcutAction {
    ...
    public var group: Group {
        ...
        case .openSettings, .reloadConfiguration, .showHideAllWindows, .globalSearch,
            ...
            return .app
        case .toggleSidebar, .newTab, .newBrowserWorkspace, .newGuiMode, .newCloudWorkspace, .newCloudMachine, .saveLayoutTemplate, .openFolder, .reopenPreviousSession, .goToWorkspace,
