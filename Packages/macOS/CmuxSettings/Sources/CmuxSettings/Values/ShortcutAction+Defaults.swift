...
extension ShortcutAction {
    ...
    public var defaultStroke: ShortcutStroke? {
        ...
        case .switchRightSidebarToSourceControl: return ShortcutStroke(key: "6", control: true)
        case .switchRightSidebarToMachines: return ShortcutStroke(key: "7", control: true)
