...
extension ShortcutAction {
    ...
    public var defaultStroke: ShortcutStroke? {
        ...
        case .toggleBoardView: return ShortcutStroke(key: "b", command: true, shift: true)
        case .openFocusedBoardCard: return ShortcutStroke(key: "\r")
        case .moveFocusedBoardCardToPrevColumn: return ShortcutStroke(key: "←", option: true, control: true)
        case .moveFocusedBoardCardToNextColumn: return ShortcutStroke(key: "→", option: true, control: true)
        case .archiveFocusedBoardCard: return ShortcutStroke(key: "⌫", option: true)
