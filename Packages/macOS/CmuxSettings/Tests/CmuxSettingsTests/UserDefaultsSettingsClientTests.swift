...
struct UserDefaultsSettingsClientTests {
    ...
    @Test func valueFallsBackToDefaultWhenAbsent() throws {
        ...
        #expect(client.value(for: catalog.sidebar.workspaceSpacing) == 1)
    ...
    @Test func roundTripsEachConvergedKey() throws {
        ...
        client.set(6, for: catalog.sidebar.workspaceSpacing)
        #expect(defaults.object(forKey: "sidebarWorkspaceSpacing") as? Int == 6)
        #expect(client.value(for: catalog.sidebar.workspaceSpacing) == 6)
    }
