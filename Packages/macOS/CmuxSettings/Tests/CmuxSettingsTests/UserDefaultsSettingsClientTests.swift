...
struct UserDefaultsSettingsClientTests {
    ...
    @Test func valueFallsBackToDefaultWhenAbsent() throws {
        ...
        #expect(client.value(for: catalog.sidebar.optimizedWorkspaceSnapshotsEnabled) == false)
        #expect(client.value(for: catalog.sidebar.optimizedWorkspaceSnapshotsMode) == "splitView")
        #expect(client.value(for: catalog.sidebar.optimizedWorkspaceSnapshotsSummaryDebounceMilliseconds) == 40)
        #expect(client.value(for: catalog.sidebar.optimizedWorkspaceSnapshotsDetailDebounceMilliseconds) == 40)
        #expect(client.value(for: catalog.sidebar.optimizedWorkspaceSnapshotsDiagnostics) == false)
        #expect(client.value(for: catalog.sidebar.optimizedWorkspaceSnapshotsLogInvalidationSource) == false)
