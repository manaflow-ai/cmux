...
public struct VMTunnelManager: Sendable {
    public enum Purpose: String, Sendable {
        case terminal
        case browser
    }

    public struct LocalTunnelState: Sendable {
        public let endpoint: VMTunnelEndpoint
    ...
    /// `CMUX_TAG`.
    public static func interfaceName(
    ...
    public static func interfaceName(forAPIBaseURL url: URL) -> String {
    ...
    public func writtenConfig() -> String? {
    ...
    public func storedDeviceFingerprint() -> String? {
    ...
    public func configuredRoutes() -> [String] {
    ...
    public static func allowedIPs(in config: String) -> [String] {
        var routes: [String] = []
        var inPeer = false
    ...
    public func keypair() throws -> (privateKey: String, publicKey: String) {
    ...
    public func configDigest() -> String? {
    ...
    public static func interfaceAddresses(in config: String) -> Set<String> {
    ...
    public static func completedConfig(
        _ config: String,
        privateKey: String,
        allowedIPs: [String] = []
    ) throws -> String {
    ...
    public func removeLocalCredentials() {
