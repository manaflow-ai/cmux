...
public enum CloudFileDelivery {
    ...
    public static let receiverTitle = "cmux file"
    public static let readyMarker = "CMUX-FILE-READY"
    public static let endMarker = "CMUX-FILE-END"
    public static let resultPattern = "CMUX-FILE-(OK|ERR)"
    public static let readyTimeoutMs = CloudEnvDelivery.readyTimeoutMs
    /// Decoding 256 KiB through a shell pipeline is quick; the margin covers a
    /// machine that is paging the shim back in.
    public static let resultTimeoutMs = 60_000
    public static let maxPayloadBytes = 256 * 1_024
    public static let defaultMode = "600"
    ...
    @MainActor
    public static func withReceiverWorkspace<T>(
    ...
    /// the bytes never are.
    public static func receiverCommand(path: String, mode: String) -> [String] {
    ...
    public static func wire(_ data: Data) -> Data {
    ...
    public static func requireOutcome(_ response: [String: Any], expectedBytes: Int) throws -> Outcome {
        let value = (response["value"] as? [String: Any]) ?? response
        let screen = (value["text"] as? String) ?? ""
