...
public struct CloudTerminalAttachmentResolver: Sendable {
    public let machineID: String
    public let commandRunner: any CloudTuiCommandRunning
    ...
    public var commandDeadline: Duration
    ...
    public var attachmentCorrelationID: String { log.correlationID }
    ...
    @Sendable
    #endif
    public nonisolated func resolve(terminalID: String) async -> CloudTuiSurfaceIDResolution {
    ...
    @Sendable
    #endif
    public nonisolated func resolve(terminalIDs: Set<String>) async -> [String: CloudTuiSurfaceIDResolution] {
