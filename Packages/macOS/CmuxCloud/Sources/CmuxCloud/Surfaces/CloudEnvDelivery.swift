...
public enum CloudEnvDelivery {
    ...
    public static let receiverTitle = "cmux env"
    public static let readyMarker = "CMUX-ENV-READY"
    public static let endMarker = "CMUX-ENV-END"
    public static let resultPattern = "CMUX-ENV-(OK|ERR)"
    ...
    public static let readyTimeoutMs = 15_000
    public static let resultTimeoutMs = 30_000
    ...
    public static let chunkBytes = 1_024
    public static let maxPayloadBytes = 256 * 1_024
    public static let base64LineWidth = 76
    ...
    @MainActor
    public static func withReceiverWorkspace(
    ...
    @MainActor
    public static func removeReceiverResources(
        terminalIDs: [String],
    ...
    public struct OperationAndCleanupError: Error, LocalizedError {
        public init(
            operationError: any Error,
            cleanupError: DeliveryError
        ) {
        ...
        public let cleanupError: DeliveryError
    ...
    public enum DeliveryError: Error, LocalizedError, Equatable {
    ...
    public static func requireReady(_ response: [String: Any], machineID: String) throws {
    ...
    public static func requireOutcome(_ response: [String: Any]) throws -> Outcome {
        let value = (response["value"] as? [String: Any]) ?? response
        let screen = (value["text"] as? String) ?? ""
    ...
    public static func payload(_ entries: [Entry]) throws -> Data {
    ...
    public static func wire(_ payload: Data) -> Data {
    ...
    public static func chunks(_ wire: Data, size: Int = chunkBytes) -> [Data] {
    ...
    public static func outcome(fromScreen text: String) -> Outcome? {
        var result: Outcome?
    ...
    public static func looksLikeOutdatedShim(_ screen: String) -> Bool {
