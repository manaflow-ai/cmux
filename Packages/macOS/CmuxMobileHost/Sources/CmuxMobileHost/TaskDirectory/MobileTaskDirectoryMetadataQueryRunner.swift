...
@MainActor
public final class MobileTaskDirectoryMetadataQueryRunner {
    ...
    private var finishObserver: (any NSObjectProtocol)?
    ...
    public static func makePredicate(query: String) -> NSPredicate {
        let tokens = query
