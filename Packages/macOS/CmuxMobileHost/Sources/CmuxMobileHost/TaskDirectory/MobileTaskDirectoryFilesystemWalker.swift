...
public struct MobileTaskDirectoryFilesystemWalker: Sendable {
    public struct Budget: Sendable {
        /// Directories read before the scan stops.
        public var maximumVisitedDirectories = 150_000
    ...
    public struct Outcome: Equatable, Sendable {
        ...
        public var visitedDirectoryCount: Int
    ...
    public func search(query: String, roots: [String]) -> Outcome {
    ...
    public static func shouldDescend(into name: String) -> Bool {
    ...
    public static func components(_ value: String) -> [String] {
