...
public actor MobileTaskDirectorySearchService {
    public struct Configuration: Sendable {
        public var maximumMetadataResults = 2_048
        public var maximumWireResults = 64
    ...
    public typealias MetadataSearchOperation = @MainActor @Sendable (
        _ query: String,
        _ maximumResults: Int,
        _ timeout: Duration
    ) async throws -> MobileTaskDirectoryMetadataQueryRunner.Snapshot
    public typealias RankOperation = @Sendable (
        _ paths: [SearchablePath],
        _ query: String,
        _ limit: Int
    ) async -> [String]
    public typealias DirectoryExists = @Sendable (_ path: String) -> Bool
    public typealias FilesystemWalkOperation = @Sendable (
        _ query: String,
        _ roots: [String]
    ...
    public nonisolated static func rank(paths: [String], query: String, limit: Int) -> [String] {
    ...
    public nonisolated static func walkRoots(
        homeDirectory: URL,
