...
public struct SupersededPhoneDismissBuffer: Sendable {
    ...
    /// throttle key.
    public static func key(tabId: UUID, surfaceId: UUID?) -> String {
    ...
    public mutating func stash(ids: [String], forKey key: String) {
    ...
    public mutating func flush(forKey key: String) -> [String] {
    ...
    public mutating func flush(matchingTabId tabId: UUID) -> [String] {
