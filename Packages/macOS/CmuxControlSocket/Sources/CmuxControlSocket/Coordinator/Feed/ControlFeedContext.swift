...
///
/// Covers only the MAIN-ACTOR feed method (`feed.list`). The
...
/// read hook state on the socket worker and stay on the app-side worker path;
/// they are NOT part of this seam.
///
