...
/// lint:allow namespace-type — the policy is a stateless, dependency-free
/// classifier shared by the CLI and socket package; callers do not need an
/// instance or injected state.
