...
extension TerminalController: ControlSystemContext {
    ...
    private func extensionSidebarWorkspaceRow(
        ...
        return ControlExtensionSidebarWorkspace(
            ...
            remoteConnectionStateRawValue: workspace.remoteConnectionCoordinator.state.remoteConnectionState.rawValue,
            remotePayload: JSONValue(foundationObject: workspace.remoteConnectionCoordinator.remoteStatusPayload()) ?? .object([:]),
