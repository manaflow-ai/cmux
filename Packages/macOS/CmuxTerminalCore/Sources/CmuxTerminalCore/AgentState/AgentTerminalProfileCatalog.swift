...
public struct AgentTerminalProfileCatalog: Sendable {
    ...
    private static let builtInProfiles: [AgentTerminalFamilyProfile] = [
        ...
        profile("kimi", "Kimi Code CLI", authoritative: true, executables: ["kimi", "kimi-cli", "kimi-code"], arguments: ["kimi-code"], idle: ["input"], working: [["esc to interrupt"]], blocked: [["[enter] upgrade", "[q] not now"]]),
