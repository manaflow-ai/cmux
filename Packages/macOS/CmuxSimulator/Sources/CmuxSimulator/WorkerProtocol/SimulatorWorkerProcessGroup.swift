...
public enum SimulatorWorkerProcessGroup {
    ...
    static func signal(
        ...
        hostGroupIdentifier: Int32
    ) -> Bool {
        guard isSafeWorkerGroup(
            groupIdentifier,
            hostGroupIdentifier: hostGroupIdentifier
        ) else {
            return false
        }
    ...
    static func isSafeWorkerGroup(
        _ groupIdentifier: Int32,
        hostGroupIdentifier: Int32
    ) -> Bool {
