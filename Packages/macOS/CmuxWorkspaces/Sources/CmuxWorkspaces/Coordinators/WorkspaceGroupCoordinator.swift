...
public final class WorkspaceGroupCoordinator<Tab: WorkspaceTabRepresenting> {
    ...
    /// `placement`. The title flag lets generated-purpose workspaces keep
    /// their creation title as a plain automatic title. Returns the new workspace.
    @discardableResult
    public func createWorkspaceInGroup(
        ...
        let newWorkspace = host.createWorkspaceForGroup(
            ...
            select: select, applyCreationTitleAsCustomTitle: applyCreationTitleAsCustomTitle
        )
