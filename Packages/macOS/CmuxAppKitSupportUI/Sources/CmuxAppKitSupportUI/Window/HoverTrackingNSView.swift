...
/// Backing `NSView` for ``HoverTrackingRepresentable`` that reports pointer
/// enter/exit through an `NSTrackingArea`, passing clicks through to the SwiftUI parent.
