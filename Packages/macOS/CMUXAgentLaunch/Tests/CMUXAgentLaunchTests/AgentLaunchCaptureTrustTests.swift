...
struct AgentLaunchCaptureTrustTests {
    ...
    @Test func openCodeSessionWrapperLaunchers() {
        #expect(AgentLaunchCaptureTrust.launcherIsOpenCodeSessionWrapper("omo"))
        #expect(AgentLaunchCaptureTrust.launcherIsOpenCodeSessionWrapper("omo-slim"))
        ...
        #expect(!AgentLaunchCaptureTrust.launcherIsOpenCodeSessionWrapper("omx"))
