...
public struct BrowserKeyboardEvent: Equatable, Sendable {
    ...
    private static let namedKeys: [String: BrowserKeyboardEvent] = {
        var keys: [String: BrowserKeyboardEvent] = [
            ...
            "Shift": .init(key: "Shift", code: "ShiftLeft", legacyKeyCode: 160, location: 1),
            "ShiftLeft": .init(key: "Shift", code: "ShiftLeft", legacyKeyCode: 160, location: 1),
            "ShiftRight": .init(key: "Shift", code: "ShiftRight", legacyKeyCode: 161, location: 2),
            ...
            "Control": .init(key: "Control", code: "ControlLeft", legacyKeyCode: 162, location: 1),
            "ControlLeft": .init(key: "Control", code: "ControlLeft", legacyKeyCode: 162, location: 1),
            "ControlRight": .init(key: "Control", code: "ControlRight", legacyKeyCode: 163, location: 2),
            ...
            "Alt": .init(key: "Alt", code: "AltLeft", legacyKeyCode: 164, location: 1),
            "AltLeft": .init(key: "Alt", code: "AltLeft", legacyKeyCode: 164, location: 1),
            "AltRight": .init(key: "Alt", code: "AltRight", legacyKeyCode: 165, location: 2),
