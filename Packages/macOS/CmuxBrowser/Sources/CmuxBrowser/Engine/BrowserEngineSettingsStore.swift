...
public struct BrowserEngineSettingsStore: Sendable {
    ...
    /// Unpacked MV3 directories explicitly trusted by the user.
    public static let extensionDirectoriesKey = "browser.extensionDirectories"

    /// Resolves configured directories without performing filesystem I/O.
    public func extensionDirectories() -> [String] {
        defaults.stringArray(forKey: Self.extensionDirectoriesKey) ?? []
    }
