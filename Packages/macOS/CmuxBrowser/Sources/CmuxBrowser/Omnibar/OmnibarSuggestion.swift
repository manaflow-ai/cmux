...
/// One omnibar suggestion row: a search, a direct navigation, a history hit, a
/// switch-to-open-tab action, or a remote search suggestion. A pure value with a
/// stable `id` (so SwiftUI keeps row identity while typing) and the display text
