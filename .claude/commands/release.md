...
5. **Bump the version in Xcode project**
   - Update all occurrences of `MARKETING_VERSION` in `Apps/cmux-macOS/GhosttyTabs.xcodeproj/project.pbxproj`
   - There are typically 4 occurrences (Debug/Release for main app and CLI)

6. **Commit and push the release branch**
   - Stage: `CHANGELOG.md`, `docs-site/content/docs/changelog.mdx`, `Apps/cmux-macOS/GhosttyTabs.xcodeproj/project.pbxproj`
...
12. **Verify homebrew cask update**
    ...
    - Verify the checked-in tap submodule: `cd vendor/homebrew-cmux && git pull && grep version Casks/cmux.rb`
