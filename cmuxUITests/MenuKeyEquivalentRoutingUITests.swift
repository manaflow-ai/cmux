...
final class SplitCloseRightBlankRegressionUITests: XCTestCase {
    ...
    func testClosingBothRightSplitsDoesNotLeaveBlankPane() {
        ...
        // and both panes should have a selected workspaceLayout tab that maps to an existing Panel.
        ...
        XCTAssertEqual(missingMapping, 0, "Expected no selected workspaceLayout tab to be missing its Panel mapping")
