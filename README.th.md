...
<p align="center">
  <a href="README.md">English</a> | <a href="README.ja.md">日本語</a> | <a href="README.zh-CN.md">简体中文</a> | <a href="README.zh-TW.md">繁體中文</a> | <a href="README.ko.md">한국어</a> | <a href="README.de.md">Deutsch</a> | <a href="README.es.md">Español</a> | <a href="README.fr.md">Français</a> | <a href="README.it.md">Italiano</a> | <a href="README.da.md">Dansk</a> | <a href="README.pl.md">Polski</a> | <a href="README.ru.md">Русский</a> | <a href="README.bs.md">Bosanski</a> | <a href="README.ar.md">العربية</a> | <a href="README.no.md">Norsk</a> | <a href="README.pt-BR.md">Português (Brasil)</a> | ไทย | <a href="README.tr.md">Türkçe</a> | <a href="README.km.md">ភាសាខ្មែរ</a> | <a href="README.uk.md">Українська</a> | <a href="README.el.md">Ελληνικά</a>
</p>
...
เมื่อออกจาก cmux ระบบจะบันทึกเซสชันปัจจุบันไว้ เมื่อเปิดใหม่ cmux จะกู้คืนสถานะที่แอปเป็นเจ้าของ:
- เลย์เอาต์หน้าต่าง/เวิร์กสเปซ/แผง
- ไดเรกทอรีทำงาน
- ประวัติการเลื่อนของเทอร์มินัล (พยายามอย่างดีที่สุด)
- URL ของเบราว์เซอร์และประวัติการนำทาง

cmux ไม่ checkpoint สถานะ live process ใด ๆ โดยพลการ tmux, vim, shell และแอปเทอร์มินัลที่ยังไม่รองรับจะเปิดกลับมาเป็นเทอร์มินัลปกติ

เซสชัน agent ที่รองรับสามารถ resume ได้เมื่อ hooks บันทึก native session ID ไว้แล้ว:
...
ผู้ใช้ขั้นสูงและ integration สามารถผูกคำสั่ง resume แบบกำหนดเองกับ terminal surface ปัจจุบันได้ เหมาะกับเครื่องมือที่มีสถานะถาวรของตัวเอง เช่น tmux session หรือ agent CLI แบบกำหนดเอง:
...
binding นี้ยังเชื่อมกับ cmux surface อยู่ binding ที่สร้างผ่าน public CLI หรือ socket จะถูกเก็บไว้สำหรับตรวจสอบและ resume ด้วยตนเอง cmux จะ auto-run เฉพาะ resume binding ที่ถูกทำเครื่องหมายว่า trusted เช่น tmux binding ที่ตรวจพบจาก process ที่กำลังทำงาน คีย์ environment ที่ละเอียดอ่อน เช่น token, password, secret และ API key จะถูกตัดทิ้งก่อนบันทึก resume binding
