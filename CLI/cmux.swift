...
struct CMUXCLI {
    ...
    private static let openCodeSessionPluginConfigSpec = OpenCodeSessionBridge.configSpec
    ...
    private static let openCodeSessionPluginMarker = OpenCodeSessionBridge.marker
    private static let openCodeSessionPluginFilename = OpenCodeSessionBridge.filename
    private static let openCodeSessionPluginSource = OpenCodeSessionBridge.source
    ...
    private static let piExtensionMarker = PiSessionBridge.marker
    private static let piExtensionFilename = PiSessionBridge.filename
    private static let piExtensionSource = PiSessionBridge.source
