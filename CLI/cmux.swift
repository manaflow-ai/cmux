...
struct CMUXCLI {
    ...
    private func runDocsCommand(commandArgs: [String], jsonOutput: Bool) throws {
    ...
    private func settingsUsage() -> String {
        return """
...
"""#
    ...
    private func printWelcome() {
        ...
        print("  \(subdued)Run \(reset)\(bold)cmux settings\(reset)\(subdued) to open Settings.\(reset)")
        print("  \(subdued)Run \(reset)\(bold)cmux docs settings\(reset)\(subdued) for settings.json docs and schema.\(reset)")
