...
extension CMUXCLI {
    ...
    static var vmRunUsage: String {
        """
        Usage: cmux vm run [--sync] [--pull <remote-path>] [--machine <id>] [--new] [--size <2g|4g|8g|16g|20g>] [--timeout <seconds>] -- <command...>
...
extension CMUXCLI {
    static var vmRouteUsage: String {
        """
        Usage: cmux vm route [--cwd <dir>] [--new] [--provision] [--size <2g|4g|8g|16g|20g>] [--json]
