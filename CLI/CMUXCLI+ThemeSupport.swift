...
extension CMUXCLI {
    ...
    func isRightSidebarCLIMode(_ value: String) -> Bool {
        ...
        case "files", "find", "vault", "sessions", "feed", "dock", "cloud", "machines", "vms", "beads", "custom", "custom-sidebar":
            return true
        default:
            return false
        }
    ...
    func normalizedRightSidebarCLIArgument(_ value: String) -> String {
        switch value.lowercased() {
        case "files", "find", "vault", "sessions", "feed", "dock", "machines", "beads", "custom", "custom-sidebar":
