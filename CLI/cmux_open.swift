    ...
    struct DiffViewerLabels {
        ...
        static func localized() -> DiffViewerLabels {
            DiffViewerLabels(values: [
                ...
                "editConflict": CMUXDiffViewerLocalization.string("diffViewer.editConflict", defaultValue: "This file changed outside the diff editor. Refresh before saving."),
                ...
                "editSaveFailed": CMUXDiffViewerLocalization.string("diffViewer.editSaveFailed", defaultValue: "Could not save all edits."),
