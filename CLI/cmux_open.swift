    ...
    private struct DiffViewerLabels {
        ...
        static func localized() -> DiffViewerLabels {
            DiffViewerLabels(values: [
                ...
                "commitMessage": CMUXDiffViewerLocalization.string("diffViewer.commitMessage", defaultValue: "Commit message"),
                ...
                "copyFailedStageCommitCommand": CMUXDiffViewerLocalization.string("diffViewer.copyFailedStageCommitCommand", defaultValue: "Could not copy stage & commit command."),
                ...
                "copiedStageCommitCommand": CMUXDiffViewerLocalization.string("diffViewer.copiedStageCommitCommand", defaultValue: "Copied stage & commit command"),
                "copyGitApplyCommand": CMUXDiffViewerLocalization.string("diffViewer.copyGitApplyCommand", defaultValue: "Copy git apply command"),
                "copyStageCommitCommand": CMUXDiffViewerLocalization.string("diffViewer.copyStageCommitCommand", defaultValue: "Copy stage & commit command"),
