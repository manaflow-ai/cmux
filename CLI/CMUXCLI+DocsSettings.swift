...
extension CMUXCLI {
    ...
    func docsReference(for topic: String) -> DocsReference? {
    ...
    func docsPayload(_ reference: DocsReference) -> [String: Any] {
    ...
    func printDocsReference(_ reference: DocsReference) {
