...
extension CMUXCLI {
    ...
    private static let docsReferences: [DocsReference] = [
        ...
        DocsReference(
            ...
            summary: "Vibe-code a custom sidebar: a runtime-interpreted cmux view file in ~/.config/cmux/sidebars/ (beta).",
            ...
            commands: [
                ...
                "cat > ~/.config/cmux/sidebars/mine.swift   # write a cmux sidebar view, then right-click the sidebar button to pick it",
