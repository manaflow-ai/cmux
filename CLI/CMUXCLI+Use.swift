...
extension CmuxUseSupport {
    static func packageJSONLaunchCommand(in checkoutURL: URL) -> CmuxUseLaunchCommand? {
    ...
    static func packageJSON(in checkoutURL: URL) -> [String: Any]? {
    ...
    static func packageManagerCommand(in checkoutURL: URL) -> String {
    ...
    static func makefileLaunchCommand(in checkoutURL: URL) -> CmuxUseLaunchCommand? {
    ...
    static func makefile(_ contents: String, hasTarget target: String) -> Bool {
