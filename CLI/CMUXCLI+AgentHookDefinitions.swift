...
extension CMUXCLI {
    ...
    enum AgentHookAction {
        case sessionStart, promptSubmit, stop, notification, approvalResponse, shellObserved, shellDone, shellFailed, shellExpire, sessionEnd, sessionFinalize, noop
    }
