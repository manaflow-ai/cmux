...
let package = Package(
    ...
    dependencies: [
        ...
        .package(path: "../../Packages/iOS/CmuxMobileCloud"),
        .package(path: "../../Packages/iOS/CmuxMobileCloudBridge"),
        .package(path: "../../Packages/iOS/CmuxMobileCloudUI"),
