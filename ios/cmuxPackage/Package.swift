...
let package = Package(
    ...
    dependencies: [
        ...
        .package(path: "../../Packages/Shared/CmuxMobilePairedMac"),
        .package(path: "../../Packages/Shared/CmuxMobileRPC"),
        .package(path: "../../Packages/Shared/CmuxMobileShell"),
        .package(path: "../../Packages/Shared/CmuxMobileShellModel"),
        .package(path: "../../Packages/iOS/CmuxMobileShellUI"),
        .package(path: "../../Packages/Shared/CmuxMobileSupport"),
