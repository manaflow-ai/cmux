...
public struct CMUXMobileRootScene: View {
    ...
    /// The same policy instance used by discovery, persistence, and validation.
    ...
    ///     by discovery, persistence, and connection validation.
    ...
    private func makeDeviceRegistry(
        ...
        let teamRegistry = DeviceRegistryService(
            ...
            deviceID: appNamespace.deviceRegistryDeviceID(
                ...
                evidence: MobileSameDeviceEvidenceProbe.current()
            ),
