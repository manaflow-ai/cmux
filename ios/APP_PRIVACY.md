...
Reason: iOS users can opt out of product analytics in `Settings > Privacy > Share Product Analytics`; signed-in iOS users can delete their account from `Settings > Account > Delete Account`; the policy explains access, deletion, and contact paths.
