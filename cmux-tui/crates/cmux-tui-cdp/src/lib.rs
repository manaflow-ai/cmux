...
pub use client::{
    ...
    CapturedFrame, CdpClient, CdpEvent, CdpKeyEvent, DownloadProgress, DownloadWillBegin,
    FrameEpoch, NavigationEntry, NavigationHistory, ScreencastFrame, TargetCreated, TargetInfo,
