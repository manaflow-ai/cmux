...
impl Mux {
    ...
    /// Atomically incarnation-check and tombstone a hosted terminal, every
    /// live view, and its public resource. The host is terminated only after
    ...
    pub fn close_terminal_with_mutation(
        ...
        self.close_terminal_with_protocol_mutation(
            terminal_id,
