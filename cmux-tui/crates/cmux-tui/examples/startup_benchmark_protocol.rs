...
mod tests {
    ...
    fn product_started_line_is_bounded_nonce_bound_and_canonical() {
        ...
        let evidence = BootstrapLaunchEvidence {
            ...
            bootstrap_process_id: 100,
            bootstrap_primary_thread_id: 101,
            ...
            job_ui_restriction_mask: cmux_startup_bootstrap::WINDOWS_JOB_UI_RESTRICTION_MASK,
