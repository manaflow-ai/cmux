...
use base64::Engine;
use cmux_tui_core::{
    BrowserSource, BrowserStatus, ClearHistoryDelivery, ClearHistoryFailure, Direction, Mux,
    MuxEvent, Node, PairingChallenge, PaneId, Rect, SplitDir, SplitEdge, SplitId, SurfaceId,
    SurfaceKind, WorkspaceId, ZoomMode, exact_split_for_pane_edge, layout_screen, split_sides,
