...
use crate::ui::graphics_writer::{GraphicsWriter, GraphicsWriterShutdown, StdoutLock};
...
fn run_with_machine_updates_inner(
    ...
    let mut terminal_restore =
        TerminalRestoreGuard::new(stdout_lock.clone(), host_keyboard_protocol.clone());
...
impl TerminalRestoreGuard {
    fn new(
        ...
        Self { stdout_lock, host_keyboard_protocol, graphics_shutdown: None, armed: true }
    }
...
mod tests {
    use super::{
        ...
        SurfaceResizeDecision, SurfaceResizeOwnership, TerminalInput, WorkspaceRailSelection,
