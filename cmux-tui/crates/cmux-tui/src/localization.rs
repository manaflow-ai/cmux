...
pub(crate) struct ServerMessages {
    ...
    pub restart_between_commands: &'static str,
    ...
    pub process_cleanup_unsupported: &'static str,
...
static ENGLISH: Catalog = Catalog {
    ...
    server: ServerMessages {
        ...
        restart_between_commands: "`, then rerun the previous command using `",
        ...
        cleanup_pending_label: "pending cleanup tasks",
...
static JAPANESE: Catalog = Catalog {
    ...
    server: ServerMessages {
        ...
        restart_between_commands: "` を実行してから、以前のコマンドを `",
        restart_after_command: "` で再実行してください。",
        ...
        cleanup_pending_label: "保留中のクリーンアップ",
