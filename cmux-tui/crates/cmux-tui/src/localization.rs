...
",
    ...
    sidebar: SidebarMessages {
        ...
        provider_connection_already_running: "Another cmux-tui connection is already running. Close it and try again.",
...
",
    ...
    sidebar: SidebarMessages {
        ...
        provider_connection_already_running: "別の cmux-tui 接続がすでに実行中です。終了してから、もう一度お試しください。",
