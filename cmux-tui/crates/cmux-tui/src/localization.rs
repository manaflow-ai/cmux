...
impl LocalServerMessages {
    pub(crate) fn owner_spawn_failed(&self, error: &std::io::Error) -> String {
...
static ENGLISH: Catalog = Catalog {
    ...
    local_server: LocalServerMessages {
        ...
        owner_spawn_failed: "cannot start the detached session owner: {error}",
...
static JAPANESE: Catalog = Catalog {
    ...
    local_server: LocalServerMessages {
        ...
        owner_spawn_failed: "デタッチされたセッション所有者を起動できません: {error}",
