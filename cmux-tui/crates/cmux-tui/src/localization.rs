...
pub(crate) struct LayoutMessages {
    ...
    pub viewport_width_requires_right: &'static str,
...
",
    ...
    layout: LayoutMessages {
        ...
        viewport_width_requires_right: "--viewport-width requires --right",
...
",
    ...
    layout: LayoutMessages {
        ...
        viewport_width_requires_right: "--viewport-width を使用するには --right が必要です",
