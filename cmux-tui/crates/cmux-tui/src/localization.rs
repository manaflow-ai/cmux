...
static ENGLISH: Catalog = Catalog {
    ...
    local_server: LocalServerMessages {
        ...
        invalid_session: "the local session name is invalid; use one path component without separators and retry",
...
static JAPANESE: Catalog = Catalog {
    ...
    local_server: LocalServerMessages {
        ...
        invalid_session: "ローカルセッション名が無効です。区切り文字を含まない一つのパス要素を使用して再試行してください",
