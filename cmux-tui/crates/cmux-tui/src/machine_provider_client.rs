...
use cmux_tui_machine_protocol::{
    ...
    CloseMachineParams, CloseMachineResult, CreateMachineParams, CreateMachineResult,
    CreateWorkspaceParams, CreateWorkspaceResult, DURABLE_NOTICES_CAPABILITY, EventEnvelope,
    HelloParams, HelloResult, InvokeActionParams, InvokeActionResult, MACHINE_LIFECYCLE_CAPABILITY,
    MachineLifecycleSnapshotParams, MachineLifecycleSnapshotResult, MachineMutationParams,
    MachineMutationResult, NoticeDelivery, OpaqueId, OpenMachineParams, OpenMachineResult,
