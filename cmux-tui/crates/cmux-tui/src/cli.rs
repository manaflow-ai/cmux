...
use cmux_tui_core::{
    ...
    platform::transport,
    server::{
        ATTACH_INITIAL_SIZE_CAPABILITY, CLEAR_HISTORY_CAPABILITY,
        GUARDED_BROWSER_POINTER_CAPABILITY, LAYOUT_UNDO_CAPABILITY,
        PER_SURFACE_CLIENT_SIZING_PROTOCOL_VERSION, VIEWPORT_COLUMN_RESIZE_CAPABILITY,
...
const CLIENT_SIZING_PROTOCOL: u64 = PER_SURFACE_CLIENT_SIZING_PROTOCOL_VERSION as u64;
