...
describe("ConnectScreen", () => {
  ...
  it("renders defaults, surfaces errors, and submits URL plus token", () => {
  ...
  it("honors a one-tap socket query and token fragment, then removes both", () => {
    ...
    expect(screen.getByLabelText("Token")).toHaveValue("one-tap");
    expect(window.location.href).not.toContain("one-tap");
  });
});
