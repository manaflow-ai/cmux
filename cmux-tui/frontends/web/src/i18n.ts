const messages = {
  en: {
    ...
    foreignSizeGeneric: "shared size {cols}x{rows} (smallest client)",
    foreignSizeNamed: "shared size {cols}x{rows}, limited by {name}",
  ...
  ja: {
    ...
    foreignSizeGeneric: "共有サイズ {cols}x{rows}（最小のクライアント）",
    foreignSizeNamed: "共有サイズ {cols}x{rows}（{name} に合わせています）",
    backToLive: "ライブ表示に戻る",
