...
| `keys.clear-history` | chord string or array or `"none"` | `"cmd+k"` | Clear retained PTY history; prompt-aware shells also clear visible prior output while preserving the edit buffer |
