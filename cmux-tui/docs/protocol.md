...
```json
{"id":1,"cmd":"identify"}
{"id":1,"ok":true,"data":{"app":"cmux-tui","version":"...","protocol":10,"capabilities":["attach-initial-size","surface-subscribe-filter","workspace-registry-v1","viewport-splits-v1","viewport-column-resize-v1","layout-undo-v1","provider-managed-workspace-authority-v2"],"session":"main","pid":12345}}
```
