...
The remote TUI requires protocol v8. It refuses servers reporting any other protocol version because it relies on Zellij stack layouts, resized attach replays, and authoritative title events.
