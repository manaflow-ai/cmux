...
```json
{"id":1,"cmd":"identify"}
{"id":1,"ok":true,"data":{"app":"cmux-tui","version":"...","protocol":10,"capabilities":["attach-initial-size","workspace-registry-v1","clear-history-v1","clear-history-key-v1","surface-subscribe-filter","provider-managed-workspace-authority-v2","server-shutdown-v1"],"session":"main","pid":12345}}
```
...
Remote transports require protocol v10 but do not require the same release build. They reject protocol-v9 servers before loading their workspace tree because v9 client-sizing requests do not identify the terminal surface they affect.
