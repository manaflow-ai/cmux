...
Audit base: aggregate-final at `2b0e717d63` (`fix(python): preserve caller
cancellation after cleanup`). This document records explicit user requests found in local
...
| ID | Explicit ask and evidence | Status at `2b0e717d63` | Acceptance test |
| --- | --- | --- | --- |
