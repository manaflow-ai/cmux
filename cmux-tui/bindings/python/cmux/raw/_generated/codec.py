...
MODEL_BY_PATH = {
    ...
    'types/LayoutColumn': models.LayoutColumn,
    ...
    'types/PlacementResult': models.PlacementResult,
    ...
    'types/ViewportSplit': models.ViewportSplit,
    ...
    'commands/merge-pane/request': models.MergePaneRequest,
    'commands/mint-terminal-renderer/request': models.MintTerminalRendererRequest,
    'commands/move-pane-to-new-column/request': models.MovePaneToNewColumnRequest,
    'commands/move-pane-to-split/request': models.MovePaneToSplitRequest,
    'commands/move-tab/request': models.MoveTabRequest,
    'commands/move-tab-to-new-column/request': models.MoveTabToNewColumnRequest,
    'commands/move-tab-to-split/request': models.MoveTabToSplitRequest,
