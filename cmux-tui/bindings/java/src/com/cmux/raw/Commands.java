...
public final class Commands {
    ...
    public static final CommandMetadata MACHINE_STATS = new CommandMetadata("machine-stats", Authority.CONTROL, 12, "machine-stats-v1", StreamKind.NONE, Map.of(), Map.of());
