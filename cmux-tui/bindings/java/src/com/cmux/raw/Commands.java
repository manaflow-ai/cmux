...
public final class Commands {
    ...
    public static final CommandMetadata MACHINE_STATS = new CommandMetadata("machine-stats", Authority.CONTROL, 12, "machine-stats-v1", StreamKind.SUBSCRIBE, Map.of(), Map.of());
    ...
    public static final CommandMetadata SERVER_STATS = new CommandMetadata("server-stats", Authority.LOCAL_ADMIN, 12, "server-stats-v1", StreamKind.SUBSCRIBE, Map.of(), Map.of());
    ...
    static {
        ...
        values.put("machine-stats", MACHINE_STATS);
