...
// Mux protocol 10; IR SHA-256 5afbe7598cbcb1563fd25b609b193d01ace4cb9e3e68fbe7f44ea2c51e58eb28.
...
func TestGeneratedSchemaPresenceRoundTrips(t *testing.T) {
	...
	t.Run("Screen.Columns", func(t *testing.T) {
		var missing Screen
		...
		if missing.Columns != nil {
			t.Fatal("Columns did not preserve absence")
		}
		assertGeneratedFieldJSON(t, missing, "columns", false, "")
		var nullValue Screen
		if err := json.Unmarshal([]byte("{\"active\":true,\"active_pane\":1,\"id\":1,\"layout\":{\"pane\":1,\"type\":\"leaf\"},\"name\":null,\"panes\":[],\"zoomed_pane\":null,\"columns\":null}"), &nullValue); err == nil {
			t.Fatal("non-nullable field columns accepted null")
		}
		var presentValue Screen
		if err := json.Unmarshal([]byte("{\"active\":true,\"active_pane\":1,\"id\":1,\"layout\":{\"pane\":1,\"type\":\"leaf\"},\"name\":null,\"panes\":[],\"zoomed_pane\":null,\"columns\":[]}"), &presentValue); err != nil {
			t.Fatal(err)
		}
		if presentValue.Columns == nil {
			t.Fatal("Columns lost its value")
		}
		assertGeneratedFieldJSON(t, presentValue, "columns", true, "[]")
	})
	...
	t.Run("Screen.ViewportBaseWidth", func(t *testing.T) {
		var missing Screen
		if err := json.Unmarshal([]byte("{\"active\":true,\"active_pane\":1,\"id\":1,\"layout\":{\"pane\":1,\"type\":\"leaf\"},\"name\":null,\"panes\":[],\"zoomed_pane\":null}"), &missing); err != nil {
			t.Fatal(err)
		}
		if missing.ViewportBaseWidth != nil {
			t.Fatal("ViewportBaseWidth did not preserve absence")
		}
		assertGeneratedFieldJSON(t, missing, "viewport_base_width", false, "")
		var nullValue Screen
		if err := json.Unmarshal([]byte("{\"active\":true,\"active_pane\":1,\"id\":1,\"layout\":{\"pane\":1,\"type\":\"leaf\"},\"name\":null,\"panes\":[],\"zoomed_pane\":null,\"viewport_base_width\":null}"), &nullValue); err == nil {
			t.Fatal("non-nullable field viewport_base_width accepted null")
		}
		var presentValue Screen
		if err := json.Unmarshal([]byte("{\"active\":true,\"active_pane\":1,\"id\":1,\"layout\":{\"pane\":1,\"type\":\"leaf\"},\"name\":null,\"panes\":[],\"zoomed_pane\":null,\"viewport_base_width\":1.5}"), &presentValue); err != nil {
			t.Fatal(err)
		}
		if presentValue.ViewportBaseWidth == nil {
			t.Fatal("ViewportBaseWidth lost its value")
		}
		assertGeneratedFieldJSON(t, presentValue, "viewport_base_width", true, "1.5")
	})
	t.Run("Screen.ViewportSplits", func(t *testing.T) {
		var missing Screen
		if err := json.Unmarshal([]byte("{\"active\":true,\"active_pane\":1,\"id\":1,\"layout\":{\"pane\":1,\"type\":\"leaf\"},\"name\":null,\"panes\":[],\"zoomed_pane\":null}"), &missing); err != nil {
			t.Fatal(err)
		}
		if missing.ViewportSplits != nil {
			t.Fatal("ViewportSplits did not preserve absence")
		}
		assertGeneratedFieldJSON(t, missing, "viewport_splits", false, "")
		var nullValue Screen
		if err := json.Unmarshal([]byte("{\"active\":true,\"active_pane\":1,\"id\":1,\"layout\":{\"pane\":1,\"type\":\"leaf\"},\"name\":null,\"panes\":[],\"zoomed_pane\":null,\"viewport_splits\":null}"), &nullValue); err == nil {
			t.Fatal("non-nullable field viewport_splits accepted null")
		}
		var presentValue Screen
		if err := json.Unmarshal([]byte("{\"active\":true,\"active_pane\":1,\"id\":1,\"layout\":{\"pane\":1,\"type\":\"leaf\"},\"name\":null,\"panes\":[],\"zoomed_pane\":null,\"viewport_splits\":[]}"), &presentValue); err != nil {
			t.Fatal(err)
		}
		if presentValue.ViewportSplits == nil {
			t.Fatal("ViewportSplits lost its value")
		}
		assertGeneratedFieldJSON(t, presentValue, "viewport_splits", true, "[]")
	})
	...
	t.Run("SurfaceResult.Pane", func(t *testing.T) {
		...
		if err := json.Unmarshal([]byte("{\"surface\":1,\"pane\":null}"), &nullValue); err == nil {
			t.Fatal("non-nullable field pane accepted null")
		}
		var presentValue SurfaceResult
		if err := json.Unmarshal([]byte("{\"surface\":1,\"pane\":1}"), &presentValue); err != nil {
			t.Fatal(err)
		}
		if presentValue.Pane == nil {
			t.Fatal("Pane lost its value")
		}
		assertGeneratedFieldJSON(t, presentValue, "pane", true, "1")
	})
	t.Run("SurfaceResult.Screen", func(t *testing.T) {
		var missing SurfaceResult
		if err := json.Unmarshal([]byte("{\"surface\":1}"), &missing); err != nil {
			t.Fatal(err)
		}
		if missing.Screen != nil {
			t.Fatal("Screen did not preserve absence")
		}
		assertGeneratedFieldJSON(t, missing, "screen", false, "")
		var nullValue SurfaceResult
		if err := json.Unmarshal([]byte("{\"surface\":1,\"screen\":null}"), &nullValue); err == nil {
			t.Fatal("non-nullable field screen accepted null")
		}
		var presentValue SurfaceResult
		if err := json.Unmarshal([]byte("{\"surface\":1,\"screen\":1}"), &presentValue); err != nil {
			t.Fatal(err)
		}
		if presentValue.Screen == nil {
			t.Fatal("Screen lost its value")
		}
		assertGeneratedFieldJSON(t, presentValue, "screen", true, "1")
	})
	...
	t.Run("SurfaceResult.Workspace", func(t *testing.T) {
		var missing SurfaceResult
		if err := json.Unmarshal([]byte("{\"surface\":1}"), &missing); err != nil {
			t.Fatal(err)
		}
		if missing.Workspace != nil {
			t.Fatal("Workspace did not preserve absence")
		}
		assertGeneratedFieldJSON(t, missing, "workspace", false, "")
		var nullValue SurfaceResult
		if err := json.Unmarshal([]byte("{\"surface\":1,\"workspace\":null}"), &nullValue); err == nil {
			t.Fatal("non-nullable field workspace accepted null")
		}
		var presentValue SurfaceResult
		if err := json.Unmarshal([]byte("{\"surface\":1,\"workspace\":1}"), &presentValue); err != nil {
			t.Fatal(err)
		}
		if presentValue.Workspace == nil {
			t.Fatal("Workspace lost its value")
		}
		assertGeneratedFieldJSON(t, presentValue, "workspace", true, "1")
	})
	...
	t.Run("Tab.TabResourceID", func(t *testing.T) {
		var missing Tab
		if err := json.Unmarshal([]byte("{\"browser_source\":null,\"dead\":true,\"kind\":\"pty\",\"name\":null,\"size\":null,\"surface\":1,\"title\":\"value\"}"), &missing); err != nil {
			t.Fatal(err)
		}
		if !missing.TabResourceID.IsAbsent() {
			t.Fatal("TabResourceID did not preserve absence")
		}
		assertGeneratedFieldJSON(t, missing, "tab_resource_id", false, "")
		var nullValue Tab
		if err := json.Unmarshal([]byte("{\"browser_source\":null,\"dead\":true,\"kind\":\"pty\",\"name\":null,\"size\":null,\"surface\":1,\"title\":\"value\",\"tab_resource_id\":null}"), &nullValue); err != nil {
			t.Fatal(err)
		}
		if !nullValue.TabResourceID.IsNull() {
			t.Fatal("TabResourceID did not preserve null")
		}
		assertGeneratedFieldJSON(t, nullValue, "tab_resource_id", true, "null")
		var presentValue Tab
		if err := json.Unmarshal([]byte("{\"browser_source\":null,\"dead\":true,\"kind\":\"pty\",\"name\":null,\"size\":null,\"surface\":1,\"title\":\"value\",\"tab_resource_id\":\"value\"}"), &presentValue); err != nil {
			t.Fatal(err)
		}
		if _, ok := presentValue.TabResourceID.Get(); !ok {
			t.Fatal("TabResourceID did not preserve a value")
		}
		assertGeneratedFieldJSON(t, presentValue, "tab_resource_id", true, "\"value\"")
	})
	...
	t.Run("Tab.URL", func(t *testing.T) {
		var missing Tab
		if err := json.Unmarshal([]byte("{\"browser_source\":null,\"dead\":true,\"kind\":\"pty\",\"name\":null,\"size\":null,\"surface\":1,\"title\":\"value\"}"), &missing); err != nil {
			t.Fatal(err)
		}
		...
		var nullValue Tab
		if err := json.Unmarshal([]byte("{\"browser_source\":null,\"dead\":true,\"kind\":\"pty\",\"name\":null,\"size\":null,\"surface\":1,\"title\":\"value\",\"url\":null}"), &nullValue); err != nil {
			t.Fatal(err)
		}
		...
		var presentValue Tab
		if err := json.Unmarshal([]byte("{\"browser_source\":null,\"dead\":true,\"kind\":\"pty\",\"name\":null,\"size\":null,\"surface\":1,\"title\":\"value\",\"url\":\"value\"}"), &presentValue); err != nil {
			t.Fatal(err)
		}
	...
	t.Run("CreateTerminalRequest.Activate", func(t *testing.T) {
		var missing CreateTerminalRequest
		if err := json.Unmarshal([]byte("{}"), &missing); err != nil {
			t.Fatal(err)
		}
		if !missing.Activate.IsAbsent() {
			t.Fatal("Activate did not preserve absence")
		}
		assertGeneratedFieldJSON(t, missing, "activate", false, "")
		var nullValue CreateTerminalRequest
		if err := json.Unmarshal([]byte("{\"activate\":null}"), &nullValue); err != nil {
			t.Fatal(err)
		}
		if !nullValue.Activate.IsNull() {
			t.Fatal("Activate did not preserve null")
		}
		assertGeneratedFieldJSON(t, nullValue, "activate", true, "null")
		var presentValue CreateTerminalRequest
		if err := json.Unmarshal([]byte("{\"activate\":true}"), &presentValue); err != nil {
			t.Fatal(err)
		}
		if _, ok := presentValue.Activate.Get(); !ok {
			t.Fatal("Activate did not preserve a value")
		}
		assertGeneratedFieldJSON(t, presentValue, "activate", true, "true")
	})
	...
	t.Run("CreateTerminalRequest.Pane", func(t *testing.T) {
		var missing CreateTerminalRequest
		if err := json.Unmarshal([]byte("{}"), &missing); err != nil {
			t.Fatal(err)
		}
	...
	t.Run("CreateTerminalOptions.Activate", func(t *testing.T) {
	...
	t.Run("CreateTerminalOptions.Pane", func(t *testing.T) {
		var missing CreateTerminalOptions
		if err := json.Unmarshal([]byte("{}"), &missing); err != nil {
			t.Fatal(err)
		}
	...
	t.Run("CreateWorkspaceRequest.Activate", func(t *testing.T) {
	...
	t.Run("CreateWorkspaceOptions.Activate", func(t *testing.T) {
	...
	t.Run("MergePaneRequest.Activate", func(t *testing.T) {
		var missing MergePaneRequest
		if err := json.Unmarshal([]byte("{\"index\":1,\"pane\":1,\"target\":1}"), &missing); err != nil {
			t.Fatal(err)
		}
		if !missing.Activate.IsAbsent() {
			t.Fatal("Activate did not preserve absence")
		...
		assertGeneratedFieldJSON(t, missing, "activate", false, "")
		var nullValue MergePaneRequest
		if err := json.Unmarshal([]byte("{\"index\":1,\"pane\":1,\"target\":1,\"activate\":null}"), &nullValue); err != nil {
			t.Fatal(err)
		}
		if !nullValue.Activate.IsNull() {
			t.Fatal("Activate did not preserve null")
		...
		assertGeneratedFieldJSON(t, nullValue, "activate", true, "null")
		var presentValue MergePaneRequest
		if err := json.Unmarshal([]byte("{\"index\":1,\"pane\":1,\"target\":1,\"activate\":true}"), &presentValue); err != nil {
			t.Fatal(err)
		}
		if _, ok := presentValue.Activate.Get(); !ok {
			t.Fatal("Activate did not preserve a value")
	...
	t.Run("MergePaneOptions.Activate", func(t *testing.T) {
		var missing MergePaneOptions
		if err := json.Unmarshal([]byte("{}"), &missing); err != nil {
			t.Fatal(err)
		}
		if !missing.Activate.IsAbsent() {
		...
		assertGeneratedFieldJSON(t, missing, "activate", false, "")
		var nullValue MergePaneOptions
		if err := json.Unmarshal([]byte("{\"activate\":null}"), &nullValue); err != nil {
			t.Fatal(err)
		}
		if !nullValue.Activate.IsNull() {
		...
		assertGeneratedFieldJSON(t, nullValue, "activate", true, "null")
		var presentValue MergePaneOptions
		if err := json.Unmarshal([]byte("{\"activate\":true}"), &presentValue); err != nil {
			t.Fatal(err)
		}
		if _, ok := presentValue.Activate.Get(); !ok {
	...
	t.Run("MovePaneToNewColumnRequest.Activate", func(t *testing.T) {
		var missing MovePaneToNewColumnRequest
		if err := json.Unmarshal([]byte("{\"index\":1,\"pane\":1,\"width\":1.5}"), &missing); err != nil {
			t.Fatal(err)
		}
		if !missing.Activate.IsAbsent() {
			t.Fatal("Activate did not preserve absence")
		...
		assertGeneratedFieldJSON(t, missing, "activate", false, "")
		var nullValue MovePaneToNewColumnRequest
		if err := json.Unmarshal([]byte("{\"index\":1,\"pane\":1,\"width\":1.5,\"activate\":null}"), &nullValue); err != nil {
			t.Fatal(err)
		}
		if !nullValue.Activate.IsNull() {
			t.Fatal("Activate did not preserve null")
		...
		assertGeneratedFieldJSON(t, nullValue, "activate", true, "null")
		var presentValue MovePaneToNewColumnRequest
		if err := json.Unmarshal([]byte("{\"index\":1,\"pane\":1,\"width\":1.5,\"activate\":true}"), &presentValue); err != nil {
			t.Fatal(err)
		}
		if _, ok := presentValue.Activate.Get(); !ok {
			t.Fatal("Activate did not preserve a value")
	...
	t.Run("MovePaneToNewColumnOptions.Activate", func(t *testing.T) {
		var missing MovePaneToNewColumnOptions
		if err := json.Unmarshal([]byte("{}"), &missing); err != nil {
			t.Fatal(err)
		}
		if !missing.Activate.IsAbsent() {
		...
		assertGeneratedFieldJSON(t, missing, "activate", false, "")
		var nullValue MovePaneToNewColumnOptions
		if err := json.Unmarshal([]byte("{\"activate\":null}"), &nullValue); err != nil {
			t.Fatal(err)
		}
		if !nullValue.Activate.IsNull() {
		...
		assertGeneratedFieldJSON(t, nullValue, "activate", true, "null")
		var presentValue MovePaneToNewColumnOptions
		if err := json.Unmarshal([]byte("{\"activate\":true}"), &presentValue); err != nil {
			t.Fatal(err)
		}
		if _, ok := presentValue.Activate.Get(); !ok {
	...
	t.Run("MovePaneToSplitRequest.Activate", func(t *testing.T) {
		var missing MovePaneToSplitRequest
		if err := json.Unmarshal([]byte("{\"dir\":\"right\",\"pane\":1,\"target\":1}"), &missing); err != nil {
			t.Fatal(err)
		}
		if !missing.Activate.IsAbsent() {
			t.Fatal("Activate did not preserve absence")
		...
		assertGeneratedFieldJSON(t, missing, "activate", false, "")
		var nullValue MovePaneToSplitRequest
		if err := json.Unmarshal([]byte("{\"dir\":\"right\",\"pane\":1,\"target\":1,\"activate\":null}"), &nullValue); err != nil {
			t.Fatal(err)
		}
		if !nullValue.Activate.IsNull() {
			t.Fatal("Activate did not preserve null")
		...
		assertGeneratedFieldJSON(t, nullValue, "activate", true, "null")
		var presentValue MovePaneToSplitRequest
		if err := json.Unmarshal([]byte("{\"dir\":\"right\",\"pane\":1,\"target\":1,\"activate\":true}"), &presentValue); err != nil {
			t.Fatal(err)
		}
		if _, ok := presentValue.Activate.Get(); !ok {
			t.Fatal("Activate did not preserve a value")
	...
	t.Run("MovePaneToSplitRequest.InsertFirst", func(t *testing.T) {
		var missing MovePaneToSplitRequest
		if err := json.Unmarshal([]byte("{\"dir\":\"right\",\"pane\":1,\"target\":1}"), &missing); err != nil {
			t.Fatal(err)
		}
		if missing.InsertFirst != nil {
			t.Fatal("InsertFirst did not preserve absence")
		}
		assertGeneratedFieldJSON(t, missing, "insert_first", false, "")
		var nullValue MovePaneToSplitRequest
		if err := json.Unmarshal([]byte("{\"dir\":\"right\",\"pane\":1,\"target\":1,\"insert_first\":null}"), &nullValue); err == nil {
			t.Fatal("non-nullable field insert_first accepted null")
		}
		var presentValue MovePaneToSplitRequest
		if err := json.Unmarshal([]byte("{\"dir\":\"right\",\"pane\":1,\"target\":1,\"insert_first\":true}"), &presentValue); err != nil {
			t.Fatal(err)
		}
		if presentValue.InsertFirst == nil {
			t.Fatal("InsertFirst lost its value")
		}
		assertGeneratedFieldJSON(t, presentValue, "insert_first", true, "true")
	})
	t.Run("MovePaneToSplitOptions.Activate", func(t *testing.T) {
		var missing MovePaneToSplitOptions
		if err := json.Unmarshal([]byte("{}"), &missing); err != nil {
			t.Fatal(err)
		}
		if !missing.Activate.IsAbsent() {
		...
		assertGeneratedFieldJSON(t, missing, "activate", false, "")
		var nullValue MovePaneToSplitOptions
		if err := json.Unmarshal([]byte("{\"activate\":null}"), &nullValue); err != nil {
			t.Fatal(err)
		}
		if !nullValue.Activate.IsNull() {
		...
		assertGeneratedFieldJSON(t, nullValue, "activate", true, "null")
		var presentValue MovePaneToSplitOptions
		if err := json.Unmarshal([]byte("{\"activate\":true}"), &presentValue); err != nil {
			t.Fatal(err)
		}
		if _, ok := presentValue.Activate.Get(); !ok {
	...
	t.Run("MovePaneToSplitOptions.InsertFirst", func(t *testing.T) {
		var missing MovePaneToSplitOptions
		if err := json.Unmarshal([]byte("{}"), &missing); err != nil {
			t.Fatal(err)
		}
		...
		assertGeneratedFieldJSON(t, missing, "insert_first", false, "")
		var nullValue MovePaneToSplitOptions
		if err := json.Unmarshal([]byte("{\"insert_first\":null}"), &nullValue); err == nil {
			t.Fatal("non-nullable field insert_first accepted null")
		}
		var presentValue MovePaneToSplitOptions
		if err := json.Unmarshal([]byte("{\"insert_first\":true}"), &presentValue); err != nil {
			t.Fatal(err)
		}
		if presentValue.InsertFirst == nil {
			t.Fatal("InsertFirst lost its value")
	...
	t.Run("MoveTabRequest.Activate", func(t *testing.T) {
		var missing MoveTabRequest
		if err := json.Unmarshal([]byte("{\"index\":1,\"pane\":1,\"surface\":1}"), &missing); err != nil {
			t.Fatal(err)
		}
		if !missing.Activate.IsAbsent() {
			t.Fatal("Activate did not preserve absence")
		...
		assertGeneratedFieldJSON(t, missing, "activate", false, "")
		var nullValue MoveTabRequest
		if err := json.Unmarshal([]byte("{\"index\":1,\"pane\":1,\"surface\":1,\"activate\":null}"), &nullValue); err != nil {
			t.Fatal(err)
		}
		if !nullValue.Activate.IsNull() {
			t.Fatal("Activate did not preserve null")
		...
		assertGeneratedFieldJSON(t, nullValue, "activate", true, "null")
		var presentValue MoveTabRequest
		if err := json.Unmarshal([]byte("{\"index\":1,\"pane\":1,\"surface\":1,\"activate\":true}"), &presentValue); err != nil {
			t.Fatal(err)
		}
		if _, ok := presentValue.Activate.Get(); !ok {
			t.Fatal("Activate did not preserve a value")
	...
	t.Run("MoveTabOptions.Activate", func(t *testing.T) {
		var missing MoveTabOptions
		if err := json.Unmarshal([]byte("{}"), &missing); err != nil {
			t.Fatal(err)
		}
		if !missing.Activate.IsAbsent() {
		...
		assertGeneratedFieldJSON(t, nullValue, "activate", true, "null")
		var presentValue MoveTabOptions
		if err := json.Unmarshal([]byte("{\"activate\":true}"), &presentValue); err != nil {
			t.Fatal(err)
		}
		if _, ok := presentValue.Activate.Get(); !ok {
	...
	t.Run("MoveTabToNewColumnRequest.Activate", func(t *testing.T) {
		var missing MoveTabToNewColumnRequest
		if err := json.Unmarshal([]byte("{\"index\":1,\"surface\":1,\"width\":1.5}"), &missing); err != nil {
			t.Fatal(err)
		}
		if !missing.Activate.IsAbsent() {
			t.Fatal("Activate did not preserve absence")
		...
		assertGeneratedFieldJSON(t, missing, "activate", false, "")
		var nullValue MoveTabToNewColumnRequest
		if err := json.Unmarshal([]byte("{\"index\":1,\"surface\":1,\"width\":1.5,\"activate\":null}"), &nullValue); err != nil {
			t.Fatal(err)
		}
		if !nullValue.Activate.IsNull() {
			t.Fatal("Activate did not preserve null")
		...
		assertGeneratedFieldJSON(t, nullValue, "activate", true, "null")
		var presentValue MoveTabToNewColumnRequest
		if err := json.Unmarshal([]byte("{\"index\":1,\"surface\":1,\"width\":1.5,\"activate\":true}"), &presentValue); err != nil {
			t.Fatal(err)
		}
		if _, ok := presentValue.Activate.Get(); !ok {
			t.Fatal("Activate did not preserve a value")
	...
	t.Run("MoveTabToNewColumnOptions.Activate", func(t *testing.T) {
		var missing MoveTabToNewColumnOptions
		if err := json.Unmarshal([]byte("{}"), &missing); err != nil {
			t.Fatal(err)
		}
		if !missing.Activate.IsAbsent() {
		...
		assertGeneratedFieldJSON(t, missing, "activate", false, "")
		var nullValue MoveTabToNewColumnOptions
		if err := json.Unmarshal([]byte("{\"activate\":null}"), &nullValue); err != nil {
			t.Fatal(err)
		}
		if !nullValue.Activate.IsNull() {
		...
		assertGeneratedFieldJSON(t, nullValue, "activate", true, "null")
		var presentValue MoveTabToNewColumnOptions
		if err := json.Unmarshal([]byte("{\"activate\":true}"), &presentValue); err != nil {
			t.Fatal(err)
		}
		if _, ok := presentValue.Activate.Get(); !ok {
	...
	t.Run("MoveTabToSplitRequest.Activate", func(t *testing.T) {
		var missing MoveTabToSplitRequest
		if err := json.Unmarshal([]byte("{\"dir\":\"right\",\"pane\":1,\"surface\":1}"), &missing); err != nil {
			t.Fatal(err)
		}
		if !missing.Activate.IsAbsent() {
			t.Fatal("Activate did not preserve absence")
		...
		assertGeneratedFieldJSON(t, missing, "activate", false, "")
		var nullValue MoveTabToSplitRequest
		if err := json.Unmarshal([]byte("{\"dir\":\"right\",\"pane\":1,\"surface\":1,\"activate\":null}"), &nullValue); err != nil {
			t.Fatal(err)
		}
		if !nullValue.Activate.IsNull() {
			t.Fatal("Activate did not preserve null")
		...
		assertGeneratedFieldJSON(t, nullValue, "activate", true, "null")
		var presentValue MoveTabToSplitRequest
		if err := json.Unmarshal([]byte("{\"dir\":\"right\",\"pane\":1,\"surface\":1,\"activate\":true}"), &presentValue); err != nil {
			t.Fatal(err)
		}
		if _, ok := presentValue.Activate.Get(); !ok {
			t.Fatal("Activate did not preserve a value")
	...
	t.Run("MoveTabToSplitRequest.InsertFirst", func(t *testing.T) {
		var missing MoveTabToSplitRequest
		if err := json.Unmarshal([]byte("{\"dir\":\"right\",\"pane\":1,\"surface\":1}"), &missing); err != nil {
			t.Fatal(err)
		}
		...
		assertGeneratedFieldJSON(t, missing, "insert_first", false, "")
		var nullValue MoveTabToSplitRequest
		if err := json.Unmarshal([]byte("{\"dir\":\"right\",\"pane\":1,\"surface\":1,\"insert_first\":null}"), &nullValue); err == nil {
			t.Fatal("non-nullable field insert_first accepted null")
		}
		var presentValue MoveTabToSplitRequest
		if err := json.Unmarshal([]byte("{\"dir\":\"right\",\"pane\":1,\"surface\":1,\"insert_first\":true}"), &presentValue); err != nil {
			t.Fatal(err)
		}
		if presentValue.InsertFirst == nil {
			t.Fatal("InsertFirst lost its value")
	...
	t.Run("MoveTabToSplitOptions.Activate", func(t *testing.T) {
		var missing MoveTabToSplitOptions
		if err := json.Unmarshal([]byte("{}"), &missing); err != nil {
			t.Fatal(err)
		}
		if !missing.Activate.IsAbsent() {
		...
		assertGeneratedFieldJSON(t, missing, "activate", false, "")
		var nullValue MoveTabToSplitOptions
		if err := json.Unmarshal([]byte("{\"activate\":null}"), &nullValue); err != nil {
			t.Fatal(err)
		}
		if !nullValue.Activate.IsNull() {
		...
		assertGeneratedFieldJSON(t, nullValue, "activate", true, "null")
		var presentValue MoveTabToSplitOptions
		if err := json.Unmarshal([]byte("{\"activate\":true}"), &presentValue); err != nil {
			t.Fatal(err)
		}
		if _, ok := presentValue.Activate.Get(); !ok {
	...
	t.Run("MoveTabToSplitOptions.InsertFirst", func(t *testing.T) {
		var missing MoveTabToSplitOptions
		if err := json.Unmarshal([]byte("{}"), &missing); err != nil {
			t.Fatal(err)
		}
	...
	t.Run("NewBrowserTabRequest.Activate", func(t *testing.T) {
		...
		if err := json.Unmarshal([]byte("{\"url\":\"value\",\"activate\":null}"), &nullValue); err != nil {
			t.Fatal(err)
		}
		if !nullValue.Activate.IsNull() {
			t.Fatal("Activate did not preserve null")
		...
		if err := json.Unmarshal([]byte("{\"url\":\"value\",\"activate\":true}"), &presentValue); err != nil {
			t.Fatal(err)
		}
		if _, ok := presentValue.Activate.Get(); !ok {
			t.Fatal("Activate did not preserve a value")
	...
	t.Run("NewBrowserTabRequest.Index", func(t *testing.T) {
		var missing NewBrowserTabRequest
		if err := json.Unmarshal([]byte("{\"url\":\"value\"}"), &missing); err != nil {
			t.Fatal(err)
		}
		...
		var nullValue NewBrowserTabRequest
		if err := json.Unmarshal([]byte("{\"url\":\"value\",\"index\":null}"), &nullValue); err != nil {
			t.Fatal(err)
		}
		...
		var presentValue NewBrowserTabRequest
		if err := json.Unmarshal([]byte("{\"url\":\"value\",\"index\":1}"), &presentValue); err != nil {
			t.Fatal(err)
		}
	...
	t.Run("NewBrowserTabOptions.Activate", func(t *testing.T) {
	...
	t.Run("NewBrowserTabOptions.Index", func(t *testing.T) {
		var missing NewBrowserTabOptions
		if err := json.Unmarshal([]byte("{}"), &missing); err != nil {
			t.Fatal(err)
		}
	...
	t.Run("NewPaneRequest.Activate", func(t *testing.T) {
		...
		if err := json.Unmarshal([]byte("{\"pane\":1,\"activate\":null}"), &nullValue); err != nil {
			t.Fatal(err)
		}
		if !nullValue.Activate.IsNull() {
			t.Fatal("Activate did not preserve null")
		...
		if err := json.Unmarshal([]byte("{\"pane\":1,\"activate\":true}"), &presentValue); err != nil {
			t.Fatal(err)
		}
		if _, ok := presentValue.Activate.Get(); !ok {
			t.Fatal("Activate did not preserve a value")
	...
	t.Run("NewPaneOptions.Activate", func(t *testing.T) {
	...
	t.Run("NewPaneRightRequest.Activate", func(t *testing.T) {
	...
	t.Run("NewPaneRightRequest.Kind", func(t *testing.T) {
		var missing NewPaneRightRequest
		if err := json.Unmarshal([]byte("{\"pane\":1}"), &missing); err != nil {
			t.Fatal(err)
		}
		...
		assertGeneratedFieldJSON(t, missing, "kind", false, "")
		var nullValue NewPaneRightRequest
		if err := json.Unmarshal([]byte("{\"pane\":1,\"kind\":null}"), &nullValue); err != nil {
			t.Fatal(err)
		}
		if !nullValue.Kind.IsNull() {
			t.Fatal("Kind did not preserve null")
		...
		assertGeneratedFieldJSON(t, nullValue, "kind", true, "null")
		var presentValue NewPaneRightRequest
		if err := json.Unmarshal([]byte("{\"pane\":1,\"kind\":\"pty\"}"), &presentValue); err != nil {
			t.Fatal(err)
		}
		if _, ok := presentValue.Kind.Get(); !ok {
			t.Fatal("Kind did not preserve a value")
		}
		assertGeneratedFieldJSON(t, presentValue, "kind", true, "\"pty\"")
	})
	...
	t.Run("NewPaneRightRequest.URL", func(t *testing.T) {
		var missing NewPaneRightRequest
		if err := json.Unmarshal([]byte("{\"pane\":1}"), &missing); err != nil {
			t.Fatal(err)
		}
		...
		assertGeneratedFieldJSON(t, missing, "url", false, "")
		var nullValue NewPaneRightRequest
		if err := json.Unmarshal([]byte("{\"pane\":1,\"url\":null}"), &nullValue); err != nil {
			t.Fatal(err)
		}
		if !nullValue.URL.IsNull() {
			t.Fatal("URL did not preserve null")
		...
		assertGeneratedFieldJSON(t, nullValue, "url", true, "null")
		var presentValue NewPaneRightRequest
		if err := json.Unmarshal([]byte("{\"pane\":1,\"url\":\"value\"}"), &presentValue); err != nil {
			t.Fatal(err)
		}
		if _, ok := presentValue.URL.Get(); !ok {
			t.Fatal("URL did not preserve a value")
	...
	t.Run("NewPaneRightOptions.Activate", func(t *testing.T) {
	...
	t.Run("NewPaneRightOptions.Kind", func(t *testing.T) {
		var missing NewPaneRightOptions
		if err := json.Unmarshal([]byte("{}"), &missing); err != nil {
			t.Fatal(err)
		}
		...
		assertGeneratedFieldJSON(t, nullValue, "kind", true, "null")
		var presentValue NewPaneRightOptions
		if err := json.Unmarshal([]byte("{\"kind\":\"pty\"}"), &presentValue); err != nil {
			t.Fatal(err)
		}
		if _, ok := presentValue.Kind.Get(); !ok {
			t.Fatal("Kind did not preserve a value")
	...
	t.Run("NewPaneRightOptions.URL", func(t *testing.T) {
		var missing NewPaneRightOptions
		if err := json.Unmarshal([]byte("{}"), &missing); err != nil {
			t.Fatal(err)
		}
	...
	t.Run("NewScreenRequest.Activate", func(t *testing.T) {
	...
	t.Run("NewScreenOptions.Activate", func(t *testing.T) {
	...
	t.Run("SplitRequest.Activate", func(t *testing.T) {
		...
		if err := json.Unmarshal([]byte("{\"dir\":\"right\",\"pane\":1,\"activate\":null}"), &nullValue); err != nil {
			t.Fatal(err)
		}
		if !nullValue.Activate.IsNull() {
			t.Fatal("Activate did not preserve null")
		...
		if err := json.Unmarshal([]byte("{\"dir\":\"right\",\"pane\":1,\"activate\":true}"), &presentValue); err != nil {
			t.Fatal(err)
		}
		if _, ok := presentValue.Activate.Get(); !ok {
			t.Fatal("Activate did not preserve a value")
	...
	t.Run("SplitRequest.Kind", func(t *testing.T) {
		var missing SplitRequest
		if err := json.Unmarshal([]byte("{\"dir\":\"right\",\"pane\":1}"), &missing); err != nil {
			t.Fatal(err)
		}
		...
		assertGeneratedFieldJSON(t, missing, "kind", false, "")
		var nullValue SplitRequest
		if err := json.Unmarshal([]byte("{\"dir\":\"right\",\"pane\":1,\"kind\":null}"), &nullValue); err != nil {
			t.Fatal(err)
		}
		if !nullValue.Kind.IsNull() {
			t.Fatal("Kind did not preserve null")
		...
		assertGeneratedFieldJSON(t, nullValue, "kind", true, "null")
		var presentValue SplitRequest
		if err := json.Unmarshal([]byte("{\"dir\":\"right\",\"pane\":1,\"kind\":\"pty\"}"), &presentValue); err != nil {
			t.Fatal(err)
		}
		if _, ok := presentValue.Kind.Get(); !ok {
			t.Fatal("Kind did not preserve a value")
	...
	t.Run("SplitRequest.URL", func(t *testing.T) {
		var missing SplitRequest
		if err := json.Unmarshal([]byte("{\"dir\":\"right\",\"pane\":1}"), &missing); err != nil {
			t.Fatal(err)
		}
		...
		assertGeneratedFieldJSON(t, missing, "url", false, "")
		var nullValue SplitRequest
		if err := json.Unmarshal([]byte("{\"dir\":\"right\",\"pane\":1,\"url\":null}"), &nullValue); err != nil {
			t.Fatal(err)
		}
		if !nullValue.URL.IsNull() {
			t.Fatal("URL did not preserve null")
		...
		assertGeneratedFieldJSON(t, nullValue, "url", true, "null")
		var presentValue SplitRequest
		if err := json.Unmarshal([]byte("{\"dir\":\"right\",\"pane\":1,\"url\":\"value\"}"), &presentValue); err != nil {
			t.Fatal(err)
		}
		if _, ok := presentValue.URL.Get(); !ok {
			t.Fatal("URL did not preserve a value")
	...
	t.Run("SplitOptions.Activate", func(t *testing.T) {
	...
	t.Run("SplitOptions.Kind", func(t *testing.T) {
		var missing SplitOptions
		if err := json.Unmarshal([]byte("{}"), &missing); err != nil {
			t.Fatal(err)
		}
	...
	t.Run("SplitOptions.URL", func(t *testing.T) {
		var missing SplitOptions
		if err := json.Unmarshal([]byte("{}"), &missing); err != nil {
			t.Fatal(err)
		}
...
func TestGeneratedRequiredFieldsRejectOmission(t *testing.T) {
	...
	t.Run("LayoutColumn.ID", func(t *testing.T) {
		var decoded LayoutColumn
		if err := json.Unmarshal([]byte("{\"layout\":{\"pane\":1,\"type\":\"leaf\"},\"width\":1.5}"), &decoded); err == nil {
			t.Fatal("missing required field id decoded successfully")
		}
	})
	t.Run("LayoutColumn.Layout", func(t *testing.T) {
		var decoded LayoutColumn
		if err := json.Unmarshal([]byte("{\"id\":1,\"width\":1.5}"), &decoded); err == nil {
			t.Fatal("missing required field layout decoded successfully")
		}
	})
	t.Run("LayoutColumn.Width", func(t *testing.T) {
		var decoded LayoutColumn
		if err := json.Unmarshal([]byte("{\"id\":1,\"layout\":{\"pane\":1,\"type\":\"leaf\"}}"), &decoded); err == nil {
			t.Fatal("missing required field width decoded successfully")
		}
	})
	...
	t.Run("PlacementResult.Pane", func(t *testing.T) {
		var decoded PlacementResult
		if err := json.Unmarshal([]byte("{\"screen\":1,\"surface\":1,\"workspace\":1}"), &decoded); err == nil {
			t.Fatal("missing required field pane decoded successfully")
		}
	})
	t.Run("PlacementResult.Screen", func(t *testing.T) {
		var decoded PlacementResult
		if err := json.Unmarshal([]byte("{\"pane\":1,\"surface\":1,\"workspace\":1}"), &decoded); err == nil {
			t.Fatal("missing required field screen decoded successfully")
		}
	})
	t.Run("PlacementResult.Surface", func(t *testing.T) {
		var decoded PlacementResult
		if err := json.Unmarshal([]byte("{\"pane\":1,\"screen\":1,\"workspace\":1}"), &decoded); err == nil {
			t.Fatal("missing required field surface decoded successfully")
		}
	})
	t.Run("PlacementResult.Workspace", func(t *testing.T) {
		var decoded PlacementResult
		if err := json.Unmarshal([]byte("{\"pane\":1,\"screen\":1,\"surface\":1}"), &decoded); err == nil {
			t.Fatal("missing required field workspace decoded successfully")
		}
	})
	t.Run("ProcessInfoResult.Command", func(t *testing.T) {
	...
	t.Run("ViewportSplit.Split", func(t *testing.T) {
		var decoded ViewportSplit
		if err := json.Unmarshal([]byte("{\"width\":1.5}"), &decoded); err == nil {
			t.Fatal("missing required field split decoded successfully")
		}
	})
	t.Run("ViewportSplit.Width", func(t *testing.T) {
		var decoded ViewportSplit
	...
	t.Run("MergePaneRequest.Index", func(t *testing.T) {
		var decoded MergePaneRequest
		if err := json.Unmarshal([]byte("{\"pane\":1,\"target\":1}"), &decoded); err == nil {
			t.Fatal("missing required field index decoded successfully")
		}
	})
	t.Run("MergePaneRequest.Pane", func(t *testing.T) {
		var decoded MergePaneRequest
		if err := json.Unmarshal([]byte("{\"index\":1,\"target\":1}"), &decoded); err == nil {
			t.Fatal("missing required field pane decoded successfully")
		}
	})
	t.Run("MergePaneRequest.Target", func(t *testing.T) {
		var decoded MergePaneRequest
	...
	t.Run("MovePaneToNewColumnRequest.Index", func(t *testing.T) {
		var decoded MovePaneToNewColumnRequest
		if err := json.Unmarshal([]byte("{\"pane\":1,\"width\":1.5}"), &decoded); err == nil {
			t.Fatal("missing required field index decoded successfully")
		}
	})
	t.Run("MovePaneToNewColumnRequest.Pane", func(t *testing.T) {
		var decoded MovePaneToNewColumnRequest
		if err := json.Unmarshal([]byte("{\"index\":1,\"width\":1.5}"), &decoded); err == nil {
			t.Fatal("missing required field pane decoded successfully")
		}
	})
	t.Run("MovePaneToNewColumnRequest.Width", func(t *testing.T) {
		var decoded MovePaneToNewColumnRequest
		if err := json.Unmarshal([]byte("{\"index\":1,\"pane\":1}"), &decoded); err == nil {
			t.Fatal("missing required field width decoded successfully")
		}
	})
	t.Run("MovePaneToSplitRequest.Dir", func(t *testing.T) {
		var decoded MovePaneToSplitRequest
		if err := json.Unmarshal([]byte("{\"pane\":1,\"target\":1}"), &decoded); err == nil {
			t.Fatal("missing required field dir decoded successfully")
		}
	})
	t.Run("MovePaneToSplitRequest.Pane", func(t *testing.T) {
		var decoded MovePaneToSplitRequest
		if err := json.Unmarshal([]byte("{\"dir\":\"right\",\"target\":1}"), &decoded); err == nil {
			t.Fatal("missing required field pane decoded successfully")
		}
	})
	t.Run("MovePaneToSplitRequest.Target", func(t *testing.T) {
		var decoded MovePaneToSplitRequest
	...
	t.Run("MoveTabToNewColumnRequest.Index", func(t *testing.T) {
		var decoded MoveTabToNewColumnRequest
		if err := json.Unmarshal([]byte("{\"surface\":1,\"width\":1.5}"), &decoded); err == nil {
			t.Fatal("missing required field index decoded successfully")
		}
	})
	t.Run("MoveTabToNewColumnRequest.Surface", func(t *testing.T) {
		var decoded MoveTabToNewColumnRequest
		if err := json.Unmarshal([]byte("{\"index\":1,\"width\":1.5}"), &decoded); err == nil {
			t.Fatal("missing required field surface decoded successfully")
		}
	})
	t.Run("MoveTabToNewColumnRequest.Width", func(t *testing.T) {
		var decoded MoveTabToNewColumnRequest
		if err := json.Unmarshal([]byte("{\"index\":1,\"surface\":1}"), &decoded); err == nil {
			t.Fatal("missing required field width decoded successfully")
		}
	})
	t.Run("MoveTabToSplitRequest.Dir", func(t *testing.T) {
		var decoded MoveTabToSplitRequest
		if err := json.Unmarshal([]byte("{\"pane\":1,\"surface\":1}"), &decoded); err == nil {
			t.Fatal("missing required field dir decoded successfully")
		}
	})
	t.Run("MoveTabToSplitRequest.Pane", func(t *testing.T) {
		var decoded MoveTabToSplitRequest
		if err := json.Unmarshal([]byte("{\"dir\":\"right\",\"surface\":1}"), &decoded); err == nil {
			t.Fatal("missing required field pane decoded successfully")
		}
	})
	t.Run("MoveTabToSplitRequest.Surface", func(t *testing.T) {
		var decoded MoveTabToSplitRequest
		if err := json.Unmarshal([]byte("{\"dir\":\"right\",\"pane\":1}"), &decoded); err == nil {
			t.Fatal("missing required field surface decoded successfully")
		}
...
func TestGeneratedRequiredNonnullableFieldsRejectNull(t *testing.T) {
	...
	t.Run("LayoutColumn.ID", func(t *testing.T) {
		var decoded LayoutColumn
		if err := json.Unmarshal([]byte("{\"id\":null,\"layout\":{\"pane\":1,\"type\":\"leaf\"},\"width\":1.5}"), &decoded); err == nil {
			t.Fatal("required non-nullable field id accepted null")
		}
	})
	t.Run("LayoutColumn.Layout", func(t *testing.T) {
		var decoded LayoutColumn
		if err := json.Unmarshal([]byte("{\"id\":1,\"layout\":null,\"width\":1.5}"), &decoded); err == nil {
			t.Fatal("required non-nullable field layout accepted null")
		}
	})
	t.Run("LayoutColumn.Width", func(t *testing.T) {
		var decoded LayoutColumn
		if err := json.Unmarshal([]byte("{\"id\":1,\"layout\":{\"pane\":1,\"type\":\"leaf\"},\"width\":null}"), &decoded); err == nil {
			t.Fatal("required non-nullable field width accepted null")
		}
	})
	t.Run("LayoutUndoConfirmationRequired.ClosesPanes", func(t *testing.T) {
	...
	t.Run("PlacementResult.Pane", func(t *testing.T) {
		var decoded PlacementResult
		if err := json.Unmarshal([]byte("{\"pane\":null,\"screen\":1,\"surface\":1,\"workspace\":1}"), &decoded); err == nil {
			t.Fatal("required non-nullable field pane accepted null")
		}
	})
	t.Run("PlacementResult.Screen", func(t *testing.T) {
		var decoded PlacementResult
		if err := json.Unmarshal([]byte("{\"pane\":1,\"screen\":null,\"surface\":1,\"workspace\":1}"), &decoded); err == nil {
			t.Fatal("required non-nullable field screen accepted null")
		}
	})
	t.Run("PlacementResult.Surface", func(t *testing.T) {
		var decoded PlacementResult
		if err := json.Unmarshal([]byte("{\"pane\":1,\"screen\":1,\"surface\":null,\"workspace\":1}"), &decoded); err == nil {
			t.Fatal("required non-nullable field surface accepted null")
		}
	})
	t.Run("PlacementResult.Workspace", func(t *testing.T) {
		var decoded PlacementResult
		if err := json.Unmarshal([]byte("{\"pane\":1,\"screen\":1,\"surface\":1,\"workspace\":null}"), &decoded); err == nil {
	...
	t.Run("ViewportSplit.Split", func(t *testing.T) {
		var decoded ViewportSplit
		if err := json.Unmarshal([]byte("{\"split\":null,\"width\":1.5}"), &decoded); err == nil {
			t.Fatal("required non-nullable field split accepted null")
		}
	})
	t.Run("ViewportSplit.Width", func(t *testing.T) {
		var decoded ViewportSplit
		if err := json.Unmarshal([]byte("{\"split\":1,\"width\":null}"), &decoded); err == nil {
			t.Fatal("required non-nullable field width accepted null")
		}
	})
	t.Run("VTStateResult.Cols", func(t *testing.T) {
	...
	t.Run("MergePaneRequest.Index", func(t *testing.T) {
		var decoded MergePaneRequest
		if err := json.Unmarshal([]byte("{\"index\":null,\"pane\":1,\"target\":1}"), &decoded); err == nil {
			t.Fatal("required non-nullable field index accepted null")
		}
	})
	t.Run("MergePaneRequest.Pane", func(t *testing.T) {
		var decoded MergePaneRequest
		if err := json.Unmarshal([]byte("{\"index\":1,\"pane\":null,\"target\":1}"), &decoded); err == nil {
			t.Fatal("required non-nullable field pane accepted null")
		}
	})
	t.Run("MergePaneRequest.Target", func(t *testing.T) {
		var decoded MergePaneRequest
		if err := json.Unmarshal([]byte("{\"index\":1,\"pane\":1,\"target\":null}"), &decoded); err == nil {
	...
	t.Run("MovePaneToNewColumnRequest.Index", func(t *testing.T) {
		var decoded MovePaneToNewColumnRequest
		if err := json.Unmarshal([]byte("{\"index\":null,\"pane\":1,\"width\":1.5}"), &decoded); err == nil {
			t.Fatal("required non-nullable field index accepted null")
		}
	})
	t.Run("MovePaneToNewColumnRequest.Pane", func(t *testing.T) {
		var decoded MovePaneToNewColumnRequest
		if err := json.Unmarshal([]byte("{\"index\":1,\"pane\":null,\"width\":1.5}"), &decoded); err == nil {
			t.Fatal("required non-nullable field pane accepted null")
		}
	})
	t.Run("MovePaneToNewColumnRequest.Width", func(t *testing.T) {
		var decoded MovePaneToNewColumnRequest
		if err := json.Unmarshal([]byte("{\"index\":1,\"pane\":1,\"width\":null}"), &decoded); err == nil {
			t.Fatal("required non-nullable field width accepted null")
		}
	})
	t.Run("MovePaneToSplitRequest.Dir", func(t *testing.T) {
		var decoded MovePaneToSplitRequest
		if err := json.Unmarshal([]byte("{\"dir\":null,\"pane\":1,\"target\":1}"), &decoded); err == nil {
			t.Fatal("required non-nullable field dir accepted null")
		}
	})
	t.Run("MovePaneToSplitRequest.Pane", func(t *testing.T) {
		var decoded MovePaneToSplitRequest
		if err := json.Unmarshal([]byte("{\"dir\":\"right\",\"pane\":null,\"target\":1}"), &decoded); err == nil {
			t.Fatal("required non-nullable field pane accepted null")
		}
	})
	t.Run("MovePaneToSplitRequest.Target", func(t *testing.T) {
		var decoded MovePaneToSplitRequest
		if err := json.Unmarshal([]byte("{\"dir\":\"right\",\"pane\":1,\"target\":null}"), &decoded); err == nil {
			t.Fatal("required non-nullable field target accepted null")
		}
	})
	t.Run("MoveTabRequest.Index", func(t *testing.T) {
	...
	t.Run("MoveTabToNewColumnRequest.Index", func(t *testing.T) {
		var decoded MoveTabToNewColumnRequest
		if err := json.Unmarshal([]byte("{\"index\":null,\"surface\":1,\"width\":1.5}"), &decoded); err == nil {
			t.Fatal("required non-nullable field index accepted null")
		}
	})
	t.Run("MoveTabToNewColumnRequest.Surface", func(t *testing.T) {
		var decoded MoveTabToNewColumnRequest
		if err := json.Unmarshal([]byte("{\"index\":1,\"surface\":null,\"width\":1.5}"), &decoded); err == nil {
			t.Fatal("required non-nullable field surface accepted null")
		}
	})
	t.Run("MoveTabToNewColumnRequest.Width", func(t *testing.T) {
		var decoded MoveTabToNewColumnRequest
		if err := json.Unmarshal([]byte("{\"index\":1,\"surface\":1,\"width\":null}"), &decoded); err == nil {
			t.Fatal("required non-nullable field width accepted null")
		}
	})
	t.Run("MoveTabToSplitRequest.Dir", func(t *testing.T) {
		var decoded MoveTabToSplitRequest
		if err := json.Unmarshal([]byte("{\"dir\":null,\"pane\":1,\"surface\":1}"), &decoded); err == nil {
			t.Fatal("required non-nullable field dir accepted null")
		}
	})
	t.Run("MoveTabToSplitRequest.Pane", func(t *testing.T) {
		var decoded MoveTabToSplitRequest
		if err := json.Unmarshal([]byte("{\"dir\":\"right\",\"pane\":null,\"surface\":1}"), &decoded); err == nil {
			t.Fatal("required non-nullable field pane accepted null")
		}
	})
	t.Run("MoveTabToSplitRequest.Surface", func(t *testing.T) {
		var decoded MoveTabToSplitRequest
		if err := json.Unmarshal([]byte("{\"dir\":\"right\",\"pane\":1,\"surface\":null}"), &decoded); err == nil {
			t.Fatal("required non-nullable field surface accepted null")
		}
	})
	t.Run("MoveTerminalRequest.TerminalID", func(t *testing.T) {
...
func TestGeneratedConstrainedFieldsRejectUnknownValues(t *testing.T) {
	...
	t.Run("MovePaneToSplitRequest.Dir", func(t *testing.T) {
		var decoded MovePaneToSplitRequest
		if err := json.Unmarshal([]byte("{\"dir\":\"__cmux_invalid__\",\"pane\":1,\"target\":1}"), &decoded); err == nil {
			t.Fatal("invalid constrained field dir decoded successfully")
		}
	})
	t.Run("MoveTabToSplitRequest.Dir", func(t *testing.T) {
		var decoded MoveTabToSplitRequest
		if err := json.Unmarshal([]byte("{\"dir\":\"__cmux_invalid__\",\"pane\":1,\"surface\":1}"), &decoded); err == nil {
			t.Fatal("invalid constrained field dir decoded successfully")
		}
	})
	t.Run("NewPaneRightRequest.Kind", func(t *testing.T) {
		var decoded NewPaneRightRequest
		if err := json.Unmarshal([]byte("{\"pane\":1,\"kind\":\"__cmux_invalid__\"}"), &decoded); err == nil {
			t.Fatal("invalid constrained field kind decoded successfully")
		}
	})
	t.Run("NewPaneRightOptions.Kind", func(t *testing.T) {
		var decoded NewPaneRightOptions
		if err := json.Unmarshal([]byte("{\"kind\":\"__cmux_invalid__\"}"), &decoded); err == nil {
			t.Fatal("invalid constrained field kind decoded successfully")
		}
	})
	...
	t.Run("SplitRequest.Kind", func(t *testing.T) {
		var decoded SplitRequest
		if err := json.Unmarshal([]byte("{\"dir\":\"right\",\"pane\":1,\"kind\":\"__cmux_invalid__\"}"), &decoded); err == nil {
			t.Fatal("invalid constrained field kind decoded successfully")
		}
	})
	t.Run("SplitOptions.Kind", func(t *testing.T) {
		var decoded SplitOptions
		if err := json.Unmarshal([]byte("{\"kind\":\"__cmux_invalid__\"}"), &decoded); err == nil {
			t.Fatal("invalid constrained field kind decoded successfully")
		}
	})
...
func TestGeneratedConstrainedFieldsRejectUnknownValuesOnMarshal(t *testing.T) {
	...
	t.Run("MovePaneToSplitRequest.Dir", func(t *testing.T) {
		var decoded MovePaneToSplitRequest
		if err := json.Unmarshal([]byte("{\"dir\":\"right\",\"pane\":1,\"target\":1}"), &decoded); err != nil {
			t.Fatal(err)
		}
		decoded.Dir = SplitDirection("__cmux_invalid__")
		if _, err := json.Marshal(decoded); err == nil {
	...
	t.Run("MoveTabToSplitRequest.Dir", func(t *testing.T) {
		var decoded MoveTabToSplitRequest
		if err := json.Unmarshal([]byte("{\"dir\":\"right\",\"pane\":1,\"surface\":1}"), &decoded); err != nil {
			t.Fatal(err)
		}
		decoded.Dir = SplitDirection("__cmux_invalid__")
		if _, err := json.Marshal(decoded); err == nil {
	...
	t.Run("NewPaneRightRequest.Kind", func(t *testing.T) {
		...
		decoded.Kind = Value(PaneKind("__cmux_invalid__"))
		if _, err := json.Marshal(decoded); err == nil {
			t.Fatal("invalid constrained field kind encoded successfully")
		}
	})
...
const (
	generatedFieldShapeCount               = 458
	generatedOptionalNullableFieldCount    = 327
	generatedRequiredNullableFieldCount    = 61
	generatedOptionalNonnullableFieldCount = 70
	generatedRequiredFieldCount            = 571
	generatedRequiredNonnullableFieldCount = 510
	generatedConstrainedFieldCount         = 76
	generatedEncodedConstrainedFieldCount  = 76
)
