...
type MachineStats struct {
	CpuPercent    RequiredNullable[float64] `json:"-"`
	Cpus          uint32                    `json:"cpus"`
	DiskPath      string                    `json:"disk_path"`
	DiskTotalMb   RequiredNullable[uint64]  `json:"-"`
	DiskUsedMb    RequiredNullable[uint64]  `json:"-"`
...
func (value MachineStats) MarshalJSON() ([]byte, error) {
	type wire MachineStats
	encoded, err := json.Marshal(wire(value))
	if err != nil {
		return nil, err
	}
	...
	if !value.CpuPercent.IsSet() {
		return nil, fmt.Errorf("encode MachineStats: required nullable field cpu_percent is missing")
	}
	if value.CpuPercent.IsNull() {
		object["cpu_percent"] = json.RawMessage("null")
	} else {
		fieldValue, _ := value.CpuPercent.Get()
		encodedField, err := json.Marshal(fieldValue)
		if err != nil {
			return nil, fmt.Errorf("encode MachineStats.CpuPercent: %w", err)
		}
		object["cpu_percent"] = encodedField
	}
	if !value.DiskTotalMb.IsSet() {
		return nil, fmt.Errorf("encode MachineStats: required nullable field disk_total_mb is missing")
	}
	if value.DiskTotalMb.IsNull() {
		object["disk_total_mb"] = json.RawMessage("null")
	} else {
		fieldValue, _ := value.DiskTotalMb.Get()
		encodedField, err := json.Marshal(fieldValue)
		if err != nil {
			return nil, fmt.Errorf("encode MachineStats.DiskTotalMb: %w", err)
		}
		object["disk_total_mb"] = encodedField
	}
	if !value.DiskUsedMb.IsSet() {
		return nil, fmt.Errorf("encode MachineStats: required nullable field disk_used_mb is missing")
	}
	if value.DiskUsedMb.IsNull() {
		object["disk_used_mb"] = json.RawMessage("null")
	} else {
		fieldValue, _ := value.DiskUsedMb.Get()
		encodedField, err := json.Marshal(fieldValue)
		if err != nil {
			return nil, fmt.Errorf("encode MachineStats.DiskUsedMb: %w", err)
		}
		object["disk_used_mb"] = encodedField
	}
	return json.Marshal(object)
}

func (value *MachineStats) UnmarshalJSON(data []byte) error {
	if !isJSONObject(data) {
		return fmt.Errorf("decode MachineStats: expected object")
	}
	var fields struct {
		CpuPercent    RequiredNullable[float64] `json:"cpu_percent"`
		Cpus          *uint32                   `json:"cpus"`
		DiskPath      *string                   `json:"disk_path"`
		DiskTotalMb   RequiredNullable[uint64]  `json:"disk_total_mb"`
		DiskUsedMb    RequiredNullable[uint64]  `json:"disk_used_mb"`
		LoadAverage1m *float64                  `json:"load_average_1m"`
		MemoryTotalMb *uint64                   `json:"memory_total_mb"`
		MemoryUsedMb  *uint64                   `json:"memory_used_mb"`
		SampledAtMs   *uint64                   `json:"sampled_at_ms"`
	...
	if err := json.Unmarshal(data, &fields); err != nil {
		return fmt.Errorf("decode MachineStats: %w", err)
	}
	type wire MachineStats
	var decoded wire
	if !fields.CpuPercent.IsSet() {
		return fmt.Errorf("decode MachineStats: required field cpu_percent is missing")
	}
	decoded.CpuPercent = fields.CpuPercent
	if fields.Cpus == nil {
		return fmt.Errorf("decode MachineStats: required field cpus is missing or null")
	}
	decoded.Cpus = *fields.Cpus
	if fields.DiskPath == nil {
		return fmt.Errorf("decode MachineStats: required field disk_path is missing or null")
	}
	decoded.DiskPath = *fields.DiskPath
	if !fields.DiskTotalMb.IsSet() {
		return fmt.Errorf("decode MachineStats: required field disk_total_mb is missing")
	}
	decoded.DiskTotalMb = fields.DiskTotalMb
	if !fields.DiskUsedMb.IsSet() {
		return fmt.Errorf("decode MachineStats: required field disk_used_mb is missing")
	}
	decoded.DiskUsedMb = fields.DiskUsedMb
	if fields.LoadAverage1m == nil {
		return fmt.Errorf("decode MachineStats: required field load_average_1m is missing or null")
	}
	decoded.LoadAverage1m = *fields.LoadAverage1m
	if fields.MemoryTotalMb == nil {
		return fmt.Errorf("decode MachineStats: required field memory_total_mb is missing or null")
	}
	decoded.MemoryTotalMb = *fields.MemoryTotalMb
	if fields.MemoryUsedMb == nil {
		return fmt.Errorf("decode MachineStats: required field memory_used_mb is missing or null")
	}
	decoded.MemoryUsedMb = *fields.MemoryUsedMb
	if fields.SampledAtMs == nil {
		return fmt.Errorf("decode MachineStats: required field sampled_at_ms is missing or null")
	}
	decoded.SampledAtMs = *fields.SampledAtMs
	*value = MachineStats(decoded)
	return nil
}

type MachineStatsResult struct {
	Stats RequiredNullable[MachineStats] `json:"-"`
}

func (value MachineStatsResult) MarshalJSON() ([]byte, error) {
	type wire MachineStatsResult
	encoded, err := json.Marshal(wire(value))
	if err != nil {
		return nil, err
	}
	...
	if !value.Stats.IsSet() {
		return nil, fmt.Errorf("encode MachineStatsResult: required nullable field stats is missing")
	}
	if value.Stats.IsNull() {
		object["stats"] = json.RawMessage("null")
	} else {
		fieldValue, _ := value.Stats.Get()
		encodedField, err := json.Marshal(fieldValue)
		if err != nil {
			return nil, fmt.Errorf("encode MachineStatsResult.Stats: %w", err)
		}
		object["stats"] = encodedField
	}
	return json.Marshal(object)
}

func (value *MachineStatsResult) UnmarshalJSON(data []byte) error {
	if !isJSONObject(data) {
		return fmt.Errorf("decode MachineStatsResult: expected object")
	}
	var fields struct {
		Stats RequiredNullable[MachineStats] `json:"stats"`
	}
	if err := json.Unmarshal(data, &fields); err != nil {
		return fmt.Errorf("decode MachineStatsResult: %w", err)
	}
	type wire MachineStatsResult
	var decoded wire
	if !fields.Stats.IsSet() {
		return fmt.Errorf("decode MachineStatsResult: required field stats is missing")
	}
	decoded.Stats = fields.Stats
	*value = MachineStatsResult(decoded)
	return nil
}
