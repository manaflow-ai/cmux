...
func (value *LayoutColumn) UnmarshalJSON(data []byte) error {
	if !isJSONObject(data) {
		return fmt.Errorf("decode LayoutColumn: expected object")
	}
	var fields struct {
		ID     *ID      `json:"id"`
		Layout *Layout  `json:"layout"`
	...
	if err := json.Unmarshal(data, &fields); err != nil {
		return fmt.Errorf("decode LayoutColumn: %w", err)
	}
	type wire LayoutColumn
	var decoded wire
	if fields.ID == nil {
		return fmt.Errorf("decode LayoutColumn: required field id is missing or null")
	}
	decoded.ID = *fields.ID
	if fields.Layout == nil {
		return fmt.Errorf("decode LayoutColumn: required field layout is missing or null")
	}
	decoded.Layout = *fields.Layout
	if fields.Width == nil {
		return fmt.Errorf("decode LayoutColumn: required field width is missing or null")
	}
	decoded.Width = *fields.Width
	*value = LayoutColumn(decoded)
	return nil
}
...
type MoveTabResult struct {
	Value any             `json:"-"`
	Raw   json.RawMessage `json:"-"`
}

func (value *MoveTabResult) UnmarshalJSON(data []byte) error {
	value.Raw = append(value.Raw[:0], data...)
	var fields map[string]json.RawMessage
	if err := decodeJSON(data, &fields); err != nil {
		return err
...
func (value MoveTabResult) MarshalJSON() ([]byte, error) {
	if value.Value != nil {
		return json.Marshal(value.Value)
	}
	if value.Raw != nil {
...
func (value MoveTabResult) AsPlacementResult() (PlacementResult, bool) {
	decoded, ok := value.Value.(PlacementResult)
	return decoded, ok
}

func (value MoveTabResult) AsEmptyResult() (EmptyResult, bool) {
	decoded, ok := value.Value.(EmptyResult)
	return decoded, ok
}
...
const (
	PaneKindPTY     PaneKind = "pty"
	PaneKindBrowser PaneKind = "browser"
)

func (value PaneKind) valid() bool {
	switch value {
	case PaneKindPTY, PaneKindBrowser:
		return true
	default:
		return false
	}
...
func (value PaneKind) MarshalJSON() ([]byte, error) {
	if !value.valid() {
		return nil, fmt.Errorf("%s has invalid value %v", "PaneKind", value)
	}
	return json.Marshal(string(value))
}

func (value *PaneKind) UnmarshalJSON(data []byte) error {
	var decoded string
	if err := json.Unmarshal(data, &decoded); err != nil {
		return err
	}
	candidate := PaneKind(decoded)
	if !candidate.valid() {
		return fmt.Errorf("%s has invalid value %v", "PaneKind", decoded)
	}
	*value = candidate
	return nil
}
...
func (value *PlacementResult) UnmarshalJSON(data []byte) error {
	if !isJSONObject(data) {
		return fmt.Errorf("decode PlacementResult: expected object")
	}
	var fields struct {
		Pane      *ID `json:"pane"`
		Screen    *ID `json:"screen"`
	...
	if err := json.Unmarshal(data, &fields); err != nil {
		return fmt.Errorf("decode PlacementResult: %w", err)
	}
	type wire PlacementResult
	var decoded wire
	if fields.Pane == nil {
		return fmt.Errorf("decode PlacementResult: required field pane is missing or null")
	}
	decoded.Pane = *fields.Pane
	if fields.Screen == nil {
		return fmt.Errorf("decode PlacementResult: required field screen is missing or null")
	}
	decoded.Screen = *fields.Screen
	if fields.Surface == nil {
		return fmt.Errorf("decode PlacementResult: required field surface is missing or null")
	}
	decoded.Surface = *fields.Surface
	if fields.Workspace == nil {
		return fmt.Errorf("decode PlacementResult: required field workspace is missing or null")
	}
	decoded.Workspace = *fields.Workspace
	*value = PlacementResult(decoded)
	return nil
}
...
func (value *Screen) UnmarshalJSON(data []byte) error {
	...
	var fields struct {
		Active            *bool                                `json:"active"`
		ActivePane        *ID                                  `json:"active_pane"`
		Columns           optionalNonNullJSON[[]LayoutColumn]  `json:"columns"`
		ID                *ID                                  `json:"id"`
		Layout            *Layout                              `json:"layout"`
		Name              RequiredNullable[string]             `json:"name"`
		Panes             *[]Pane                              `json:"panes"`
		ShortID           optionalNonNullJSON[string]          `json:"short_id"`
		ViewportBaseWidth optionalNonNullJSON[float32]         `json:"viewport_base_width"`
		ViewportSplits    optionalNonNullJSON[[]ViewportSplit] `json:"viewport_splits"`
	...
	if fields.Columns.null {
		return fmt.Errorf("decode Screen: non-nullable field columns is null")
	}
	if fields.Columns.set {
		decoded.Columns = &fields.Columns.value
	}
	if fields.ID == nil {
	...
	if fields.ViewportBaseWidth.null {
		return fmt.Errorf("decode Screen: non-nullable field viewport_base_width is null")
	}
	if fields.ViewportBaseWidth.set {
		decoded.ViewportBaseWidth = &fields.ViewportBaseWidth.value
	}
	if fields.ViewportSplits.null {
		return fmt.Errorf("decode Screen: non-nullable field viewport_splits is null")
	}
	if fields.ViewportSplits.set {
		decoded.ViewportSplits = &fields.ViewportSplits.value
	}
...
func (value *SurfaceResult) UnmarshalJSON(data []byte) error {
	...
	var fields struct {
		Pane                optionalNonNullJSON[ID] `json:"pane"`
		Screen              optionalNonNullJSON[ID] `json:"screen"`
		Surface             *ID                     `json:"surface"`
		TerminalID          Presence[string]        `json:"terminal_id"`
		TerminalIncarnation Presence[string]        `json:"terminal_incarnation"`
		Workspace           optionalNonNullJSON[ID] `json:"workspace"`
	}
	if err := json.Unmarshal(data, &fields); err != nil {
	...
	var decoded wire
	if fields.Pane.null {
		return fmt.Errorf("decode SurfaceResult: non-nullable field pane is null")
	}
	if fields.Pane.set {
		decoded.Pane = &fields.Pane.value
	}
	if fields.Screen.null {
		return fmt.Errorf("decode SurfaceResult: non-nullable field screen is null")
	}
	if fields.Screen.set {
		decoded.Screen = &fields.Screen.value
	}
	if fields.Surface == nil {
	...
	decoded.TerminalID = fields.TerminalID
	decoded.TerminalIncarnation = fields.TerminalIncarnation
	if fields.Workspace.null {
		return fmt.Errorf("decode SurfaceResult: non-nullable field workspace is null")
	}
	if fields.Workspace.set {
		decoded.Workspace = &fields.Workspace.value
	}
...
type Tab struct {
	...
	Surface                         ID                                 `json:"surface"`
	TabResourceID                   Presence[string]                   `json:"-"`
	TerminalID                      Presence[string]                   `json:"-"`
	TerminalIncarnation             Presence[string]                   `json:"-"`
...
func (value Tab) MarshalJSON() ([]byte, error) {
	...
	if value.TabResourceID.IsAbsent() {
		delete(object, "tab_resource_id")
	} else if value.TabResourceID.IsNull() {
		object["tab_resource_id"] = json.RawMessage("null")
	} else {
		fieldValue, _ := value.TabResourceID.Get()
		encodedField, err := json.Marshal(fieldValue)
		if err != nil {
			return nil, fmt.Errorf("encode Tab.TabResourceID: %w", err)
		}
		object["tab_resource_id"] = encodedField
	}
	if value.TerminalID.IsAbsent() {
		delete(object, "terminal_id")
	} else if value.TerminalID.IsNull() {
	...
	if value.URL.IsAbsent() {
		...
		encodedField, err := json.Marshal(fieldValue)
		if err != nil {
			return nil, fmt.Errorf("encode Tab.URL: %w", err)
		}
...
func (value *Tab) UnmarshalJSON(data []byte) error {
	...
	var fields struct {
		...
		Surface                         *ID                                `json:"surface"`
		TabResourceID                   Presence[string]                   `json:"tab_resource_id"`
		TerminalID                      Presence[string]                   `json:"terminal_id"`
		TerminalIncarnation             Presence[string]                   `json:"terminal_incarnation"`
	...
	decoded.Surface = *fields.Surface
	decoded.TabResourceID = fields.TabResourceID
	decoded.TerminalID = fields.TerminalID
	decoded.TerminalIncarnation = fields.TerminalIncarnation
...
func (value *ViewportSplit) UnmarshalJSON(data []byte) error {
	if !isJSONObject(data) {
		return fmt.Errorf("decode ViewportSplit: expected object")
	}
	var fields struct {
		Split *ID      `json:"split"`
		Width *float32 `json:"width"`
	...
	if err := json.Unmarshal(data, &fields); err != nil {
		return fmt.Errorf("decode ViewportSplit: %w", err)
	}
	type wire ViewportSplit
	var decoded wire
	if fields.Split == nil {
		return fmt.Errorf("decode ViewportSplit: required field split is missing or null")
	}
	decoded.Split = *fields.Split
	if fields.Width == nil {
		return fmt.Errorf("decode ViewportSplit: required field width is missing or null")
	}
	decoded.Width = *fields.Width
	*value = ViewportSplit(decoded)
	return nil
}
