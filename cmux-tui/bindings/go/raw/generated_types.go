...
func (value FrontendFocusTarget) valid() bool {
	switch value {
	case FrontendFocusTargetPane, FrontendFocusTargetMachineRail, FrontendFocusTargetWorkspaceRail:
		return true
	default:
		return false
	}
...
type ReceiptedSurfaceResult struct {
	Replayed bool `json:"replayed"`
	Surface  ID   `json:"surface"`
}

func (value *ReceiptedSurfaceResult) UnmarshalJSON(data []byte) error {
	if !isJSONObject(data) {
		return fmt.Errorf("decode ReceiptedSurfaceResult: expected object")
	}
	var fields struct {
		Replayed *bool `json:"replayed"`
		Surface  *ID   `json:"surface"`
	...
	if err := json.Unmarshal(data, &fields); err != nil {
		return fmt.Errorf("decode ReceiptedSurfaceResult: %w", err)
	}
	type wire ReceiptedSurfaceResult
	var decoded wire
	if fields.Replayed == nil {
		return fmt.Errorf("decode ReceiptedSurfaceResult: required field replayed is missing or null")
	}
	decoded.Replayed = *fields.Replayed
	if fields.Surface == nil {
		return fmt.Errorf("decode ReceiptedSurfaceResult: required field surface is missing or null")
	}
	decoded.Surface = *fields.Surface
	*value = ReceiptedSurfaceResult(decoded)
	return nil
}
...
type ViewReleaseResult struct {
	Outcome ViewAttachmentOutcome `json:"outcome"`
}

func (value *ViewReleaseResult) UnmarshalJSON(data []byte) error {
	if !isJSONObject(data) {
		return fmt.Errorf("decode ViewReleaseResult: expected object")
	}
	var fields struct {
		Outcome *ViewAttachmentOutcome `json:"outcome"`
	}
	if err := json.Unmarshal(data, &fields); err != nil {
		return fmt.Errorf("decode ViewReleaseResult: %w", err)
	}
	type wire ViewReleaseResult
	var decoded wire
	if fields.Outcome == nil {
		return fmt.Errorf("decode ViewReleaseResult: required field outcome is missing or null")
	}
	decoded.Outcome = *fields.Outcome
	*value = ViewReleaseResult(decoded)
	return nil
}

type ViewResizeResult struct {
	Accepted      bool                     `json:"accepted"`
	Outcome       ViewAttachmentOutcome    `json:"outcome"`
	ReservationID RequiredNullable[uint64] `json:"-"`
}

func (value ViewResizeResult) MarshalJSON() ([]byte, error) {
	type wire ViewResizeResult
	encoded, err := json.Marshal(wire(value))
	if err != nil {
		return nil, err
	}
	...
	if !value.ReservationID.IsSet() {
		return nil, fmt.Errorf("encode ViewResizeResult: required nullable field reservation_id is missing")
	}
	if value.ReservationID.IsNull() {
		object["reservation_id"] = json.RawMessage("null")
	} else {
		...
		encodedField, err := json.Marshal(fieldValue)
		if err != nil {
			return nil, fmt.Errorf("encode ViewResizeResult.ReservationID: %w", err)
		}
		object["reservation_id"] = encodedField
	}
	return json.Marshal(object)
...
func (value *ViewResizeResult) UnmarshalJSON(data []byte) error {
	if !isJSONObject(data) {
		return fmt.Errorf("decode ViewResizeResult: expected object")
	}
	var fields struct {
		Accepted      *bool                    `json:"accepted"`
		Outcome       *ViewAttachmentOutcome   `json:"outcome"`
	...
	if err := json.Unmarshal(data, &fields); err != nil {
		return fmt.Errorf("decode ViewResizeResult: %w", err)
	}
	type wire ViewResizeResult
	var decoded wire
	if fields.Accepted == nil {
		return fmt.Errorf("decode ViewResizeResult: required field accepted is missing or null")
	}
	decoded.Accepted = *fields.Accepted
	if fields.Outcome == nil {
		return fmt.Errorf("decode ViewResizeResult: required field outcome is missing or null")
	}
	decoded.Outcome = *fields.Outcome
	if !fields.ReservationID.IsSet() {
		return fmt.Errorf("decode ViewResizeResult: required field reservation_id is missing")
	}
	decoded.ReservationID = fields.ReservationID
	*value = ViewResizeResult(decoded)
	return nil
}
