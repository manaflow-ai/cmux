...
type PresenceAnchorCellKind string

const (
	PresenceAnchorCellKindCell PresenceAnchorCellKind = "cell"
)

func (value PresenceAnchorCellKind) valid() bool {
	switch value {
	case PresenceAnchorCellKindCell:
		return true
	default:
		return false
	}
...
func (value PresenceAnchorCellKind) MarshalJSON() ([]byte, error) {
	if !value.valid() {
		return nil, fmt.Errorf("%s has invalid value %v", "PresenceAnchorCellKind", value)
	}
	return json.Marshal(string(value))
}

func (value *PresenceAnchorCellKind) UnmarshalJSON(data []byte) error {
	var decoded string
	if err := json.Unmarshal(data, &decoded); err != nil {
		return err
	}
	candidate := PresenceAnchorCellKind(decoded)
	if !candidate.valid() {
		return fmt.Errorf("%s has invalid value %v", "PresenceAnchorCellKind", decoded)
	}
	*value = candidate
	return nil
}

type PresenceAnchorCell struct {
	Col          uint32                 `json:"col"`
	Kind         PresenceAnchorCellKind `json:"kind"`
	Row          uint32                 `json:"row"`
	ScrollOffset *uint64                `json:"scroll_offset,omitempty"`
}

func (value PresenceAnchorCell) MarshalJSON() ([]byte, error) {
	switch value.Kind {
	case "cell":
	default:
		return nil, fmt.Errorf("encode PresenceAnchorCell.Kind: invalid value %v", value.Kind)
	}
	type wire PresenceAnchorCell
	return json.Marshal(wire(value))
}

func (value *PresenceAnchorCell) UnmarshalJSON(data []byte) error {
	if !isJSONObject(data) {
		return fmt.Errorf("decode PresenceAnchorCell: expected object")
	}
	var fields struct {
		Col          *uint32                     `json:"col"`
		Kind         *PresenceAnchorCellKind     `json:"kind"`
	...
	if err := json.Unmarshal(data, &fields); err != nil {
		return fmt.Errorf("decode PresenceAnchorCell: %w", err)
	}
	type wire PresenceAnchorCell
	var decoded wire
	if fields.Col == nil {
		return fmt.Errorf("decode PresenceAnchorCell: required field col is missing or null")
	}
	decoded.Col = *fields.Col
	if fields.Kind == nil {
		return fmt.Errorf("decode PresenceAnchorCell: required field kind is missing or null")
	}
	decoded.Kind = *fields.Kind
	switch decoded.Kind {
	case "cell":
	default:
		return fmt.Errorf("decode PresenceAnchorCell.Kind: invalid value %v", decoded.Kind)
	}
	if fields.Row == nil {
		return fmt.Errorf("decode PresenceAnchorCell: required field row is missing or null")
	}
	decoded.Row = *fields.Row
	if fields.ScrollOffset.null {
		return fmt.Errorf("decode PresenceAnchorCell: non-nullable field scroll_offset is null")
	}
	if fields.ScrollOffset.set {
		decoded.ScrollOffset = &fields.ScrollOffset.value
	}
	*value = PresenceAnchorCell(decoded)
	return nil
}

type PresenceAnchorPointKind string

const (
	PresenceAnchorPointKindPoint PresenceAnchorPointKind = "point"
)

func (value PresenceAnchorPointKind) valid() bool {
	switch value {
	case PresenceAnchorPointKindPoint:
		return true
	default:
		return false
	}
...
func (value PresenceAnchorPointKind) MarshalJSON() ([]byte, error) {
	if !value.valid() {
		return nil, fmt.Errorf("%s has invalid value %v", "PresenceAnchorPointKind", value)
	}
	return json.Marshal(string(value))
}

func (value *PresenceAnchorPointKind) UnmarshalJSON(data []byte) error {
	var decoded string
	if err := json.Unmarshal(data, &decoded); err != nil {
		return err
	}
	candidate := PresenceAnchorPointKind(decoded)
	if !candidate.valid() {
		return fmt.Errorf("%s has invalid value %v", "PresenceAnchorPointKind", decoded)
	}
	*value = candidate
	return nil
}

type PresenceAnchorPoint struct {
	Kind PresenceAnchorPointKind `json:"kind"`
	X    float64                 `json:"x"`
	Y    float64                 `json:"y"`
}

func (value PresenceAnchorPoint) MarshalJSON() ([]byte, error) {
	switch value.Kind {
	case "point":
	default:
		return nil, fmt.Errorf("encode PresenceAnchorPoint.Kind: invalid value %v", value.Kind)
	}
	type wire PresenceAnchorPoint
	return json.Marshal(wire(value))
}

func (value *PresenceAnchorPoint) UnmarshalJSON(data []byte) error {
	if !isJSONObject(data) {
		return fmt.Errorf("decode PresenceAnchorPoint: expected object")
	}
	var fields struct {
		Kind *PresenceAnchorPointKind `json:"kind"`
		X    *float64                 `json:"x"`
	...
	if err := json.Unmarshal(data, &fields); err != nil {
		return fmt.Errorf("decode PresenceAnchorPoint: %w", err)
	}
	type wire PresenceAnchorPoint
	var decoded wire
	if fields.Kind == nil {
		return fmt.Errorf("decode PresenceAnchorPoint: required field kind is missing or null")
	}
	decoded.Kind = *fields.Kind
	switch decoded.Kind {
	case "point":
	default:
		return fmt.Errorf("decode PresenceAnchorPoint.Kind: invalid value %v", decoded.Kind)
	}
	if fields.X == nil {
		return fmt.Errorf("decode PresenceAnchorPoint: required field x is missing or null")
	}
	decoded.X = *fields.X
	if fields.Y == nil {
		return fmt.Errorf("decode PresenceAnchorPoint: required field y is missing or null")
	}
	decoded.Y = *fields.Y
	*value = PresenceAnchorPoint(decoded)
	return nil
}
...
func (value *PresenceAnchor) UnmarshalJSON(data []byte) error {
	var fields map[string]json.RawMessage
	if err := decodeJSON(data, &fields); err != nil {
		return err
	}
	rawTag, hasTag := fields["kind"]
	if !hasTag {
		return fmt.Errorf("decode PresenceAnchor: required field kind is missing")
	}
	if isJSONNull(rawTag) {
		return fmt.Errorf("decode PresenceAnchor: non-nullable field kind is null")
	}
	var decodedTag string
	if err := decodeJSON(rawTag, &decodedTag); err != nil {
		return fmt.Errorf("decode PresenceAnchor.Kind: %w", err)
	}
	value.Tag = decodedTag
	value.Raw = append(value.Raw[:0], data...)
	switch decodedTag {
	case "cell":
		var decoded PresenceAnchorCell
		if err := decodeJSON(data, &decoded); err != nil {
			return err
		}
		value.Value = decoded
	case "point":
		var decoded PresenceAnchorPoint
		if err := decodeJSON(data, &decoded); err != nil {
			return err
		}
		value.Value = decoded
...
func (value PresenceAnchor) MarshalJSON() ([]byte, error) {
	if value.Value == nil {
		if value.Raw != nil {
			return value.Raw, nil
		}
...
func NewPresenceAnchorCell(value PresenceAnchorCell) PresenceAnchor {
	value.Kind = PresenceAnchorCellKindCell
	return PresenceAnchor{Tag: "cell", Value: value}
}

func (value PresenceAnchor) AsCell() (PresenceAnchorCell, bool) {
	decoded, ok := value.Value.(PresenceAnchorCell)
	return decoded, ok
}

func NewPresenceAnchorPoint(value PresenceAnchorPoint) PresenceAnchor {
	value.Kind = PresenceAnchorPointKindPoint
	return PresenceAnchor{Tag: "point", Value: value}
}

func (value PresenceAnchor) AsPoint() (PresenceAnchorPoint, bool) {
	decoded, ok := value.Value.(PresenceAnchorPoint)
	return decoded, ok
}
...
type PresenceEntry struct {
	...
	Highlight   RequiredNullable[PresenceHighlight] `json:"-"`
	Kind        RequiredNullable[string]            `json:"-"`
	Name        RequiredNullable[string]            `json:"-"`
	Pointer     RequiredNullable[PresenceAnchor]    `json:"-"`
	Surface     RequiredNullable[ID]                `json:"-"`
	UpdatedAtMs uint64                              `json:"updated_at_ms"`
}

func (value PresenceEntry) MarshalJSON() ([]byte, error) {
	type wire PresenceEntry
	encoded, err := json.Marshal(wire(value))
	if err != nil {
		return nil, err
	}
	...
	if !value.Highlight.IsSet() {
		return nil, fmt.Errorf("encode PresenceEntry: required nullable field highlight is missing")
	}
	if value.Highlight.IsNull() {
		...
		encodedField, err := json.Marshal(fieldValue)
		if err != nil {
			return nil, fmt.Errorf("encode PresenceEntry.Highlight: %w", err)
		}
		object["highlight"] = encodedField
	}
	if !value.Kind.IsSet() {
		return nil, fmt.Errorf("encode PresenceEntry: required nullable field kind is missing")
	}
	if value.Kind.IsNull() {
		object["kind"] = json.RawMessage("null")
	} else {
		...
		encodedField, err := json.Marshal(fieldValue)
		if err != nil {
			return nil, fmt.Errorf("encode PresenceEntry.Kind: %w", err)
		}
		object["kind"] = encodedField
	}
	if !value.Name.IsSet() {
		return nil, fmt.Errorf("encode PresenceEntry: required nullable field name is missing")
	}
	if value.Name.IsNull() {
		object["name"] = json.RawMessage("null")
	} else {
		...
		encodedField, err := json.Marshal(fieldValue)
		if err != nil {
			return nil, fmt.Errorf("encode PresenceEntry.Name: %w", err)
		}
		object["name"] = encodedField
	}
	if !value.Pointer.IsSet() {
		return nil, fmt.Errorf("encode PresenceEntry: required nullable field pointer is missing")
	}
	if value.Pointer.IsNull() {
		object["pointer"] = json.RawMessage("null")
	} else {
		fieldValue, _ := value.Pointer.Get()
		encodedField, err := json.Marshal(fieldValue)
		if err != nil {
			return nil, fmt.Errorf("encode PresenceEntry.Pointer: %w", err)
		}
		object["pointer"] = encodedField
	}
	if !value.Surface.IsSet() {
		return nil, fmt.Errorf("encode PresenceEntry: required nullable field surface is missing")
	}
	if value.Surface.IsNull() {
		object["surface"] = json.RawMessage("null")
	} else {
		...
		encodedField, err := json.Marshal(fieldValue)
		if err != nil {
			return nil, fmt.Errorf("encode PresenceEntry.Surface: %w", err)
		}
		object["surface"] = encodedField
	}
	return json.Marshal(object)
...
func (value *PresenceEntry) UnmarshalJSON(data []byte) error {
	if !isJSONObject(data) {
		return fmt.Errorf("decode PresenceEntry: expected object")
	}
	var fields struct {
		Client      *uint64                             `json:"client"`
		Color       *uint64                             `json:"color"`
		Generation  *uint64                             `json:"generation"`
		Highlight   RequiredNullable[PresenceHighlight] `json:"highlight"`
		Kind        RequiredNullable[string]            `json:"kind"`
		Name        RequiredNullable[string]            `json:"name"`
		Pointer     RequiredNullable[PresenceAnchor]    `json:"pointer"`
		Surface     RequiredNullable[ID]                `json:"surface"`
		UpdatedAtMs *uint64                             `json:"updated_at_ms"`
	}
	if err := json.Unmarshal(data, &fields); err != nil {
		return fmt.Errorf("decode PresenceEntry: %w", err)
	}
	type wire PresenceEntry
	var decoded wire
	if fields.Client == nil {
		return fmt.Errorf("decode PresenceEntry: required field client is missing or null")
	}
	decoded.Client = *fields.Client
	if fields.Color == nil {
		return fmt.Errorf("decode PresenceEntry: required field color is missing or null")
	}
	decoded.Color = *fields.Color
	if fields.Generation == nil {
		return fmt.Errorf("decode PresenceEntry: required field generation is missing or null")
	}
	decoded.Generation = *fields.Generation
	if !fields.Highlight.IsSet() {
		return fmt.Errorf("decode PresenceEntry: required field highlight is missing")
	}
	decoded.Highlight = fields.Highlight
	if !fields.Kind.IsSet() {
		return fmt.Errorf("decode PresenceEntry: required field kind is missing")
	}
	decoded.Kind = fields.Kind
	if !fields.Name.IsSet() {
		return fmt.Errorf("decode PresenceEntry: required field name is missing")
	}
	decoded.Name = fields.Name
	if !fields.Pointer.IsSet() {
		return fmt.Errorf("decode PresenceEntry: required field pointer is missing")
	}
	decoded.Pointer = fields.Pointer
	if !fields.Surface.IsSet() {
		return fmt.Errorf("decode PresenceEntry: required field surface is missing")
	}
	decoded.Surface = fields.Surface
	if fields.UpdatedAtMs == nil {
		return fmt.Errorf("decode PresenceEntry: required field updated_at_ms is missing or null")
	}
	decoded.UpdatedAtMs = *fields.UpdatedAtMs
	*value = PresenceEntry(decoded)
	return nil
}

type PresenceHighlight struct {
	End   PresenceAnchor        `json:"end"`
	Mode  PresenceHighlightMode `json:"mode"`
	Start PresenceAnchor        `json:"start"`
}

func (value *PresenceHighlight) UnmarshalJSON(data []byte) error {
	if !isJSONObject(data) {
		return fmt.Errorf("decode PresenceHighlight: expected object")
	}
	var fields struct {
		End   *PresenceAnchor        `json:"end"`
		Mode  *PresenceHighlightMode `json:"mode"`
	...
	if err := json.Unmarshal(data, &fields); err != nil {
		return fmt.Errorf("decode PresenceHighlight: %w", err)
	}
	type wire PresenceHighlight
	var decoded wire
	if fields.End == nil {
		return fmt.Errorf("decode PresenceHighlight: required field end is missing or null")
	}
	decoded.End = *fields.End
	if fields.Mode == nil {
		return fmt.Errorf("decode PresenceHighlight: required field mode is missing or null")
	}
	decoded.Mode = *fields.Mode
	if fields.Start == nil {
		return fmt.Errorf("decode PresenceHighlight: required field start is missing or null")
	}
	decoded.Start = *fields.Start
	*value = PresenceHighlight(decoded)
	return nil
}

type PresenceHighlightMode string

const (
	PresenceHighlightModeLaser PresenceHighlightMode = "laser"
	PresenceHighlightModePin   PresenceHighlightMode = "pin"
)

func (value PresenceHighlightMode) valid() bool {
	switch value {
	case PresenceHighlightModeLaser, PresenceHighlightModePin:
		return true
	default:
		return false
	}
...
func (value PresenceHighlightMode) MarshalJSON() ([]byte, error) {
	if !value.valid() {
		return nil, fmt.Errorf("%s has invalid value %v", "PresenceHighlightMode", value)
	}
	return json.Marshal(string(value))
}

func (value *PresenceHighlightMode) UnmarshalJSON(data []byte) error {
	var decoded string
	if err := json.Unmarshal(data, &decoded); err != nil {
		return err
	}
	candidate := PresenceHighlightMode(decoded)
	if !candidate.valid() {
		return fmt.Errorf("%s has invalid value %v", "PresenceHighlightMode", decoded)
	}
	*value = candidate
	return nil
}
...
func (value *PresenceListResult) UnmarshalJSON(data []byte) error {
	if !isJSONObject(data) {
		return fmt.Errorf("decode PresenceListResult: expected object")
	}
	var fields struct {
		Entries *[]PresenceEntry `json:"entries"`
	}
	if err := json.Unmarshal(data, &fields); err != nil {
		return fmt.Errorf("decode PresenceListResult: %w", err)
	}
	type wire PresenceListResult
	var decoded wire
	if fields.Entries == nil {
		return fmt.Errorf("decode PresenceListResult: required field entries is missing or null")
	}
	decoded.Entries = *fields.Entries
	*value = PresenceListResult(decoded)
	return nil
}
