...
type ProcessInfoResult struct {
	...
	ForegroundCwd RequiredNullable[string] `json:"-"`
...
func (value ProcessInfoResult) MarshalJSON() ([]byte, error) {
	...
	if !value.ForegroundCwd.IsSet() {
		return nil, fmt.Errorf("encode ProcessInfoResult: required nullable field foreground_cwd is missing")
	}
	if value.ForegroundCwd.IsNull() {
...
func (value *ProcessInfoResult) UnmarshalJSON(data []byte) error {
	...
	var fields struct {
		...
		ForegroundCwd RequiredNullable[string] `json:"foreground_cwd"`
	...
	decoded.Cwd = fields.Cwd
	if !fields.ForegroundCwd.IsSet() {
		return fmt.Errorf("decode ProcessInfoResult: required field foreground_cwd is missing")
	}
