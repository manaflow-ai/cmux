...
// TerminalLifecycleEvent is emitted by protocol v12.
type TerminalLifecycleEvent struct {
	Cause               RequiredNullable[string]            `json:"-"`
	DiscardedInputBytes uint64                              `json:"discarded_input_bytes"`
	ElapsedMs           uint64                              `json:"elapsed_ms"`
	From                RequiredNullable[TerminalLifecycle] `json:"-"`
	RegistryTerminalID  string                              `json:"registry_terminal_id"`
	Surface             RequiredNullable[uint64]            `json:"-"`
	TerminalID          RequiredNullable[string]            `json:"-"`
	To                  TerminalLifecycle                   `json:"to"`
}

func (value TerminalLifecycleEvent) MarshalJSON() ([]byte, error) {
	type wire TerminalLifecycleEvent
	encoded, err := json.Marshal(wire(value))
	if err != nil {
		return nil, err
	}
	...
	if !value.Cause.IsSet() {
		return nil, fmt.Errorf("encode TerminalLifecycleEvent: required nullable field cause is missing")
	}
	if value.Cause.IsNull() {
		object["cause"] = json.RawMessage("null")
	} else {
		fieldValue, _ := value.Cause.Get()
		encodedField, err := json.Marshal(fieldValue)
		if err != nil {
			return nil, fmt.Errorf("encode TerminalLifecycleEvent.Cause: %w", err)
		}
		object["cause"] = encodedField
	}
	if !value.From.IsSet() {
		return nil, fmt.Errorf("encode TerminalLifecycleEvent: required nullable field from is missing")
	}
	if value.From.IsNull() {
		object["from"] = json.RawMessage("null")
	} else {
		fieldValue, _ := value.From.Get()
		encodedField, err := json.Marshal(fieldValue)
		if err != nil {
			return nil, fmt.Errorf("encode TerminalLifecycleEvent.From: %w", err)
		}
		object["from"] = encodedField
	}
	if !value.Surface.IsSet() {
		return nil, fmt.Errorf("encode TerminalLifecycleEvent: required nullable field surface is missing")
	}
	if value.Surface.IsNull() {
		object["surface"] = json.RawMessage("null")
	} else {
		...
		encodedField, err := json.Marshal(fieldValue)
		if err != nil {
			return nil, fmt.Errorf("encode TerminalLifecycleEvent.Surface: %w", err)
		}
		object["surface"] = encodedField
	}
	if !value.TerminalID.IsSet() {
		return nil, fmt.Errorf("encode TerminalLifecycleEvent: required nullable field terminal_id is missing")
	}
	if value.TerminalID.IsNull() {
		...
		encodedField, err := json.Marshal(fieldValue)
		if err != nil {
			return nil, fmt.Errorf("encode TerminalLifecycleEvent.TerminalID: %w", err)
		}
...
func (value *TerminalLifecycleEvent) UnmarshalJSON(data []byte) error {
	if !isJSONObject(data) {
		return fmt.Errorf("decode TerminalLifecycleEvent: expected object")
	}
	var fields struct {
		Cause               RequiredNullable[string]            `json:"cause"`
		DiscardedInputBytes *uint64                             `json:"discarded_input_bytes"`
		ElapsedMs           *uint64                             `json:"elapsed_ms"`
		From                RequiredNullable[TerminalLifecycle] `json:"from"`
		RegistryTerminalID  *string                             `json:"registry_terminal_id"`
		Surface             RequiredNullable[uint64]            `json:"surface"`
		TerminalID          RequiredNullable[string]            `json:"terminal_id"`
		To                  *TerminalLifecycle                  `json:"to"`
	}
	if err := json.Unmarshal(data, &fields); err != nil {
		return fmt.Errorf("decode TerminalLifecycleEvent: %w", err)
	}
	type wire TerminalLifecycleEvent
	var decoded wire
	if !fields.Cause.IsSet() {
		return fmt.Errorf("decode TerminalLifecycleEvent: required field cause is missing")
	}
	decoded.Cause = fields.Cause
	if fields.DiscardedInputBytes == nil {
		return fmt.Errorf("decode TerminalLifecycleEvent: required field discarded_input_bytes is missing or null")
	}
	decoded.DiscardedInputBytes = *fields.DiscardedInputBytes
	if fields.ElapsedMs == nil {
		return fmt.Errorf("decode TerminalLifecycleEvent: required field elapsed_ms is missing or null")
	}
	decoded.ElapsedMs = *fields.ElapsedMs
	if !fields.From.IsSet() {
		return fmt.Errorf("decode TerminalLifecycleEvent: required field from is missing")
	}
	decoded.From = fields.From
	if fields.RegistryTerminalID == nil {
		return fmt.Errorf("decode TerminalLifecycleEvent: required field registry_terminal_id is missing or null")
	}
	decoded.RegistryTerminalID = *fields.RegistryTerminalID
	if !fields.Surface.IsSet() {
		return fmt.Errorf("decode TerminalLifecycleEvent: required field surface is missing")
	}
	decoded.Surface = fields.Surface
	if !fields.TerminalID.IsSet() {
		return fmt.Errorf("decode TerminalLifecycleEvent: required field terminal_id is missing")
	}
	decoded.TerminalID = fields.TerminalID
	if fields.To == nil {
		return fmt.Errorf("decode TerminalLifecycleEvent: required field to is missing or null")
	}
	decoded.To = *fields.To
	*value = TerminalLifecycleEvent(decoded)
	return nil
}

func (TerminalLifecycleEvent) EventName() string { return "terminal-lifecycle" }
func (TerminalLifecycleEvent) isDeltaEvent()     {}
func (TerminalLifecycleEvent) isSubscribeEvent() {}
