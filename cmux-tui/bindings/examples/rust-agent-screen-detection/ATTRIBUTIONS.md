...
bounded traversal and `/proc` streaming, safer path candidates, and an explicit
Linux child-group fallback. Its strict Pi package-entrypoint check includes herdr's Windows fix
