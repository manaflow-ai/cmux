...
constexpr std::array<CommandFieldRequirement, 1> kCommand38FieldRequirements{{
...
constexpr std::array<CommandFieldRequirement, 5> kCommand46FieldRequirements{{
    {"expected_generation", 7U, ""},
    {"expected_revision", 7U, ""},
    {"key", 7U, "workspace-registry-v1"},
    {"mutation_id", 7U, ""},
...
constexpr std::array<CommandFieldRequirement, 3> kCommand49FieldRequirements{{
    {"activate", 10U, "independent-client-selection-v1"},
    {"kind", 10U, "independent-client-selection-v1"},
    {"url", 10U, "independent-client-selection-v1"},
}};
constexpr std::array<CommandFieldRequirement, 1> kCommand50FieldRequirements{{
    {"activate", 10U, "independent-client-selection-v1"},
}};
...
constexpr std::array<CommandMetadata, 96> kCommands{{
    ...
    {"merge-pane", "control", 10U, "canonical-layout-relocation-v1", false, "", "", std::span<const CommandFieldRequirement>(kCommand38FieldRequirements)},
    {"mint-terminal-renderer", "frontend", 9U, "", false, "", "", std::span<const CommandFieldRequirement>{}},
    {"move-pane-to-new-column", "control", 10U, "canonical-layout-relocation-v1", false, "", "", std::span<const CommandFieldRequirement>(kCommand40FieldRequirements)},
    {"move-pane-to-split", "control", 10U, "canonical-layout-relocation-v1", false, "", "", std::span<const CommandFieldRequirement>(kCommand41FieldRequirements)},
    {"move-tab", "control", 5U, "", false, "", "", std::span<const CommandFieldRequirement>(kCommand42FieldRequirements)},
    {"move-tab-to-new-column", "control", 10U, "canonical-layout-relocation-v1", false, "", "", std::span<const CommandFieldRequirement>(kCommand43FieldRequirements)},
    {"move-tab-to-split", "control", 10U, "canonical-layout-relocation-v1", false, "", "", std::span<const CommandFieldRequirement>(kCommand44FieldRequirements)},
    {"move-terminal", "control", 9U, "", false, "", "", std::span<const CommandFieldRequirement>{}},
    {"move-workspace", "control", 5U, "", false, "", "", std::span<const CommandFieldRequirement>(kCommand46FieldRequirements)},
    {"new-browser-tab", "control", 5U, "", false, "", "", std::span<const CommandFieldRequirement>(kCommand47FieldRequirements)},
    {"new-pane", "control", 9U, "", false, "", "", std::span<const CommandFieldRequirement>(kCommand48FieldRequirements)},
    {"new-pane-right", "control", 9U, "viewport-splits-v1", false, "", "", std::span<const CommandFieldRequirement>(kCommand49FieldRequirements)},
    {"new-screen", "control", 5U, "", false, "", "", std::span<const CommandFieldRequirement>(kCommand50FieldRequirements)},
    ...
    {"split", "control", 5U, "", false, "", "", std::span<const CommandFieldRequirement>(kCommand88FieldRequirements)},
