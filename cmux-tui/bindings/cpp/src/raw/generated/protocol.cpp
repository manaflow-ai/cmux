...
constexpr std::array<CommandFieldRequirement, 2> kCommand91FieldRequirements{{
    {"surface", 9U, "surface-subscribe-filter"},
    {"tree_events", 7U, ""},
}};
constexpr std::array<CommandMetadata, 98> kCommands{{
    ...
    {"shutdown-daemon", "local-admin", 9U, "", false, "", "", std::span<const CommandFieldRequirement>(kCommand88FieldRequirements)},
    ...
    {"subscribe", "frontend", 5U, "", true, "subscribe", "", std::span<const CommandFieldRequirement>(kCommand91FieldRequirements)},
