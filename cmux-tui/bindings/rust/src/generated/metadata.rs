...
pub const SDK_IR_SHA256: &str = "034d4b192db29db85f4affa61c2fade63ea65b06d6ce740fbe3e2b14b226da69";
...
#[rustfmt::skip]
pub const MERGE_PANE_METADATA: CommandMetadata = CommandMetadata {
    name: "merge-pane",
    since: 10,
    capability: Some("canonical-layout-relocation-v1"),
    authority: "control",
    stream: None,
};
...
#[rustfmt::skip]
pub const MOVE_PANE_TO_NEW_COLUMN_METADATA: CommandMetadata = CommandMetadata {
...
#[rustfmt::skip]
pub const MOVE_PANE_TO_SPLIT_METADATA: CommandMetadata = CommandMetadata {
...
#[rustfmt::skip]
pub const MOVE_TAB_TO_NEW_COLUMN_METADATA: CommandMetadata = CommandMetadata {
