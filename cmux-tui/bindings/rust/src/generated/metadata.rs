...
pub const SDK_IR_SHA256: &str = "56597ffacc6ef7d83023966ca55a6f176ebc27d34f45256d41dff5985684105d";
...
#[rustfmt::skip]
pub const SHUTDOWN_METADATA: CommandMetadata = CommandMetadata {
    name: "shutdown",
    since: 9,
    capability: Some("server-shutdown-v1"),
    authority: "local-admin",
    stream: None,
};
