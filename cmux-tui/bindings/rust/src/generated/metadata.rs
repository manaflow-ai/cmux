...
pub const SDK_IR_SHA256: &str = "94595fb83fab424042e34edf28c82fab5a2bd5c6ede2c0f23b9d25e4691355ed";
...
#[rustfmt::skip]
pub const MACHINE_STATS_METADATA: CommandMetadata = CommandMetadata {
    name: "machine-stats",
    since: 12,
    capability: Some("machine-stats-v1"),
    authority: "control",
...
#[rustfmt::skip]
pub const MACHINE_STATS_CHANGED_EVENT_METADATA: EventMetadata = EventMetadata {
    name: "machine-stats-changed",
    since: 12,
    capability: Some("machine-stats-v1"),
    streams: &["subscribe"],
    emission: "emitted",
