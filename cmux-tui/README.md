...
Cloud Linux devbox daemons are identified by their `/etc/cmux/tool-versions`
image marker. For their provider-owned browser, the daemon configures a bounded
temporary download directory and retains a
