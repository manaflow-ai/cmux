...
The authenticated remote daemon has an independent protocol version. [`remote-daemon.md`](remote-daemon.md) and [`remote-rpc.md`](remote-rpc.md) define remote protocol 3; `mux-control` carries control protocol 9 inside that session.
...
| `remote-daemon.md` | Remote protocol 3 authority, transport, authentication, reliability, and service contract |
| `remote-rpc.md` | Remote protocol 3 workspace RPC envelopes, schemas, process execution, diffs, and routes |
