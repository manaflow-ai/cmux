...
| --- | --- |
| Version check | Call `identify` or require the caller to supply protocol compatibility before using newer features; require named capabilities for build-level additions such as initial attach sizing |
