...
- query OSC 10 and OSC 11 briefly at startup; use OSC 11 only to select
  automatic cmux chrome, with a dark fallback when it has no reply. Keep the
  configured terminal defaults unchanged;
