...
This file specifies the JSON command contract for the cmux-tui protocol. Implemented commands match protocol v12 in `cmux-tui/crates/cmux-tui-core/src/server.rs`.
