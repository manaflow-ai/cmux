...
That line builds on `1d111a072`, the fork-main merge of
https://github.com/manaflow-ai/ghostty/pull/182, which integrates the cached,
enablement-gated macOS unified logger line from `6dc671074` with
`19d03fa4d`. The logger line landed through
https://github.com/manaflow-ai/ghostty/pull/177. `19d03fa4d` suppresses empty
opener stderr diagnostics on top of `f0f8273b7`, the iOS startup
locale/crash-reporting order fix. That commit follows `88357634c`, the
fork-main merge of https://github.com/manaflow-ai/ghostty/pull/175. That
previous merge combines
