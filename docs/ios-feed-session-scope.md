...
| V05 | [macOS build run](https://github.com/manaflow-ai/cmux/actions/runs/34922165927) succeeded. Tag `xfd2` was installed locally. | Includes the runtime fixes, predates later harness-only changes. Personal-account sign-in remains unresolved. |
