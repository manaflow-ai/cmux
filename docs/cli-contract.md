...
`cmux events` validates the ack and heartbeat shape plus event sequences, warns
on stderr when `ack.resume.gap` requires snapshot recovery, and uses reconnect
