...
- [ ] macOS executable
  ...
  - [ ] Replace the 26 importing files remaining under `Sources`, including the
    application root, feed, and sidebar. Workspace, terminal, browser, and the
    browser design-mode composer are native AppKit.
