...
var commands = []commandSpec{
	...
	{name: "new-pane", proto: protoV2, v2Method: "pane.create", flagKeys: []string{"workspace", "direction", "type", "url", "bundle"}, defaultParams: map[string]any{"direction": "right"}},
	{name: "new-surface", proto: protoV2, v2Method: "surface.create", flagKeys: []string{"workspace", "pane", "type", "url", "bundle"}},
