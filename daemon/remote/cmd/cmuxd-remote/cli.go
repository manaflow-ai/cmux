...
doneFlags:
	...
	if cmdName == "omo-slim" || cmdName == "omos" {
		return runOMOSlimRelay(socketPath, cmdArgs, refreshAddr)
	}
	if cmdName == "omx" {
...
func cliUsage() {
	...
	fmt.Fprintln(os.Stderr, "  omo-slim|omos [args...]   Launch OpenCode with oh-my-opencode-slim and cmux integration")
