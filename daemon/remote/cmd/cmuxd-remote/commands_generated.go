// Code generated by go generate (cmd/cmuxd-remote/gen/main.go); DO NOT EDIT.
...
var commands = []commandSpec{
	{
		name:      "break-pane",
		v2Method:  "pane.break",
		flagKeys:  []string{"pane", "surface", "workspace", "window", "focus"},
	...
	},
	{
		name:      "join-pane",
		v2Method:  "pane.join",
		flagKeys:  []string{"target-pane", "pane", "surface", "workspace", "window", "focus"},
		boolFlags: []string{"focus"},
	},
	{
		name:     "jump-to-unread",
