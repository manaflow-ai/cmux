...
func usage(w io.Writer) {
	...
	_, _ = fmt.Fprintln(w, "  cmuxd-remote serve --ws --auth-lease-file <path> [--rpc-auth-lease-file <path>] [--auth-public-key <base64-ed25519-public-key>] [--listen 127.0.0.1:7777]")
